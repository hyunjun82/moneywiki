...
```
┌──────────────────────────────────┬──────────────────────────────┐
│  핵심 연관검색어 (자연어, 쉼표 OK) │  보조 롱테일 / 질문형          │
│  ← 허브 주제를 대표하는 키워드 →  │  ← 추가 검색 의도·관련 질문 → │
└──────────────────────────────────┴──────────────────────────────┘
                      ↑ 파이프 | 구분자 ↑
                       총 60자 이내

[왼쪽] 허브 주제의 핵심 연관검색어를 자연어로 배치. 쉼표(,) 사용 가능.
       단어 나열 금지 → 사람이 읽었을 때 자연스러운 문장/구(句).
[오른쪽] 보조 의도를 자연어로. 질문형(~은?/~까지) 가능.
...
GOOD: '퇴직금 계산 방법, 지급 기한 | 세금과 지연이자까지'
  → 왼쪽: 핵심 키워드 자연 배치  /  오른쪽: 추가 의도 자연어

GOOD: '2026 기초생활수급자 조건과 급여 | 소득인정액 계산부터 신청까지'
  → 왼쪽: 허브 대표 키워드  /  오른쪽: 범위를 보여주는 자연어

BAD:  '2026 문화누리카드 신청 대상 사용처 | 1인당 최대 16만원'
  → 왼쪽 단어 나열. 오른쪽도 검색 의도 아님(숫자 정보).

BAD:  '기초생활수급자 총정리 | 2026 완벽 가이드'
...
meta: {
  ...
  // 구조: "[핵심 연관검색어, 자연어] | [보조 롱테일/질문]"
  // 60자 이내, | 필수, 키워드 나열 금지 → 쉼표+자연어!
  // GOOD: '퇴직금 계산 방법, 지급 기한 | 세금과 지연이자까지'
  // BAD:  '2026 문화누리카드 신청 대상 사용처 | 1인당 최대 16만원'
  title: '핵심 키워드, 자연어 배치 | 보조 롱테일 또는 질문형',  // 60자 이내
