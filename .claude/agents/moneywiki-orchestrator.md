...
- **중간 승인 요청 금지.** 사용자 입력은 키워드 하나, 출력은 완성본 보고 하나.
  멈추고 묻는 경우는 딱 둘: 신규 URL 생성 필요 / 301 리다이렉트 적용
- **규칙 추가는 규칙 삭제와 교환.** 이 명세들에 항목을 덧대지 말 것 —
  바꾸고 싶으면 정본 템플릿(docs/moneywiki-article-template.html)을 고친다
