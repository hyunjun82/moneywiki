...
본문 전체에서 다음 금지 단어를 grep (2026-08-12 템플릿 기준으로 개정):
- "있거든요"
- "또한"
- "결론적으로"
- "다양한"
...
("총정리"는 meta.title에서만 허용, 본문 남용 시 WARN. "확인하세요"는 CTA 유도 문맥이면 허용)

문체 검증 (2026-08-12 역전):
- 기준 문체 = **합니다체** (정본 템플릿 docs/moneywiki-article-template.html)
- "~이에요/~예요"가 본문의 주 문체면 FAIL (템플릿 문체 위반)
...
- **평서형 종결어미 FAIL**: "~해요" "~합니다" "~됩니다" "~된다"로 끝나면 FAIL.
  질문형("~되나요?", "~될까?", "~은?")과 명사형 종결은 허용
