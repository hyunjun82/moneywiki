...
/* ───────── Guides ───────── */
const GUIDES = [
  { num: "01", cat: "근로·급여", title: "퇴직금 완벽 가이드", excerpt: "계산법부터 IRP 이전, 절세 방법까지. 1년 이상 근무했다면 누구나 받는 법정 급여를 한 번에 정리했어요.", author: "M", authorLabel: "공식 출처 인용", meta: "3분 · 2026.05.10", slug: "퇴직금" },
  { num: "02", cat: "세금", title: "연말정산 절세 전략", excerpt: "놓치기 쉬운 공제 8가지. 신용카드, 의료비, 교육비 등 직장인이 가장 많이 놓치는 항목과 환급 늘리는 법.", author: "M", authorLabel: "공식 출처 인용", meta: "4분 · 2026.05.08", slug: "연말정산" },
  { num: "03", cat: "부동산", title: "전세자금대출 총정리", excerpt: "은행별 한도·금리 비교. 버팀목·일반·신혼부부 중 본인 상황에 맞는 전세대출을 한눈에 확인하세요.", author: "M", authorLabel: "공식 출처 인용", meta: "5분 · 2026.05.05", slug: "전세자금대출" },
  { num: "04", cat: "실업급여", title: "실업급여 받는 법", excerpt: "자격부터 신청까지 단계별. 자발적 퇴사·알바·계약직 가능 여부와 헷갈리는 자격 요건을 차근차근 안내해요.", author: "M", authorLabel: "공식 출처 인용", meta: "3분 · 2026.05.01", slug: "실업급여" },
  { num: "05", cat: "금융", title: "개인사업자 대출 갈아타기", excerpt: "금리 비교 한 번에. 스마트폰으로 5분, 1금융·2금융 신용대출 금리를 비교하고 갈아타는 가장 빠른 방법.", author: "M", authorLabel: "공식 출처 인용", meta: "3분 · 2026.04.28", slug: "개인사업자-신용대출-갈아타기" },
  { num: "06", cat: "법률", title: "이혼 퇴직금 재산분할", excerpt: "대상·청구 조건·절차. 퇴직금이 재산분할 대상인지, 어떤 경우 청구 가능한지 자세히 안내해요.", author: "M", authorLabel: "공식 출처 인용", meta: "6분 · 2026.04.22", slug: "이혼-퇴직금-재산분할-대상" },
];
