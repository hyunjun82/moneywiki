...
const STEPS = [
  ...
  {
    title: "평균임금 구성 항목 대조",
    desc: "정산서에 표시된 3개월 총임금이 급여명세서 합계와 일치하는지 직접 더해봐요. 정기 상여금은 연간 총액 ÷ 12 × 3으로 환산해 포함시켜야 해요. 식대·교통비 같은 고정수당도 빠지지 않았는지 짚어봐요.",
...
const FAQS = [
  ...
  },
  {
    ...
    a: "퇴직소득세가 원천징수된 금액이 입금되거든요. 정산서는 세전 퇴직금이고, 실제 입금은 세후 금액이에요. 원천징수영수증에서 원천징수된 세금 금액을 확인해봐요.",
  },
  {
