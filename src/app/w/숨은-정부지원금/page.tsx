  ...
  return (
    <div style={{ maxWidth: "720px", margin: "0 auto", padding: "0 16px 40px" }}>
      ...
      <Checklist
        title="대상별 해당 지원금"
        items={[
          { id: "c1", label: "농업인 (농업경영체 등록) → 기본형 공익직불제 + 농업인 건강·연금보험료 지원 + 영농도우미", checked: false },
          { id: "c2", label: "장애인 → 장애수당 or 장애인연금 (중증) + 장애아동수당 (18세 미만 자녀)", checked: false },
          { id: "c3", label: "국민연금 지역가입자 (저소득) → 저소득 지역가입자 보험료 지원 50%", checked: false },
          { id: "c4", label: "65세 이상 독거노인 → 독거노인·장애인 응급안전안심서비스 (무료 장비 설치)", checked: false },
          { id: "c5", label: "만 9~24세 여성청소년 (저소득) → 여성청소년 생리용품 지원 월 13,000원", checked: false },
          { id: "c6", label: "청소년복지시설 퇴소자 → 자립지원수당 월 50만원", checked: false },
          { id: "c7", label: "위기 상황 청소년 → 특별지원 연 최대 200만원 (1388 상담)", checked: false },
          { id: "c8", label: "취약계층 채용한 사업주 → 고용촉진장려금 1인당 최대 720만원", checked: false },
          { id: "c9", label: "임신 예정 부부 → 임신 사전건강관리 지원사업 무료 검진", checked: false },
          { id: "c10", label: "청소년 한부모 or 부모 → 아동양육비 월 20~35만원", checked: false },
          { id: "c11", label: "다문화가족 자녀 → 기초학습·진로설계·교육활동비 지원", checked: false },
          { id: "c12", label: "예술인 (예술활동증명 완료) → 국민연금 보험료 50% 지원", checked: false },
        ]}
      />
