  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        "네 잘못으로 해고된 거니까 실업급여 안 돼."<br />
        회사에서 이런 말을 들으면 그냥 포기하게 되죠.<br /><br />
        그런데 <strong>모든 귀책사유 해고가 실업급여 대상 밖인 건 아니에요</strong>.<br />
        <a href="https://www.law.go.kr/법령/고용보험법" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험법 제58조</a>가 말하는 &ldquo;중대한 귀책사유&rdquo;는 범위가 꽤 좁아요.<br />
        횡령, 폭행, 기밀 유출 같은 수준이어야 하죠. 업무능력 부족이나 경미한 규칙 위반은 해당 안 돼요.
      </p>
      ...
      <p style={body}>
        <a href="https://www.law.go.kr/법령/고용보험법" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험법 제58조</a>에서 실업급여 수급을 제한하는 이직 사유를 정해놨어요. 여기서 말하는 &ldquo;중대한 귀책사유&rdquo;는 일반적으로 생각하는 &ldquo;잘못&rdquo;보다 훨씬 범위가 좁아요. 구체적인 목록은 <a href="https://www.law.go.kr/법령/고용보험법시행규칙" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험법 시행규칙 별표2</a>에 나와 있죠.
      </p>
      <p style={body}>
        대표적으로 형법 위반 행위(횡령, 배임, 절도 등), 고의로 사업장에 막대한 재산상 손해를 끼친 경우, 정당한 사유 없이 장기간(보통 7일 이상) 무단결근을 한 경우가 해당돼요. 핵심은 &ldquo;고의성&rdquo;과 &ldquo;중대한 손해&rdquo;예요. 실수로 일을 못 한 건 여기에 해당하지 않죠.
      </p>
      <p style={body}>
        이게 왜 중요하냐면, 회사가 &ldquo;귀책사유&rdquo;라고 해고해도 고용센터가 보기에 &ldquo;중대한&rdquo; 수준이 아니면 실업급여를 받을 수 있기 때문이에요. 회사의 판단과 고용센터의 판단은 다를 수 있죠. 그래서 해고됐다고 바로 포기하면 안 돼요.
      </p>
      ...
      <p style={{ ...body, marginTop: 14 }}>
        고용센터에서 중대한 귀책사유 해당 여부를 최종 판단해요. 회사가 징계해고를 했더라도 그 사유가 시행규칙 별표2에 열거된 항목에 해당하지 않으면 실업급여를 받을 수 있죠. 반대로 회사가 &ldquo;권고사직&rdquo;이라고 처리했어도 실제로는 형법 위반이 원인이었다면 제한될 수 있어요.
      </p>
      ...
      <p style={body}>
        중대한 귀책사유에 해당하지 않아서 실업급여를 받게 되면, 금액 계산은 일반적인 비자발적 퇴사와 동일해요. 퇴직 전 3개월 평균임금의 60%가 기준이고, 하루 상한 68,100원, 하한 66,048원이 적용되죠.
      </p>
      <p style={body}>
        수급기간은 나이와 고용보험 가입기간으로 결정돼요. 50세 이상이면 같은 가입기간이어도 30일을 더 받아요. 다만 귀책사유 해고의 경우 고용센터 심사에 시간이 좀 더 걸릴 수 있어요. 일반적인 비자발적 퇴사보다 서류 확인이 꼼꼼하니까요.
      </p>
      ...
      <p style={body}>
        계산기 결과를 보면 아시겠지만, 실업급여 금액이 적지 않아요. 5년 가입 기준으로도 약 1,200만원이에요. &ldquo;귀책사유니까 안 되겠지&rdquo;하고 넘어가면 이 돈을 그냥 버리는 거예요. 일단 고용센터에 가서 물어보는 게 답이에요.
      </p>
      ...
      <p style={body}>
        실무에서 가장 헷갈리는 부분이에요. 회사는 &ldquo;너 잘못이야&rdquo;라고 하는데, 고용보험법 기준으로는 중대하지 않은 경우가 많죠. 업무능력 부족은 대표적인 예예요. 실적이 안 나온다고 해고했다면 이건 근로자의 &ldquo;중대한&rdquo; 잘못이 아니에요.
      </p>
      <p style={body}>
        동료와의 갈등이나 상사와의 불화로 해고된 경우도 마찬가지예요. 물리적 폭행이 아닌 이상 중대한 귀책사유로 보기 어렵죠. 경미한 취업규칙 위반(지각, 복장 규정 위반, 사내 절차 미준수 등)으로 해고된 것도 실업급여 제한 사유에 해당하지 않아요.
      </p>
      <p style={body}>
        영업 비밀이 아닌 일반 정보를 동료에게 공유한 경우, 과실로 인한 경미한 손해(실수로 물건을 파손한 정도), 시용기간(수습기간) 만료 후 본채용 거부도 중대한 귀책사유가 아니에요. 이런 상황에서 해고됐다면 실업급여를 신청할 수 있죠.
      </p>
      ...
      <p style={body}>
        해고 사유를 정확히 파악하는 게 첫 번째예요. 해고통지서나 징계서류에 적힌 사유를 고용보험법 시행규칙 별표2와 대조해보세요. 거기 나와 있지 않은 사유라면 실업급여 수급 가능성이 높아요.
      </p>
      ...
      <p style={body}>
        고용센터가 중대한 귀책사유에 해당한다고 결정하면 실업급여가 바로 거부돼요. 하지만 여기서 끝이 아니에요. 이의신청 절차가 있으니까요. 심사청구를 처분을 안 날로부터 90일 이내에 고용보험심사관에게 제출하면 돼요.
      </p>
      <p style={body}>
        심사청구가 기각되면 재심사청구를 30일 이내에 고용보험심사위원회에 할 수 있어요. 여기서도 안 되면 행정소송까지 가능하죠. 실제로 &ldquo;중대한 귀책사유&rdquo;의 범위를 놓고 다퉈서 뒤집힌 사례가 적지 않아요. 특히 &ldquo;무단결근 일수&rdquo;나 &ldquo;손해의 중대성&rdquo;에 대한 판단은 사안마다 다를 수 있죠.
      </p>
      <p style={body}>
        이의신청을 할 때는 해고 당시 정황을 구체적으로 설명하는 게 중요해요. &ldquo;회사가 교육이나 배치전환 없이 바로 해고했다&rdquo;, &ldquo;손해 금액이 경미했다&rdquo;, &ldquo;고의가 아니라 과실이었다&rdquo; 같은 점을 소명하면 뒤집힐 가능성이 올라가요.
      </p>
      ...
      <p style={body}>
        해고예고수당도 마찬가지예요. 해고 30일 전에 통보하지 않았다면 30일분의 통상임금을 해고예고수당으로 받을 권리가 있어요. 다만 근로자가 회사에 중대한 손해를 끼친 경우(근로기준법 시행규칙 별표)에는 해고예고수당 의무가 면제되니 이 부분은 따로 확인이 필요하죠.
      </p>
      <p style={body}>
        귀책사유 해고를 당하면 심리적으로 위축되기 쉬워요. 그래서 받을 수 있는 것도 안 챙기는 경우가 많죠. 실업급여가 안 되더라도 퇴직금, 해고예고수당, 미사용 연차수당은 반드시 챙기세요. 임금체불이면 고용노동부에 진정을 넣으면 돼요.
      </p>
