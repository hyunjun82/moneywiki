...
// Q1: 귀책사유 해고를 당했는데 회사나 지인이 "실업급여 못 받는다"고 해서 사실인지 확인하러 온 상황
// Q2: 내 해고 사유가 중대한 귀책사유에 해당하는지 판단하고, 해당 안 되면 신청, 해당되면 이의신청 절차를 밟는다
// Q3: 중대한 귀책사유의 법적 기준(별표2), 경미한 사유와의 구분, 이의신청 기한과 방법, 퇴직금은 별도라는 점
// Q4: GreenBox(제한/비제한 대조), EligibilityChecker(체크), Calculator(금액), Checklist(신청 전 준비), FAQ(5개+)
...
const FAQS = [
  {
    ...
    a: "아니에요. 단순 업무능력 부족은 중대한 귀책사유가 아니에요. 회사가 교육이나 배치전환 노력 없이 바로 해고한 거라면 오히려 부당해고일 수 있죠. 실업급여는 신청 가능하죠.",
  },
  {
    q: "지각을 여러 번 했다는 이유로 해고됐어요. 실업급여 받을 수 있나요?",
    a: "횟수와 정도에 따라 달라요. 경고도 없이 몇 번 지각으로 해고한 건 중대한 귀책사유로 보기 어렵죠. 다만 수십 회 반복에 여러 차례 경고까지 받았다면 결론이 달라지고요. 고용센터에서 구체적으로 판단하죠.",
  },
  {
  ...
  },
  {
    ...
    a: "형사 유죄 판결 전이라도 고용센터가 자체 판단으로 중대한 귀책사유 해당 여부를 결정해요. 해고 사유가 횡령이면 실업급여가 제한될 가능성이 높죠. 무죄가 확정되면 그때 재신청할 수 있고요.",
  },
  {
    q: "중대한 귀책사유로 실업급여가 거부됐는데, 불복할 수 있나요?",
    a: "할 수 있죠. 고용센터 결정에 불복하면 심사청구(90일 이내)를 하고, 그래도 안 되면 재심사청구(30일 이내)를 할 수 있죠. 귀책사유의 &ldquo;중대성&rdquo;에 대한 판단은 사안마다 다를 수 있으니 적극적으로 다퉈볼 만해요.",
  },
  {
    q: "실업급여가 제한돼도 퇴직금은 받을 수 있나요?",
    a: "퇴직금은 별개의 제도라 실업급여와 무관하죠. 1년 이상 근무했다면 귀책사유 해고와 상관없이 퇴직금을 받을 권리가 있고요. 사업주가 안 주면 고용노동부에 진정을 넣으면 되죠.",
  },
];
...
const RELATED = [
  ...
  },
  {
    ...
    description: "부당해고 구제신청 중에도 실업급여를 받을 수 있죠. 복직하면 반환하지만 심사 중에는 가능하죠.",
  },
  {
    slug: "실업급여-이의신청",
  ...
  return (
    ...
    >
      ...
      <p style={body}>
        ...
        구체적인 목록은{" "}
        <a href="https://www.law.go.kr/법령/고용보험법시행규칙" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험법 시행규칙 별표2</a>에 나와 있고요.
      </p>
      <p style={body}>
      ...
      <p style={body}>
        중대한 귀책사유에 해당하지 않아서 수급이 가능하다면, 금액 계산법은 일반적인 비자발적 퇴사와 동일하죠.
      ...
      <p style={body}>
        ...
        다만 귀책사유 해고의 경우 고용센터 심사에 시간이 좀 더 걸릴 수 있죠.
      ...
      <p style={body}>
        계산기 결과를 보면 금액이 적지 않다는 걸 알 수 있죠.
      ...
      <p style={body}>
        심사청구가 기각되면 <strong>30일 이내</strong>에 재심사청구를 고용보험심사위원회에 할 수 있죠.
        여기서도 안 되면 행정소송까지 가능하죠.
        실제로 &ldquo;중대한 귀책사유&rdquo;의 범위를 놓고 다퉈서 뒤집힌 사례가 적지 않아요.
        특히 &ldquo;무단결근 일수&rdquo;나 &ldquo;손해의 중대성&rdquo;에 대한 판단은 사안마다 다를 수 있죠.
      </p>
      <p style={body}>
      ...
      <p style={body}>
        해고예고수당도 따져봐야 해요.
        해고 30일 전에 통보하지 않았다면 30일분의 통상임금을 해고예고수당으로 받을 권리가 있죠.
      ...
      <p style={body}>
        ...
        <a href="/w/임금체불-실업급여" style={{ color: "#1D9E75", textDecoration: "underline" }}>임금체불</a>이면 고용노동부에 진정을 넣으면 되죠.
      </p>
      ...
      <Disclaimer text="이 글은 2026년 3월 기준 고용보험법과 고용보험법 시행규칙을 바탕으로 작성됐어요. 법령은 개정될 수 있으니 중요한 결정 전에 고용24(ei.go.kr)나 고용센터(1350)에 직접 문의하세요." />
    </ArticleLayout>
  );
}
