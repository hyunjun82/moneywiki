  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        "파견직으로 일하다가 계약이 끝났어요. 파견회사 소속인데 실업급여를 받을 수 있나요?"<br />
        받을 수 있죠. <a href="https://www.law.go.kr/법령/파견근로자보호등에관한법률" style={{ color: "#1D9E75", textDecoration: "underline" }}>파견근로자보호법</a>에 따르면
        파견회사(파견사업주)가 <strong>4대보험을 가입</strong>하고, 파견계약 만료로 퇴직하면 비자발적 퇴사로 인정돼요.<br /><br />
      ...
      <p style={body}>
        파견직은 고용 관계가 좀 복잡해요. 나를 고용한 곳은 <strong>파견회사(파견사업주)</strong>이고, 실제로 출근해서 일하는 곳은 <strong>사용사업체</strong>예요. 월급은 파견회사에서 주고, 4대보험도 파견회사 이름으로 가입돼 있죠.
      </p>
      <p style={body}>
        그래서 퇴직할 때도 파견회사 기준으로 처리해요. 이직확인서를 보내는 곳도, 고용보험 상실 신고를 하는 곳도 전부 파견회사예요. 사용사업체가 아니에요. <a href="https://www.law.go.kr/법령/고용보험법" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험법</a>상 사업주는 파견회사라는 점을 기억하세요.
      </p>
      <p style={body}>
        한 가지 더 중요한 게 있어요. 파견회사가 바뀌지 않는 한 사용사업체가 바뀌어도 고용보험은 끊기지 않아요. A공장에서 B공장으로 배치가 바뀌어도 파견회사가 같으면 계속 근무로 처리되죠. 피보험기간이 이어진다는 뜻이에요.
      </p>

      <GreenBox title="나의 수급자격 체크">
        아래 항목을 체크해서 조건을 충족하는지 확인해 보세요.
      </GreenBox>
      ...
      <p style={body}>
        파견직이라고 조건이 다르지 않아요. <a href="https://www.law.go.kr/법령/고용보험법" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험법</a> 기준으로 퇴직 전 18개월 내에 <strong>피보험단위기간 180일 이상</strong>이면 돼요. 파견 기간이 6개월을 넘겼다면 대부분 이 조건을 충족하죠.
      </p>
      <p style={body}>
        파견계약 만료는 <strong>비자발적 퇴사</strong>로 인정돼요. 내가 그만두고 싶어서 나간 게 아니라 계약이 끝났으니까요. 다만 파견회사에서 계약 연장을 제안했는데 본인이 거부한 경우라면 자발적 퇴사로 볼 수 있으니 주의하세요.
      </p>
      <p style={body}>
        여러 파견회사에서 일한 경력이 있다면 고용보험 가입기간을 합산할 수 있어요. A파견회사에서 3개월, B파견회사에서 4개월 일했다면 합쳐서 7개월로 180일을 넘기죠. 단, 중간에 실업급여를 이미 받은 기간은 제외돼요.
      </p>

      <BorderBox title="파견직 실업급여 3가지 조건">
        1. 퇴직 전 18개월 내 고용보험 가입기간 180일 이상<br />
        2. 비자발적 퇴사 (파견계약 만료 포함)<br />
        3. 재취업 의사와 능력이 있고 구직활동을 할 것
      </BorderBox>
      ...
      <p style={body}>
        파견계약이 만료되면 가장 먼저 할 일은 <strong>파견회사에 이직확인서 발급을 요청</strong>하는 거예요. 파견회사가 고용센터로 이직확인서를 보내야 신청 절차가 시작되죠. 사용사업체가 아니라 반드시 파견회사에 요청해야 해요.
      </p>
      <p style={body}>
        이직확인서가 처리되면 <a href="https://www.ei.go.kr" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용24</a>에서 수급자격 신청자 온라인 교육을 이수하세요. 그 다음 관할 고용센터에 방문하거나 온라인으로 수급자격을 신청해요. 심사가 끝나면 4주마다 실업인정을 받으면서 급여가 지급되죠.
      </p>
      <p style={body}>
        파견회사가 폐업했거나 연락이 안 될 때가 가장 난감한 상황이에요. 이런 경우에는 <strong>근로복지공단(1588-0075)</strong>에 직접 피보험자격 상실 확인을 신청할 수 있어요. 근로계약서, 급여명세서, 통장 입금내역 등 파견회사에서 일한 증빙을 미리 챙겨두세요.
      </p>
      ...
      <p style={body}>
        사용사업체가 "더 이상 파견 안 받겠다"고 통보하는 경우가 종종 생겨요. 이때 바로 퇴직이 되는 건 아니에요. 파견회사와 근로계약이 살아있으면, 파견회사가 다른 사용사업체에 배치해줄 수도 있죠.
      </p>
      <p style={body}>
        문제는 파견회사가 새로운 배치를 해주지 않는 경우예요. "대기 발령" 상태로 두면서 급여도 안 주고, 새 배치도 안 하면 사실상 퇴직이나 마찬가지죠. 이런 상황이 되면 파견회사 인사팀에 명확히 확인해야 해요. "내 근로관계가 종료된 건지, 대기 상태인 건지"를요.
      </p>
      <p style={body}>
        근로관계가 공식 종료되면 그때 이직확인서를 발급받고 실업급여를 신청하면 돼요. 대기 상태에서 급여를 못 받는 기간이 길어지면, <a href="https://www.moel.go.kr" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용노동부</a>(1350)에 상담해서 정확한 처리 방향을 잡으세요.
      </p>

      <BorderBox title="파견회사가 바뀔 때">
        같은 파견회사 내 사업체 이동 → 계속 근무 (가입기간 유지)<br />
        파견회사 자체가 변경 → 이전 회사 퇴직 + 새 회사 입사<br />
        이전 가입기간 → 합산 가능 (실업급여 미수급분)
      </BorderBox>
      ...
      <p style={body}>
        파견직도 일반 근로자와 동일한 수급기간이 적용돼요. 고용보험 가입기간과 나이에 따라 <strong>120일에서 최대 270일</strong>까지 받을 수 있죠. 여러 파견회사에서 일한 기간도 합산되니까, 생각보다 가입기간이 길 수 있어요.
      </p>
      <p style={body}>
        실업급여 금액은 퇴직 전 3개월 평균임금의 60%예요. 2026년 기준 하한액은 1일 66,048원이고, 상한액은 68,100원이죠. 파견직 급여가 낮은 편이라 하한액에 해당하는 경우가 많은데, 하한액이 최저임금의 80%라서 어느 정도는 보장돼요.
      </p>
      <p style={body}>
        수급기간 중에도 구직활동을 해야 해요. 4주에 한 번 실업인정일에 고용센터를 방문하거나 온라인으로 구직활동을 보고하면 돼요. 구직활동 없이 실업인정을 빠뜨리면 해당 기간 급여가 지급되지 않으니 꼭 챙기세요.
      </p>

      <GreenBox title="수급기간 요약 (가입기간별)">
        1년 미만 → 120일<br />
        1~3년 → 150일 (50세 이상 180일)<br />
        3~5년 → 180일 (50세 이상 210일)<br />
        5~10년 → 210일 (50세 이상 240일)<br />
