...
const CHECK_ITEMS = [
  ...
  { id: "c3", label: "회사에 지급을 요청했거나 내용증명을 보낸 적이 있어요" },
...
const STEPS = [
  {
    title: "소멸시효 확인",
    desc: "퇴직일로부터 3년이에요. 퇴직일이 2023년 1월 1일이면 2026년 1월 1일 전에 청구해야 해요. 날짜가 촉박하다면 지금 당장 행동해야 하죠.",
    tip: "내용증명 발송만으로도 시효를 중단시킬 수 있어요",
  },
  {
    title: "시효 중단 조치",
    desc: "소멸시효를 멈추려면 청구 행위가 필요해요. 내용증명 발송, 소송 제기, 지급명령 신청 — 이 중 하나만 해도 시효가 중단돼요. 이후 6개월 내에 소송을 제기해야 완전히 중단되죠.",
    tip: "우체국 내용증명은 법적 청구 의사 표명으로 인정돼요",
  },
  {
    title: "고용노동부 진정 접수",
    desc: "진정을 접수하면 시효 진행이 사실상 멈춰요. 진정 처리 기간은 1~3개월이지만, 접수된 사실 자체가 청구 의사를 증명해요.",
    tip: "minwon.moel.go.kr에서 온라인 접수",
  },
  {
    title: "소송 또는 지급명령 신청",
...
const FAQS = [
  {
    ...
    a: "원칙적으로 청구권이 소멸해요. 다만 회사가 소멸시효를 모르고 지급한다면 유효한 변제가 돼요. 시효가 지났어도 상대방이 이의를 제기하지 않으면 받을 수 있는 경우도 있죠.",
  },
  {
    q: "내용증명을 보내면 소멸시효가 멈추나요?",
    a: "6개월 동안 일시 중단돼요. 중단된 상태에서 6개월 내에 소송이나 지급명령 신청을 해야 완전히 중단되죠.",
  },
  {
    q: "회사가 파산했어도 3년 시효가 적용되나요?",
    a: "적용돼요. 단, 체당금 제도로 정부에서 대신 받을 경우엔 별도 신청 기한이 있어요. 파산 선고일로부터 2년 내 신청해야 하죠.",
  },
  {
...
const RELATED = [
  {
    slug: "퇴직금-미지급-신고",
    title: "퇴직금 미지급 신고 방법",
    description: "3년 안에 신고하는 방법을 단계별로 안내해요.",
  },
  {
    slug: "퇴직금-지연이자",
    title: "퇴직금 지연이자 연 20% 받는 방법",
    description: "지연이자 계산과 청구 절차를 정리했어요.",
  },
  {
    slug: "퇴직금-계산법",
    title: "퇴직금 계산법, 얼마나 받을까?",
    description: "내 퇴직금이 얼마인지 계산기로 확인해보세요.",
  },
];
  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        퇴직금 청구권은 퇴직일로부터 <strong>3년</strong>이 지나면 소멸해요.
        <a href="https://www.law.go.kr/법령/근로기준법" style={{ color: "#1D9E75", textDecoration: "underline" }}>근로기준법 제49조</a>에 명시된 기한이에요.
        "나중에 받아야지"하고 미루다가 3년이 지나면 법적으로 청구할 수 없어요.
        아직 시효 내라면 지금 바로 행동해야 해요.
      ...
      <p style={body}>
        소멸시효는 퇴직일 당일부터 3년이에요. 퇴직금을 한 번도 받지 못했고, 아직 3년이 지나지 않았다면 청구가 가능하죠.
        퇴직금 일부만 받았다면 나머지 미지급분도 퇴직일 기준 3년이에요.
      </p>
      <p style={body}>
        시효가 촉박하다면 지금 당장 내용증명을 발송해도 6개월 중단 효과가 있어요. 그 사이에 소송이나 지급명령 신청을 하면 시효가 완전히 중단되죠.
      </p>
      ...
      <GreenBox title="3년 시효가 임박했다면 지금 내용증명 발송!">
        ...
        "퇴직금 ○○만원 지급 요청, 이내 미지급 시 법적 조치 예정"이라는 내용이면 충분해요.
