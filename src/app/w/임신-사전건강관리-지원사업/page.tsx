...
// Q1. 임신을 계획하거나 준비 중인 여성이 건강 상태를 미리 점검하고 싶은 상황
// Q2. 임신 사전건강관리 무료 검사 항목을 파악하고 보건소에서 검사받는다
// Q2-1. 가까운 보건소 방문 또는 정부24에서 신청 완료
  ...
  return (
    <div style={{ maxWidth: "720px", margin: "0 auto", padding: "0 16px 40px" }}>
      <h1 style={{ fontSize: "clamp(20px,4vw,26px)", fontWeight: 800, lineHeight: 1.35, marginBottom: "16px" }}>
        <span style={{ color: "#1D9E75" }}>임신 사전건강관리 지원 무료 검사 항목</span>
      </h1>

      <p style={{ fontSize: "15px", lineHeight: 1.8, color: "#374151", marginBottom: "12px" }}>
        임신을 준비 중이라면 임신 전 건강 상태를 미리 확인하는 게 중요해요. 풍진이나 B형간염 같은 감염이 임신 중에 발견되면 태아에 큰 영향을 줄 수 있죠. 정부는 임신을 계획하는 여성이 보건소에서 12가지 항목을 무료로 검사받을 수 있도록 지원하고 있죠.
      </p>
      <p style={{ fontSize: "15px", lineHeight: 1.8, color: "#374151", marginBottom: "12px" }}>
      ...
      <H2>검사 대상과 신청 자격</H2>
      <p style={{ fontSize: "15px", lineHeight: 1.8, color: "#374151", marginBottom: "12px" }}>
        임신 사전건강관리 검사는 임신을 계획하거나 준비 중인 여성이라면 누구나 받을 수 있죠. 나이 제한이나 소득 기준이 없어서 임신을 준비하는 모든 여성에게 열려 있는 서비스예요. 결혼 여부나 임신 경험 유무와 관계없이 신청 가능해요.
      </p>
      <p style={{ fontSize: "15px", lineHeight: 1.8, color: "#374151", marginBottom: "12px" }}>
      ...
      <H2>무료 검사 12가지 항목</H2>
      <p style={{ fontSize: "15px", lineHeight: 1.8, color: "#374151", marginBottom: "12px" }}>
        임신 사전건강관리 검사 항목은 임신 중 위험 요소를 미리 파악하기 위한 항목들로 구성돼요. 감염성 질환, 혈액 이상, 내분비 이상, 자궁 상태 등을 종합적으로 점검해요. 12가지 항목 모두를 검사받을 수도 있고, 필요한 항목만 선택할 수도 있죠.
      </p>
      <p style={{ fontSize: "15px", lineHeight: 1.8, color: "#374151", marginBottom: "12px" }}>
      ...
      <p style={{ fontSize: "15px", lineHeight: 1.8, color: "#374151", marginBottom: "12px" }}>
        신청은 가까운 보건소를 방문하거나 정부24를 통해 신청할 수 있죠. 보건소 방문 시 모자보건실 또는 검사실을 찾으면 돼요. 당일 검사가 가능한 보건소도 있지만, 일부는 예약이 필요하니 사전 확인이 필요해요. 보건소별로 검사 가능한 요일과 시간이 다를 수 있어서 전화 확인 후 방문하는 게 좋아요.
      </p>
      <p style={{ fontSize: "15px", lineHeight: 1.8, color: "#374151", marginBottom: "12px" }}>
