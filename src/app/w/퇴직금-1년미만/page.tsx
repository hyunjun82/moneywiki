...
//     만 1년을 못 채우고 퇴직했거나 퇴직 예정이라, 퇴직금을 받을 수 있는지 불안한 상황이에요.
// Q2. 이 사람이 이 글을 읽고 나서 할 수 있어야 하는 행동은?
//     내 근무 기간이 퇴직금 대상인지 판단하고, 퇴직금이 없어도 연차수당·실업급여를 챙기는 행동이에요.
// Q3. 이 행동을 하려면 반드시 알아야 하는 정보는?
//     만 1년 계산법, 연차수당 발생 조건, 실업급여 신청 요건, 1년 직전 해고 시 부당해고 대응법이에요.
// Q4. 이 정보를 가장 잘 전달하는 형태는?
//     결론 GreenBox → 계산기 시뮬레이션 → 단계별 Steps → 체크리스트 순서로 행동 흐름을 따라가는 구조이에요.
...
const FAQS = [
  ...
  },
  {
    ...
    a: "법정 퇴직금은 없어요. 하지만 연차 미사용 수당은 청구할 수 있고, 비자발적 계약 종료라면 실업급여도 신청 가능해요. 1년 미만이라도 챙길 것들이 있죠.",
  },
  {
  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        ...
        연차 미사용 수당과 실업급여는 퇴직금과 별개 요건으로 챙길 수 있죠.
      </p>

      <Divider />
      <ArticleAd position="intro" />

      <H2>퇴직금이 발생하지 않는 상황인지 체크해봐요</H2>
      <p style={body}>
        1년 미만 근무자라면 법정 퇴직금이 없어요.
        주 15시간 미만 근무나 만 1년이 안 되는 경우가 이에 해당해요.
        의도적으로 1년 직전에 계약을 끊는 경우엔 부당해고 여부를 따져봐야 해요.
      </p>
      <p style={body}>
        아래 항목에서 내 상황이 몇 개 해당하는지 살펴봐요.
      ...
      <EligibilityChecker
        items={CHECK_ITEMS}
        allMatchText="법정 퇴직금 대상이 아닌 상황이에요. 연차수당과 실업급여 요건을 아래에서 살펴봐요."
        partialMatchText="상황이 복합적이에요. 고용노동부(1350) 또는 고용24에서 정확한 안내를 받아봐요."
      />

      <Divider />

      <H2>1년 미만 퇴직 시 받을 수 있는 금액 시뮬레이션</H2>
      <p style={body}>
        1년 미만이면 퇴직금은 0원이에요. 아래 계산기로 직접 돌려보면 이해가 쉬워요.
      ...
      <p style={body}>
        ...
        근로계약서는 근무 기간과 시간을 증명하는 핵심 서류에요.
      </p>
      <p style={body}>
        실업급여 신청을 위한 고용보험 피보험자격 상실 신고서는 회사가 처리해야 해요.
        퇴직 후 지연되는 경우가 있으니 고용24에서 처리 여부를 직접 살펴봐요.
      </p>
      ...
      <p style={body}>
        ...
        연차수당 청구, 실업급여 신청, 부당해고 구제까지 순서대로 챙겨봐요.
      </p>
      ...
      <H2>퇴직 전 최종 체크리스트</H2>
      <p style={body}>
        연차수당은 청구하지 않으면 소멸해요. 퇴직 전에 아래 항목들을 순서대로 살펴봐요.
        소멸시효를 놓치면 받을 수 있는 돈도 사라지고요.
      </p>
