...
const FAQS = [
  { q: "연말정산 신용카드 체크카드 비교에 대해 자세히 알 수 있나요?", a: "이 글에서 핵심 내용을 정리했어요. 아래 내용을 참고하세요." },
...
const RELATED = [
  { slug: "연말정산-신용카드-공제-한도", title: "- title: 연말정산 신용카드 공제 한도", description: "" },
  { slug: "연말정산-신용카드-소득공제-계산", title: "연말정산 신용카드 소득공제 계산", description: "" },
...
export default function Page() {
  return (
    <ArticleLayout>
      ...
      <h1 style={{ fontSize: 26, fontWeight: 700, lineHeight: 1.45, marginBottom: 14 }}>연말정산 신용카드 체크카드 비교</h1>
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>"신용카드랑 체크카드 중에 뭘 써야 연말정산에서 더 유리할까요? 무턱대고 체크카드만 쓰는 건 비효율적이에요. 전략이 필요해요."</p>
      <p style={body}>체크카드 공제율 30%, 신용카드 15%로 체크카드가 2배 유리해요. 총급여 25% 초과분부터 공제가 시작돼요.</p>
      <Divider /><ArticleAd position="intro" />
      <H2>핵심 정리</H2>
      <GreenBox title="요약">"· 체크카드 공제율 30%, 신용카드 15%로 체크카드가 2배 유리해요.\\n· 총급여 25% 초과분부터 공제가 시작되고 신용카드 사용분이 먼저 차감돼요.\\n· 상반기에 신용카드로 25%를 채우고 하반기에 체크카드를 사용하는 게 효율적이에요."</GreenBox>
