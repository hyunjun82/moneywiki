  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        "실업급여 받다가 취업했는데 3개월 만에 또 그만뒀어요. 남은 급여 받을 수 있나요?"<br />
        상황에 따라 가능해요. <strong>수급기간 내</strong>이고 <strong>비자발적 퇴직</strong>이면 남은 급여를 이어 받을 수 있죠.<br /><br />
        <a href="https://www.law.go.kr/법령/고용보험법" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험법 제48조</a>에 따라
        수급기간(첫 퇴직일로부터 12개월) 안에 재취업했다가 다시 퇴직하면
        남은 실업급여를 이어서 수급할 수 있어요. 재취업 기간이 12개월 이상이면
        아예 <strong>새로운 수급자격</strong>이 생기기도 하죠.
      </p>
      ...
      <p style={body}>
        실업급여 수급기간은 <strong>첫 퇴직일로부터 12개월</strong>이에요. 이 12개월 안에 재취업했다가 다시 비자발적으로 퇴직하면, 아직 소진하지 못한 <strong>남은 실업급여</strong>를 이어서 받을 수 있죠. 핵심은 "수급기간 12개월"이 첫 퇴직 시점부터 시작된다는 점이에요.
      </p>
      <p style={body}>
        예를 들어 2026년 1월 1일에 퇴직해서 120일분 수급자격을 받았다고 할게요. 60일분을 받다가 3월에 재취업했어요. 남은 60일분이 살아 있죠. 그런데 6월에 다시 비자발적으로 퇴직했어요. 수급기간(2026년 12월 31일까지)이 안 끝났으니까 <strong>남은 60일분을 그대로 받을 수 있어요</strong>.
      </p>
      <p style={body}>
        다만 재취업한 회사에서도 <strong>비자발적으로 퇴직</strong>해야 해요. 권고사직, 계약만료, 정당한 이직 사유가 해당되죠. 본인이 그냥 그만둔 자발적 퇴사라면 남은 급여를 받을 수 없어요.
      </p>

      <GreenBox title="남은 급여를 이어 받는 3가지 조건">
      ...
      <p style={body}>
        재취업 후 재퇴직 상황은 크게 네 가지로 나뉘어요. <strong>재취업 기간(12개월 기준)</strong>과 <strong>퇴직 사유(자발/비자발)</strong>의 조합이죠. 어디에 해당하느냐에 따라 남은 급여를 받을지, 새 수급자격을 받을지, 아예 못 받을지가 결정돼요.
      </p>

      <BorderBox title="상황별 실업급여 수급 가능 여부">
      ...
      <p style={body}>
        재취업한 회사에서 <strong>12개월 이상</strong> 근무하고 비자발적으로 퇴직하면 <strong>새로운 수급자격</strong>이 생겨요. 이전 남은 급여가 아니라 새 기준으로 금액과 기간이 계산되죠. 새 직장의 월급과 근무기간을 기준으로 새로 산정하니, 보통은 새로운 수급자격이 더 유리해요.
      </p>
      <p style={body}>
        "정당한 이직 사유"가 있으면 자발적 퇴사여도 비자발적 퇴직으로 인정받을 수 있어요. 임금체불(30% 이상 또는 2개월 이상 미지급), 직장 내 괴롭힘, 출퇴근 왕복 3시간 초과가 대표적이죠. <a href="https://www.law.go.kr/법령/고용보험법시행규칙" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험법 시행규칙 별표2</a>에 전체 사유가 나와 있어요.
      </p>
      ...
      <p style={body}>
        조기재취업수당은 남은 실업급여의 절반을 일시금으로 받는 제도예요. 이걸 받으면 <strong>남은 실업급여는 완전히 소멸</strong>되죠. "절반을 미리 받았으니 나머지도 없어진다"고 이해하면 돼요.
      </p>
      <p style={body}>
        그래서 조기재취업수당을 받은 뒤 재취업한 회사에서 다시 퇴직하면, 이전 남은 급여를 이어 받을 수 없어요. <strong>새로운 수급자격</strong>을 처음부터 만들어야 하죠. 재취업한 회사에서 12개월 이상 근무하고 비자발적으로 퇴직해야 새 자격이 생겨요.
      </p>
      <p style={body}>
        12개월을 못 채웠다면 안타깝지만 방법이 없어요. 조기재취업수당을 받을지, 남은 급여를 보험으로 남겨둘지는 <strong>재취업의 안정성</strong>을 따져서 판단해야 하죠. 이직이 잦은 업종이라면 수당보다 남은 급여를 남겨두는 게 안전할 수 있어요.
      </p>

      <SectionBadge>조기재취업수당 받은 후 정리</SectionBadge>
      <GreenBox title="조기재취업수당 후 재퇴직 시">
        남은 실업급여 → <strong>소멸</strong> (이미 절반 수령 완료)<br />
        새 수급자격 → 12개월 이상 근무 + 비자발적 퇴직 시 <strong>가능</strong><br />
        12개월 미달 시 → <strong>수급 불가</strong>
      </GreenBox>
      ...
      <p style={body}>
        수급기간은 <strong>첫 퇴직일로부터 12개월</strong>이에요. 이 기한이 지나면 아직 소진하지 못한 남은 급여는 사라져요. 예를 들어 2025년 1월에 퇴직했는데 재취업했다가 2026년 3월에 다시 퇴직하면? 이미 수급기간 12개월이 넘었으니 이전 남은 급여는 못 받죠.
      </p>
      <p style={body}>
        이 경우에도 <strong>새로운 수급자격</strong>을 만들 수 있어요. 재취업한 회사에서 피보험기간 180일 이상을 새로 충족하고 비자발적으로 퇴직하면 새 수급자격이 생기죠. 이전 직장 피보험기간은 이미 실업급여로 소진했으니 합산 대상이 아니에요.
      </p>
      <p style={body}>
        그래서 수급기간이 얼마나 남았는지 항상 파악해두는 게 중요해요. <a href="https://www.ei.go.kr" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용24</a>에서 본인의 수급자격 상태와 남은 기간을 조회할 수 있죠. 재취업 중이더라도 수급기간 만료일을 알아두면 재퇴직 시 대응이 빨라져요.
      </p>
      ...
      <p style={body}>
        <strong>남은 급여를 이어 받는 경우</strong>에는 고용센터에 방문해서 수급자격 재신청을 해요. 이전 수급자격과 연결되기 때문에 절차가 간단하죠. 새로 구직등록을 하고, 이직확인서를 제출하고, 실업인정을 받으면 이전과 동일한 금액으로 남은 일수만큼 지급돼요.
      </p>
      <p style={body}>
        <strong>새로운 수급자격인 경우</strong>에는 처음 신청하는 것과 동일한 절차를 거쳐요. 워크넷 구직등록, 수급자격 신청, 실업인정 순서로 진행하면 되죠. 새로운 기준으로 금액과 기간이 산정되고, 2026년 기준 퇴직 전 평균임금의 60%를 받아요. 1일 최대 68,100원이에요.
      </p>
      <p style={body}>
        어떤 경우든 재취업한 회사에서 <strong>이직확인서</strong>를 받아야 해요. 이직 사유가 "비자발적"으로 정확히 기재됐는지 반드시 확인하세요. 이직확인서 발급을 거부하면 고용센터(1350)에 신고할 수 있고, 회사는 퇴직 후 10일 이내에 발급할 의무가 있어요.
      </p>
