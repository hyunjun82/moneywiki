  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        실업급여를 부정하게 받은 사실이 적발되면 받은 돈을 전부 돌려줘야 해요.
        그것만으로 끝나지 않죠.{" "}
      ...
      <p style={body}>
        고용센터가 부정수급 사실을 확인하면 <strong>반환명령</strong>과 <strong>추가징수 처분</strong>을 동시에 내려요.
        반환명령은 부정하게 받은 실업급여 원금 전액을 돌려내라는 거고, 추가징수는 그 위에 얹는 일종의 벌금이죠.{" "}
        <a href="https://www.law.go.kr/법령/고용보험법" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험법 제62조</a>는
        추가징수 상한을 부정수급액의 5배로 정하고 있어요.
      </p>
      <p style={body}>
        실무에서 추가징수 배율은 위반 정도에 따라 달라지죠.
        단순 신고 누락이면 원금의 2배, 고의적·반복적 부정수급이면 3~5배까지 올라가요.
        가장 흔한 케이스는 취업 사실을 신고하지 않고 실업급여를 계속 받은 경우인데, 이때 보통 2배 추가징수가 부과돼요.
      </p>
      <p style={body}>
        환수 절차는 이렇게 진행돼요.
        고용센터가 부정수급 사실을 조사한 뒤 통보서를 발송하고, 통보서에는 환수 원금과 추가징수액, 납부 기한이 적혀 있죠.
        기한 내에 납부하지 않으면 국세징수법에 따라 강제징수 절차로 넘어가요.
        급여 압류나 재산 압류까지 갈 수 있으니까 통보를 받으면 바로 대응해야 해요.
      </p>

      <GreenBox title="부정수급 환수 구조 한눈에 보기">
        원금 반환 — 부정하게 받은 실업급여 전액 반환<br />
        추가징수 — 원금의 2~5배 (고의성·반복성에 따라 차등)<br />
        총 부담 — 최소 원금 x 3배 (원금 + 추가징수 2배가 일반적)
      </GreenBox>
      ...
      <p style={body}>
        환수금 계산은 단순해요.
        부정수급 일수에 1일 수급액을 곱하면 원금이 나오고, 거기에 추가징수 배율을 적용하면 총 부담액이 나오죠.
      ...
      <p style={body}>
        ...
        여기에 2배 추가징수가 붙으면 약 396만 원이 추가되니까 총 약 594만 원을 내야 하죠.
        수급액이 높았거나 부정수급 기간이 길수록 금액이 눈덩이처럼 불어나요.
      </p>
      <p style={body}>
        특히 주의할 점은 부정수급 시점 이후의 남은 수급기간에 대해서도 <strong>급여 지급이 정지</strong>된다는 거예요.
        30일 부정수급이 적발되면 환수금만 내는 게 아니라 나머지 수급기간까지 날아가죠.
        돈을 돌려내고 앞으로 받을 돈도 못 받게 되니까 손해가 이중으로 발생하는 셈이에요.
      </p>
      ...
      <p style={body}>
        가장 많은 유형은 <strong>취업 사실 미신고</strong>예요.
        알바든 프리랜서든 소득활동을 하면서 고용센터에 신고하지 않고 실업급여를 계속 받으면 부정수급이 되죠.
        건강보험 자격 변동, 국세청 소득자료 등으로 자동 적발되는 경우가 많아요.
      </p>
      <p style={body}>
        두 번째는 <strong>구직활동 허위 보고</strong>예요.
        실업인정일에 구직활동 내역을 제출해야 하는데, 실제로 하지 않은 면접이나 교육을 했다고 거짓으로 보고하면 적발되죠.
        고용센터가 해당 기업에 확인 전화를 하거나 출결 기록을 대조하면 바로 드러나요.
      </p>
      <p style={body}>
        세 번째는 <strong>이직 사유 허위 기재</strong>예요.
        자발적 퇴사인데 권고사직으로 이직확인서를 허위 기재해서 실업급여를 받은 경우죠.
        이 경우 사업주도 공동 책임을 지게 되고, 사업주에게도 최대 300만 원의 과태료가 부과돼요.
      </p>

      <BorderBox title="부정수급 대표 유형 3가지">
        취업 사실 미신고 — 알바·프리랜서 등 소득활동 하면서 실업급여 수급<br />
        구직활동 허위 보고 — 하지 않은 면접·교육을 했다고 거짓 보고<br />
      ...
      <p style={body}>
        환수금 통보를 받았는데 일시에 납부하기 어려운 상황이라면{" "}
        <a href="https://www.ei.go.kr" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용24</a> 또는 관할 고용센터에 <strong>분할납부</strong>를 신청할 수 있어요.
        경제적 곤란 사정을 소명하면 최대 24개월까지 나눠 낼 수 있죠.
        천재지변이나 중대 질병 같은 특수 사정이 있으면 납부 유예도 가능해요.
      </p>
      <p style={body}>
        분할납부를 신청하더라도 납부 기한은 철저히 지켜야 해요.
        한 번이라도 기한을 어기면 분할납부 약정이 해지되고 남은 금액 전체를 즉시 납부해야 하죠.
        국세징수법에 따른 강제징수 절차가 시작되면 급여 압류, 예금 압류, 부동산 압류까지 진행될 수 있어요.
      </p>
      <p style={body}>
        환수 결정 자체에 이의가 있다면 <strong>고용보험심사위원회</strong>에 심사청구를 할 수 있어요.
        통보일로부터 90일 이내에 청구해야 하고, 심사 결과에 불복하면 재심사청구나 행정소송으로 다툴 수 있죠.
        부정수급이 아니라 단순 착오였다는 소명이 받아들여지면 추가징수가 감면되거나 취소되는 경우도 있어요.
      </p>

      <GreenBox title="환수금 납부가 어려울 때">
        분할납부 — 고용센터에 신청, 최대 24개월 분납 가능<br />
        납부 유예 — 천재지변·중대 질병 등 특수 사정 시<br />
        이의신청 — 통보일로부터 90일 이내 심사청구 가능
      </GreenBox>
      ...
      <p style={body}>
        부정수급으로 환수 처분을 받으면 이후 실업급여 수급에도 영향이 있어요.
        고용보험법 제61조에 따라 부정수급일 이후의 잔여 수급기간에 대해 <strong>급여 지급이 정지</strong>되죠.
        남은 수급일이 60일이었다면 그 60일치를 아예 못 받게 되는 거예요.
      </p>
      <p style={body}>
        다음에 실업급여를 다시 신청할 때도 불이익이 있을 수 있어요.
        부정수급 이력 자체가 수급자격을 차단하는 건 아니지만, 고용센터 심사에서 더 꼼꼼한 검증을 받게 되죠.
        구직활동 내역도 더 엄격하게 확인받아요.
      </p>
      <p style={body}>
        금액이 크거나 반복 부정수급이면 형사처벌까지 갈 수 있어요.{" "}
        ...
        실제로 고용노동부는 매년 부정수급 집중 점검 기간을 운영하고 있고, 적발 건수도 해마다 증가하는 추세예요.
      </p>
