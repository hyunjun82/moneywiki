  ...
  return (
    ...
    >
      ...
      <p style={body}>
        ...
        퇴직 전에 반드시 인사팀에 &quot;이직확인서 기재 사유&quot;를 점검하세요.
      </p>
      <p style={body}>
        이미 잘못 기재됐다면 고용센터(1350)에 <a href="/w/실업급여-이의신청" style={{ color: "#1D9E75", textDecoration: "underline" }}>이의를 제기</a>할 수 있어요.
      ...
      <p style={body}>
        ...
        회사가 제출했는지, 퇴직 사유가 &lsquo;권고사직&rsquo;으로 기재돼 있는지 먼저 살펴보세요.
      ...
      <p style={body}>
        인정을 받은 뒤에는 1~4주마다 실업인정일에 <a href="/w/실업급여-구직활동-횟수" style={{ color: "#1D9E75", textDecoration: "underline" }}>구직활동</a> 내역을 보고해야 해요.
