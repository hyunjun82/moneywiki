  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        회사에서 명예퇴직 대상이라고 연락이 왔다면, 실업급여도 받을 수 있어요.
        회사가 구조조정이나 인력 감축 때문에 퇴직을 권유한 거라면{" "}
        <a href="https://www.law.go.kr/법령/고용보험법" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험법</a>상{" "}
        <strong>권고사직</strong>으로 인정되죠.
        명예퇴직금은 회사가 주는 돈이고, 실업급여는 고용보험에서 나오는 돈이라 둘 다 받을 수 있어요.
      ...
      <p style={body}>
        ...
        비자발적 이직이니까 실업급여 수급 자격이 생겨요.
      </p>
      <p style={body}>
        명예퇴직, 희망퇴직, 조기퇴직이라는 명칭은 회사마다 달라요.
        이름이 뭐든 간에 실질적으로 회사 주도의 퇴직 권유라면 전부 같은 취급을 받죠.{" "}
        <a href="https://www.ei.go.kr" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용24</a>에서 이직확인서를 확인할 때도 퇴직 명칭이 아니라 실질적 사유를 기준으로 판단해요.
      </p>
      <p style={body}>
        반대 상황도 알아둬야 해요.
        본인이 먼저 "명예퇴직하고 싶어요"라고 신청한 경우는 달라요.
        회사 권유 없이 스스로 요청한 거라면 자발적 퇴사로 분류될 수 있어서 실업급여가 어려워지죠.
        회사 공고나 권유가 있은 뒤에 신청한 거라면 문제없고요.
      </p>
      ...
      <p style={body}>
        실업급여 금액은 퇴직 전 3개월 평균임금의 <strong>60%</strong>예요.
        2026년 기준으로 1일 상한액은 <strong>68,100원</strong>, 하한액은 <strong>66,048원</strong>이에요.
        월로 환산하면 최대 약 204만 원 수준이죠.
        명예퇴직 대상은 보통 장기근속자라서 수급기간이 길어요.
      </p>
      <p style={body}>
        수급기간은 나이와 고용보험 가입기간에 따라 달라지죠.
        50세 미만이고 10년 이상 가입했다면 최대 240일, 50세 이상이면 최대 270일까지 받을 수 있어요.
        20년 넘게 다닌 50세 이상이라면 270일, 약 9개월 동안 실업급여를 받게 되는 거예요.
      </p>
      <p style={body}>
        명예퇴직금은 이것과 별개예요.
        회사가 퇴직 유도 대가로 주는 위로금이고, 실업급여는 고용보험 기금에서 나오는 돈이죠.
        법정 퇴직금까지 합치면 세 가지를 모두 받을 수 있어요.
        하나도 빠뜨리지 말고 챙기세요.
      </p>
      ...
      <p style={body}>
        실업급여 수급 여부를 가르는 가장 중요한 서류가 <strong>이직확인서</strong>예요.
        회사가 고용센터에 제출하는 이 서류에 퇴직 사유가 어떻게 적혀 있느냐에 따라 결과가 갈리죠.
        '권고사직', '경영상 필요에 의한 퇴직', '조기퇴직 프로그램' 중 하나로 기재되어야 해요.
      </p>
      <p style={body}>
        문제는 일부 회사에서 명예퇴직인데도 이직확인서에 '자진퇴사'로 적는 경우가 있다는 거예요.
        이렇게 되면 고용센터에서 자발적 이직으로 분류해서 실업급여를 거부할 수 있죠.
        그래서 명예퇴직 신청 전에 반드시 인사팀에 "이직확인서에 뭐라고 기재할 건지" 확인해야 해요.
      </p>
      <p style={body}>
        만약 회사가 잘못 기재했다면 고용센터(1350)에 이의를 제기할 수 있어요.
        명예퇴직 권유 공문, 사내 공지, 이메일 등을 증거로 제출하면 정정이 가능하죠.
        증빙자료는 퇴직 전에 미리 확보해두는 게 안전해요.
      </p>
      ...
      <p style={body}>
        "명예퇴직금을 받았는데 실업급여도 받으면 이중 수급 아닌가요?" 아니에요.
        완전히 별개의 돈이죠.
        명예퇴직금은 회사가 퇴직 유도 대가로 자체 재원에서 지급하는 위로금이에요.
      </p>
      <p style={body}>
        반면 실업급여는 <strong>고용보험 기금</strong>에서 나오죠.
        근로자가 재직 중에 낸 고용보험료를 재원으로 지급하는 거라서, 회사가 별도로 준 명예퇴직금과는 아무 관계가 없어요.
        법정 퇴직금, 명예퇴직금(위로금), 실업급여 세 가지를 모두 받을 수 있는 거예요.
      </p>
      <p style={body}>
        법정 퇴직금은 1년 이상 근무한 경우에 발생해요.
        명예퇴직 대상자는 보통 장기 근속자이니까 퇴직금 규모도 상당하죠.
        이 세 가지를 합치면 퇴직 후 경제적 공백을 메꾸는 데 큰 도움이 돼요.
        퇴직금 지급기한은 퇴직일로부터 <strong>14일</strong>이고, 미지급 시 지연이자는 <strong>연 20%</strong>예요.
      </p>
      ...
      <p style={body}>
        첫 단계는{" "}
        <a href="https://www.ei.go.kr" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용24</a>에서 이직확인서 처리 상태를 확인하는 거예요.
        회사가 이직확인서를 제출했는지, 퇴직 사유가 '권고사직'으로 돼 있는지 먼저 확인하세요.
        미제출이거나 사유가 잘못됐다면 인사팀에 연락해서 정정을 요청해야 하죠.
      </p>
      <p style={body}>
      ...
      <p style={body}>
        수급자격을 인정받은 뒤에는 1~4주마다 실업인정일에 구직활동 내역을 보고해야 해요.
        구직활동이 인정되면 실업급여가 통장에 입금되죠.
        명예퇴직처럼 퇴직 사유가 명확한 경우는 심사가 빨리 끝나는 편이에요.
        퇴직하면 <strong>12개월 이내</strong>에 반드시 신청해야 하니까 미루지 말고 바로 움직이세요.
      </p>
