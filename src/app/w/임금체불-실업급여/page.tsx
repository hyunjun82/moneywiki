...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={body}>
        일하고 돈을 못 받으면 생계가 흔들리죠. <a href="https://www.law.go.kr/법령/고용보험법시행규칙" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험법 시행규칙 별표2</a>는 이런 상황을 &quot;근로자가 계속 근로할 수 없는 사유&quot;로 규정하고 있죠. 약속한 급여를 회사가 지키지 않은 거니까, 퇴사해도 근로자 잘못이 아닌 거예요.
      </p>
      <p style={body}>
      ...
      <p style={body}>
        문제는 임금을 체불하는 회사가 이걸 순순히 써줄 리 없다는 거죠. &quot;자진퇴사&quot;나 &quot;개인 사유&quot;로 적어버리는 경우가 흔하죠. 당황할 필요 없어요. <strong>고용센터에 이의를 제기</strong>하면 되니까요. 통장 내역, 급여명세서, 대화 기록을 제출하면 퇴직 사유를 정정받을 수 있죠.
      </p>
      <p style={body}>
      ...
      <p style={body}>
        임금체불 퇴사도 수급기간은 <strong>일반 근로자와 동일</strong>해요. 고용보험 가입 기간과 나이에 따라 120일~270일까지 받을 수 있죠. 1년 미만 가입이면 120일, 10년 이상이면 50세 미만 240일 / 50세 이상 270일이에요.
      </p>
      <p style={body}>
