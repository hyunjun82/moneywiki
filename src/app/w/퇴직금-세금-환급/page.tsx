...
const CHECK_ITEMS = [
  ...
  { id: "c4", label: "IRP 계좌가 있고 연금 수령을 시작하지 않았어요" },
];
...
const STEPS = [
  {
    ...
    tip: "홈택스 → 조회/발급 → 지급명세서에서도 조회 가능해요",
  },
  {
    title: "환급 사유 확인",
    desc: "퇴직소득세 환급은 ①근속 기간 오계산 ②산정 기초 오류 ③연금 전환 후 퇴직소득세 감면 세 가지 경우에 발생해요. IRP에서 연금으로 받으면 퇴직소득세의 30~40%를 환급받는 효과가 있어요.",
...
const FAQS = [
  ...
  },
  {
    ...
    a: "원천징수영수증의 근속 기간과 산정 기초를 확인하세요. 오류가 있으면 회사에 수정 요청을 먼저 해보고, 해결이 안 되면 홈택스 경정청구를 통해 직접 환급 신청할 수 있어요.",
  },
];
  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        ...
        연금으로 수령하면 퇴직소득세의 30~40%를 절세하는 효과도 있어요.
      </p>
      ...
      <p style={body}>
        ...
        둘째, 퇴직금 산정 기초(평균임금)가 잘못 계산된 경우예요. 셋째, IRP에서 연금으로 수령하면 퇴직소득세를 30~40% 줄일 수 있어요.
      </p>
      <p style={body}>
      ...
      <p style={body}>
        퇴직소득세가 100만원이라면 10년 이상 연금 수령 시 40만원을 아낄 수 있어요.
        금액이 클수록 절세 효과도 커지죠.
      </p>
      ...
      <p style={body}>
        ...
        홈택스에서 온라인으로 처리할 수 있어 세무사 없이도 충분해요.
      </p>
      ...
      <p style={body}>
        ...
        근속 기간 오류는 금방 찾을 수 있으니 원천징수영수증을 먼저 꼭 확인해보세요.
      </p>
