...
const FAQS = [
  ...
  },
  {
    ...
    a: "정부24(gov.kr)에서 주민등록 초본을 무료로 발급받을 수 있어요. 부동산 미보유 사실은 등기부등본으로도 확인할 수 있어요. 회사마다 요구 서류 기준이 다르니 인사팀에 먼저 물어봐요.",
  },
  {
  ...
  },
  {
    ...
    a: "거부할 수 있어요. 중간정산은 법적 의무가 아니에요. 회사가 취업규칙으로 중간정산을 허용하더라도 서류가 불완전하면 거부할 수 있어요. 신청 전에 인사팀에서 필요 서류 목록을 먼저 확인해봐요.",
  },
  {
  ...
  return (
    ...
    >
      ...
      <EligibilityChecker
        ...
        partialMatchText="사유 해당 여부를 고용노동부(1350) 또는 인사팀에서 먼저 확인해봐요."
      />
      ...
      <Calculator
        ...
        note="※ 평균임금 × 근속 연수 기준. 세금은 퇴직소득세로 원천징수돼요. 정확한 세액은 국세청 홈택스에서 직접 계산해봐요."
      />
      ...
      <Disclaimer text="이 글은 2026년 3월 기준 근로자퇴직급여보장법 시행령을 바탕으로 작성됐어요. 제도 변경이 있을 수 있으니 최신 기준은 고용노동부(1350)에 직접 문의하세요." />
    </ArticleLayout>
  );
}
