...
const FAQS = [
  { q: "연말정산 직계존속에 대해 자세히 알 수 있나요?", a: "이 글에서 핵심 내용을 정리했어요. 아래 내용을 참고하세요." },
...
const RELATED = [
  ...
  { slug: "연말정산-gyeongouda-gongje", title: "연말정산 경로우대 공제", description: "" },
  { slug: "연말정산-buyanggajok-gongje", title: "연말정산 부양가족 공제", description: "" }
];
...
export default function Page() {
  return (
    <ArticleLayout>
      ...
      <h1 style={{ fontSize: 26, fontWeight: 700, lineHeight: 1.45, marginBottom: 14 }}>연말정산 직계존속</h1>
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>""직계존속이 뭐예요? 부모님도 해당되나요?""</p>
      <p style={body}>직계존속은 부모·조부모·증조부모를 말해요. 만 60세 이상이고 소득 100만원 이하면 1명당 150만원 인적공제받아요.</p>
      <Divider /><ArticleAd position="intro" />
      <H2>핵심 정리</H2>
      <GreenBox title="요약">"· 직계존속은 부모·조부모·증조부모예요.\\n· 만 60세 이상, 소득 100만원 이하면 1명당 150만원 공제받아요.\\n· 70세 이상이면 경로우대 추가공제 100만원 받아요."</GreenBox>
      ...
      <Divider />
      <H2>알아두면 좋은 것들</H2>
      <BorderBox><strong>참고사항</strong>{"\n"}· 직계존속은 부모·조부모·증조부모예요.\n· 만 60세 이상, 소득 100만원 이하면 1명당 150만원 공제받아요.\n· 70세 이상이면 경로우대 추가공제 100만원 받아요.</BorderBox>
      <Divider />
      <H2>자주 묻는 질문</H2>
      <FAQ items={FAQS} />
      <Divider />
