  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        "장사가 안 돼서 가게를 접으려고 해요. 자영업자도 실업급여가 되나요?"<br />
        <strong>고용보험에 가입돼 있었다면 가능해요.</strong> 자영업자 고용보험은 임의가입(선택 가입)이라서,
        가입 여부를 먼저 확인해야 하죠.<br /><br />
        <a href="https://www.law.go.kr/법령/고용보험법" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험법</a>에서
        자영업자도 <strong>1년 이상 가입 + 비자발적 폐업</strong>이면 실업급여를 받을 수 있도록 정하고 있어요.
      </p>
      ...
      <p style={body}>
        일반 근로자는 입사하면 자동으로 고용보험에 가입돼요. 자영업자는 달라요. <strong>본인이 직접 신청</strong>해야 가입이 되죠. 그래서 "임의가입"이라고 불러요. 가입하지 않았으면 아무리 오래 사업을 했어도 실업급여 대상이 아니에요.
      </p>
      <p style={body}>
        가입할 때 <strong>기준보수등급(1~7등급)</strong>을 직접 선택해요. 등급이 높을수록 보험료를 많이 내지만, 나중에 받는 실업급여도 많아지죠. 보험료율은 기준보수의 2.25%이고, 전액 본인 부담이에요. 근로자처럼 회사가 반을 내주는 구조가 아니죠.
      </p>
      <p style={body}>
        <a href="https://www.ei.go.kr" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용24</a>에서 본인의 가입 여부와 가입기간을 조회할 수 있어요. 혹시 가입했는지 기억이 안 나면 지금 바로 확인해 보세요. 폐업을 결정하기 전에 가입 상태부터 점검하는 게 첫 번째 단계예요.
      </p>
      ...
      <p style={body}>
        자영업자 실업급여의 핵심 조건은 두 가지예요. 첫째, <strong>고용보험 가입기간이 1년(12개월) 이상</strong>이어야 해요. 일반 근로자(180일)보다 기준이 더 높죠. 가입 후 1년이 안 됐으면 아무리 힘들어도 실업급여를 받을 수 없어요.
      </p>
      <p style={body}>
        둘째, <strong>비자발적 폐업</strong>이어야 해요. "사업을 확장하려고 기존 가게를 접는다"거나 "다른 업종으로 전환하겠다"는 건 자발적 폐업이라 해당이 안 되죠. 매출 급감(전년 대비 30% 이상), 6개월 연속 적자, 건강 악화 등이 비자발적 폐업 사유로 인정돼요.
      </p>
      <p style={body}>
        폐업 후에는 재취업 또는 재창업 의사가 있어야 해요. 고용센터에서 실업인정을 받을 때 구직활동 내역을 보고해야 하죠. 그리고 <strong>사업자등록 폐업 처리</strong>가 완료돼야 신청할 수 있어요. 국세청 홈택스에서 폐업 신고를 먼저 해야 하는 거예요.
      </p>
      ...
      <p style={body}>
        가장 먼저 국세청 <a href="https://www.hometax.go.kr" style={{ color: "#1D9E75", textDecoration: "underline" }}>홈택스</a>에서 사업자등록 폐업 신고를 해요. 폐업일이 확정돼야 고용보험 상실 처리가 진행되죠. 폐업일 기준 25일 이내에 부가가치세 확정신고도 함께 해야 해요.
      </p>
      <p style={body}>
        폐업 처리가 끝나면 <a href="https://www.ei.go.kr" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용24</a>에서 수급자격 신청자 온라인 교육을 이수하세요. 그 다음 관할 고용센터에 방문해서 수급자격 인정을 신청해요. 비자발적 폐업임을 증명할 서류(매출 감소 증빙, 건강진단서 등)를 같이 제출하죠.
      </p>
      <p style={body}>
        심사가 끝나면 4주마다 실업인정일에 구직활동을 보고하면서 급여를 수령해요. 자영업자는 재창업 준비도 구직활동으로 인정받을 수 있어요. 창업 교육 수강, 사업계획서 작성 등이 해당되죠. 고용센터 상담사에게 어떤 활동이 인정되는지 미리 확인하세요.
      </p>
      ...
      <p style={body}>
        자영업자 실업급여의 수급기간은 일반 근로자보다 짧은 편이에요. 가입기간 1년 이상~3년 미만이면 <strong>120일</strong>, 3~5년이면 150일, 5~10년이면 180일, 10년 이상이면 최대 <strong>210일</strong>이에요. 나이와 관계없이 가입기간만으로 결정되죠.
      </p>
      <p style={body}>
        1일 수급액은 <strong>기준보수의 60%</strong>예요. 3등급(일 70,400원)으로 가입했다면 1일 수급액이 42,240원이에요. 월로 따지면 약 127만원이죠. 7등급(일 128,000원)으로 가입했다면 1일 76,800원, 월 약 230만원을 받게 돼요.
      </p>
      <p style={body}>
        여기서 중요한 포인트가 있어요. 가입 등급을 높이면 보험료 부담은 커지지만, 폐업 시 받는 금액도 훨씬 많아지죠. 3등급과 7등급의 차이가 월 100만원 넘게 나요. 사업이 안정적일 때 등급을 올려놓는 게 보험 차원에서 유리해요.
      </p>
      ...
      <p style={body}>
        폐업하면서 직원들에게 <strong>임금을 못 준 경우</strong>가 많죠. 이럴 때 <a href="https://www.law.go.kr/법령/임금채권보장법" style={{ color: "#1D9E75", textDecoration: "underline" }}>임금채권보장법</a>에 따른 체당금 제도를 활용할 수 있어요. <a href="https://www.comwel.or.kr" style={{ color: "#1D9E75", textDecoration: "underline" }}>근로복지공단</a>이 사업주 대신 밀린 임금을 지급해주는 제도예요.
      </p>
      <p style={body}>
        체당금은 두 종류예요. <strong>소액체당금</strong>(간이대지급금)은 400만원 이하의 소액체불에 적용되고, <strong>일반 체당금</strong>은 도산 기업(폐업·파산)의 체불임금에 적용되죠. 직원들이 근로복지공단에 직접 신청하면 돼요.
      </p>
      <p style={body}>
        사업주로서 마지막으로 챙겨야 할 게 있어요. 직원들의 이직확인서를 발급해주세요. 고용보험 상실신고와 이직확인서 제출은 사업주 의무예요. 이걸 안 하면 직원들이 실업급여 신청을 못 해서 고용센터에서 사업주를 찾게 되죠. 폐업 처리와 함께 깔끔하게 정리하는 게 좋아요.
      </p>
