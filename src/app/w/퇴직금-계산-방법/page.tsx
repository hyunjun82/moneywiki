...
const CHECK_ITEMS = [
  ...
  { id: "c4", label: "상여금이나 연차수당을 받은 적이 있어요" },
];
...
const STEPS = [
  {
    title: "평균임금 산정",
    desc: "퇴직 전 3개월간 지급된 임금 총액을 3개월 총 일수로 나눠요. 기본급만이 아니라 상여금(월 환산), 연차수당, 고정수당도 포함해야 정확해요. 1일 평균임금 = 3개월 총임금 ÷ 총 일수예요.",
...
const FAQS = [
  {
    ...
    a: "1일 평균임금 × 30 × (근속일수 ÷ 365)예요. 쉽게 말하면 1개월치 평균임금 × 근속연수인데, 정확하게는 일 단위로 계산해야 해요.",
  },
  {
    q: "기본급만으로 계산하면 안 되나요?",
  ...
  return (
    ...
    >
      ...
      <p style={body}>
        ...
        여기서 월 평균임금은 기본급만이 아니라 상여금 월 환산도 포함한 금액이에요.
      ...
      <p style={body}>
        14일 안에 퇴직금이 들어오지 않으면 고용노동부 민원마당에서 온라인 진정을 낼 수 있어요.
      ...
      <GreenBox title="소멸시효 3년, 퇴직 후 꼭 챙기세요">
        ...
        퇴직 후 바로 받지 못했다면 소멸시효 전에 반드시 청구하세요.<br />
