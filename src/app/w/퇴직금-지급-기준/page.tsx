...
const STEPS = [
  {
    title: "지급 기준 2가지 충족 여부 확인",
    desc: "1년 이상 계속 근로 + 4주 평균 주 15시간 이상이에요. 사업장 규모, 고용 형태, 4대보험 가입 여부는 무관해요. 입사일과 퇴직일 사이 날수를 정확히 계산하고, 근무 스케줄로 주 평균 시간을 확인해봐요.",
    tip: "고용24(www.ei.go.kr)에서 고용보험 이력 조회로 재직 기간 확인 가능해요",
    link: { label: "고용24 이력 조회", href: "https://www.ei.go.kr" },
  },
  {
    title: "퇴직금 계산",
    desc: "1일 평균임금 × 30일 × (근속일수 ÷ 365) 공식으로 계산해요. 퇴직 직전 3개월 급여명세서가 기준이에요. 상여금과 연차수당도 포함해야 실제 금액이 나와요. 기본급만 쓰면 실제보다 10~20% 낮게 나올 수 있어요.",
    tip: "상여금은 연간 총액 ÷ 12로 월 환산해서 평균임금에 포함시켜야 해요",
  },
  {
    title: "회사에 서면 지급 요청",
  ...
  },
  {
    ...
    desc: "14일이 지났는데도 안 주면 연 20% 지연이자를 청구할 수 있어요. 내용증명 발송 → 고용노동부 진정 순서로 대응하면 대부분 해결돼요. 청구권 소멸시효는 퇴직일로부터 3년이에요.",
    tip: "고용노동부 민원마당(minwon.moel.go.kr)에서 온라인 진정 신청 가능해요",
    link: { label: "고용노동부 민원마당", href: "https://minwon.moel.go.kr" },
  },
];

const CHECKLIST = [
  "1년 조건: 입사일과 퇴직일 사이 정확히 날수 계산해두기",
  "주 15시간: 4주 평균이므로 기간별 스케줄 기록 보관",
  "3개월 급여명세서: 상여금·연차수당 포함 여부 확인",
...
const FAQS = [
  ...
  },
  {
    ...
    a: "받을 수 있어요. 주 15시간 이상, 1년 이상 근무했다면 알바도 지급 기준을 충족해요. 고용 형태는 무관하고, 사업주가 안 준다고 해도 고용노동부 진정으로 받을 수 있어요.",
  },
  {
  ...
  },
  {
    ...
    a: "거부할 수 있어요. 근로자퇴직급여 보장법은 강행법규예요. 근로자가 서명했더라도 법적으로 무효고, 퇴직금 청구권은 그대로 유지돼요.",
  },
  {
    q: "주 15시간 미만으로 근무했는데 퇴직금을 받을 수 있나요?",
    a: "못 받아요. 4주 평균 주 15시간 미만이면 단시간 근로자로 분류돼서 퇴직금 지급 의무가 없어요. 다만 주 15시간을 넘는 주가 있어도 4주 평균이 기준이에요.",
  },
];
  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        ...
        핵심은 단 두 가지예요. 같은 사업장에서 1년 이상 계속 근로했고, 4주 평균 주 15시간 이상 일했다면 무조건 받을 수 있어요.
      </p>
      ...
      <p style={body}>
        퇴직금 지급 기준은 두 가지만 충족하면 돼요. 같은 사업장에서 1년 이상 계속 근무했고, 4주 평균 주 15시간 이상 일했다면 받을 수 있어요.
      ...
      <p style={body}>
        ...
        퇴직금 300만원 초과 시 <a href="/w/퇴직금-IRP-계좌" style={{ color: "#1D9E75", textDecoration: "underline" }}>IRP 계좌</a>로만 수령할 수 있어요.
      </p>
      ...
      <Disclaimer text="이 글은 2026년 3월 기준 근로자퇴직급여 보장법을 바탕으로 작성됐어요. 제도 변경이 있을 수 있으니 최신 기준은 고용노동부(1350)에서 확인해봐요." />
    </ArticleLayout>
  );
}
