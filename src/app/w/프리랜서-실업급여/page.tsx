  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        "프리랜서로 3년 일했는데 계약이 끝났어요. 실업급여는 직장인만 받는 거 아닌가요?"<br />
        아니에요. <strong>고용보험에 가입돼 있었다면</strong> 프리랜서도 받을 수 있죠.<br /><br />
        <a href="https://www.law.go.kr/법령/고용보험법" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험법</a>에서
        특수형태근로종사자와 예술인을 의무가입 대상으로 정하고 있어요.
        본인도 모르게 이미 가입돼 있을 수 있으니, <a href="https://www.ei.go.kr" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용24</a>에서 먼저 확인해 보세요.
      </p>
      ...
      <p style={body}>
        프리랜서라고 다 같은 조건은 아니에요. <a href="https://www.law.go.kr/법령/고용보험법" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험법</a>에서 정한 <strong>특수형태근로종사자</strong>에 해당하면 의무가입 대상이에요. 보험설계사, 학습지교사, 택배기사, 대리운전기사, 방과후학교 강사, 화물차주, 플랫폼 배달원 등이 여기에 속하죠.
      </p>
      <p style={body}>
        <strong>예술인</strong>도 마찬가지예요. <a href="https://www.law.go.kr/법령/예술인복지법" style={{ color: "#1D9E75", textDecoration: "underline" }}>예술인복지법</a>에 따라 문화예술용역 계약을 맺으면 고용보험에 자동으로 가입돼요. 작가, 배우, 음악가, 디자이너, 사진작가 등 예술활동을 하는 분들이 해당되죠.
      </p>
      <p style={body}>
        가입 신고는 계약을 맺은 사업주가 해요. 본인이 직접 신고하는 게 아니에요. <a href="https://www.ei.go.kr" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용24</a>에서 피보험자격 이력을 조회하면 가입 여부를 바로 확인할 수 있으니, 한번 들어가보세요.
      </p>
      ...
      <p style={body}>
        프리랜서 실업급여도 기본 조건이 있어요. 이직 전 24개월 중 <strong>피보험 단위기간이 12개월 이상</strong>이어야 하죠. 일반 근로자(18개월 중 180일)보다 기간이 더 길다는 점에 주의하세요.
      </p>
      <p style={body}>
        <strong>비자발적 이직</strong>이어야 해요. 계약기간 만료, 원청의 계약 해지, 소득 급감(전년 대비 50% 이상 감소)이 대표적인 사유예요. 본인이 스스로 계약을 끊으면 자발적 이직이라 수급이 어렵죠. 그런데 소득이 크게 줄어서 더는 일을 계속하기 어려운 경우라면, 소득감소 사유로 인정받을 수 있어요.
      </p>
      <p style={body}>
        재취업 의사와 능력도 갖춰야 해요. 수급 기간 동안 정해진 횟수만큼 구직활동을 해야 급여가 계속 나오죠. 프리랜서라면 새 프로젝트 지원이나 포트폴리오 업데이트도 구직활동으로 인정받을 수 있어요.
      </p>

      <BorderBox title="프리랜서 실업급여 3대 조건">
        1. 이직 전 24개월 중 피보험기간 12개월 이상<br />
        2. 비자발적 이직 (계약 만료, 소득 50% 이상 감소 등)<br />
      ...
      <p style={body}>
        일반 프리랜서는 원칙적으로 고용보험 의무가입 대상이 아니에요. 그래서 실업급여를 받기가 쉽지 않죠. 그런데 방법이 아예 없는 건 아니에요.
      </p>
      <p style={body}>
        사업주와 <strong>실질적인 근로관계</strong>가 있었다면 일반 근로자로 인정될 수 있어요. 출퇴근 시간이 정해져 있었거나, 구체적인 업무 지시를 받았거나, 정해진 장소에서 일했다면 근로자성을 주장할 수 있죠. 계약서에 "프리랜서"라고 적혀 있어도 실질이 근로자면 인정돼요.
      </p>
      <p style={body}>
        고용센터에서 실제 근무 형태를 보고 판단해요. 계약서, 업무지시 이메일, 출근 기록, 급여 입금 내역 등 증빙이 많을수록 유리하죠. 혹시 해당될 수 있다면 퇴직 전에 증빙부터 챙겨놓으세요.
      </p>
      ...
      <p style={body}>
        1일 구직급여액은 기준보수일액의 <strong>60%</strong>예요. 등급에 따라 1일 34,560원(1등급)부터 76,800원(7등급)까지 차이가 나죠. 월로 환산하면 약 104만원에서 230만원 사이를 받게 돼요. 등급이 낮아도 최소 100만원 이상은 보장되는 셈이에요.
      </p>
      <p style={body}>
        수급 기간은 피보험기간과 나이에 따라 달라져요. 가입기간이 1년 미만이면 50세 미만·이상 모두 120일이에요. 1~3년이면 150일(50세 미만) 또는 180일(50세 이상), 3~5년이면 180일 또는 210일이죠. 10년 이상 가입했다면 최대 240일(50세 미만)에서 270일(50세 이상)까지 받을 수 있어요.
      </p>
      <p style={body}>
        예를 들어 3등급으로 3년 일한 40대라면, 150일(약 5개월) 동안 매달 약 127만원을 받게 돼요. 전체 수령액은 약 634만원이죠. 적지 않은 금액이니 꼭 챙기세요.
      </p>
      ...
      <p style={body}>
        계약 종료 후 사업주가 <strong>이직확인서</strong>를 제출해야 해요. <a href="https://www.ei.go.kr" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용24</a>에서 이직확인서가 처리됐는지 확인하세요. 사업주가 안 내주면 고용센터에 도움을 요청할 수 있어요. 직권으로 처리해주는 경우도 있죠.
      </p>
      <p style={body}>
        이직확인서가 처리되면 수급자격 신청자 온라인 교육을 이수해요. 약 1시간 정도 걸리죠. 그다음 수급자격 인정 신청을 하면 고용센터에서 심사 후 수급자격을 결정해요. 전체 과정이 2~3주 정도 걸리는 편이에요.
      </p>
      <p style={body}>
        가장 중요한 건 <strong>퇴직 다음날부터 12개월 이내</strong>에 신청해야 한다는 거예요. 이 기간을 넘기면 아무리 조건을 갖췄어도 실업급여를 못 받아요. 프로젝트 정리한다고 미루지 말고, 계약이 끝나면 바로 움직이세요.
      </p>

      <GreenBox title="프리랜서 실업급여 핵심 정리">
        특고·예술인 → 의무가입 대상, 12개월 이상 가입하면 수급 가능<br />
        일반 프리랜서 → 근로자성 인정 시 일반 근로자 기준 적용<br />
