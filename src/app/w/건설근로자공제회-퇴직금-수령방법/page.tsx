...
const STEPS = [
  {
    title: "적립일수 확인",
    desc: "건설근로자공제회 앱(건설근로자공제회) 또는 홈페이지(cw.or.kr)에 로그인해 적립일수를 확인해요. 252일 이상이어야 퇴직공제금을 받을 수 있어요. 여러 현장의 적립일수는 합산돼요.",
  ...
  {
    title: "온라인 또는 방문 청구",
    desc: "건설근로자공제회 홈페이지(cw.or.kr)에서 온라인으로 청구하거나, 전국 지부를 방문해 신청해요. 신분증, 청구서, 통장 사본이 필요해요. 청구 후 보통 5~10일 내에 입금돼요.",
