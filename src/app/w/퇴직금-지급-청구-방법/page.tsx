...
const STEPS = [
  {
    ...
    tip: "내용증명은 우체국에서 발송하면 법적 증거로 활용 가능해요",
  },
  {
    title: "회사 내 해결 시도",
  ...
  },
  {
    ...
    desc: "진정 후에도 지급이 안 되면 법원에 지급명령 신청 또는 소액사건 소송을 낼 수 있어요. 법률구조공단(132)에서 무료 법률 지원을 받을 수 있어요.",
...
const FAQS = [
  {
    q: "퇴직금 청구서는 꼭 써야 하나요?",
    a: "법적으로 정해진 양식은 없어요. 회사에 구두로 요청해도 되지만, 분쟁이 생길 경우 서면이나 메일로 남기는 게 훨씬 유리해요. 내용증명이 가장 강력한 증거예요.",
  },
  {
  ...
  },
  {
    ...
    a: "체당금 제도를 이용하면 돼요. 고용노동부에 체당금 신청을 하면 국가가 퇴직금의 일부를 먼저 지급해줘요.",
  },
  {
...
const RELATED = [
  { slug: "퇴직금-지급-기한-초과", title: "퇴직금 미지급 신고 방법", description: "노동청 진정 절차를 단계별로 안내해요." },
  { slug: "퇴직금-지연이자", title: "퇴직금 지연이자 계산", description: "연 20% 지연이자를 직접 계산해봐요." },
  { slug: "퇴직금-지급-기한", title: "퇴직금 소멸시효 3년", description: "청구 기한과 시효 중단 방법을 설명해요." },
];
  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        퇴직금은 퇴직일로부터 14일 이내에 받아야 해요. 14일이 지나도 받지 못했다면
        <a href="/w/퇴직금-지연이자" style={{ color: "#1D9E75", textDecoration: "underline" }}>지연이자(연 20%)</a>와 함께 청구할 수 있어요.
      ...
      <p style={body}>
        퇴직 후 14일이 지나도 퇴직금이 들어오지 않거나, 회사가 지급을 거부하거나 계속 미루는 경우에 청구 절차가 필요해요.
        퇴직금이 300만원을 초과한다면 IRP 계좌로 받아야 하는데, IRP가 없으면 이체 자체가 불가능해요.
      ...
      <p style={body}>
        ...
        평균임금에 상여금이 포함됐다면 실제 금액은 더 높게 나올 수 있어요.
      </p>
