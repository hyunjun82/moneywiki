...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={body}>
        내 임금이 직접 깎이지 않은 경우도 해당될 수 있죠. <strong>동종업계 같은 직급 평균보다 현저히 낮아진 경우</strong>에도 정당한 사유가 되죠. 같은 업종, 같은 경력인데 내 급여만 터무니없이 낮다면 이직 사유로 충분해요.
      </p>
      ...
      <p style={body}>
        수급일수는 고용보험 가입 기간과 나이로 결정돼요. 50세 미만이고 1년~3년 미만 가입이라면 150일(약 5개월)을 받죠. 10년 넘게 가입했으면 최대 270일(약 9개월)까지 가능해요. 위 계산기에 나이와 가입 기간을 넣으면 예상 총액이 바로 나오니 꼭 확인해보세요.
      </p>
      <p style={body}>
        신청은 퇴직 후 <a href="https://www.ei.go.kr" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용24</a> 온라인 또는 관할 고용센터 방문으로 진행하면 돼요. 퇴직일 다음 날부터 <strong>12개월 이내</strong>에 신청해야 하니 미루지 마세요. 이직확인서가 나오는 즉시 움직이는 게 가장 좋죠.
      </p>
