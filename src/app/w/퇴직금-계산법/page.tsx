...
const CHECK_ITEMS = [
  ...
  { id: "c4", label: "상여금이나 성과급을 받은 적 있어요" },
];
...
const STEPS = [
  ...
  {
    title: "근속일수 확인",
    desc: "입사일부터 퇴직일까지 총 일수를 계산해요. 육아휴직·병가 기간도 근속일수에 포함돼요. 반면 무단결근은 제외될 수 있어요.",
    tip: "고용보험 이력 조회(고용24)로 정확한 입사일 확인 가능",
  },
  {
    title: "퇴직금 계산",
    desc: "퇴직금 = 1일 평균임금 × 30 × (근속일수 ÷ 365)예요. 근속 1년이면 월급의 약 1배, 10년이면 약 10배가 기준이에요.",
    tip: "상여금·연차수당 포함하면 기본급 기준보다 5~20% 높게 나와요",
  },
  {
    title: "퇴직 후 14일 이내 수령 확인",
    desc: "법적으로 퇴직 후 14일 이내에 지급해야 해요. 미지급 시 연 20% 지연이자가 붙죠. 14일이 지나도록 안 주면 고용노동부에 바로 신고하세요.",
...
const FAQS = [
  ...
  },
  {
    ...
    a: "맞아요. 계속 근로 1년이 충족돼야 퇴직금이 발생해요. 11개월 29일이면 한 푼도 없죠. 1년을 채우면 1개월치가 기준이 되죠.",
  },
];
  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        ...
        <a href="https://www.law.go.kr/법령/근로자퇴직급여보장법" style={{ color: "#1D9E75", textDecoration: "underline" }}>근로자퇴직급여보장법</a>에서 정한
      ...
      <p style={body}>
        ...
        첫째, 같은 사업장에서 계속 근로 1년 이상. 둘째, 4주 평균 주 15시간 이상 근무.
      ...
      <H2>내 퇴직금, 얼마나 나올까?</H2>
      <p style={body}>
        퇴직금 공식은 1일 평균임금 × 30 × (근속일수 ÷ 365)예요.
        쉽게 말하면 1년 근무할 때마다 월급 1개월치가 퇴직금으로 쌓이는 구조죠.
        아래에서 월급과 근속기간을 조절해보세요.
      </p>
      <p style={body}>
        계산 결과에서 중요한 점은 상여금과 연차수당이에요. 연봉의 10~20%를 상여금으로 받는다면 퇴직금도 그만큼 올라가죠.
      ...
      <p style={body}>
        계산기로 나온 금액이 예상치라면, 실제 수령액은 서류 기반으로 계산한 값이에요.
        회사 인사팀에 아래 서류를 요청하거나, 직접 보관해두세요.
        퇴직 후엔 발급이 어려울 수 있으니 재직 중에 챙겨두는 게 좋아요.
      </p>
      <p style={body}>
        서류가 없어도 통장 입금 내역, 카카오톡 급여 안내 메시지, 4대보험 가입 이력만 있어도 기본 증명이 돼요.
        고용보험 가입 이력은 고용24에서 바로 조회할 수 있어요.
      </p>
      ...
      <GreenBox title="1년 미만으로 끊기는 경우 주의">
        ...
        실질적으로 계속 근로라는 증거가 있다면 고용노동부에 진정을 넣을 수 있어요.<br />
        급여 이체 내역, 업무 지시 문자 등이 증거가 돼요.
      </GreenBox>
