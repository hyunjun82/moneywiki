...
const CHECK_ITEMS = [
  ...
  { id: "c4", label: "상여금이나 연차수당을 받은 적 있어요" },
];
...
const STEPS = [
  {
    title: "3개월 임금 총액 계산",
    desc: "퇴직 전 3개월간 받은 모든 임금을 더해요. 기본급 외에 식대·교통비(고정 지급분), 연차수당, 성과급·상여금(연간 총액의 3/12)도 포함돼요. 세전 금액 기준이에요.",
    tip: "급여명세서 세전 총액 3개월치를 더한 뒤, 연간 상여금 × 3 ÷ 12를 더하면 돼요",
  },
  {
    title: "실제 일수로 나눠 1일 평균임금 산출",
    desc: "3개월 임금 총액을 해당 기간의 실제 일수(보통 89~92일)로 나눠요. 달력상 일수이기 때문에 2월이 포함되면 일수가 줄어서 평균임금이 살짝 높아지기도 해요.",
  ...
  {
    title: "IRP 계좌로 수령",
    desc: "퇴직금이 300만원을 초과하면 IRP 계좌로만 받을 수 있어요. 퇴직 전에 미리 개설해두면 이체가 빠르게 진행돼요. IRP에 두면 연금 수령 시 세금을 30~40% 줄일 수 있어요.",
...
const FAQS = [
  {
    q: "기본급만으로 계산하면 안 되나요?",
    a: "기본급만 쓰면 실제보다 10~20% 낮게 나와요. 상여금, 고정 식대·교통비, 연차수당까지 포함해야 법적으로 정확한 퇴직금이에요. 회사가 기본급 기준으로 계산했다면 차액을 청구할 수 있어요.",
  },
  {
    q: "성과급이 매년 달라도 포함되나요?",
    a: "포함돼요. 퇴직 전 1년간 받은 성과급 총액의 3/12(3개월치)를 평균임금에 더해요. 금액이 해마다 달라도 직전 1년 기준으로 계산하면 돼요.",
  },
  {
    q: "육아휴직 기간도 근속일수에 들어가나요?",
    a: "들어가요. 육아휴직은 법적 보호를 받는 기간이라 근속일수에 포함돼요. 다만 육아휴직 중엔 임금을 받지 않으므로 평균임금 계산에서 해당 기간과 임금은 제외해요. 결과적으로 퇴직금이 줄지 않아요.",
  },
  {
    q: "퇴직금을 14일 안에 안 주면 어떻게 되나요?",
    a: "연 20% 지연이자가 붙어요. 고용노동부(1350) 진정을 넣으면 근로감독관이 직접 조사해요. 형사 처벌(3년 이하 징역 또는 3,000만원 벌금)까지 갈 수 있어요.",
  },
  {
  ...
  },
  {
    ...
    a: "기본 구조는 맞지만, 상여금·연차수당을 빼면 부정확해요. 계산기는 어디까지나 예상치예요. 급여명세서를 직접 기반으로 계산하거나, 고용노동부 퇴직금 계산기(moel.go.kr)를 쓰는 게 정확해요.",
  },
];
...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={body}>
        퇴직금은 고용 형태와 무관하게 두 가지 조건을 충족하면 받을 수 있어요.
        계속 근로 1년 이상, 4주 평균 주 15시간 이상 근무. 정규직·계약직·파트타임·아르바이트 모두 동일하게 적용돼요.
      </p>
      <p style={body}>
        1인 사업장도 예외 없이 지급 의무가 있어요. 4대보험 미가입 상태여도 실제 근무 증거가 있으면 청구할 수 있죠.
      ...
      <EligibilityChecker
        items={CHECK_ITEMS}
        allMatchText="퇴직금 계산 조건을 모두 갖췄어요. 아래 계산기로 상여금까지 포함해서 예상 금액을 확인해보세요."
        partialMatchText="조건 일부가 부족할 수 있어요. 고용노동부(1350) 상담을 먼저 받아보세요."
      />
      ...
      <p style={body}>
        ...
        여기서 평균임금은 기본급만이 아니에요. 연간 상여금을 12로 나눈 값도 매달 평균임금에 더해져요.
      ...
      <p style={body}>
        계산 방법을 알아도 어떻게 수령하는지 모르면 늦어질 수 있어요.
      ...
      <p style={body}>
        ...
        상여금 하나만 빠져도 예상보다 수십만원 낮게 나올 수 있어요.
      </p>
