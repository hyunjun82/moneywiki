...
const SIDEBAR_LINKS = ["대구 평생교육이용권 신청방법", "대구광역시 평생교육이용권 자격", "평생교육이용권 AI디지털 이용권", "평생교육이용권 사용처 조회", "서울 평생교육이용권 신청", "인천 평생교육이용권 신청", "충남 평생교육이용권 신청", "경남 평생교육이용권 신청", "NH농협카드 채움카드 발급", "차상위계층 확인 방법", "기초생활수급자 신청", "대구시 복지 교육 지원", "평생교육이용권 추첨 기준", "평생교육이용권 우수이용자 70만원", "대구 평생학습 포털"];
...
const STEPS = [{"title": "내 유형 먼저 고르세요", "desc": "일반·AI디지털·노인 중 1개만 신청. 중복 신청 자동 무효예요.", "tip": "소득 무관 유형이 경쟁 모수가 작아요"}, {"title": "lllcard.kr/daegu 접속", "desc": "카카오·PASS 간편인증 후 신청서를 작성해요.", "link": {"label": "lllcard.kr/daegu", "url": "https://www.lllcard.kr/daegu"}}, {"title": "신청서 작성 + 제출", "desc": "유형 선택 → 자격 정보 입력 → 제출.", "tip": "4월 2일 마감, 오늘 바로 신청하세요"}, {"title": "선정 결과 통보", "desc": "문자·카카오톡으로 개별 통보. 선정 시 NH농협 채움카드에 35만원 포인트 자동 충전이에요."}, {"title": "강좌 수강 + 사용", "desc": "등록된 기관에서 수강료·교재비로 결제해요. 12월 31일까지 사용해야 해요.", "tip": "미사용 잔액 연말 자동 소멸"}];
const FAQS = [{"urgent": true, "q": "추첨 경쟁률을 낮추려면 어떤 유형이 유리해요?", "a": "AI·디지털(30세 이상, 소득 무관)과 노인(65세 이상, 소득 무관) 이용권은 해당 대상만 신청 가능해서 경쟁 모수가 작아요. 일반 이용권보다 경쟁이 덜할 수 있어요. 해당 연령이면 소득 무관 유형을 먼저 선택해보세요."}, {"urgent": true, "q": "대구에 살지만 경북 주민등록이에요. 신청 가능한가요?", "a": "주민등록등본 상 주소지 기준이에요. 대구에 거주해도 경북에 주민등록이 있으면 경북 공고로 신청해야 해요. 대구 공고는 대구에 주민등록이 된 분만 신청 가능해요."}, {"urgent": false, "q": "대구 상담센터 번호가 맞나요?", "a": "대구 평생교육이용권 상담센터는 053-210-5683이에요. 유형 선택, 자격 확인, 사용처 안내 등 전반적인 문의가 가능해요."}, {"urgent": false, "q": "NH농협카드가 없어요.", "a": "선정 후 card.nonghyup.com 또는 NH농협은행·농축협 영업점에서 채움카드를 발급하면 돼요."}, {"urgent": false, "q": "추첨 탈락하면 기회가 없나요?", "a": "2차 모집이 진행될 수 있어요. lllcard.kr/daegu에서 다음 공고를 확인하거나 053-210-5683으로 문의하세요."}];
...
const REFERENCES = [{"category": "공식 공고", "items": [{"label": "대구 평생교육이용권 누리집 (lllcard.kr/daegu)", "url": "https://www.lllcard.kr/daegu"}, {"label": "대구 상담센터 ☎053-210-5683", "url": "tel:0532105683"}]}, {"category": "법령·카드", "items": [{"label": "평생교육법 제16조의2 — 평생교육이용권의 발급 등", "url": "https://www.law.go.kr/"}, {"label": "NH농협카드 채움카드 신규 발급", "url": "https://card.nonghyup.com"}]}];
const APPLY_URL = "https://www.lllcard.kr/daegu";
const APPLY_LABEL = "대구 평생교육이용권 신청하기";
const DEADLINE_ISO = "2026-04-02T23:59:00+09:00";
const DEADLINE_LABEL = "2026년 4월 2일(목) 마감";
const DEADLINE_SHORT = "4월 2일";
const NOTE_SPECIFIC = "대구 1차: 일반·AI디지털·노인 3개 유형 · 상담 053-210-5683";
  ...
  return (
    <div style={{ maxWidth: 1060, margin: "0 auto", padding: "2rem 1.5rem", fontFamily: "'Pretendard', 'Apple SD Gothic Neo', sans-serif", color: "#111", display: "flex", gap: 28, alignItems: "flex-start" }}>
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <p style={{ fontSize: 13, color: "#1D9E75", fontWeight: 600, marginBottom: 10 }}>복지 · 교육 지원 · 대구광역시</p>
        <h1 style={{ fontSize: 26, fontWeight: 700, lineHeight: 1.45, marginBottom: 14 }}>
          2026 대구 평생교육이용권 신청방법 |<br />
          추첨 탈락 줄이는 유형 선택법
        </h1>
        <p style={{ fontSize: 15, color: "#374151", lineHeight: 2.1, marginBottom: "1rem" }}>
          대구는 4월 2일 마감이에요. 얼마 안 남았어요.\n유형 선택 하나로 추첨 경쟁률이 크게 달라질 수 있어요.\n소득 무관 유형이 있다면 그쪽이 유리해요. 지금 확인하세요.
        </p>
        ...
        <H2>대구광역시 평생교육이용권, 신청 전에 이것부터 확인하세요</H2>
        <p style={body}>
          대구광역시에 주민등록이 있어야 대구광역시 공고로 신청할 수 있어요.<br />
          2026년부터 국가 단일 모집이 아닌 광역 지자체별 개별 모집으로 바뀌었어요.<br />
          타 지역 공고로 신청하면 자동 탈락이에요.
        </p>
        <GreenBox title="2026 대구광역시 1차 핵심 정보">
          신청 기간: 2026년 3월 19일(목) ~ 4월 2일(목)<br />
          지원 금액: 1인당 연 35만원 · 우수이용자 최대 70만원<br />
          신청 방법: www.lllcard.kr/daegu (PC·모바일 가능)<br />
        ...
        <p style={body}>
          온라인 사용기관은 전국 공통이에요. 대구광역시 어디서나 수강할 수 있어요.<br />
          실제 강좌 목록은 www.lllcard.kr/daegu에서 검색하세요.
        </p>
        ...
        <CTA url={APPLY_URL} deadline={DEADLINE_SHORT} ctaTitle={"4월 2일 마감이에요.\\n지금 바로 신청하세요."} ctaDesc={"AI·디지털(30세↑)·노인(65세↑) 이용권은 소득 조건 없어요.\\n연 35만원 교육비 지원이에요."} />

        <Divider />
        <References refs={REFERENCES} />

        <div style={{ marginTop: "1.2rem", padding: "14px 18px", background: "#f9fafb", borderRadius: 10, fontSize: 12, color: "#9ca3af", lineHeight: 1.9 }}>
          이 글은 법률·정책 정보 제공을 목적으로 작성됐어요. 개별 선정 결과는 대구광역시 공고 기준에 따르며, 중요한 결정 전에 반드시 공식 출처를 직접 확인하세요.
          <br />※ 대구 1차: 일반·AI디지털·노인 3개 유형 · 상담 053-210-5683
        </div>
      </div>
    </div>
  );
