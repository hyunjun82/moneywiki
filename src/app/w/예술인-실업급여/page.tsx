  ...
  return (
    ...
    >
      ...
      <p style={body}>
        ...
        아래에서 등급 기준부터 계산 방법까지 바로 정리해드릴게요.
      </p>
      ...
      <p style={body}>
        ...
        수급기간이 짧은 만큼, 기간 내에 다음 계약을 빨리 찾는 게 중요하죠.
      </p>
      <p style={body}>
      ...
      <p style={body}>
        ...
        계약서에 적힌 보수 금액이 기준이 되니까, 최근 계약서를 꺼내서 금액을 확인해보세요.
      ...
      <p style={body}>
        마지막으로 <strong>퇴직 후 12개월 이내에 신청</strong>해야 해요.
        이 기한을 넘기면 수급자격 자체가 사라지니까, 계약이 끝나면 미루지 말고 바로 고용센터에 연락하세요.
