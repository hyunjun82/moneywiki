...
// Q1. 회사가 폐업하거나 사장이 잠적해 퇴직금을 한 푼도 못 받고 있는 상황
// Q2. 체당금을 신청해서 퇴직금을 실제로 통장에 돌려받는다
// Q3. 소액체당금 vs 도산체당금 차이, 신청 기한, 필요 서류, 4단계 절차, 우선변제권 활용
// Q4. 자격 체커 + 계산기 + Steps + DocTable + Checklist (순서대로 행동 유도)
...
const STEPS = [
  ...
  },
  {
    ...
    desc: "정식 파산·회생이면 법원 결정문이 나오면 돼요. 사장이 잠적하거나 사업 중단 상태라면 고용노동지청이 '사실상 도산'으로 인정해줘요. 인정 결정이 나야 체당금 신청 단계로 넘어갈 수 있죠.",
  ...
  },
  {
    ...
    desc: "체당금 상한을 초과하는 퇴직금이 남았다면 파산·회생 절차에서 채권자로 신고해요. 근로기준법 제38조에 따라 최종 3년분 퇴직금은 은행 담보채권보다도 우선 변제받을 수 있죠.",
    tip: "법률구조공단(132) 무료 법률 지원으로 채권 신고를 도움받을 수 있죠",
  },
];
...
const FAQS = [
  ...
  },
  {
    ...
    a: "소액체당금은 법원 확정 없이도 최대 1,000만원 한도로 빠르게 받을 수 있는 제도예요. 도산체당금은 파산·회생이나 사실상 도산 인정 후 신청하고 상한액이 연령·근속에 따라 달라요. 둘 중 하나만 선택해서 받을 수 있죠.",
  },
  {
    q: "우선변제권이 있으면 퇴직금 전액을 받을 수 있나요?",
    a: "우선변제권은 다른 채권자보다 먼저 배당받는 권리예요. 회사에 남은 재산이 있어야 실제로 회수할 수 있죠. 재산이 없다면 우선변제권이 있어도 받지 못할 수 있고요.",
  },
  {
    q: "회사가 폐업 신고를 안 했는데도 신청할 수 있나요?",
    a: "가능해요. 법원 파산·회생 결정이 없어도 사장이 연락 두절이거나 사업장이 문을 닫았다면 고용노동지청이 '사실상 도산'으로 인정해줄 수 있죠. 고용노동부에 진정을 접수하면서 사실상 도산 인정도 함께 신청해봐요.",
  },
  {
    q: "퇴직금 외에 밀린 임금도 체당금으로 받을 수 있나요?",
    a: "가능해요. 체당금은 퇴직금뿐 아니라 최종 3개월분 임금과 최종 3년분 퇴직금, 휴업수당을 포함해요. 미지급 임금이 있다면 퇴직금과 함께 신청해봐요.",
  },
  {
  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        ...
        국가가 사업주 대신 퇴직금을 지급하는 체당금 제도가 있죠.
        ...
        두 제도를 순서대로 활용하면 폐업 상황에서도 퇴직금을 최대한 지킬 수 있죠.
      </p>
      ...
      <p style={body}>
        체당금은 도산·폐업 상태의 사업장 근로자가 받을 수 있죠.
        일반체당금(도산체당금)은 법원 파산·회생 결정이나 사실상 도산 인정이 필요하고,
        소액체당금은 법원 확정 없이도 최대 1,000만원 한도로 신청할 수 있죠.
        아르바이트·단시간 근로자도 조건을 충족하면 신청 대상이에요.
      </p>
      <p style={body}>
        가장 중요한 기준은 퇴직 후 신청 기한이에요.
        도산체당금은 도산 인정일로부터 2년, 소액체당금은 법원 확정일로부터 1년 이내 신청해야 하죠.
      ...
      <EligibilityChecker
        items={CHECK_ITEMS}
        allMatchText="체당금 신청 조건을 갖추고 있죠. 아래 계산기로 예상 금액을 먼저 파악해봐요."
        partialMatchText="일부 조건이 맞지 않아요. 근로복지공단(1588-0075)에 전화해서 자격 여부를 살펴봐요."
      />

      <Divider />

      <H2>퇴직금과 체당금 수령 예상액 파악하기</H2>
      <p style={body}>
        체당금으로 퇴직금 전액을 받을 수 있는지 먼저 파악해야 전략을 세울 수 있죠.
        소액체당금 상한은 1,000만원이고, 일반체당금 상한은 연령·근속에 따라 달라지죠.
        퇴직금이 상한액보다 많다면 우선변제권 행사까지 함께 진행해야 해요.
      </p>
      <p style={body}>
        아래 슬라이더로 월 급여와 근속 기간을 조절해서 예상 금액을 살펴봐요.
      ...
      <p style={body}>
        회사가 폐업하면 서류를 구하기 어려워지죠.
        근로계약서·급여명세서·출퇴근 기록 중 하나라도 있으면 근무 사실을 입증할 수 있죠.
        카카오톡 급여 안내 메시지나 통장 이체 내역도 인정되는 경우가 많고요.
      </p>
      <p style={body}>
        임금체불 확인서는 고용노동부에 진정을 접수하면 발급받을 수 있죠.
      ...
      <p style={body}>
        ...
        각 단계마다 소요 기간이 있으니 일찍 시작할수록 유리하죠.
      </p>
      ...
      <p style={body}>
        ...
        체당금 신청 기한은 그보다 더 짧은 경우도 많아서 폐업 소식을 들은 날부터 움직여야 하죠.
        법률구조공단(132)은 무료로 법률 지원을 받을 수 있으니 부담 없이 전화해봐요.
      </p>
      ...
      <Disclaimer text="이 글은 2026년 3월 기준 임금채권보장법과 근로기준법을 바탕으로 작성됐어요. 제도 변경이 있을 수 있으니 최신 기준은 근로복지공단(1588-0075)에 문의해봐요." />
    </ArticleLayout>
  );
}
