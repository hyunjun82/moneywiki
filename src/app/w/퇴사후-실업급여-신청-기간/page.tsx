  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        "퇴사하고 좀 쉬다가 실업급여 신청해도 되나요?"<br />
        가능은 해요. 하지만 <strong>퇴직일 다음 날부터 12개월</strong>이 절대 마감이에요.<br /><br />
        <a href="https://www.law.go.kr/법령/고용보험법" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험법 제48조</a>가 정한 수급기간이 딱 12개월이거든요.
        늦게 신청하면 그만큼 받을 수 있는 날이 줄어들고,
        12개월이 지나면 수급일수가 남아 있어도 한 푼도 받을 수 없죠.
      </p>
      ...
      <p style={body}>
        실업급여에서 말하는 <strong>수급기간</strong>은 퇴직일 다음 날부터 12개월이에요. 이건 "신청 기한"이 아니라 "수급을 완료해야 하는 기한"이죠. 신청만 12개월 안에 하면 되는 게 아니라, 받을 수 있는 일수를 전부 소화해야 하는 기간이에요.
      </p>
      <p style={body}>
        예를 들어 2026년 1월 15일에 퇴직했다면, 수급기간은 2026년 1월 16일부터 2027년 1월 15일까지예요. 이 12개월이 지나는 순간 수급권이 소멸돼요. 수급일수가 90일이 남았든 150일이 남았든 상관없이 끝나버리죠. <a href="https://www.law.go.kr/법령/고용보험법" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험법</a>에 명시된 강행규정이라 예외가 거의 없어요.
      </p>
      <p style={body}>
        그래서 핵심은 <strong>가능한 빨리 신청</strong>하는 거예요. 늦게 시작하면 12개월 안에 수급일수를 다 채우지 못하죠. <a href="https://www.ei.go.kr" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용24</a>에서 이직확인서 처리가 완료되면 곧바로 움직이세요.
      </p>
      ...
      <p style={{ ...body, marginTop: 14 }}>
        정년퇴직도 비자발적 퇴사로 인정돼요. 계약 만료, 권고사직, 폐업도 마찬가지고요. 자발적 퇴사라도 임금체불이나 직장 내 괴롭힘 같은 정당한 사유가 있으면 인정받을 수 있죠.
      </p>
      ...
      <p style={body}>
        수급기간 12개월은 퇴직일 기준이라 신청 시점과 관계없이 <strong>고정</strong>이에요. 3개월 뒤에 신청하면 남은 수급기간이 9개월뿐이죠. 본인의 수급일수가 150일(약 5개월)이라면 9개월 안에 다 받을 수 있어요. 이 경우는 손해가 없어요.
      </p>
      <p style={body}>
        문제는 더 늦어질 때예요. 같은 150일 수급자가 퇴직 후 8개월째에 신청하면, 남은 수급기간은 4개월(약 120일)뿐이에요. 150일 중 30일치를 날리게 되죠. 2026년 기준 1일 하한액 <strong>66,048원</strong>만 잡아도 약 <strong>198만원</strong>을 그냥 버리는 셈이에요.
      </p>
      <p style={body}>
        1일 상한액 <strong>68,100원</strong> 기준이면 30일에 약 204만원이에요. 60일을 놓치면 408만원, 90일이면 612만원이죠. 신청을 미루는 하루하루가 돈으로 직결된다고 보면 돼요. 아래 계산기에서 내 예상 수령액을 확인해보세요.
      </p>

      <BorderBox title="늦게 신청한 경우 비교">
      ...
      <p style={body}>
        퇴사하면 바로 신청할 수 있는 건 아니에요. 회사가 <strong>이직확인서</strong>를 고용센터에 제출해야 하는데, 법적으로 퇴직 후 10일 이내예요. 대부분의 회사가 이 기한 안에 처리하지만, 안 해주면 고용센터(1350)에 신고하면 되죠. 미제출 사업주에게는 과태료가 부과돼요.
      </p>
      <p style={body}>
        이직확인서가 처리되면 <a href="https://www.ei.go.kr" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용24</a>에서 확인이 돼요. 그다음 워크넷에 구직등록을 하고, 수급자격 신청자 온라인 교육을 이수하세요. 교육 이수 후 관할 고용센터에 방문해서 수급자격을 신청하면 돼요. 요즘은 온라인으로도 진행할 수 있죠.
      </p>
      <p style={body}>
        수급자격 신청 후에는 <strong>대기기간 7일</strong>이 지나고 첫 실업인정일이 돼요. 첫 실업인정에서 인정을 받으면 바로 입금되죠. 퇴사 후 대략 <strong>3~4주</strong>면 첫 실업급여를 받게 되는 셈이에요. 빠르게 움직이면 한 달 안에 첫 입금까지 가능하죠.
      </p>
      ...
      <p style={body}>
        원칙적으로 12개월이 지나면 수급권이 소멸돼요. 하지만 <a href="https://www.law.go.kr/법령/고용보험법" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험법</a>에서 정한 <strong>법정 사유</strong>가 있으면 수급기간 연장 신청이 가능해요. 질병, 부상, 출산, 만 8세 이하 자녀 육아, 의무 군복무가 해당 사유죠.
      </p>
      <p style={body}>
        질병이나 부상으로 취업 자체가 어려운 경우, 의사 진단서를 첨부해서 고용센터에 연장 신청을 하면 돼요. 출산 전후나 자녀 육아로 구직활동이 불가능한 기간도 인정되죠. 의무 군복무 기간 역시 수급기간에서 제외할 수 있어요.
      </p>
      <p style={body}>
        연장이 승인되면 최대 <strong>4년</strong>까지 수급기간이 늘어나요. 단, 자동 연장이 아니라 본인이 직접 증빙서류와 함께 신청해야 하죠. "몰랐다", "바빠서 못 했다"는 연장 사유가 아니에요. 법정 사유에 해당하는 경우에만 적용되니까, 해당 사유가 생기면 즉시 고용센터에 연락하세요.
      </p>
      ...
      <p style={body}>
        안타깝지만 수급기간이 지나면 <strong>법적으로 수급권이 소멸</strong>돼요. 어떤 사유를 대도 이미 지난 기간에 대해서는 실업급여를 받을 방법이 없어요. 고용센터에 문의해도 같은 답변을 받게 되죠. 이건 법에 명시된 강행규정이라 담당자 재량으로 바꿀 수 있는 문제가 아니에요.
      </p>
      <p style={body}>
        그렇다고 실업급여 자체를 영영 못 받는 건 아니에요. 새로 취업해서 <strong>고용보험 가입기간을 다시 쌓으면</strong> 다음에 퇴직할 때 수급자격이 새로 생기죠. 18개월 중 180일 이상 가입하면 돼요. 이전에 실업급여를 받지 못했다고 불이익이 가중되진 않아요.
      </p>
      <p style={body}>
        교훈은 하나예요. 퇴사하면 <strong>가능한 빨리 신청</strong>하세요. 쉬고 싶으면 실업급여를 받으면서 쉬면 돼요. 어차피 구직활동 보고는 2~4주에 한 번이라 부담이 크지 않아요. 신청을 미루면 1일 6만원 이상을 매일 버리는 거라고 생각하면 절대 늦출 수 없죠.
      </p>
