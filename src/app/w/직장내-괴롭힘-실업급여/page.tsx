...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={body}>
        체크리스트에서 하나 더 강조할 부분이 있죠. 고용24(ei.go.kr)에서 <strong>피보험자격 이력</strong>을 미리 조회해보세요. 고용보험 가입기간 180일을 채웠는지, 혹시 회사가 고용보험 신고를 빠뜨린 적은 없는지 퇴사 전에 확인하는 게 안전하죠.
      </p>
      ...
      <p style={body}>
        심사 과정에서 고용센터가 사업주에게 확인 조사를 진행해요. 회사가 괴롭힘 사실을 부인할 수 있으니까 근로자 쪽 증거가 탄탄할수록 좋죠. 일반 비자발적 퇴사보다 심사가 1~2주 더 걸리는 편이에요. 수급자격이 인정되면 7일 대기기간 후 1~4주 간격으로 실업인정을 받고 급여가 입금돼요.
      </p>
      ...
      <p style={body}>
        증거를 모아서 제출했는데도 고용센터에서 괴롭힘을 인정하지 않는 경우가 있죠. 이때 바로 포기하면 안 돼요. <strong>심사청구</strong>를 처분을 안 날로부터 90일 이내에 고용보험심사관에게 제출하면 다시 판단을 받을 수 있죠.
      </p>
      <p style={body}>
