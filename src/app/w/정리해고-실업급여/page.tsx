  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        ...
        고용보험 가입기간 180일만 넘으면 월급의 60%를 최대 270일까지 받을 수 있죠.
      ...
      <GreenBox title="정리해고 실업급여 금액 핵심">
      ...
      <BorderBox title="정리해고 실업급여 금액 기준 (2026년)">
      ...
      <p style={body}>
        정리해고는 비자발적 퇴사가 확실한데도 거부되는 경우가 있죠. 대부분 서류 문제죠. 이직확인서에 퇴직 사유가 &ldquo;자진퇴직&rdquo;으로 잘못 기재된 경우가 가장 흔하죠. 사직서를 쓰라는 말에 응했거나, 회사가 고용센터에 잘못 신고한 거죠.
      </p>
      <p style={body}>
      ...
      <p style={body}>
        정정 요청으로도 안 되면 <strong>심사청구(90일 이내)</strong>와 <strong>재심사청구(30일 이내)</strong>를 순서대로 할 수 있죠. 정리해고인데 수급이 안 되면 수백만 원에서 최대 1,800만 원 넘는 돈을 놓치는 거예요. 한 번 거절당했다고 포기하지 마세요. <a href="https://www.law.go.kr/법령/근로기준법" style={{ color: "#1D9E75", textDecoration: "underline" }}>근로기준법 제24조</a>의 정리해고 요건을 회사가 어긴 정황이 보인다면, 부당해고 구제신청(노동위원회, 해고일로부터 3개월 이내)도 동시에 진행할 수 있죠.
      </p>
