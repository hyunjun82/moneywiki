...
const CHECK_ITEMS = [
  ...
  { id: "c3", label: "연장 동의서에 서명해야 하는지 모르겠어요" },
  { id: "c4", label: "연장 시 지연이자를 받을 수 있는지 궁금해요" },
];
...
const STEPS = [
  {
    ...
    tip: "퇴직일이 휴일이어도 14일 기산은 퇴직일 다음 날부터 시작해요",
  },
  {
    title: "연장 동의 여부 결정",
    desc: "회사가 지급 기한 연장을 요청할 수 있어요. 근로기준법 제36조는 사용자와 근로자가 사전에 합의하면 지급 기한을 연장할 수 있다고 규정하고 있어요. 하지만 이 합의는 퇴직 전에 이뤄져야 하고, 사후 강요는 무효예요.",
  ...
  },
  {
    ...
    tip: "지연이자는 퇴직금과 별도로 청구해요 (포기하지 마세요)",
  },
  {
    title: "미지급 퇴직금 신고",
    desc: "회사가 퇴직금을 지급하지 않거나 지연이자를 거부하면 고용노동부 고객상담센터(1350) 또는 사업장 관할 지방노동청에 진정을 낼 수 있어요. 3년 소멸시효 내에 신고하면 돼요.",
...
const FAQS = [
  ...
  },
  {
    ...
    a: "동의서에 지연이자 포기 문구가 없다면 청구 가능해요. 포기 문구가 있어도 사전 합의 없이 강요로 서명했다면 무효 주장이 가능해요. 세부 사항은 노동 전문가 상담이 필요해요.",
  },
  {
    q: "퇴직 후 14일이 지나도 받지 못하면 어디에 신고하나요?",
    a: "고용노동부 고객상담센터(1350)에 전화하거나, 사업장 관할 지방노동청에 진정서를 제출하면 돼요. 온라인으로는 고용노동부 홈페이지에서도 신고 가능해요.",
  },
  {
    q: "지연이자는 얼마나 되나요?",
...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={body}>
        회사가 자금 사정 등을 이유로 연장을 요청할 수 있어요.
        이때 근로자가 동의하면 지급 기한을 늦출 수 있지만, 이 합의는 퇴직 전에 이뤄져야 하고 강요나 사후 합의는 무효예요.
        동의서에 서명할 때는 지연이자 포기 조항이 있는지 꼭 확인하세요.
      </p>
      ...
      <GreenBox title="지연이자는 포기하지 마세요">
        ...
        근로기준법 제37조로 보장된 권리예요. 모르고 포기하는 경우가 많으니 꼭 챙기세요.
      </GreenBox>
