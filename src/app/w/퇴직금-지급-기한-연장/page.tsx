...
const FAQS = [
  ...
  },
  {
    ...
    a: "합의서에 지연이자 포기 문구가 없다면 청구 가능해요. 포기 문구가 있더라도 강요로 서명했다면 무효 주장이 가능해요. 합의서 내용을 먼저 확인해봐요.",
  },
  {
  ...
  return (
    ...
    >
      ...
      <EligibilityChecker
        ...
        partialMatchText="상황에 따라 다를 수 있어요. 합의서 내용과 서명 시점을 먼저 확인해봐요."
      />
      ...
      <p style={body}>
        합의서에 서명하기 전에 지연이자 포기 조항이 없는지 꼭 확인해봐요.
      ...
      <Disclaimer text="이 글은 2026년 3월 기준 근로기준법 제36조·제37조를 바탕으로 작성됐어요. 개별 사안에 따라 적용이 달라질 수 있으니 고용노동부(1350) 또는 관할 노동청에서 확인해봐요." />
    </ArticleLayout>
  );
}
