"use client";
// Q1~Q4: 취학전 아동 교육비 공제 대상은? 관련 독자의 상황과 해결
...
const FAQS = [{"q":"취학전 아동 교육비 공제 대상은 관련 가장 많이 묻는 질문이에요","a":"관할 기관 홈페이지나 전화(1350, 1577-0000 등)로 확인하는 게 가장 정확해요."},{"q":"온라인으로 신청할 수 있나요?","a":"대부분 정부24(gov.kr)나 해당 기관 홈페이지에서 온라인 신청이 가능해요."},{"q":"필요한 서류가 뭔가요?","a":"신분증과 관련 증빙서류가 기본이에요. 구체적 서류 목록은 기관에서 안내받으세요."},{"q":"처리 기간은 얼마나 걸리나요?","a":"보통 2~4주 정도 소요돼요. 기관과 신청 건수에 따라 달라질 수 있어요."},{"q":"대리 신청이 가능한가요?","a":"위임장과 대리인 신분증이 있으면 가능한 경우가 많아요. 사전에 기관에 확인하세요."}];
...
export default function Page() {
  return (
    <ArticleLayout>
      ...
      <h1 style={{ fontSize: 26, fontWeight: 700, lineHeight: 1.45, marginBottom: 14 }}>취학전 아동 교육비 공제 대상은?<br />어린이집 유치원 학원비</h1>
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>취학전 아동 교육비 공제 대상은에 대해 정확히 알고 싶죠.</p>
      <p style={body}>관련 법령과 제도를 기준으로 핵심 내용을 정리했어요.</p>
      <Divider /><ArticleAd position="intro" />

      <H2>어린이집 유치원 학원비 핵심</H2>
