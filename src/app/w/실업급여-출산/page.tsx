...
const FAQS = [
  {
    ...
    a: "받을 수 있죠. 다만 동시에는 안 돼요. 출산전후휴가 급여가 끝난 뒤에 실업급여를 신청해야 해요. 둘 다 고용보험에서 나오는 급여라 중복 수급이 법으로 금지돼 있어요.",
  },
  {
  ...
  },
  {
    ...
    a: "받을 수 있죠. 육아휴직 기간도 고용보험 가입기간으로 인정돼요. 다만 회사가 복직을 받아줬는데 본인이 거부한 경우, 자발적 퇴직으로 분류될 수 있어요. 퇴직 사유를 잘 정리해두는 게 중요하죠.",
  },
  {
...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={body}>
        &ldquo;비자발적 퇴직&rdquo;이라는 조건도 빠뜨리면 안 돼요. 계약만료, 권고사직, 근무조건 불리변경은 당연히 해당되죠. 그런데 회사가 복직을 제안했는데 본인이 거부한 경우라면 자발적 퇴직으로 분류될 수 있죠. 이직확인서에 퇴직 사유가 어떻게 적히는지 반드시 체크해봐요.
      </p>
      ...
      <p style={body}>
        갈림길은 <strong>퇴직 사유</strong>예요. 회사가 복직을 거부했거나 복귀 뒤 근무조건이 나빠졌다면 비자발적 퇴직이죠. 실업급여 수급이 가능해요. 반면 회사가 원래 자리로 돌아오라는데 본인이 &ldquo;안 가겠다&rdquo;고 했다면 자발적 퇴직으로 잡힐 수 있죠.
      </p>
      <p style={body}>
        자발적 퇴직이라고 길이 완전히 막힌 건 아니에요. 육아를 이유로 한 퇴직이{" "}
        <a href="/w/실업급여-정당한-퇴사-사유" style={{ color: "#1D9E75", textDecoration: "underline" }}>정당한 이직 사유</a>로 인정받는 경우가 있죠. 어린이집 대기가 걸려서 아이를 맡길 곳이 없는 상황 등이 해당될 수 있죠. 고용센터(1350)에 사전 상담을 꼭 받아봐야 해요.
      </p>
