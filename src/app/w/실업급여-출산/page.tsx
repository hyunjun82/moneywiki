...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={body}>
        &ldquo;비자발적 퇴직&rdquo;이라는 조건도 빠뜨리면 안 돼요. 계약만료, 권고사직, 근무조건 불리변경은 당연히 해당되죠. 그런데 회사가 복직을 제안했는데 본인이 거부한 경우라면 자발적 퇴직으로 분류될 수 있어요. 이직확인서에 퇴직 사유가 어떻게 적히는지 반드시 확인하세요.
      </p>
      ...
      <p style={body}>
        그래서 <a href="https://www.law.go.kr/법령/고용보험법" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험법 제52조</a>가 출산과 육아를 수급기간 연장 사유로 인정하고 있어요. 고용센터에 출생증명서나 모자보건수첩 등을 내면 수급기간을 <strong>최대 4년까지</strong> 늘려줘요. 아이가 좀 크고 어린이집에 맡기기 시작한 뒤에 여유 있게 구직활동을 해도 되는 거예요.
      </p>
      <p style={body}>
      ...
      <p style={body}>
        자발적 퇴직이라고 길이 완전히 막힌 건 아니에요. 육아를 이유로 한 퇴직이 &ldquo;정당한 이직 사유&rdquo;로 인정받는 경우가 있죠. 어린이집 대기가 걸려서 아이를 맡길 곳이 없는 상황 등이 해당될 수 있어요. 고용센터(1350)에 사전 상담을 꼭 받아보세요.
      </p>
      ...
      <p style={body}>
        면접장을 돌아다녀야만 구직활동이 인정되는 건 아니에요. <strong>워크넷(work.go.kr) 온라인 입사지원</strong>만으로도 충분히 인정돼요. 아기 재우고 나서 컴퓨터 앞에 앉아 입사지원 몇 건 넣으면 되는 거죠. 고용센터에 매번 가지 않아도 되는 방법이 여럿 있어요.
      </p>
      <p style={body}>
