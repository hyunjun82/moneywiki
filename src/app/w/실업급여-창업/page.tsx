...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={body}>
        부정수급이 확정되면 피해가 커요. 받은 급여 전액 반환에 <strong>최대 5배 추가 징수</strong>가 붙어요. 100만 원을 부정수급했으면 최대 600만 원을 내야 하는 거죠. 남은 실업급여도 전액 중단돼요. 신고 한 번이면 피할 수 있는 일인데, 아까워서 미루다가 훨씬 큰 금액을 잃게 되는 거예요.
      </p>
