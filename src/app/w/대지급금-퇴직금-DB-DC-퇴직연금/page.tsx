...
const CHECK_ITEMS = [
  { id: "c1", label: "회사가 폐업·도산했거나 임금을 체불했어요" },
  { id: "c2", label: "퇴직금 또는 DB·DC 퇴직연금을 못 받았어요" },
  { id: "c3", label: "퇴직한 지 2년이 지나지 않았어요" },
  { id: "c4", label: "재직 당시 상시근로자 수가 300인 미만이에요" },
];
...
const STEPS = [
  {
    title: "고용노동청에 체불 신고",
    desc: "회사가 퇴직금·임금을 주지 않으면 관할 고용노동청에 체불 진정을 내요. 온라인(고용24)이나 방문으로 접수할 수 있어요. 신고 후 근로감독관이 조사에 들어가요.",
    tip: "퇴직 후 3년 이내에 신고해야 해요 (소멸시효)",
  },
  {
    title: "체불 확인서 발급",
    desc: "근로감독관이 체불 사실을 확인하면 '체불 임금 등 사업주 확인서'를 발급해줘요. 이 서류가 대지급금 신청의 핵심 서류예요. 도산·폐업 기업은 법원의 도산 사실 확인도 필요해요.",
    tip: "확인서 발급까지 보통 1~3개월 소요",
  },
  {
    title: "근로복지공단에 대지급금 신청",
    desc: "체불 확인서를 받은 날로부터 1년 이내에 근로복지공단에 대지급금을 신청해요. 온라인(kcomwel.or.kr) 또는 방문으로 신청 가능해요. DB·DC 퇴직연금 미지급분도 대지급금으로 받을 수 있어요.",
    tip: "퇴직 후 2년 이내, 확인서 발급 후 1년 이내라는 기간 조건 모두 충족해야 해요",
  },
  {
    title: "대지급금 수령",
    desc: "신청 후 보통 2~4주 내에 지급돼요. 상한액은 2,100만원이에요. 대지급금을 받은 뒤 국가가 사업주에게 구상권을 행사해요. 수령 후에도 부족분은 사업주에게 직접 청구할 수 있어요.",
    tip: "IRP로도 받을 수 있어요 — 세금 이연 가능",
  },
];
...
const CHECKLIST = [
  ...
  "DB·DC 퇴직연금도 대지급금으로 청구 가능",
];

const FAQS = [
  {
    q: "DB·DC 퇴직연금을 못 받은 경우도 대지급금 신청이 되나요?",
    a: "가능해요. 퇴직연금(DB·DC형) 미지급분도 체불 임금에 해당해서 대지급금 신청 대상이에요. 단, 사업주가 퇴직연금 납입을 안 했거나 운용사에서 지급 거부한 경우에 해당해요.",
  },
  {
  ...
  },
  {
    ...
    a: "고용24나 국세청 홈택스에서 사업자 정보를 확인할 수 있어요. 정보가 없어도 고용노동청 방문 상담을 받으면 조사 방법을 안내해줘요.",
  },
  {
  ...
  },
  {
    ...
    a: "아니에요. 대지급금은 퇴직 후에 신청할 수 있어요. 재직 중 체불은 고용노동청 진정 후 사업주에게 지급을 강제하는 방식으로 해결해요.",
  },
];
...
const RELATED = [
  { slug: "퇴직금-미지급-청구-기한-지연이자", title: "퇴직금 미지급 청구 기한", description: "소멸시효 3년과 연 20% 지연이자." },
  { slug: "퇴직금-지급-청구-방법", title: "퇴직금 청구 방법", description: "내용증명·노동청 신고·소송 절차." },
  { slug: "db형-퇴직금-수령방법", title: "DB형 퇴직연금 수령 방법", description: "확정급여형 수령 절차 정리." },
];
...
export default function Page() {
  return (
    <ArticleLayout
      sidebar={<Sidebar heading="퇴직금 가이드" items={퇴직금_SIDEBAR} currentSlug="대지급금-퇴직금-DB-DC-퇴직연금" />}
    >
      <p style={{ fontSize: 13, color: "#1D9E75", fontWeight: 600, marginBottom: 10 }}>퇴직금 · 대지급금 · DB·DC퇴직연금</p>

      <h1 style={{ fontSize: 26, fontWeight: 700, lineHeight: 1.45, marginBottom: 14 }}>
        회사 도산 후 퇴직금·퇴직연금 못 받았을 때<br />
        대지급금으로 DB·DC형도 청구할 수 있어요
      </h1>
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        ...
        <a href="/w/퇴직금-미지급-청구-기한-지연이자" style={{ color: "#1D9E75", textDecoration: "underline" }}>소멸시효</a>가 지나면 청구할 수 없으니 빠르게 신청하세요.
      </p>
      ...
      <H2>신청에 필요한 서류</H2>
      <p style={body}>
        체불 확인서가 핵심이에요. 이 서류는 고용노동청 근로감독관이 발급해줘요.
