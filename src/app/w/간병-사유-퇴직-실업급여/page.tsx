  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        ...
        아니에요, 받을 수 있죠.
        <a href="https://www.law.go.kr/법령/고용보험법" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험법</a>은 가족 간병 때문에 어쩔 수 없이 퇴직한 경우를 <strong>정당한 이직 사유</strong>로 인정하죠.
      ...
      <BorderBox title="회사가 퇴직을 강요한다면?">
        ...
        간병 사유 자진퇴사 대신 권고사직으로 처리하면 실업급여 수급이 더 수월해요.
      </BorderBox>
      ...
      <p style={body}>
        심사 결과는 보통 1~2주면 나와요. 승인되면 약 2주 내에 첫 실업급여가 통장에 입금되죠. 만약 불인정 결정이 나오더라도 <strong>60일 이내에 이의신청</strong>이 가능해요. 추가 증빙을 첨부해서 재심사를 받으면 되니, 서류를 미리 넉넉하게 확보해두는 게 유리하죠.
      </p>
