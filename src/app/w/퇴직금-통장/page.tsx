...
const CHECK_ITEMS = [
  ...
  { id: "c3", label: "DB형 퇴직금 제도 또는 퇴직금 제도 사업장에서 일해요" },
...
const STEPS = [
  {
    title: "IRP 계좌 개설",
    desc: "은행·증권사·보험사 어디서든 IRP를 개설할 수 있죠. 앱에서 신분증 촬영과 간편인증만으로 10분 이내 완료돼요. 수수료 0% 상품이 있는 증권사 IRP를 먼저 비교해보세요.",
    tip: "퇴직금 수령만 목적이라면 수수료 0% 증권사 IRP가 유리해요",
  },
  {
    title: "IRP 계좌번호 인사팀에 전달",
    desc: "개설 후 은행명·계좌번호·예금주명을 문자나 이메일로 인사팀에 전달해요. 이 정보가 있어야 회사가 퇴직금을 이체할 수 있으니, 퇴직 확정 전에 미리 전달해두는 게 좋아요.",
    tip: "문자나 이메일로 전달해서 기록을 남겨두세요",
  },
  {
    title: "퇴직 후 14일 이내 입금 확인",
    desc: "퇴직 후 14일 이내에 IRP 계좌에 입금됐는지 확인해요. 14일이 지났는데 입금이 없으면 인사팀에 서면으로 지급 요청을 해요. 그래도 안 되면 고용노동부에 임금체불 진정을 낼 수 있죠.",
    tip: "14일 초과 지연분에는 연 20% 지연이자가 붙어요",
    link: { label: "고용노동부 민원신청", href: "https://minwon.moel.go.kr" },
  },
  {
    title: "수령 방식 선택 (일시금 vs 연금)",
    desc: "IRP에 들어온 퇴직금은 원리금보장형(예금)이나 실적배당형(ETF) 중 선택해 운용해요. 만 55세 이후 연금으로 받으면 퇴직소득세가 30~40% 줄어요. 당장 목돈이 필요하면 일시금 인출도 가능해요.",
...
const FAQS = [
  {
    ...
    a: "원칙적으로 안 돼요. 퇴직금 300만원 초과 시 IRP 계좌로 받는 게 의무예요. 만 55세 이상 퇴직, 300만원 이하, 외국인 출국, 사망·장해 등 법정 예외에 해당하면 일반 통장으로 받을 수 있죠.",
  },
  {
    q: "IRP에 입금된 퇴직금을 바로 꺼낼 수 있나요?",
    a: "가능해요. IRP 입금 후 일시금 인출 신청을 하면 퇴직소득세를 원천징수한 뒤 지급돼요. 다만 연금 수령 시 받을 수 있는 30~40% 세금 감면 혜택은 사라지니 주의해야 해요.",
  },
  {
    q: "IRP 계좌가 여러 개여도 되나요?",
    a: "여러 금융기관에 IRP를 개설할 수 있죠. 퇴직금은 그중 하나의 IRP로만 받을 수 있고요. 수수료와 운용 상품을 비교해서 가장 유리한 계좌를 선택한 뒤 회사에 알려주세요.",
  },
  {
    q: "통장 종류에 따라 세금이 달라지나요?",
    a: "달라져요. IRP로 받으면 퇴직소득세 납부가 이연되고, 연금으로 수령 시 세금이 30~40% 줄어요. 일반 통장으로 받으면 수령 즉시 퇴직소득세가 부과돼요. 퇴직금이 클수록 차이가 커져요.",
  },
  {
    q: "IRP 계좌를 만들었는데 퇴직금이 안 들어왔어요",
    a: "퇴직 후 14일 이내에 이체해야 해요. 14일이 지났다면 인사팀에 문의하고, 그래도 안 되면 고용노동부 임금체불 진정을 낼 수 있죠. 지연 기간만큼 연 20% 지연이자를 청구할 수 있고요.",
  },
  {
  ...
  {
    q: "DC형 퇴직연금에 가입돼 있으면 IRP를 따로 만들어야 하나요?",
    a: "DC형 퇴직연금은 이미 IRP와 비슷한 구조로 운용돼요. 퇴직 시 DC형 계좌에서 IRP로 자동 이전되는 경우가 많아요. 회사 담당자에게 이전 방식을 먼저 확인하는 게 좋아요.",
  },
];
  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        ...
        IRP로 받으면 세금이 이연되고, 연금으로 수령하면 퇴직소득세가 30~40% 줄어드는 혜택까지 받을 수 있죠.
      </p>
      ...
      <p style={body}>
        ...
        이 중 하나에 해당하면 일반 예금 통장으로도 받을 수 있죠.
        나머지는 IRP 계좌를 미리 개설해두지 않으면 수령이 지연될 수 있으니 미리 준비해두세요.
      </p>
      ...
      <EligibilityChecker
        ...
        partialMatchText="IRP 의무 예외 여부를 먼저 확인해보세요. 예외에 해당하면 일반 통장도 가능해요."
      />
      ...
      <p style={body}>
        퇴직소득세는 근속연수 공제 후 적용 세율이 달라지기 때문에, 퇴직금이 같아도 세금 차이는 수십만 원에서 수백만 원까지 날 수 있죠.
        아래 계산기로 내 상황에 맞는 세금을 먼저 파악해보세요.
      </p>
      ...
      <Calculator
        ...
        note="※ 퇴직소득세는 근속연수 공제 후 세율 기준. 실제 세금은 홈택스 퇴직소득세 계산기로 정확히 파악하세요."
      />
      ...
      <p style={body}>
        ...
        재직증명서는 일부 금융사에서만 요구하니, 해당 금융사 앱에서 미리 파악해두세요.
      </p>
      <p style={body}>
      ...
      <p style={body}>
        ...
        퇴직이 확정됐다면 아래 체크리스트를 하나씩 점검해보세요.
      </p>
      ...
      <Disclaimer text="이 글은 2026년 3월 기준 근로자퇴직급여 보장법을 바탕으로 작성됐어요. 금융 상품 조건은 변동될 수 있으니, 가입 금융기관에서 확인해주세요." />
    </ArticleLayout>
  );
}
