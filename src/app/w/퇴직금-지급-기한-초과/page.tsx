...
const CHECK_ITEMS = [
  ...
  { id: "c3", label: "지급 기한 연장에 서면으로 합의한 적이 없어요" },
...
const STEPS = [
  ...
  {
    title: "고용노동부 진정 신청",
    desc: "사업장 관할 지방노동청 또는 고용노동부 민원마당(minwon.moel.go.kr)에 진정을 접수해요. 근로감독관이 사실 조사 후 지급 명령을 내려요. 진정 시 지연이자도 함께 청구 가능해요.",
    tip: "보통 2~4주 내에 처리돼요",
  },
  {
...
const RELATED = [
  ...
  { slug: "퇴직금-지급-기한-14일-원칙-지연이자", title: "14일 원칙 지연이자", description: "기한 계산과 청구 절차." },
  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        ...
        회사가 응하지 않으면 <a href="/w/퇴직금-지급-기한-연장" style={{ color: "#1D9E75", textDecoration: "underline" }}>노동청 진정</a>이나 형사 고발로 대응할 수 있어요.
      </p>
      ...
      <p style={body}>
        지연이자를 함께 청구하는 걸 잊지 마세요. 소멸시효 3년도 반드시 챙겨야 해요.
      </p>
