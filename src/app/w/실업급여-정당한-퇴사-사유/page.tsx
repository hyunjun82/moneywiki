...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={body}>
        <a href="https://www.law.go.kr/법령/고용보험법시행규칙" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험법 시행규칙</a>이 정당한 이직 사유를 구체적으로 나열하고 있어요. 가장 흔한 게 <strong>임금 관련 문제</strong>죠. 월급의 30% 이상을 안 줬거나, 2개월 이상 밀렸거나, 최저임금에 미달하는 급여를 받았다면 전부 해당돼요. 체불 금액이 적더라도 반복되면 인정 가능성이 높아지고요.
      </p>
      <p style={body}>
        <strong>직장 내 괴롭힘과 성희롱</strong>도 많이 인정되는 사유예요. 상사나 동료에게 지속적으로 괴롭힘을 당하거나 성희롱 피해를 입고 퇴사했는데, 회사가 제대로 조치를 안 했다면 정당한 사유가 되죠. <strong>통근 곤란</strong>은 사업장 이전이나 전근으로 출퇴근 왕복 3시간 이상이 된 경우에 해당돼요.
      </p>
      <p style={body}>
      ...
      <p style={body}>
        심사에서 불인정 결정이 나왔다고 끝이 아니에요. <strong>60일 이내에 이의신청</strong>을 할 수 있죠. 처음 제출하지 못한 추가 증거를 첨부해서 재심사를 받는 거예요. 새로운 증거가 추가되면 결과가 뒤집히는 경우도 꽤 많죠.
      </p>
      <p style={body}>
