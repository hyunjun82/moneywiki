...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={body}>
        비자 종류에 따라 완전히 달라요.
        <strong>F-2, F-4, F-5, F-6, H-2</strong> 같은 거주·취업 비자라면 고용보험에 의무가입이니까 내국인과 동일하게 실업급여를 받을 수 있죠.
        반면 <strong>E-9 비자</strong>는 고용보험이 아니라 출국만기보험 대상이에요. 구조 자체가 다르죠.
      </p>
      <p style={body}>
        <a href="https://www.law.go.kr/법령/고용보험법" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험법</a>이
        체류 자격별 적용 범위를 명확히 나누고 있죠.
        의무가입 대상이라면 <strong>180일</strong> 이상 가입 시 수급자격이 생기고, 신청 서류도 몇 가지만 추가하면 끝이에요.
        내 비자가 어디에 해당하는지 아래에서 바로 짚어볼게요.
      </p>
      ...
      <p style={body}>
        ...
        체류 자격에 따라 <strong>의무가입</strong>과 <strong>임의가입</strong>으로 나뉘죠.
        의무가입 비자라면 회사가 반드시 고용보험에 가입시켜야 하고, 보험료도 내국인과 동일하게 내요.
      </p>
      <p style={body}>
        <a href="https://www.law.go.kr/법령/고용보험법" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험법</a>에 따르면
        거주 계열 비자가 의무가입 대상이에요.
        <strong>F-2(거주)</strong>, <strong>F-5(영주)</strong>, <strong>F-6(결혼이민)</strong>은 장기 체류가 보장된 자격이니까 당연히 적용되죠.
        <strong>F-4(재외동포)</strong>와 <strong>H-2(방문취업)</strong>도 여기에 포함돼요.
      </p>
      <p style={body}>
      ...
      <p style={body}>
        먼저 전문인력 비자부터 볼게요.
        <strong>E-1부터 E-7까지</strong>는 교수, 연구, 기술지도, 전문직업 비자예요.
        이 비자들은 <strong>임의가입</strong> 대상이라, 본인과 사업주가 합의하면 고용보험에 가입할 수 있고, 가입했다면 실업급여도 받을 수 있죠.
      </p>
      <p style={body}>
        그런데 <strong>E-9(비전문취업)</strong>은 구조 자체가 달라요.
        E-9 비자 근로자는 고용보험 가입 대상이 아니에요.
        대신 <a href="https://www.law.go.kr/법령/외국인근로자의고용등에관한법률" style={{ color: "#1D9E75", textDecoration: "underline" }}>외국인근로자의 고용 등에 관한 법률</a>에 따라 <strong>출국만기보험</strong>에 가입되죠.
        사업주가 매달 보험료를 적립하고, 근로자가 출국할 때 일시금으로 받는 방식이에요.
      </p>
      <p style={body}>
        왜 이렇게 만들었냐면, E-9은 &quot;한국에서 일하고 본국으로 돌아가는&quot; 구조를 전제로 설계된 비자이기 때문이에요.
        한국에서 재취업을 전제로 하는 실업급여 대신, 출국 시 목돈을 받는 보험이 적용되는 거죠.
      ...
      <p style={body}>
        기본 조건은 내국인과 같아요.
        고용보험에 <strong>180일 이상</strong> 가입돼 있어야 하고, <strong>비자발적 퇴사</strong>여야 하며, <strong>재취업 의사</strong>가 있어야 하죠.
        여기까지는 차이가 전혀 없어요.
      </p>
      <p style={body}>
        외국인에게만 추가되는 조건이 하나 있죠. <strong>체류 자격 유지</strong>예요.
        비자가 만료되면 불법체류 상태가 되니까 실업급여 지급이 바로 중단되죠.
        수급 기간 중에 비자 만료일이 다가오면 <a href="https://www.immigration.go.kr" style={{ color: "#1D9E75", textDecoration: "underline" }}>출입국관리사무소</a>에서 연장 신청을 먼저 해야 해요. 이걸 놓치면 남은 급여를 아예 못 받게 돼요.
      </p>
      <p style={body}>
        구직활동 의무도 동일하게 적용돼요.
        실업인정일에 고용센터를 방문해서 구직활동 내역을 보고해야 하죠.
        주의할 점은, 취업 제한 비자로 변경되면 구직활동 자체가 불가능해진다는 거예요.
        비자 종류가 바뀌지 않도록 신경 써야 해요.
      </p>
      ...
      <p style={body}>
        ...
        영어, 중국어, 베트남어, 태국어, 인도네시아어 등 다국어 통역 서비스를 무료로 제공하고 있죠.
        고용센터 방문할 때 통역 지원도 요청할 수 있죠. 언어 때문에 신청을 포기할 필요는 전혀 없어요.
      </p>
      <p style={body}>
        수급자격이 인정되면 1~4주 간격으로 고용센터에 출석해서 실업인정을 받아야 해요.
        실업인정일에 <a href="/w/실업급여-구직활동-횟수" style={{ color: "#1D9E75", textDecoration: "underline" }}>구직활동</a> 내역을 보고하면 그 기간에 해당하는 실업급여가 지급되는 구조예요.
        퇴직 후 <strong>12개월 이내</strong>에 신청해야 하니까, 퇴직하면 바로 움직이세요.
      </p>
      ...
      <p style={body}>
        ...
        실업급여는 한국에서 구직활동을 하면서 받는 제도이기 때문이죠.
        다시 입국하더라도 남은 수급기간 내에서만 재개할 수 있죠. 기간이 지나면 그대로 소멸되고요.
      </p>
      <p style={body}>
        실업급여를 못 받고 출국하는 경우에는 <strong>고용보험 반환일시금</strong>이라는 제도가 있죠. <a href="/w/실업급여-부정수급" style={{ color: "#1D9E75", textDecoration: "underline" }}>부정수급</a> 문제가 생기지 않도록 수급 중 출입국 기록은 빠짐없이 신고해야 하고요.
        본인이 납부한 고용보험료의 일부를 돌려받는 제도예요.
        출국 전에 고용센터에서 신청해야 하니까, 귀국 일정이 잡히면 미리 방문하세요.
      </p>
      <p style={body}>
        정리하면 이래요.
        한국에서 계속 체류하면서 재취업할 계획이면 실업급여를, 본국으로 돌아갈 계획이면 반환일시금을 받는 거예요.
