  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        ...
        별개의 제도이기 때문에, 고용보험 가입 이력만 있으면 기초수급자도 실업급여를 받을 수 있어요.<br /><br />
      ...
      <p style={body}>
        결론부터 말하면, <strong>받을 수 있어요</strong>. 기초생활보장제도는{" "}
      ...
      <p style={body}>
        실업급여 수급 조건도 일반인과 똑같아요. 고용보험 가입 사업장에서 180일 이상 근무하고, 비자발적 퇴사(또는 정당한 사유의 자발적 퇴사)여야 하며, 적극적인 구직활동 의사가 있어야 하죠. 기초수급자라서 조건이 달라지거나 추가되는 건 없어요.
      </p>
      <p style={body}>
        퇴직 후 12개월 이내에 신청해야 한다는 점도 동일해요. 기초수급자라고 우대하거나 불이익을 주는 조항이 따로 없기 때문에, 고용보험 자격 조건만 맞으면 누구나 동일하게 신청할 수 있죠.
      </p>
      ...
      <p style={body}>
        <strong>받을 수 있지만, 생계급여가 조정돼요.</strong>{" "}
        <a href="https://www.law.go.kr/법령/국민기초생활보장법" style={{ color: "#1D9E75", textDecoration: "underline" }}>국민기초생활보장법</a>에서 정한 &quot;소득인정액&quot; 계산 때문이에요.
        기초생활보장 급여는 소득인정액이 기준 중위소득의 일정 비율 이하일 때 지급되는데, 실업급여를 받으면 그게 소득으로 잡히죠.
      </p>
      <p style={body}>
        소득인정액 = 소득평가액 + 재산의 소득환산액이에요. 실업급여는 <strong>실제 수령 금액 전액</strong>이 소득평가액에 반영돼요.
      ...
      <p style={body}>
        ...
        <a href="https://www.law.go.kr/법령/국민기초생활보장법" style={{ color: "#1D9E75", textDecoration: "underline" }}>국민기초생활보장법 제37조</a>에서
        수급자의 소득·재산 변동 신고 의무를 정하고 있어요. 실업급여를 받기 시작하면 소득이 생긴 것이니까, 변동 사실을 알려야 하죠.
      </p>
      <p style={body}>
        신고 기한은 변동 발생일로부터 <strong>30일 이내</strong>예요. 실업급여 수급자격을 인정받고 첫 급여가 나오면 바로 주민센터에 알리면 돼요. 미리 신고해도 괜찮아요.
      ...
      <GreenBox title="신고 안 하면 어떻게 되나요?">
        ...
        국민기초생활보장법 제46조에 따라 받은 금액 전액 환수 + 최대 40% 가산금이 부과되고,
        향후 급여 지급이 제한될 수 있어요. &quot;몰랐다&quot;는 건 구제 사유가 되기 어렵죠.
      </GreenBox>
      ...
      <p style={body}>
        <strong>영향이 있을 수 있어요.</strong> 실업급여로 소득인정액이 올라가면 생계급여뿐 아니라 의료급여, 주거급여 자격에도 변화가 생길 수 있죠.
        의료급여는 1종(근로능력 없는 가구)과 2종(근로능력 있는 가구)으로 나뉘는데, 소득인정액이 올라가면 1종에서 2종으로 바뀌거나 자격이 상실될 수도 있어요.
      </p>
      <p style={body}>
        정확한 영향은 가구 구성, 다른 소득, 재산 등에 따라 달라지기 때문에 일률적으로 말하기 어려워요. 그래서 실업급여를 신청하기 전에 주민센터에서 <strong>사전 상담</strong>을 받는 게 가장 확실하죠. 실업급여를 받게 되면 생계·의료·주거급여가 각각 어떻게 변하는지 한꺼번에 알려줘요.
      </p>
      <p style={body}>
        국민취업지원제도의 구직촉진수당(월 50만 원, 최대 6개월)과 실업급여는 동시에 못 받는다는 점도 알아두세요. 실업급여 자격이 되면 실업급여를 먼저 받는 게 금액적으로 유리한 경우가 많아요. 실업급여 수급이 끝난 뒤에 국민취업지원제도를 신청하는 것도 방법이죠.
      </p>
      ...
      <p style={body}>
        실업급여 수급이 끝나면 소득이 줄어든 거니까, <strong>주민센터에 다시 신고</strong>해야 해요. 신고하면 생계급여가 원래 금액으로 복원되죠. 자동으로 돌아오는 게 아니라 본인이 직접 알려야 한다는 점이 핵심이에요.
      </p>
      <p style={body}>
        신고 기한은 실업급여 수급 종료 후 30일 이내예요. "실업급여 수급 종료 확인서"를 첨부하면 처리가 빨라져요.{" "}
        <a href="https://www.ei.go.kr" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용24</a>에서 수급 내역을 출력할 수 있어요.
      </p>
      <p style={body}>
        재취업에 성공하면 근로소득이 새로 생기니까 또 신고해야 하죠. 소득에 변동이 생길 때마다 30일 이내에 신고하는 게 원칙이에요. 번거롭더라도 신고를 빠뜨리면 나중에 환수당할 수 있으니 꼭 챙기세요.
      </p>
      ...
      <p style={{ ...body, marginBottom: 14 }}>
        기초수급자 실업급여에 대해 실제로 많이 물어보는 내용만 골랐어요.
      </p>
      <FAQ items={FAQS} />
