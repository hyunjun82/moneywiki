...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={body}>
        퇴직 후 12개월 이내에 신청해야 한다는 점도 동일하죠. 기초수급자라고 우대하거나 불이익을 주는 조항이 따로 없기 때문에, 고용보험 자격 조건만 맞으면 누구나 동일하게 신청할 수 있어요.
      </p>
      ...
      <p style={body}>
        국민취업지원제도의 구직촉진수당(월 50만 원, 최대 6개월)과 실업급여는 동시에 못 받는다는 점도 알아두세요. 실업급여 자격이 되면 실업급여를 먼저 받는 편이 금액적으로 유리한 경우가 많아요. 실업급여 수급이 끝난 뒤에 국민취업지원제도를 신청하는 것도 방법이죠.
      </p>
