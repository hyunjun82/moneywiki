...
const FAQS = [
  { q: "연말정산 자가운전보조금에 대해 자세히 알 수 있나요?", a: "이 글에서 핵심 내용을 정리했어요. 아래 내용을 참고하세요." },
...
const SOURCES = [
  { name: "- name: 국세청 자가운전보조금 비과세", href: "https://www.nts.go.kr" },
  { name: "소득세법 시행령 제12조", href: "https://www.law.go.kr/법령/소득세법시행령" }
];

const RELATED = [
  { slug: "연말정산-비과세-소득", title: "- title: 연말정산 비과세 소득", description: "" },
...
export default function Page() {
  return (
    <ArticleLayout>
      ...
      <h1 style={{ fontSize: 26, fontWeight: 700, lineHeight: 1.45, marginBottom: 14 }}>연말정산 자가운전보조금</h1>
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>"내 차로 출퇴근하는데 차량유지비 받으면 세금 내야 하나요? 월 20만원까지는 비과세예요. 연간 240만원 비과세 혜택이에요."</p>
      <p style={body}>본인 차량을 업무에 사용하면 월 20만원까지 비과세예요. 실비 정산이 아닌 정액 지급 방식이에요.</p>
      <Divider /><ArticleAd position="intro" />
      <H2>핵심 정리</H2>
      <GreenBox title="요약">"· 자가운전보조금은 월 20만원까지 비과세예요.\\n· 본인 소유 차량을 업무에 사용해야 해요.\\n· 실비 정산이 아닌 정액 지급이어야 해요."</GreenBox>
