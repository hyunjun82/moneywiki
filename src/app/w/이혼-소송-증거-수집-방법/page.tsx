  ...
  return (
    <div style={{ maxWidth: 1060, margin: "0 auto", padding: "2rem 1.5rem", fontFamily: "'Pretendard', 'Apple SD Gothic Neo', sans-serif", color: "#111", display: "flex", gap: 28, alignItems: "flex-start" }}>
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <HubLinks />
        <H2>외도 증거는 어떻게 모을까</H2>
        <p style={body}>외도 증거는 이혼 소송에서 가장 중요한 증거 중 하나예요. 상대방이 외도를 인정해도 증거가 없으면 법원이 인정하지 않을 수 있거든요. 합법적인 외도 증거로 인정받으려면 증거를 수집하는 과정이 중요해요.</p>
        <p style={body}>내가 직접 받은 문자 메시지나 카카오톡, 상대방과의 통화 녹음(내가 한쪽 당사자인 경우), 신용카드 사용 내역(호텔·숙박소·음식점 등), 상대방이 직접 보낸 외도 인정 문자는 모두 합법적인 증거가 돼요. 흥신소나 탐정을 통한 미행 사진도 사생활 침해가 없으면 증거 능력이 있어요.</p>
        <H2>불법 증거 수집 — 절대 하면 안 되는 것들</H2>
        <p style={body}>증거는 있지만 수집 방법이 불법이면 역풍을 맞을 수 있어요. 가장 흔한 실수는 상대방의 핸드폰을 몰래 보거나 계정에 무단 접근하는 거예요. 이건 정보통신망법·개인정보보호법 위반이 돼요. 법원이 증거 능력을 부정할 뿐 아니라 상대방이 당신을 역으로 고소할 수도 있어요.</p>
        <p style={body}>또 다른 주의점은 상대방과의 통화 중 '내가 없는 자리에서' 제3자와의 대화를 몰래 녹음하는 거예요. 내가 있는 자리에서의 대화 녹음은 괜찮지만, 내가 없는 상황의 녹음은 통신비밀보호법 위반이 돼요. 무단 침입이나 불법 카메라도 절대 안 돼요.</p>
        <H2>폭력·학대 증거 확보 방법</H2>
        <p style={body}>폭력 증거는 외도만큼이나 중요해요. 많은 사람들이 사진이나 영상만 있으면 된다고 생각하는데, 법원은 의료 기록을 가장 신뢰해요. 병원 진단서를 받을 때 '치료 후' 발급을 요청하고 반드시 상해 원인에 '폭행으로 인한 상해'라고 명시하도록 요청해야 해요. 진단서 없이는 증거 능력이 약해져요.</p>
        <p style={body}>그 외에 112 신고 접수증, 폭행 당일 자신의 상처 사진(날짜 표시 필수), 카카오톡 협박 메시지, 주변 목격자 진술서도 증거가 돼요. 특히 신고 접수증은 그 사건이 실제로 일어났다는 객관적 증거가 되거든요. 협박 메시지는 스크린샷이 아니라 카톡에서 '더 보기'로 '메시지 신고' 기능을 통해 서버 기록으로 확보하면 위조 혐의를 피할 수 있어요.</p>
