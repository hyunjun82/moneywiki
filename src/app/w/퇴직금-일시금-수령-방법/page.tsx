...
const STEPS = [
  {
    ...
    tip: "수수료 0원 상품을 먼저 확인해봐요. 증권사 IRP는 수수료 면제 이벤트가 많아요",
  ...
  },
  {
    ...
    desc: "일시금 인출 후 금융사에서 퇴직소득 원천징수영수증을 발급해줘요. 세금이 제대로 계산됐는지 확인해봐요. 잘못 계산됐으면 홈택스에서 경정청구로 환급받을 수 있어요.",
...
const FAQS = [
  ...
  },
  {
    ...
    a: "근속 기간과 퇴직금 규모에 따라 달라요. 근속 10년·퇴직금 3,000만원 기준으로 수십만 원~100만원 수준이에요. 정확한 금액은 홈택스 퇴직소득세 모의계산으로 확인해봐요.",
  },
  {
...
export default function Page() {
  return (
    ...
    >
      ...
      <EligibilityChecker
        items={CHECK_ITEMS}
        allMatchText="일시금 인출 절차를 바로 시작할 수 있어요. 아래 계산기로 세후 수령액을 먼저 확인해봐요."
      ...
      <Disclaimer text="이 글은 2026년 3월 기준 근로자퇴직급여보장법과 소득세법을 바탕으로 작성됐어요. 세법 개정이 있을 수 있으니 최신 기준은 국세청(126)에서 확인해봐요." />
    </ArticleLayout>
  );
}
