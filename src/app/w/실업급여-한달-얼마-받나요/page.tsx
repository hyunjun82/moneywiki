...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={body}>
        수급 기간을 늘리는 핵심은 <a href="/w/실업급여-피보험기간" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험 가입 기간</a>을 오래 유지하는 거예요. 이직할 때 고용보험 가입 이력이 끊기지 않도록 신경 써야 하죠. 퇴직 후에는 <strong>12개월 이내</strong>에 반드시 신청해야 해요. 이 기한을 넘기면 수급 자격 자체가 사라지니까요.
      </p>
      <p style={body}>
