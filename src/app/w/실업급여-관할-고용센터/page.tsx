...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={body}>
        왜 이렇게 나눠놨을까요? 실업급여를 받는 동안에는 1~4주마다 <strong>실업인정</strong>을 받아야 해요. 한 사람의 서류를 한 센터에서 일관되게 처리해야 업무가 꼬이지 않죠. 수급자격 심사부터 실업인정까지 같은 담당자가 이어서 보는 구조라, 엉뚱한 센터에 가면 처음부터 다시 확인하는 비효율이 생겨요.
      </p>
      <p style={body}>
      ...
      <BorderBox title="관할 고용센터 조회 방법 3가지">
      ...
      <p style={body}>
        이직확인서가 확인됐으면 <strong>수급자격 신청자 온라인 교육</strong>을 들어야 해요. 고용24에서 약 1시간짜리 동영상을 이수하는 건데, 이걸 빠뜨리면 센터에 가서도 접수가 안 되죠. 수료증은 따로 출력할 필요 없이 시스템에 자동 반영돼요.
      </p>
      <p style={body}>
      ...
      <BorderBox title="방문 신청 vs 온라인 신청">
      ...
      <p style={body}>
        가장 치명적인 실수는 <strong>퇴직 후 12개월 기한</strong>을 넘기는 거예요. <a href="https://www.law.go.kr/법령/고용보험법" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험법</a>에 따라 퇴직일 다음 날부터 12개월 안에 수급자격 인정을 신청해야 해요. 이 기한이 지나면 조건을 다 갖춰도 받을 수 없죠. 퇴직하면 미루지 말고 바로 움직이세요.
      </p>
