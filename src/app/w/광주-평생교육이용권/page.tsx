...
// ─── 데이터
const TYPES = [{"minAge": 19, "name": "일반 이용권", "age": "만 19세 이상", "income": "기초생활수급자·차상위계층 우선 / 잔여 추첨", "color": "#1D9E75", "bg": "#E1F5EE", "quota": "-"}, {"minAge": 65, "name": "노인 이용권", "age": "만 65세 이상", "income": "소득 무관", "color": "#D97706", "bg": "#FFFBEB", "quota": "-"}];
const SIDEBAR_LINKS = ["광주 평생교육이용권 신청방법", "광주광역시 평생교육이용권 자격", "평생교육이용권 노인 이용권", "평생교육이용권 사용처 조회", "서울 평생교육이용권 신청", "인천 평생교육이용권 신청", "충남 평생교육이용권 신청", "경남 평생교육이용권 신청", "NH농협카드 채움카드 발급", "차상위계층 확인 방법", "기초생활수급자 신청", "광주시 복지 교육 지원", "평생교육이용권 추첨 기준", "평생교육이용권 우수이용자 70만원", "광주 평생학습 포털"];
const HUB_LINKS = [{"title": "서울 평생교육이용권 | 4월 9일까지", "desc": "서울 4개 유형 자격·절차 정리", "href": "/w/서울-평생교육이용권"}, {"title": "충남 평생교육이용권 | 4월 17일까지", "desc": "충남 신청 조건·사용처 안내", "href": "/w/충남-평생교육이용권"}, {"title": "경남 평생교육이용권 | 4월 17일까지", "desc": "경남 시군별 접수처 안내", "href": "/w/경남-평생교육이용권"}, {"title": "부산 평생교육이용권 | 4월 7일까지", "desc": "부산 일반 이용권 자격·사용처 정리", "href": "/w/부산-평생교육이용권"}];
const STEPS = [{"title": "내 유형 먼저 고르세요", "desc": "일반·노인 중 1개만 신청. 65세 이상이면 노인 이용권(소득 무관)이 유리해요.", "tip": "65세 이상이면 노인 이용권 추천"}, {"title": "lllcard.kr/gwangju 접속", "desc": "카카오·PASS 간편인증 후 신청서를 작성해요.", "link": {"label": "lllcard.kr/gwangju", "url": "https://www.lllcard.kr/gwangju"}}, {"title": "신청서 작성 + 제출", "desc": "유형 선택 → 자격 정보 입력 → 제출.", "tip": "4월 15일 마감, 여유 있게 신청하세요"}, {"title": "선정 결과 통보", "desc": "문자·카카오톡으로 개별 통보. 선정 시 NH농협 채움카드에 35만원 포인트 자동 충전이에요."}, {"title": "강좌 수강 + 사용", "desc": "등록된 기관에서 수강료·교재비로 결제해요. 12월 31일까지 사용해야 해요.", "tip": "미사용 잔액 연말 자동 소멸"}];
const FAQS = [{"urgent": true, "q": "광주는 AI디지털 이용권이 없나요?", "a": "2026년 1차 모집 기준 광주는 일반·노인 이용권 2개 유형이에요. AI디지털 이용권은 광주 1차 공고에 포함되지 않았어요. 30~64세이고 디지털 교육을 받고 싶다면 일반 이용권으로 신청하고, 사용처에서 디지털 강좌를 선택하면 돼요."}, {"urgent": true, "q": "65세인데 노인 이용권 소득 조건이 있나요?", "a": "광주 노인 이용권은 만 65세 이상이면 소득 조건 없이 신청할 수 있어요. 일반 이용권보다 경쟁이 덜할 수 있으니 65세 이상이면 노인 이용권을 추천해요."}, {"urgent": false, "q": "광주에서 전남 교육기관도 이용할 수 있나요?", "a": "사용기관은 전국 단위로 등록된 기관이에요. 광주뿐 아니라 전국 온·오프라인 등록 기관을 이용할 수 있어요. lllcard.kr/gwangju에서 기관 목록을 확인하세요."}, {"urgent": false, "q": "NH농협카드가 없어요.", "a": "선정 후 card.nonghyup.com 또는 NH농협은행·농축협 영업점에서 채움카드를 발급하면 돼요."}, {"urgent": false, "q": "추첨 탈락하면 기회가 없나요?", "a": "2차 모집이 진행될 수 있어요. lllcard.kr/gwangju에서 다음 공고를 확인하세요."}];
const COURSES = [{"cat": "자격증", "col": "#1D9E75", "items": ["컴퓨터활용능력", "정보처리기사", "공인중개사", "사회복지사"]}, {"cat": "어학", "col": "#2563EB", "items": ["영어 회화", "일본어", "중국어", "HSK 준비"]}, {"cat": "취미·생활", "col": "#D97706", "items": ["바리스타", "제과제빵", "캘리그라피", "공예"]}, {"cat": "건강·복지", "col": "#059669", "items": ["요가·필라테스", "건강관리", "인문학", "사진 촬영"]}];
const REFERENCES = [{"category": "공식 공고", "items": [{"label": "광주 평생교육이용권 누리집 (lllcard.kr/gwangju)", "url": "https://www.lllcard.kr/gwangju"}]}, {"category": "법령·카드", "items": [{"label": "평생교육법 제16조의2 — 평생교육이용권의 발급 등", "url": "https://www.law.go.kr/"}, {"label": "NH농협카드 채움카드 신규 발급", "url": "https://card.nonghyup.com"}]}];
const APPLY_URL = "https://www.lllcard.kr/gwangju";
const APPLY_LABEL = "광주 평생교육이용권 신청하기";
const DEADLINE_ISO = "2026-04-15T23:59:00+09:00";
const DEADLINE_LABEL = "2026년 4월 15일(수) 마감";
const DEADLINE_SHORT = "4월 15일";
const NOTE_SPECIFIC = "광주 1차: 일반·노인 2개 유형 (AI디지털 미운영)";
  ...
  return (
    <div style={{ maxWidth: 1060, margin: "0 auto", padding: "2rem 1.5rem", fontFamily: "'Pretendard', 'Apple SD Gothic Neo', sans-serif", color: "#111", display: "flex", gap: 28, alignItems: "flex-start" }}>
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <p style={{ fontSize: 13, color: "#1D9E75", fontWeight: 600, marginBottom: 10 }}>복지 · 교육 지원 · 광주광역시</p>
        <h1 style={{ fontSize: 26, fontWeight: 700, lineHeight: 1.45, marginBottom: 14 }}>
          2026 광주 평생교육이용권 신청 |<br />
          일반·노인 이용권 자격 비교
        </h1>
        <p style={{ fontSize: 15, color: "#374151", lineHeight: 2.1, marginBottom: "1rem" }}>
          광주시는 일반과 노인 이용권 2개 유형으로 운영해요.\nAI디지털 이용권이 없어서 30~64세는 일반 이용권만 선택할 수 있어요.\n4월 15일까지 여유가 있으니 조건 먼저 확인하세요.
        </p>
        ...
        <H2>광주광역시 평생교육이용권, 신청 전에 이것부터 확인하세요</H2>
        <p style={body}>
          광주광역시에 주민등록이 있어야 광주광역시 공고로 신청할 수 있어요.<br />
          2026년부터 국가 단일 모집이 아닌 광역 지자체별 개별 모집으로 바뀌었어요.<br />
          타 지역 공고로 신청하면 자동 탈락이에요.
        </p>
        <GreenBox title="2026 광주광역시 1차 핵심 정보">
          신청 기간: 2026년 3월 30일(일) ~ 4월 15일(수)<br />
          지원 금액: 1인당 연 35만원 · 우수이용자 최대 70만원<br />
          신청 방법: www.lllcard.kr/gwangju (PC·모바일 가능)<br />
          결제 수단: NH농협 채움카드 포인트 자동 충전<br />
          사용 기한: 2026년 12월 31일까지<br />
          유형: 일반 / 노인 이용권 (2개) · AI디지털 이용권 미운영
        </GreenBox>
        ...
        <p style={body}>
          온라인 사용기관은 전국 공통이에요. 광주광역시 어디서나 수강할 수 있어요.<br />
          실제 강좌 목록은 www.lllcard.kr/gwangju에서 검색하세요.
        </p>
        ...
        <CTA url={APPLY_URL} deadline={DEADLINE_SHORT} ctaTitle={"지금 바로 신청하세요.\\n4월 15일 마감이에요."} ctaDesc={"노인(65세↑) 이용권은 소득 조건 없어요.\\n연 35만원 교육비 지원이에요."} />

        <Divider />
        <References refs={REFERENCES} />

        <div style={{ marginTop: "1.2rem", padding: "14px 18px", background: "#f9fafb", borderRadius: 10, fontSize: 12, color: "#9ca3af", lineHeight: 1.9 }}>
          이 글은 법률·정책 정보 제공을 목적으로 작성됐어요. 개별 선정 결과는 광주광역시 공고 기준에 따르며, 중요한 결정 전에 반드시 공식 출처를 직접 확인하세요.
          <br />※ 광주 1차: 일반·노인 2개 유형 (AI디지털 미운영)
        </div>
      </div>
    </div>
  );
