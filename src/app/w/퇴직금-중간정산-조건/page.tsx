...
const CHECK_ITEMS = [
  { id: "c1", label: "무주택자이고 주택을 구입하거나 전세보증금을 마련해야 해요" },
...
const STEPS = [
  {
    ...
    desc: "중간정산은 근로자퇴직급여보장법 제8조 제2항에서 정한 8가지 법정 사유 중 하나에 해당해야 해요. 사유가 없으면 회사가 거부해도 법적으로 문제없어요. 내 상황이 어떤 사유에 해당하는지 먼저 파악하세요.",
    tip: "사유별 증빙서류 목록은 인사팀에 미리 문의하면 빠르게 준비할 수 있어요",
  },
  {
    title: "증빙서류 준비",
  ...
  },
  {
    ...
    desc: "법정 사유와 증빙서류를 갖췄다면 인사팀에 신청서를 제출해요. 회사마다 양식이 다를 수 있으니 인사팀 양식을 받아서 작성하세요. 법정 사유가 명확한데도 거부한다면 고용노동부(1350)에 진정할 수 있어요.",
...
const CHECKLIST = [
  "법정 사유 해당 여부 확인 — 8가지 중 하나여야 신청 가능",
...
const FAQS = [
  {
    ...
    a: "근로자퇴직급여보장법 시행령이 정한 8가지예요. ① 무주택 근로자의 주택 구입, ② 무주택 근로자의 전세보증금 부담, ③ 본인·부양가족 6개월 이상 요양, ④ 파산선고·개인회생 개시, ⑤ 천재지변·재해 피해, ⑥ 임금피크제 적용(근속 5년 이상), ⑦ 근로시간 단축으로 임금 감소, ⑧ 고용노동부 장관이 고시한 사유예요.",
  },
  {
  ...
  },
  {
    ...
    a: "법정 사유가 명확한데도 회사가 거부하면 고용노동부(1350)에 진정을 낼 수 있어요. 단, 법정 외 임의 사유는 회사 동의가 필요해서 거부해도 법적으로 문제없어요. 사유가 법정에 해당하는지를 먼저 확인하는 게 중요해요.",
  },
  {
  ...
  },
  {
    ...
    a: "300만원을 초과하면 IRP 계좌로 받아야 해요. 2022년부터 퇴직금 IRP 의무화가 시행됐고 중간정산도 동일하게 적용돼요. 단, 법정 사유에 해당하면 IRP에서 중도 인출할 수 있어요.",
  },
  {
  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        ...
        주택 구입, 전세보증금, 장기 요양, 파산·회생, 천재지변 등 8가지 사유예요.
      ...
      <p style={body}>
        법정 사유 8가지 중 하나에 해당해야 중간정산을 신청할 수 있어요.
        가장 많이 쓰이는 건 무주택자 주택 구입과 전세보증금 사유예요.
      ...
      <EligibilityChecker
        items={CHECK_ITEMS}
        allMatchText="중간정산 신청 사유에 해당할 가능성이 높아요. 아래 계산기로 예상 금액을 확인하세요."
        partialMatchText="해당 사유와 세부 조건을 고용노동부(1350) 또는 노무사 상담으로 확인하세요."
      />
      ...
      <p style={body}>
        ...
        상여금이나 수당 포함 여부에 따라 실제 금액이 달라질 수 있어요.
      </p>
      <p style={body}>
        중간정산을 받으면 그 시점부터 근속기간이 0년으로 초기화돼요.
        퇴직 시기가 얼마 안 남았다면 세금 측면에서 중간정산보다 퇴직까지 기다리는 게 유리할 수 있어요.
      ...
      <Calculator
        ...
        note="※ 퇴직 전 3개월 평균임금 기준. 상여금·수당 포함 여부에 따라 실제 금액이 달라질 수 있어요."
      />
      ...
      <p style={body}>
        법정 사유에 해당한다는 걸 확인했다면 아래 절차를 따르면 돼요.
      ...
      <p style={body}>
        ...
        신청 전에 아래 항목을 하나씩 점검하면 반려 없이 처리할 수 있어요.
      </p>
      ...
      <Disclaimer text="이 글은 2026년 3월 기준 근로자퇴직급여보장법 및 시행령을 바탕으로 작성됐어요. 제도 변경이 있을 수 있으니 최신 기준은 고용노동부(1350)에서 확인하세요." />
    </ArticleLayout>
  );
}
