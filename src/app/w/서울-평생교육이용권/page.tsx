...
// ─── 데이터
const TYPES = [{"minAge": 19, "name": "일반 이용권", "age": "만 19세 이상", "income": "기초생활수급자·차상위계층 우선 / 잔여 추첨", "color": "#1D9E75", "bg": "#E1F5EE", "quota": "14,332명"}, {"minAge": 30, "name": "AI·디지털 이용권", "age": "만 30세 이상", "income": "소득 무관", "color": "#2563EB", "bg": "#EFF6FF", "quota": "1,685명"}, {"minAge": 65, "name": "노인 이용권", "age": "만 65세 이상", "income": "소득 무관", "color": "#D97706", "bg": "#FFFBEB", "quota": "1,346명"}, {"minAge": 19, "name": "장애인 이용권", "age": "만 19세 이상 등록장애인", "income": "소득 무관 · 정부24 신청", "color": "#7C3AED", "bg": "#F5F3FF", "quota": "1,596명"}];
const SIDEBAR_LINKS = ["서울 평생교육이용권 신청방법", "서울시 평생교육이용권 자격", "평생교육이용권 장애인 이용권", "평생교육이용권 AI디지털 이용권", "평생교육이용권 사용처 조회", "인천 평생교육이용권 신청", "강원 평생교육이용권 신청", "충북 평생교육이용권 신청", "충남 평생교육이용권 신청", "NH농협카드 채움카드 발급", "차상위계층 확인 방법", "기초생활수급자 신청", "평생교육이용권 추첨 기준", "평생교육이용권 우수이용자 70만원", "서울시 복지 지원 총정리"];
const HUB_LINKS = [{"title": "인천 평생교육이용권 | 4월 8일까지", "desc": "인천형 소득 무관 유형 안내", "href": "/w/인천-평생교육이용권"}, {"title": "강원 평생교육이용권 | 4월 7일까지", "desc": "강원 AI디지털·노인 조건 정리", "href": "/w/강원-평생교육이용권"}, {"title": "충남 평생교육이용권 | 4월 17일까지", "desc": "충남 신청 조건·사용처 안내", "href": "/w/충남-평생교육이용권"}, {"title": "경남 평생교육이용권 | 4월 17일까지", "desc": "경남 시군별 접수처 안내", "href": "/w/경남-평생교육이용권"}];
const STEPS = [{"title": "내 유형 먼저 고르세요", "desc": "일반·AI디지털·노인·장애인 중 1개만 신청. 중복 신청 자동 무효예요.", "tip": "유형 선택이 가장 중요해요"}, {"title": "lllcard.kr/seoul 접속", "desc": "카카오·PASS 간편인증 후 신청서 작성해요. 장애인 이용권은 정부24에서 별도 신청이에요.", "link": {"label": "lllcard.kr/seoul", "url": "https://www.lllcard.kr/seoul"}}, {"title": "신청서 작성 + 제출", "desc": "유형 선택 → 자격 정보 입력 → 제출. 모바일도 가능해요.", "tip": "마감 전날까지 여유 있게 신청하세요"}, {"title": "선정 결과 통보", "desc": "문자·카카오톡으로 개별 통보. 선정 시 NH농협 채움카드에 35만원 포인트 자동 충전이에요."}, {"title": "강좌 수강 + 사용", "desc": "등록된 온·오프라인 기관에서 수강료·교재비로 결제해요. 12월 31일까지 사용해야 해요.", "tip": "미사용 잔액 연말 자동 소멸"}];
const FAQS = [{"urgent": true, "q": "4가지 유형 중 어떤 걸 선택해야 해요?", "a": "중복 신청이 안 되니 유형 선택이 중요해요. 65세 이상이면 노인 이용권(소득 무관), 30세 이상이면 AI디지털(소득 무관)이 유리해요. 등록장애인이면 장애인 이용권이 별도 정원이라 경쟁이 덜해요. 일반 이용권은 사용처가 가장 넓어요."}, {"urgent": true, "q": "차상위계층이 아니어도 일반 이용권 신청할 수 있나요?", "a": "네, 신청할 수 있어요. 기초생활수급자·차상위계층을 먼저 선발하고 남은 자리는 무작위 추첨이에요. 소득이 높아도 추첨에는 참여 가능해요."}, {"urgent": true, "q": "장애인 이용권은 어디서 신청해요?", "a": "정부24(www.gov.kr) 보조금24에서 신청해요. lllcard.kr/seoul이 아니에요. 정부24 접속 후 '평생교육이용권' 검색 → 장애인 유형 선택하면 돼요."}, {"urgent": false, "q": "NH농협카드가 없어요.", "a": "선정 후 card.nonghyup.com 또는 NH농협은행·농축협 영업점에서 채움카드를 발급하면 돼요. 기존 채움카드 소지자는 자동 충전이에요. 2025년부터 구 평생교육희망카드(BC카드)는 사용 불가예요."}, {"urgent": false, "q": "AI디지털 이용권으로 어떤 강좌를 들을 수 있어요?", "a": "ChatGPT 활용, 영상편집, 코딩, 정보처리기사, 컴퓨터활용능력, 데이터분석 등 디지털·AI 강좌예요. 디지털 전용 사용기관에서만 써요. 일반 이용권 사용처보다 범위가 좁으니 미리 기관을 확인하세요."}, {"urgent": false, "q": "추첨 탈락하면 기회가 없나요?", "a": "2차 모집이 진행될 수 있어요. 서울시 평생교육이용권 상담콜센터(1551-4777)에 문의하거나 lllcard.kr/seoul에서 다음 공고를 확인하세요."}, {"urgent": false, "q": "교재만 따로 살 수 있나요?", "a": "안 돼요. 강좌 수강료와 함께 결제할 때만 교재비 사용이 가능해요. 교재 단독 구매, 재료비, 전자기기 구입은 불가예요."}];
const COURSES = [{"cat": "자격증", "col": "#1D9E75", "items": ["컴퓨터활용능력", "정보처리기사", "공인중개사", "사회복지사"]}, {"cat": "어학", "col": "#2563EB", "items": ["영어 회화", "일본어", "중국어", "토익 준비"]}, {"cat": "AI·디지털", "col": "#7C3AED", "items": ["ChatGPT 활용", "영상편집", "코딩 입문", "유튜브 제작"]}, {"cat": "취미·생활", "col": "#D97706", "items": ["바리스타", "제과제빵", "캘리그라피", "인문학"]}];
const REFERENCES = [{"category": "공식 공고", "items": [{"label": "2026년 서울시 평생교육이용권 지원사업(1차) 공식 공고", "url": "https://news.seoul.go.kr/welfare/archives/579552"}, {"label": "서울 평생교육이용권 누리집 (lllcard.kr/seoul)", "url": "https://www.lllcard.kr/seoul"}, {"label": "서울시 상담콜센터 ☎1551-4777", "url": "tel:15514777"}]}, {"category": "법령·카드", "items": [{"label": "평생교육법 제16조의2 — 평생교육이용권의 발급 등", "url": "https://www.law.go.kr/"}, {"label": "NH농협카드 채움카드 신규 발급", "url": "https://card.nonghyup.com"}]}];
const APPLY_URL = "https://www.lllcard.kr/seoul";
const APPLY_LABEL = "서울 평생교육이용권 신청하기";
const DEADLINE_ISO = "2026-04-09T18:00:00+09:00";
const DEADLINE_LABEL = "2026년 4월 9일(목) 18:00 마감";
const DEADLINE_SHORT = "4월 9일";
const NOTE_SPECIFIC = "서울시 4개 유형 (일반·AI디지털·노인·장애인), 장애인 이용권은 정부24 별도 신청";
  ...
  return (
    <div style={{ maxWidth: 1060, margin: "0 auto", padding: "2rem 1.5rem", fontFamily: "'Pretendard', 'Apple SD Gothic Neo', sans-serif", color: "#111", display: "flex", gap: 28, alignItems: "flex-start" }}>
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <p style={{ fontSize: 13, color: "#1D9E75", fontWeight: 600, marginBottom: 10 }}>복지 · 교육 지원 · 서울특별시</p>
        <h1 style={{ fontSize: 26, fontWeight: 700, lineHeight: 1.45, marginBottom: 14 }}>
          2026 서울 평생교육이용권 신청방법 |<br />
          자격조건·사용처 한번에 확인하세요
        </h1>
        <p style={{ fontSize: 15, color: "#374151", lineHeight: 2.1, marginBottom: "1rem" }}>
          4월 9일 마감이에요. 4개 유형 중 1개만 신청할 수 있어요.\n소득이 높아도 신청 가능한 유형이 있어요. 내 상황부터 먼저 확인하세요.
        </p>
        ...
        <H2>서울특별시 평생교육이용권, 신청 전에 이것부터 확인하세요</H2>
        <p style={body}>
          서울특별시에 주민등록이 있어야 서울특별시 공고로 신청할 수 있어요.<br />
          2026년부터 국가 단일 모집이 아닌 광역 지자체별 개별 모집으로 바뀌었어요.<br />
          타 지역 공고로 신청하면 자동 탈락이에요.
        </p>
        <GreenBox title="2026 서울특별시 1차 핵심 정보">
          신청 기간: 2026년 3월 16일(월) 10:00 ~ 4월 9일(목) 18:00<br />
          지원 금액: 1인당 연 35만원 · 우수이용자 최대 70만원<br />
          신청 방법: www.lllcard.kr/seoul (PC·모바일 가능)<br />
          결제 수단: NH농협 채움카드 포인트 자동 충전<br />
          사용 기한: 2026년 12월 31일까지<br />
          총 모집: 19,959명 (4개 유형 합산)\n장애인 이용권: 정부24(보조금24)에서 별도 신청
        </GreenBox>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
            <thead>
              <tr style={{ background: "#f9fafb" }}>
                {["유형", "신청 나이", "소득 조건", "모집 인원"].map((h: any) => (
            ...
            <tbody>
              {TYPES.map((t: any, i: any) => (
                <tr key={i} style={{ borderBottom: "1px solid #f3f4f6" }}>
                  ...
                  {t.quota && <td style={{ padding: "10px 12px", color: "#374151" }}>{t.quota}</td>}
                </tr>
              ))}
            </tbody>
          </table>
        ...
        <p style={body}>
          온라인 사용기관은 전국 공통이에요. 서울특별시 어디서나 수강할 수 있어요.<br />
          실제 강좌 목록은 www.lllcard.kr/seoul에서 검색하세요.
        </p>
        ...
        <CTA url={APPLY_URL} deadline={DEADLINE_SHORT} ctaTitle={"지금 바로 신청하세요.\\n4개 유형, 소득 무관도 있어요."} ctaDesc={"AI디지털(30세↑)·노인(65세↑)·장애인 이용권은 소득 조건 없어요.\\n서울시민 약 2만 명 지원 · 연 35만원 교육비 지원이에요."} />

        <Divider />
        <References refs={REFERENCES} />

        <div style={{ marginTop: "1.2rem", padding: "14px 18px", background: "#f9fafb", borderRadius: 10, fontSize: 12, color: "#9ca3af", lineHeight: 1.9 }}>
          이 글은 법률·정책 정보 제공을 목적으로 작성됐어요. 개별 선정 결과는 서울특별시 공고 기준에 따르며, 중요한 결정 전에 반드시 공식 출처를 직접 확인하세요.
          <br />※ 서울시 4개 유형 (일반·AI디지털·노인·장애인), 장애인 이용권은 정부24 별도 신청
        </div>
      </div>
    </div>
  );
