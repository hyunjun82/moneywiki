...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={body}>
        180일 기준도 자주 착각하는 부분이에요. 달력상 6개월이 아니라 실제 유급일(급여를 받으며 일한 날) 기준이죠. 주5일제 직장이면 주휴일 포함 한 달에 약 25~26일이 잡혀요. 직장을 여러 군데 다녔으면 가입기간을 합산할 수 있지만, 이전에 실업급여를 수급한 이력이 있으면 그 이후 기간만 인정돼요.
      </p>
      ...
      <p style={body}>
        절대 잊으면 안 되는 게 하나 있어요. 퇴직일로부터 <strong>12개월</strong> 안에 신청해야 해요. 수급기간이 아무리 길어도 12개월이 지나면 남은 일수가 전부 사라지죠. 퇴직하면 미루지 말고 바로 움직이세요. 궁금한 건 고용센터(<strong>1350</strong>)에 전화부터 해도 돼요.
      </p>
