  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        "구직활동 실적을 조금 부풀렸는데, 형사처벌까지 받을 수 있나요?"<br />
        받을 수 있어요.<br /><br />
        실업급여 부정수급은 단순 행정 처분으로 끝나지 않죠.
        <a href="https://www.law.go.kr/법령/고용보험법" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험법 제116조</a>에 따라
        <strong>5년 이하 징역 또는 5천만원 이하 벌금</strong>까지 선고될 수 있어요.
      </p>
      ...
      <p style={body}>
        두 번째로 많은 유형은 구직활동 허위 신고예요. 실제로 지원하지 않은 채용공고를 입사지원 실적으로 제출하거나, 면접을 보지 않았는데 면접 확인서를 위조하는 경우가 해당돼요. 요즘은 온라인 시스템이 자동 대조하기 때문에 적발이 쉬워졌죠.
      </p>
      <p style={body}>
        가장 심각한 유형은 사업주와 공모하는 거예요. 이직 사유를 "권고사직"으로 허위 기재하거나, 실제로는 재직 중인데 퇴직한 것처럼 이직확인서를 발급받는 경우예요. 이 경우 수급자와 사업주 모두 처벌 대상이에요.
      </p>
      ...
      <p style={body}>
        둘째, <strong>추가 징수</strong>예요. 반환에 더해 부정수급 금액의 최대 2배(단독 부정수급) 또는 최대 5배(사업주 공모)를 추가로 내야 해요. 100만원을 부정수급했다면 반환 100만원 + 추가 징수 최대 200만원 = 300만원이 되는 거죠. 사업주와 공모했다면 100만원 + 500만원 = 600만원까지 갈 수 있어요.
      </p>
      <p style={body}>
        셋째, <strong>형사처벌</strong>이에요. <a href="https://www.law.go.kr/법령/고용보험법" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험법 제116조</a>에 따라 <strong>5년 이하 징역 또는 5천만원 이하 벌금</strong>에 처할 수 있어요. 모든 부정수급이 형사처벌로 이어지진 않고, 고의성·규모·횟수를 종합적으로 판단해서 고발 여부를 결정하죠.
      </p>

      <BorderBox title="처벌 수위 비교">
        반환 명령: 부정수급 전액 (자진신고와 무관)<br />
        추가 징수: 최대 2배 (단독) / 최대 5배 (사업주 공모)<br />
        형사처벌: 5년 이하 징역 또는 5천만원 이하 벌금<br />
        남은 실업급여: <strong>전액 중단</strong>
      </BorderBox>
      ...
      <p style={body}>
        "현금으로 받았으니 괜찮겠지"라고 생각하는 경우가 많은데, 사업주가 비용 처리를 위해 지급 내역을 신고하면 결국 드러나요. 배달앱이나 플랫폼 노동도 마찬가지예요. 앱 운영사가 소득 신고를 하기 때문에 기록이 남죠.
      </p>
      <p style={body}>
        <strong>제보</strong>로 적발되는 경우도 꽤 많아요. 동료나 지인의 신고, 회사의 신고 등이 있죠. 고용노동부에서 부정수급 신고를 받는 전용 채널을 운영하고 있어서 접근이 쉬워요. 신고 접수 후 고용센터에서 사실 조사를 하고, 처분 결정을 내리는 구조예요.
      </p>
      ...
      <p style={body}>
        자진신고는 <a href="https://www.ei.go.kr" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용24</a>에서 온라인으로 하거나 고용센터(1350)에 전화해서 할 수 있어요. 부정수급 사실을 솔직하게 밝히고, 반환 의사를 표시하면 돼요. 반환 금액이 크면 분할 납부도 가능하죠.
      </p>
      <p style={body}>
        다만 형사처벌 면제와는 별개예요. 자진신고 사실이 양형에 참작될 수 있지만, 금액이 크거나 고의성이 명백하면 형사고발이 진행될 수 있어요. 금액이 큰 경우에는 법률 전문가와 상담하는 게 안전하죠.
      </p>
      ...
      <p style={body}>
        구직활동도 정직하게 하세요. 실제로 지원한 공고만 실적으로 제출하고, 면접을 보지 않았으면 면접 실적을 쓰지 않으면 돼요. 워크넷에서 입사지원하면 자동 기록되니까 증빙도 쉽죠. 굳이 허위 실적을 만들 이유가 없어요.
      </p>
      <p style={body}>
        부정수급으로 얻는 금액보다 잃는 금액이 압도적으로 커요. 알바 수입 50만원을 숨겼다가 적발되면 반환 + 추가 징수 + 남은 급여 전액 중단이에요. 수백만원을 잃게 되죠. 신고만 하면 아무 문제 없는데, 그 작은 절차를 빠뜨려서 큰 불이익을 받는 건 정말 아까운 일이에요.
      </p>

      <GreenBox title="부정수급 예방 핵심">
        소득 발생 → 실업인정일에 신고<br />
        구직활동 → 실제 활동만 제출<br />
        이직 사유 → 사실대로 기재<br />
        <strong>신고만 정직하게 하면 부정수급이 아니에요.</strong>
      </GreenBox>
