...
export default function Page() {
  return (
    <ArticleLayout sidebar={null}>
      ...
      <Steps steps={[
        { title: "등기부등본 을구에서 모든 권리의 접수일자를 시간 순으로 나열" },
        { title: "저당권·근저당권·압류·가압류·경매개시결정 중 가장 먼저 등기된 권리 찾기 (→ 이게 말소기준권리)" },
        { title: "판단하려는 가압류의 접수일자와 말소기준권리 비교" },
        { title: "가압류가 말소기준권리보다 앞이면 인수, 뒤면 말소" },
      ]} />
