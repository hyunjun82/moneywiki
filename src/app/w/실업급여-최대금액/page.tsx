...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={body}>
        수급일수가 관건이에요. 나이와 고용보험 가입기간에 따라 120일부터 최대 270일까지 차이가 나죠. 270일을 적용받으면 68,100원 x 270일 = <strong>18,387,000원</strong>이에요. 약 9개월 동안 매달 204만원씩 받는 셈이니까, 적지 않은 금액이죠.
      </p>
      <p style={body}>
        반대로 가장 짧은 120일만 인정받으면 68,100원 x 120일 = 8,172,000원이에요. 같은 상한액인데 수급일수 하나로 총액이 1,000만원 이상 벌어지는 거예요. 그래서 &quot;내가 며칠 동안 받을 수 있는지&quot;를 먼저 파악하는 게 핵심이죠.
      </p>
      ...
      <p style={body}>
        대신 <strong>조기재취업수당</strong>이라는 제도로 일부를 돌려받을 수 있어요. 수급일수의 절반 이상을 남기고 안정적인 직장에 취업하면, 남은 수급일수의 절반을 일시금으로 지급하죠. 위 예시라면 120일의 절반인 60일분, 약 409만원을 한꺼번에 받는 거예요.
      </p>
      <p style={body}>
      ...
      <p style={body}>
        정리하면, <strong>50세 이상 + 10년 이상 가입 + 비자발적 퇴직</strong>일 때 최대 18,387,000원이에요. 50세 미만이면 아무리 오래 일해도 최대 16,344,000원이 한도이고요. 정확한 예상 수령액은 위 계산기를 돌리거나, <a href="https://www.ei.go.kr" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용24</a> 모의계산 서비스에서 한 번 더 확인해보세요.
      </p>
