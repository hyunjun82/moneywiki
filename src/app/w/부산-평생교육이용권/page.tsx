...
// ─── 데이터
const TYPES = [{"minAge": 19, "name": "일반 이용권", "age": "만 19세 이상", "income": "기초생활수급자·차상위계층 우선 / 잔여 무작위 추첨", "color": "#1D9E75", "bg": "#E1F5EE", "quota": "-"}];
const SIDEBAR_LINKS = ["부산 평생교육이용권 신청방법", "부산광역시 평생교육이용권 자격", "평생교육이용권 사용처 조회", "서울 평생교육이용권 신청", "인천 평생교육이용권 신청", "충남 평생교육이용권 신청", "경남 평생교육이용권 신청", "광주 평생교육이용권 신청", "NH농협카드 채움카드 발급", "차상위계층 확인 방법", "기초생활수급자 신청", "부산시 복지 교육 지원", "평생교육이용권 추첨 기준", "평생교육이용권 우수이용자 70만원", "부산 평생학습 포털"];
const HUB_LINKS = [{"title": "서울 평생교육이용권 | 4월 9일까지", "desc": "서울 4개 유형 자격·절차 정리", "href": "/w/서울-평생교육이용권"}, {"title": "충남 평생교육이용권 | 4월 17일까지", "desc": "충남 신청 조건·사용처 안내", "href": "/w/충남-평생교육이용권"}, {"title": "광주 평생교육이용권 | 4월 15일까지", "desc": "광주 일반·노인 이용권 비교", "href": "/w/광주-평생교육이용권"}, {"title": "경남 평생교육이용권 | 4월 17일까지", "desc": "경남 시군별 접수처 안내", "href": "/w/경남-평생교육이용권"}];
const STEPS = [{"title": "lllcard.kr/busan 접속", "desc": "부산 평생교육이용권 공식 누리집에서 회원가입 후 카카오·PASS 간편인증으로 본인 확인해요.", "link": {"label": "lllcard.kr/busan", "url": "https://www.lllcard.kr/busan"}}, {"title": "신청서 작성 + 제출", "desc": "자격 정보 입력 후 제출해요. 일반 이용권 단일 유형이에요.", "tip": "4월 7일 마감, 오늘 바로 신청하세요"}, {"title": "선정 결과 통보", "desc": "문자·카카오톡으로 개별 통보. 선정 시 NH농협 채움카드에 35만원 포인트 자동 충전이에요."}, {"title": "강좌 수강 + 사용", "desc": "등록된 기관에서 수강료·교재비로 결제해요. 12월 31일까지 사용해야 해요.", "tip": "미사용 잔액 연말 자동 소멸"}];
const FAQS = [{"urgent": true, "q": "부산은 AI디지털·노인 이용권이 없나요?", "a": "2026년 부산 1차 모집은 일반 이용권만 운영해요. AI디지털·노인 이용권은 추후 2차 공고에서 별도 진행될 수 있어요. 부산 바로콜(051-120)에 문의하거나 lllcard.kr/busan에서 공고를 확인하세요."}, {"urgent": true, "q": "소득이 높아도 신청할 수 있나요?", "a": "네. 기초생활수급자·차상위계층을 먼저 선발하고 남은 자리는 무작위 추첨이에요. 소득이 높아도 추첨 참여는 가능해요. 단, 부산 1차에는 소득 무관 유형이 없으니 이 점 참고하세요."}, {"urgent": false, "q": "부산에서 사용 가능한 교육기관은 어디예요?", "a": "lllcard.kr/busan에서 사용 기관 목록을 검색할 수 있어요. 온라인 기관은 전국 공통이라 어학, 자격증, IT 강좌 등을 수강할 수 있어요."}, {"urgent": false, "q": "NH농협카드가 없어요.", "a": "선정 후 card.nonghyup.com 또는 NH농협은행·농축협 영업점에서 채움카드를 발급하면 돼요. 기존 채움카드 소지자는 자동 충전이에요."}, {"urgent": false, "q": "추첨 탈락하면 기회가 없나요?", "a": "2차 모집에서 AI디지털·노인 이용권 공고가 있을 수 있어요. lllcard.kr/busan에서 공고를 확인하거나 부산 바로콜(051-120)에 문의하세요."}];
...
const REFERENCES = [{"category": "공식 공고", "items": [{"label": "부산 평생교육이용권 누리집 (lllcard.kr/busan)", "url": "https://www.lllcard.kr/busan"}, {"label": "부산 바로콜 ☎051-120", "url": "tel:051120"}]}, {"category": "법령·카드", "items": [{"label": "평생교육법 제16조의2 — 평생교육이용권의 발급 등", "url": "https://www.law.go.kr/"}, {"label": "NH농협카드 채움카드 신규 발급", "url": "https://card.nonghyup.com"}]}];
const APPLY_URL = "https://www.lllcard.kr/busan";
const APPLY_LABEL = "부산 평생교육이용권 신청하기";
const DEADLINE_ISO = "2026-04-07T23:59:00+09:00";
const DEADLINE_LABEL = "2026년 4월 7일(화) 마감";
const DEADLINE_SHORT = "4월 7일";
const NOTE_SPECIFIC = "부산 1차: 일반 이용권 단일 운영 · 부산 바로콜 051-120";
  ...
  return (
    <div style={{ maxWidth: 1060, margin: "0 auto", padding: "2rem 1.5rem", fontFamily: "'Pretendard', 'Apple SD Gothic Neo', sans-serif", color: "#111", display: "flex", gap: 28, alignItems: "flex-start" }}>
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <p style={{ fontSize: 13, color: "#1D9E75", fontWeight: 600, marginBottom: 10 }}>복지 · 교육 지원 · 부산광역시</p>
        <h1 style={{ fontSize: 26, fontWeight: 700, lineHeight: 1.45, marginBottom: 14 }}>
          2026 부산 평생교육이용권 신청기간 |<br />
          일반 이용권 자격·사용처 정리
        </h1>
        <p style={{ fontSize: 15, color: "#374151", lineHeight: 2.1, marginBottom: "1rem" }}>
          부산 1차는 일반 이용권 단일 운영이에요.\n기초생활수급자·차상위계층이 우선이지만 잔여는 추첨이에요.\n4월 7일 마감이니 지금 바로 신청하세요.
        </p>
        ...
        <p style={body}>
          온라인 사용기관은 전국 공통이에요. 부산광역시 어디서나 수강할 수 있어요.<br />
          실제 강좌 목록은 www.lllcard.kr/busan에서 검색하세요.
        </p>
        ...
        <CTA url={APPLY_URL} deadline={DEADLINE_SHORT} ctaTitle={"4월 7일 마감이에요.\\n지금 바로 신청하세요."} ctaDesc={"연 35만원 교육비 지원이에요.\\n기초생활수급자·차상위 우선, 잔여는 추첨이에요."} />

        <Divider />
        <References refs={REFERENCES} />

        <div style={{ marginTop: "1.2rem", padding: "14px 18px", background: "#f9fafb", borderRadius: 10, fontSize: 12, color: "#9ca3af", lineHeight: 1.9 }}>
          이 글은 법률·정책 정보 제공을 목적으로 작성됐어요. 개별 선정 결과는 부산광역시 공고 기준에 따르며, 중요한 결정 전에 반드시 공식 출처를 직접 확인하세요.
          <br />※ 부산 1차: 일반 이용권 단일 운영 · 부산 바로콜 051-120
        </div>
      </div>
    </div>
  );
