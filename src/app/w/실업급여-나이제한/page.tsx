  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        ...
        퇴직할 때 나이가 아니라 <strong>고용보험에 처음 가입한 시점</strong>이 중요하죠.<br />
      ...
      <p style={body}>
        고용보험법 제10조에서 실업급여 나이 기준을 정해놨어요. 기준선은 만 65세예요. 그런데 여기서 많이 헷갈리는 부분이 있죠.
      </p>
      <p style={body}>
        65세 기준이 적용되는 건 <strong>퇴직할 때 나이가 아니라 고용보험에 가입한 시점의 나이</strong>예요. 60세에 입사해서 고용보험에 가입하고 68세에 퇴직했다면? 입사 시점이 65세 미만이었으니까 실업급여를 받을 수 있죠. 반대로 66세에 새로 취업해서 고용보험에 가입했다면? 가입 시점이 65세 이후니까 실업급여 대상에서 빠져요.
      </p>
      <p style={body}>
        이 차이를 모르면 최대 810만원(270일치)을 통째로 놓칠 수 있죠. 자기가 언제 고용보험에 처음 들었는지, 이거 하나만 확인하면 되는 문제예요.
      </p>
      ...
      <p style={{ ...body, marginTop: 14 }}>
        정년퇴직도 비자발적 퇴사로 인정돼요. 만 60세든 65세든 정년이 됐다면 실업급여 대상이에요. 계약 만료, 권고사직, 폐업도 마찬가지고요. 자발적 퇴사라도 임금체불이나 직장 내 괴롭힘 같은 정당한 사유가 있으면 인정받을 수 있죠.
      </p>
      ...
      <p style={body}>
        계산기에서 나이를 49세 → 50세로 바꿔보세요. 수급기간과 총액이 확 달라지는 게 보일 거예요. 퇴직 시점을 조절할 수 있다면 50세 이후로 미루는 게 유리할 수 있죠. 물론 이건 개인 상황에 따라 다르니까 무조건 그렇다는 건 아니에요.
      </p>
      ...
      <p style={body}>
        다만 정부가 이 문제를 인식하고 있죠. 법정정년을 65세로 단계적 연장하는 흐름에 맞춰 65세 이상 신규 취업자도 실업급여를 받을 수 있도록 확대하는 방안을 검토 중이에요. 이르면 2027년 상반기에 논의를 시작해서 2028년 이후 적용될 가능성이 있죠.
      </p>

      <BorderBox title="65세 이상이라면 이런 대안을 활용하세요">
      ...
      <p style={body}>
        실업급여를 못 받는다고 아무 지원이 없는 건 아니에요. 국민연금, 근로장려금, 지자체 고령자 일자리 프로그램까지 확인해보면 생각보다 받을 수 있는 게 많아요. 주민센터나 고용센터에서 통합 상담을 받아보는 걸 추천해요.
      </p>
      ...
      <p style={body}>
        나이 기준 하나 잘못 알아서 신청이 거절되는 경우가 꽤 많아요. 미리 체크해두면 헛걸음 안 해요. 고용24에서 피보험자격 이력을 조회하면 내가 언제 고용보험에 가입했는지, 가입기간이 얼마나 되는지 한 번에 확인할 수 있죠.
      </p>
      ...
      <p style={body}>
        실업급여 신청이 거부됐을 때 "나이 때문"이라고 단정하기 전에 다른 조건도 봐야 해요. 사실 나이보다 가입기간 180일 미달이나 자발적 퇴사 판정으로 탈락하는 경우가 더 많죠.
      </p>
      <p style={body}>
        65세 이전에 고용보험에 가입했다는 걸 증명할 수 있으면 나이 이유로 탈락한 게 아니에요. 이직확인서에 고용보험 가입일이 나와 있으니까 그걸 가지고 이의신청을 하면 돼요. 고용센터 결정에 불복하면 심사청구(고용보험심사위원회)나 재심사청구도 가능하죠.
      </p>
      <p style={body}>
