...
const CHECK_ITEMS = [
  ...
  { id: "c3", label: "회사에 지급 요청했지만 무응답이거나 계속 미루고 있어요" },
  { id: "c4", label: "근로 사실을 증명할 수 있는 기록이 하나라도 있어요" },
];
...
const STEPS = [
  {
    ...
    desc: "구두가 아닌 문자나 이메일로 '퇴직금을 언제 지급할 예정인지' 먼저 물어보세요. 카카오톡 대화도 법적 증거로 인정돼요. 이 기록 하나가 나중에 진정 접수 시 핵심 증거가 돼요.",
    tip: "요청 문자를 보낸 날짜, 내용, 수신 여부까지 캡처해서 보관하세요",
  },
  {
    title: "내용증명 발송",
    desc: "문자 요청 후 무응답이면 내용증명을 보내세요. '퇴직금 미지급으로 고용노동부에 신고할 예정'이라는 문장 하나면 충분해요. 내용증명 발송만으로도 소멸시효 3년이 6개월 중단돼요. 카카오 전자내용증명은 앱에서 5분이면 보낼 수 있어요.",
    tip: "대부분 이 단계에서 회사가 지급하는 경우가 많아요",
  },
  {
    title: "고용노동부 임금체불 진정 접수",
    desc: "내용증명 이후에도 무응답이면 사업장 소재지 관할 지방고용노동청에 임금체불 진정서를 내요. 고용노동부 민원마당(minwon.moel.go.kr)에서 온라인으로 무료 접수할 수 있어요. 접수 후 근로감독관이 조사하고 보통 1~3개월 내에 결과가 나와요.",
    tip: "온라인 접수: minwon.moel.go.kr → 민원신청 → 임금체불 진정",
    link: { label: "민원마당 바로가기", href: "https://minwon.moel.go.kr" },
  },
  {
    title: "소액심판 또는 지급명령 (최후 수단)",
    desc: "진정 이후에도 회사가 지급하지 않으면 법원에 소액심판이나 지급명령을 신청해요. 3,000만원 이하는 변호사 없이 직접 소송이 가능하고, 인지대는 수만 원 수준이에요. 대한법률구조공단(전화 132)에서 무료 법률 지원도 받을 수 있어요.",
...
const CHECKLIST = [
  "퇴직일 기준 14일 초과 시점부터 지연이자(연 20%) 발생 — 날짜 꼭 기록",
...
const FAQS = [
  {
    ...
    a: "사업장 소재지 관할 지방고용노동청에 임금체불 진정서를 내요. 방문, 우편, 온라인(고용노동부 민원마당) 모두 가능하고 무료예요. 사업장이 어디 있는지 모를 땐 고용노동부 고객센터(1350)에 전화하면 안내해줘요.",
  },
  {
    q: "신고하면 회사가 보복할 수 있나요?",
    a: "근로기준법 제104조가 신고를 이유로 한 불이익을 금지해요. 보복 행위가 있으면 별도로 진정을 접수할 수 있고, 사업주가 처벌 대상이 돼요. 신고자 신분도 원칙적으로 공개되지 않아요.",
  },
  {
    q: "신고 후 결과가 나오기까지 얼마나 걸리나요?",
    a: "보통 1~3개월이에요. 사건이 복잡하거나 사업주가 출석을 거부하면 더 걸릴 수 있어요. 민사소송(6개월~1년)보다 훨씬 빠른 편이에요.",
  },
  {
    q: "회사가 폐업했어도 신고할 수 있나요?",
    a: "신고는 가능해요. 대표이사 개인을 상대로 진정할 수 있어요. 체당금 제도를 통해 정부가 일부를 대신 지급해주는 경우도 있어요. 고용노동부(1350) 또는 근로복지공단에 먼저 상담을 해보세요.",
  },
  {
    q: "지연이자는 자동으로 받아지나요?",
    a: "자동으로 받아지지 않아요. 내용증명 발송이나 노동청 진정 시 '연 20% 지연이자 포함'이라고 명시해야 청구가 가능해요. 빠뜨리면 퇴직금 원금만 받고 끝날 수 있어요.",
  },
  {
    q: "근로계약서가 없어도 신고할 수 있나요?",
    a: "가능해요. 통장 입금 내역, 카카오톡 대화, 동료 증언, 4대보험 가입 이력 중 하나만 있어도 진정 접수는 할 수 있어요. 4대보험 가입 이력은 고용24(ei.go.kr)에서 무료로 출력할 수 있어요.",
  },
];
  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        ...
        미지급 상태가 계속되면 <a href="/w/퇴직금-지연이자" style={{ color: "#1D9E75", textDecoration: "underline" }}>연 20% 지연이자</a>가 추가되고, 3년 이하 징역 또는 3,000만원 이하 벌금까지 회사에 부과될 수 있어요.
        어디에 어떻게 신고하는지, 서류는 뭘 챙겨야 하는지 한 번에 정리했어요.
      </p>
      ...
      <p style={body}>
        ...
        퇴직금 청구권은 퇴직일로부터 3년이 지나면 소멸시효가 끝나요.
        그 안에 내용증명이나 진정을 접수해야 권리가 살아요.
      </p>
      <p style={body}>
        서류가 없어도 진정 접수는 할 수 있어요. 통장 입금 내역, 카카오톡 대화, 동료 증언 중 하나만 있어도 돼요.
      ...
      <EligibilityChecker
        items={CHECK_ITEMS}
        allMatchText="지금 바로 신고 가능해요. 아래 절차를 단계별로 따라가세요."
      ...
      <p style={body}>
        퇴직금을 14일 넘겨 지급하면 그 초과 기간에 대해 연 20% 지연이자가 붙어요.
        퇴직금 500만원을 90일 미뤘다면 이자만 약 25만원을 더 청구할 수 있어요.
        기간이 길어질수록 이자도 늘어나니, 미지급 시작일(14일 초과 시점)을 정확히 기록해두세요.
      </p>
      <p style={body}>
        지연이자는 자동으로 받아지지 않아요. 내용증명이나 진정 접수 시 '연 20% 지연이자 포함'을 명시해야 해요.
        빠뜨리면 원금만 받고 끝나요.
      </p>
      ...
      <H2>신고에 필요한 서류</H2>
      <p style={body}>
        노동청 진정에는 서류가 많지 않아도 돼요. 근로 사실과 미지급 사실 두 가지만 증명하면 충분해요.
        없는 서류가 있어도 통장 내역이나 카카오톡 기록만으로 진행할 수 있어요.
      </p>
      <p style={body}>
        퇴직 직후에는 회사가 서류 제공에 협조할 가능성이 높아요. 시간이 지날수록 요청이 어려워지기 때문에
        퇴직하자마자 챙겨두는 게 좋아요.
      </p>
      ...
      <p style={body}>
        대부분의 경우 2단계(내용증명)에서 해결돼요. 단계를 건너뛰지 않고 순서대로 가야 증거도 쌓이고 협상력도 생겨요.
        회사가 응하지 않을 때만 다음 단계로 넘어가면 돼요.
      </p>
      ...
      <p style={body}>
        ...
        지급 요청 기록은 나중에 결정적인 증거가 되고, 소멸시효 관리를 놓치면 청구권 자체가 사라져요.
      </p>
