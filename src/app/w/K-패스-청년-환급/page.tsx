  ...
  return (
    <ArticleLayout sidebar={<Sidebar heading="K-패스 가이드" items={K패스_SIDEBAR} currentSlug="K-패스-청년-환급" />}>
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        나는 청년인데 30% 환급이 진짜 나한테도 되는 건지, 언제까지 받을 수 있는지 궁금하죠?
        만 19~34세면 별도 서류 없이 자동 적용되고, 일반(20%)보다 연간 수만 원을 더 돌려받아요.
        만 35세 생일 전까지이니 해당되면 지금 바로 가입하는 게 이득이에요.
      </p>
      ...
      <p style={body}>
        만 19세 생일 지난 달부터 만 34세까지 자동 적용돼요.
        같은 교통비로도 일반 대비 연 수만 원을 더 받으니 해당 여부부터 봐요.
      </p>
