...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={body}>
        연장의 최대 한도는 <strong>4년</strong>이에요. <a href="https://www.law.go.kr/법령/고용보험법" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험법 제50조</a>에 이 규정이 명시되어 있죠. 장기 입원이나 중증 질환을 치료하고 있더라도 수급기간이 끊길 걱정은 안 해도 돼요.
      </p>
      <p style={body}>
      ...
      <p style={body}>
        &quot;좀 더 쉬고 복귀해야지&quot; 하면서 회복 시점을 늦게 알리면 큰 문제가 돼요. 이미 일할 수 있는데 상병급여를 계속 받으면 <strong>부정수급</strong>이에요. 적발되면 받은 금액의 최대 5배를 반환해야 할 수 있죠. 완치 사실은 즉시 신고하는 게 안전해요.
      </p>
      <p style={body}>
