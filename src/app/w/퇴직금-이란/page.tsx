...
const CHECK_ITEMS = [
  { id: "c1", label: "같은 사업주 아래서 1년 이상 근무했어요" },
  { id: "c2", label: "주 소정근로시간이 15시간 이상이었어요" },
  { id: "c3", label: "근로계약서나 급여명세서가 있어요" },
  { id: "c4", label: "아직 퇴직금을 한 번도 받지 못했어요" },
];

const CALC_SLIDERS = [
  { id: "salary", label: "월 평균급여", min: 200, max: 600, step: 10, defaultValue: 280, format: (v: number) => `${v}만원` },
...
const STEPS = [
  {
    ...
    tip: "주 15시간은 월 65시간으로도 확인해요",
  },
  {
    title: "IRP 계좌 개설",
    desc: "퇴직금이 300만원을 초과하면 IRP 계좌로만 받을 수 있어요. 퇴직이 확정되면 바로 은행이나 증권사 앱에서 개설해요. 수수료가 낮은 증권사 IRP를 선택하면 장기적으로 절세 효과가 있어요.",
    tip: "퇴직 확정 전에 미리 개설해두면 좋아요",
  },
  {
    title: "계좌번호 인사팀 통보",
    desc: "IRP 계좌번호(은행명·계좌번호·예금주명)를 인사팀에 문자나 메일로 알려줘요. 회사는 퇴직 후 14일 이내에 이 계좌로 퇴직금을 이체해야 해요. 구두 통보보다 서면이 분쟁 시 증거가 돼요.",
    tip: "문자·메일로 남기는 게 나중을 위해 좋아요",
  },
  {
    title: "수령 방식 결정",
    desc: "IRP에 들어온 퇴직금은 일시금으로 인출하거나 연금으로 나눠 받을 수 있어요. 55세 이후 10년 이상 연금으로 수령하면 퇴직소득세를 40%까지 줄일 수 있어요. 일시금 인출 시에는 퇴직소득세 전액을 납부해요.",
    tip: "연금 수령이 장기적으로 세금 면에서 유리해요",
  },
];

const CHECKLIST = [
  "수급 자격: 1년 이상 근무 + 주 15시간 이상",
  "퇴직금 공식: 월 평균급여 × 근속연수 (간편식)",
...
const FAQS = [
  ...
  {
    q: "파트타임이나 아르바이트도 받을 수 있나요?",
    a: "받을 수 있어요. 주 15시간 이상, 1년 이상 근무하면 고용 형태에 관계없이 퇴직금이 발생해요. 주 15시간 미만이면 초단시간 근로자로 퇴직금이 없어요.",
  },
  {
    q: "퇴직금 포기 각서를 써도 되나요?",
    a: "효력이 없어요. 퇴직금 청구권은 사전에 포기해도 무효예요. 퇴직 후에 실제로 받고 나서 포기하는 건 가능하지만, 강요에 의한 것이면 취소할 수 있어요.",
  },
  {
    q: "회사가 14일 이내에 퇴직금을 안 주면 어떻게 하나요?",
    a: "연 20% 지연이자가 자동으로 붙어요. 고용노동부(1350) 또는 민원마당에서 진정을 접수하면 근로감독관이 직접 조사하고 지급 명령을 내려요.",
  },
  {
    q: "5인 미만 사업장도 퇴직금을 줘야 하나요?",
    a: "줘야 해요. 2010년부터 5인 미만 사업장도 퇴직금 지급 의무가 있어요. 사업장 규모와 무관하게 1년 이상, 주 15시간 이상이면 받을 수 있어요.",
  },
];
...
const RELATED = [
  ...
  { slug: "퇴직금-계산법", title: "퇴직금 계산법, 얼마나 받을까?", description: "월급·근속기간으로 금액 바로 확인." },
  ...
  return (
    ...
    >
      ...
      <h1 style={{ fontSize: 26, fontWeight: 700, lineHeight: 1.45, marginBottom: 14 }}>
        퇴직금이란 무엇인가요?<br />
        조건·계산법·수령 절차 한 번에 정리
      </h1>

      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        퇴직금은 1년 이상 근무한 근로자가 퇴직할 때 받는 돈이에요.
        <a href="https://www.law.go.kr/법령/근로자퇴직급여보장법" style={{ color: "#1D9E75", textDecoration: "underline" }}>근로자퇴직급여보장법 제8조</a>에 따라
        법으로 보장된 권리예요. 정규직이든 계약직이든 파트타임이든, 조건만 맞으면 반드시 받을 수 있어요.
        조건 확인부터 계산법, 수령 절차까지 정리했어요.
      </p>
      ...
      <p style={body}>
        조건은 두 가지예요. 같은 사업주 아래서 1년 이상 계속 근무하고, 주 소정근로시간이 15시간 이상이면 돼요.
        4대 보험 가입 여부는 관계없어요. 실제 근무 사실이 증명되면 청구할 수 있어요.
      </p>
      <p style={body}>
        계약직이 계약을 반복하며 2년을 일했다면, 공백 없이 같은 사업주 아래 근무한 것으로 인정받을 수 있어요.
        주 15시간 미만 초단시간 근로자는 해당하지 않아요.
      </p>
      ...
      <EligibilityChecker
        items={CHECK_ITEMS}
        allMatchText="퇴직금 수급 자격이 있어요. 아래 계산기로 예상 금액을 확인해보세요."
      ...
      <p style={body}>
        ...
        상여금·고정수당이 있으면 기본급보다 높게 나와요.
      </p>
      <p style={body}>
        아래 계산기는 월급 기준 간편식이에요. 상여금이나 수당이 있다면
        <a href="/w/퇴직금-계산법" style={{ color: "#1D9E75", textDecoration: "underline" }}>퇴직금 계산기</a>에서 3개월 임금 기준으로 더 정확하게 계산해보세요.
      </p>
      ...
      <Calculator
        ...
        note="※ 월 평균급여 기준 간편 계산. 상여금·수당 포함 시 실제 금액이 더 높아요."
      />
      ...
      <H2>수령에 필요한 서류</H2>
      <p style={body}>
        퇴직금 수령은 대부분 회사가 처리해줘요. 본인이 챙겨야 할 건 IRP 계좌 개설과 계좌번호 통보예요.
        300만원 초과 퇴직금은 IRP 계좌 없이 받을 수 없어요.
      </p>
      <p style={body}>
        분쟁이 생겼을 때를 대비해 근로계약서와 급여명세서는 퇴직 전에 사본을 챙겨두세요.
        퇴직 후에는 회사 시스템 접근이 어려워질 수 있어요.
      </p>
      ...
      <H2>놓치면 손해인 체크리스트</H2>
      <p style={body}>
        퇴직을 앞두고 있거나 이미 퇴직한 분들이 놓치기 쉬운 것들만 골랐어요.
        특히 IRP 계좌와 지급 기한을 챙기지 않으면 수십만원 손해로 이어질 수 있어요.
      </p>
      ...
      <GreenBox title="14일 안에 퇴직금 못 받았다면">
        ...
        고용노동부(1350) 또는 민원마당(minwon.moel.go.kr)에서 진정을 접수하면 근로감독관이 직접 지급 명령을 내려요.
      </GreenBox>
