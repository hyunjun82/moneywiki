  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        ...
        당황스럽겠지만 포기하지 마세요. <a href="https://www.law.go.kr/법령/고용보험법" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험법</a>에 따르면
      ...
      <p style={body}>
        소급가입으로 실업급여를 받으려면 몇 가지 조건이 맞아야 해요. 가장 중요한 건 <strong>근무 사실을 증명할 수 있느냐</strong>예요. 아무런 증빙 없이 "거기서 일했어요"라고만 하면 처리가 어렵죠.
      </p>
      <p style={body}>
        그 다음은 근무기간이에요. 실업급여 수급자격 자체가 피보험기간 180일 이상을 요구하니까, 소급가입을 해도 180일이 안 되면 의미가 없어요. 여러 직장의 가입기간을 합산할 수 있으니 이전 직장 기록도 같이 확인해보세요.
      </p>
      <p style={body}>
        아래 체크리스트에서 네 가지 항목을 확인해보세요. 전부 해당되면 소급가입 후 실업급여를 받을 가능성이 높아요.
      </p>
      ...
      <p style={body}>
        소급가입은 원래 가입했어야 할 과거 기간을 지금이라도 가입 처리하는 제도예요. 소급가입이 완료되면 그 기간이 피보험기간으로 인정되고, 실업급여 수급자격을 얻을 수 있죠.
      </p>
      <p style={body}>
        절차는 이래요. 먼저 <strong>고용노동부(1350) 또는 근로복지공단(1588-0075)</strong>에 고용보험 미가입 사업장을 신고해요. 그러면 담당자가 조사에 들어가죠. 이때 근로 사실을 증명할 자료가 필요해요.
      </p>
      <p style={body}>
        조사가 끝나면 소급가입 처리가 돼요. 밀린 보험료를 납부하고, 피보험기간이 확정되면 실업급여를 신청할 수 있죠. 사업주가 협조하지 않아도 괜찮아요. <strong>고용노동부에서 직권으로 가입 처리</strong>할 수 있으니까요.
      </p>
      ...
      <p style={body}>
        가장 강력한 증거는 <strong>근로계약서</strong>예요. 그 다음이 급여명세서, 급여 입금 내역(통장 거래내역)이에요. 원천징수영수증도 유효하죠. 이런 서류가 없으면 출퇴근 기록, 업무 관련 이메일, 동료 증언도 증거로 인정받을 수 있어요.
      </p>
      <p style={body}>
        중요한 건 <strong>다니는 동안 미리 자료를 챙겨두는 것</strong>이에요. 퇴직 후에는 회사에서 자료를 받기 어려울 수 있으니까요. 급여명세서 캡처, 통장 내역 출력, 근로계약서 사본 정도는 미리 보관해두세요.
      </p>
      ...
      <p style={body}>
        소급가입하면 밀린 보험료를 납부해야 해요. 원래 고용보험료는 사업주와 근로자가 <strong>각각 0.9%씩</strong> 부담하는 구조예요. 월급 200만원이면 각 18,000원, 합쳐서 36,000원이 매달 보험료죠.
      </p>
      <p style={body}>
        그런데 미가입 자체가 사업주 의무 위반이니까, 사업주에게 <strong>전액 부담</strong>을 시키는 경우도 있어요. 고용노동부 조사 결과에 따라 달라지죠. 근로자 부담분을 내야 하더라도 실업급여 금액에 비하면 아주 적은 금액이에요.
      </p>
      <p style={body}>
        사업주에게는 과태료도 부과돼요. <a href="https://www.law.go.kr/법령/고용보험법" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험법</a>에 따르면 미가입 사업주에게 <strong>최대 300만원</strong>의 과태료가 부과되죠. 미가입 기간과 근로자 수에 따라 금액이 달라져요.
      </p>
      ...
      <p style={body}>
        가장 중요한 건 <strong>시간</strong>이에요. 실업급여 신청 기한은 퇴직 후 12개월이에요. 소급가입 처리에 1~2개월이 걸리니까, 퇴직하자마자 바로 신고해야 기한 안에 실업급여를 받을 수 있죠.
      </p>
      <p style={body}>
        소급가입 진행 중이라도 <strong>12개월 기한은 연장되지 않아요</strong>. 처리가 늦어지면 실업급여를 아예 못 받는 상황이 생길 수 있죠. 퇴직 후 최대한 빨리 움직이세요.
      </p>
      <p style={body}>
        신고는 어디든 가능해요. 고용노동부 고객상담센터(1350), 근로복지공단(1588-0075), 고용24(ei.go.kr), 관할 고용센터 직접 방문 등 여러 채널이 있으니 편한 곳에서 진행하면 돼요. 전화 한 통이면 절차가 시작되죠.
      </p>
      ...
      <p style={{ ...body, marginBottom: 14 }}>
        고용보험 미가입과 소급가입에 대해 가장 많이 물어보시는 내용이에요.
      </p>
      <FAQ items={FAQS} />
