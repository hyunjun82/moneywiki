...
const FAQS = [
  { q: "퇴직연금 세액공제 얼마나 받아요?", a: "연 최대 900만원 납입 시 13.2~16.5% 공제예요. 최대 148.5만원 돌려받아요." },
  { q: "IRP 세액공제 한도가 얼마예요?", a: "IRP 단독으로 900만원까지예요. 연금저축 포함하면 합산 900만원이에요." },
  { q: "연봉에 따라 공제율이 달라요?", a: "네. 연봉 5,500만원 이하면 16.5%, 초과면 13.2%예요." }
];
  ...
  return (
    <ArticleLayout>
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        IRP 추가 납입하면 연 최대 900만원까지 16.5% 세액공제 받아요. 연말정산에서 최대 148만원 환급받을 수 있어요.
      </p>
      <Divider />
