...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={body}>
        가입기간이 길고, 나이가 50세 이상일수록 유리한 구조예요. 퇴직 시점을 조절할 여지가 있다면 이 기준을 참고하세요. 특히 50세 생일 직전에 퇴직하려는 분이라면 한 달만 늦추는 게 약 200만원 차이를 만들 수 있어요.
      </p>
      ...
      <p style={body}>
        수급자격 심사 결과도 변수예요. 자발적 퇴사로 판정나면 아예 수급 자체가 안 되고, 대기기간 7일이 적용되면 첫 달 금액이 줄어들 수 있죠. 실업급여 수급 중에 아르바이트 같은 소득이 생기면 그만큼 공제되는 것도 빠뜨리기 쉬운 부분이에요. 소득이 생겼는데 신고를 안 하면 부정수급이 되니까 꼭 신고하세요.
      </p>
