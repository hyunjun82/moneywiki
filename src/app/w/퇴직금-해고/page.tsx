...
const STEPS = [
  ...
  },
  {
    ...
    desc: "1년 이상 근무했다면 해고 사유와 상관없이 퇴직금을 청구할 수 있어요. 30일 전 예고 없이 즉시 해고됐다면 30일분 통상임금을 해고예고수당으로 추가 청구해요. 회사에 퇴직금 지급을 서면으로 요청하고 지급 기한인 해고 후 14일을 확인해봐요.",
...
export default function Page() {
  return (
    ...
    >
      ...
      <Disclaimer text="이 글은 2026년 3월 기준 근로기준법·근로자퇴직급여보장법을 바탕으로 작성됐어요. 제도 변경이 있을 수 있으니 최신 기준은 고용노동부(1350)에서 확인해봐요." />
    </ArticleLayout>
  );
}
