...
const FAQS = [
  { q: "집주인 변경 시 임차인 권리에 대해 자세히 알 수 있나요?", a: "이 글에서 핵심 내용을 정리했어요. 아래 내용을 참고하세요." },
...
const SOURCES = [
  { name: "- name: 주택임대차보호법 제3조", href: "https://www.law.go.kr/법령/주택임대차보호법" }
];

const RELATED = [
  { slug: "부동산/대항력-발생-시점", title: "- title: 대항력 발생 시점", description: "" },
  { slug: "부동산/임대차보호법", title: "임대차보호법", description: "" },
  { slug: "부동산/전세보증금-반환-절차", title: "전세보증금 반환 절차", description: "" }
];
...
export default function Page() {
  return (
    <ArticleLayout>
      ...
      <h1 style={{ fontSize: 26, fontWeight: 700, lineHeight: 1.45, marginBottom: 14 }}>집주인 변경 시 임차인 권리</h1>
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>"# 집주인 변경 시 임차인 권리"</p>
      <p style={body}>집주인이 바뀌었을 때 임차인의 권리를 알아봅니다. 대항력이 있으면 새 집주인에게도 임대차를 주장할 수 있습니다.</p>
      <Divider /><ArticleAd position="intro" />
      <H2>핵심 정리</H2>
      <GreenBox title="요약">"· 집주인이 바뀌었을 때 임차인의 권리를 알아봅니다. 대항력이 있으면 새 집주인에게도 임대차를 주장할 수 있습니다."</GreenBox>
      ...
      <Divider />
      <H2>알아두면 좋은 것들</H2>
      <BorderBox><strong>참고사항</strong>{"\n"}· 집주인이 바뀌었을 때 임차인의 권리를 알아봅니다. 대항력이 있으면 새 집주인에게도 임대차를 주장할 수 있습니다.</BorderBox>
      <Divider />
      <H2>자주 묻는 질문</H2>
      <FAQ items={FAQS} />
      <Divider />
