...
const STEPS = [
  {
    title: "14일 기한 확인",
    desc: "퇴직일 다음 날부터 14일째 되는 날이 지급 마감이에요. 예를 들어 3월 1일 퇴직이면 3월 15일이 기한이죠. 이 날까지 입금이 없으면 지연이자 계산이 시작돼요.",
    tip: "공휴일이나 주말이 기한이어도 그날 안에 지급해야 해요",
  },
  {
    title: "문자·메일로 지급 요청",
    desc: "구두 요청보다 문자·메일로 '퇴직금 지급 기한이 지났다'고 통보하세요. 증거가 남아 나중에 유리해요. 이 단계에서 해결되는 경우도 많아요.",
    tip: "날짜 포함해서 '○월 ○일 기준으로 14일이 경과했다'고 명시",
  },
  {
    title: "내용증명 발송",
    desc: "문자 요청 후에도 응답 없으면 내용증명을 보내요. '퇴직금 미지급으로 연 20% 지연이자와 함께 고용노동부에 신고할 예정'이라는 내용이면 충분해요.",
    tip: "우체국 또는 카카오 전자내용증명으로 간편 발송",
  },
  {
    title: "고용노동부 진정 접수",
    desc: "그래도 안 주면 고용노동부 민원마당에서 온라인으로 '임금체불 진정'을 접수해요. 근로감독관이 조사해 시정 명령을 내리고, 이행하지 않으면 형사 처벌까지 가요.",
...
const FAQS = [
  {
    ...
    a: "퇴사일 다음 날부터 14일째 되는 날까지예요. 근로기준법 제36조에 명시된 기한이죠.",
  },
  {
    q: "지급 기한 연장이 가능한가요?",
    a: "당사자 간 합의가 있으면 연장 가능해요. 하지만 회사가 일방적으로 연장하는 건 불법이에요. 반드시 서면 동의가 있어야 하죠.",
  },
  {
    q: "지연이자는 자동으로 붙나요?",
  ...
  {
    q: "회사가 폐업하면 받을 수 없나요?",
    a: "체당금 제도로 정부에서 대신 지급받을 수 있어요. 대표이사 개인에 대한 진정도 가능하죠.",
  },
];
...
const RELATED = [
  {
    ...
    description: "지연이자 계산법과 청구 방법을 정리했어요.",
  },
  {
    slug: "퇴직금-미지급-신고",
    title: "퇴직금 미지급 신고 절차",
  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        ...
        <a href="https://www.law.go.kr/법령/근로기준법" style={{ color: "#1D9E75", textDecoration: "underline" }}>근로기준법 제36조</a>가 명시한 기한이고, 이걸 어기면 바로 위법이에요.
        14일이 지나면 <a href="/w/퇴직금-지연이자" style={{ color: "#1D9E75", textDecoration: "underline" }}>연 20% 지연이자</a>가 붙고, 3년 이하 징역 또는 3,000만원 벌금까지 가능하죠.
        기한 체크부터 지연이자 계산, 신고 절차까지 정리했어요.
      </p>
      ...
      <p style={body}>
        14일 기한은 퇴직일 <strong>다음 날</strong>부터 시작해요. 3월 1일 퇴직이면 3월 15일까지가 기한이죠.
        이 날까지 IRP 또는 일반 계좌로 입금이 안 됐다면 법적 위반이에요.
      </p>
      <p style={body}>
        당사자 합의로 기한을 연장할 수는 있어요. 하지만 <strong>서면 동의</strong>가 있어야 하고, 회사가 일방적으로 "다음 달에 준다"고 하는 건 합의가 아니에요.
        구두로 동의했더라도 서면이 없으면 효력이 없죠.
      </p>

      <SectionBadge>내 상황 체크해보세요</SectionBadge>
      <EligibilityChecker
        items={CHECK_ITEMS}
        allMatchText="지연이자 청구 및 신고가 가능해요. 아래 단계별로 대응하세요."
      ...
      <p style={body}>
        단계를 순서대로 밟으면 대부분 2~3단계에서 해결돼요. 증거도 쌓이고 협상력도 올라가죠.
      </p>
      ...
      <GreenBox title="소멸시효 3년, 반드시 챙기세요">
        퇴직금과 지연이자 청구권 모두 퇴직일로부터 3년이 지나면 소멸해요.
