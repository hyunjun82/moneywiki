"use client";
// Q1. 파견 업체 소속으로 일하다 퇴직하거나 계약이 끝났는데, 퇴직금을 어디에 청구해야 할지 몰라서 당황한 상황이에요.
// Q2. 파견 업체(파견사업주)에 퇴직금 청구서를 내고, 거부당하면 고용노동부에 진정을 접수해요.
// Q3. 퇴직금 지급 의무자(파견사업주)·불법파견 예외·1년 합산 기준·14일 지급 기한·소멸시효 3년
// Q4. GreenBox(핵심 요약) + EligibilityChecker(조건 체크) + Calculator(예상액) + Steps(절차) + Checklist + FAQ
// MAP: Q1→서론 첫 문장(고용주 혼동 공감) Q2→H2순서(청구대상→계산→서류→절차→체크) Q3→H2깊이(불법파견 별도 강조) Q4→컴포넌트 배치
...
const CHECK_ITEMS = [
  { id: "c1", label: "파견 업체(파견사업주)와 근로계약을 체결했죠" },
  { id: "c2", label: "파견 업체 소속으로 1년 이상 근무했죠" },
  { id: "c3", label: "주 평균 15시간 이상 근무했죠" },
  { id: "c4", label: "퇴직일로부터 3년이 지나지 않았죠" },
];
...
const STEPS = [
  {
    ...
    desc: "퇴직금은 파견 업체(파견사업주)에 청구해요. 파견 근로자의 법적 고용주는 파견 업체이기 때문이죠. 사용 업체는 근무 장소와 업무만 제공하고, 고용관계의 당사자는 아니에요. 이메일이나 내용증명으로 서면 요청을 남겨두세요.",
    tip: "카카오톡·이메일 요청도 증거로 인정돼요 — 날짜와 내용이 명확하게 남도록 해두세요",
  },
  {
    title: "퇴직일로부터 14일 이내 지급 여부 체크",
    desc: "파견 업체는 퇴직일로부터 14일 이내에 퇴직금을 지급해야 해요. 14일이 지났는데 입금이 안 됐다면 지연이자(연 20%)가 자동으로 붙죠. 다시 서면으로 독촉하고 날짜를 기록해두세요.",
    tip: "지연이자는 14일 초과 시점부터 실제 지급일까지 누적돼요",
  },
  {
    title: "고용노동부 민원마당에서 진정 접수",
    desc: "파견 업체가 퇴직금 지급을 거부하면 고용노동부 민원마당(minwon.moel.go.kr)에서 온라인으로 진정을 접수해요. 불법 파견이 의심되는 경우에는 불법 파견 여부 확인도 함께 신청할 수 있죠.",
    tip: "온라인 접수 무료 — 접수 즉시 담당 근로감독관이 배정돼요",
    link: { label: "고용노동부 진정 접수", href: "https://minwon.moel.go.kr" },
  },
  {
    title: "불법 파견 인정 시 사용 업체에 추가 청구",
    desc: "고용노동부가 불법 파견으로 인정하면 사용 업체에 직접 고용 의무와 퇴직금 지급 의무가 발생해요. 2년 초과 파견이나 허용 업종 외 파견이 불법 파견에 해당하죠. 법률구조공단(132)에서 무료 법률 지원을 받을 수 있죠.",
    tip: "법률구조공단(132) 무료 상담 — 소송까지 지원받을 수 있죠",
  },
];

const CHECKLIST = [
  "퇴직금 청구 대상 체크: 파견 업체(파견사업주)에 청구",
  "파견 업체 기준 1년 근속 여부: 사용 업체 여러 곳이어도 합산",
  "지급 기한 14일: 초과 시 지연이자(연 20%) 청구 가능",
  "불법 파견 여부: 2년 초과 파견 또는 허용 업종 외 파견",
...
const FAQS = [
  {
    ...
    a: "원칙적으로 파견 업체(파견사업주)가 지급해요. 파견근로자 보호 등에 관한 법률에서 파견 근로자의 고용주는 파견 업체로 정해져 있거든요. 단, 불법 파견이 인정되면 사용 업체가 책임지는 경우도 있죠.",
  },
  {
    q: "사용 업체 여러 곳을 옮겨 다녔는데 퇴직금 계산은 어떻게 하나요?",
    a: "파견 업체와의 고용관계가 계속 이어졌다면 근속 기간이 합산돼요. A 업체 6개월, B 업체 8개월 일했어도 파견 업체 소속으로 총 14개월이면 퇴직금이 발생하죠. 파견 업체와의 고용관계가 중단된 시점이 있었는지 먼저 살펴봐야 해요.",
  },
  {
  ...
  },
  {
    ...
    a: "파견 업체가 폐업해도 체당금(임금 대지급금) 제도로 퇴직금 일부를 받을 수 있죠. 근로복지공단에 체당금 신청을 하면 되고, 상한액이 있으니 금액은 미리 살펴두세요.",
  },
  {
  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        일하는 곳(사용 업체)과 고용 계약한 곳(파견 업체)이 달라서 퇴직금을 어디에 청구해야 할지 헷갈리죠.
        <a href="https://www.law.go.kr/법령/파견근로자보호등에관한법률" style={{ color: "#1D9E75", textDecoration: "underline" }}>파견근로자 보호 등에 관한 법률</a>에 따르면,
        퇴직금 지급 의무는 파견 업체(파견사업주)에 있죠.
        사용 업체를 여러 곳 옮겨 다녔어도 파견 업체 소속으로 1년이 넘으면 퇴직금이 발생하고,
      ...
      <p style={body}>
        ...
        사용 업체는 근무 장소와 업무만 제공하는 역할이고, 고용관계의 당사자는 아니에요.
        퇴직금 청구서도, 지급 의무도, 14일 기한도 모두 파견 업체 기준으로 적용돼요.
      </p>
      <p style={body}>
        사용 업체를 여러 곳 옮겨 다녔더라도 파견 업체와의 고용관계가 끊기지 않았다면 근속 기간이 합산돼요.
        A 업체 6개월, B 업체 8개월 일했어도 파견 업체 소속으로 총 14개월이면 <a href="/w/퇴직금-조건" style={{ color: "#1D9E75", textDecoration: "underline" }}>퇴직금 발생 조건</a>을 충족하죠.
      </p>
      ...
      <EligibilityChecker
        items={CHECK_ITEMS}
        allMatchText="퇴직금 청구 조건을 갖췄어요. 아래 계산기로 예상 금액을 먼저 살펴보세요."
        partialMatchText="일부 조건이 다를 수 있죠. 파견 업체와의 고용관계를 살펴본 뒤 고용노동부(1350)에 상담받아보세요."
      />
      ...
      <p style={body}>
        ...
        퇴직금 계산 공식이 헷갈린다면 <a href="/w/퇴직금-계산-방법" style={{ color: "#1D9E75", textDecoration: "underline" }}>퇴직금 계산 방법</a>을 참고해보세요.
      </p>
      ...
      <Calculator
        ...
        note="※ 파견 업체 기준 근속 기간으로 계산해요. 상여금·연차수당 포함 시 실제 금액이 더 높아질 수 있죠."
      />
      ...
      <p style={body}>
        ...
        파견 계약서와 급여명세서가 핵심이고, 4대보험 가입 이력으로 근속 기간을 보강할 수 있죠.
      </p>
      <p style={body}>
        불법 파견을 주장하는 경우에는 사용 업체에서의 업무 지시 기록, 출입 기록도 함께 확보해두세요.
        <a href="/w/퇴직금-미지급-신고" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용노동부 진정</a>을 낼 때 증거로 첨부할 수 있죠.
      </p>
      ...
      <BorderBox>
        ...
        고용노동부에 불법 파견 여부 확인을 신청하고, 법률구조공단(132)에서 무료 법률 지원을 받을 수 있죠.
      </BorderBox>
      ...
      <p style={body}>
        ...
        소멸시효 3년을 놓치지 않도록 퇴직 즉시 아래 항목을 살펴보세요.
      </p>
      ...
      <GreenBox>
        파견 업체가 폐업해도 근로복지공단 체당금 신청으로 퇴직금 일부를 받을 수 있죠.
        상한액이 있으니 금액을 미리 살펴보고 신청하세요.
      </GreenBox>
      ...
      <Disclaimer text="이 글은 2026년 3월 기준 파견근로자 보호 등에 관한 법률과 근로자퇴직급여 보장법을 바탕으로 작성됐어요. 제도 변경이 있을 수 있으니, 최신 기준은 고용노동부(1350)에서 문의해보세요." />
    </ArticleLayout>
  );
}
