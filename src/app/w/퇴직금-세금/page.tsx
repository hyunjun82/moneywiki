...
const STEPS = [
  ...
  },
  {
    ...
    desc: "퇴직금을 IRP 계좌로 받으면 바로 세금을 내지 않아요. 연금으로 수령할 때 퇴직소득세의 30~40%를 감면해주죠. 장기 절세 효과가 크기 때문에 여유가 있다면 권해요.",
    tip: "퇴직금 300만원 초과 시 IRP 이체 의무화",
  },
  {
    title: "연금 수령 (최대 절세)",
    desc: "IRP에 넣은 퇴직금을 55세 이후 10년 이상 연금으로 나눠 받으면 퇴직소득세의 60~70%만 내요. 일시금 수령 대비 세금이 30~40% 줄어드는 셈이죠.",
...
const FAQS = [
  ...
  },
  {
    ...
    a: "당장 안 내는 거예요. 나중에 연금으로 받을 때 퇴직소득세의 60~70%만 내게 돼요. 일시금 수령 대비 30~40% 절세 효과가 있죠.",
  },
  {
    q: "회사에서 세금을 알아서 떼주나요?",
    a: "네, 회사가 원천징수해요. 퇴직금에서 퇴직소득세를 차감한 금액이 입금되죠. 계산이 맞는지 퇴직소득원천징수영수증으로 확인하세요.",
  },
  {
  ...
  },
  {
    ...
    a: "각 회사에서 별도로 원천징수해요. 다음 해 5월에 종합소득세 신고 때 합산 정산이 필요하죠. 추가 납부 또는 환급이 발생할 수 있어요.",
  },
];
...
const RELATED = [
  {
    ...
    title: "IRP로 퇴직금 세금 줄이는 방법",
    description: "IRP 연금 수령 시 퇴직소득세 30~40% 절세 방법이에요.",
  },
  {
    slug: "퇴직금-IRP-수령방법",
    title: "퇴직금 IRP 수령 방법",
    description: "IRP 계좌 개설부터 연금 설정까지 단계별로 안내해요.",
  },
  {
    slug: "퇴직금-계산법",
    title: "퇴직금 계산법, 얼마나 받을까?",
    description: "평균임금 기준 퇴직금 계산 공식과 실전 예시예요.",
  },
];
  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        퇴직금에도 세금이 붙어요. 하지만 근로소득세와 다른 <strong>퇴직소득세</strong>가 적용되고,
        근속연수가 길수록 세금이 줄어드는 구조예요.
      ...
      <p style={body}>
        퇴직소득세는 회사가 원천징수해서 차감한 뒤 지급해요. 별도로 신고할 필요는 없지만, 두 곳 이상에서 퇴직금을 받으면 다음 해 5월에 합산 정산이 필요하죠.
      </p>
      ...
      <H2>내 퇴직소득세, 얼마일까?</H2>
      <p style={body}>
        퇴직소득세는 <strong>근속연수 공제 → 환산급여 공제 → 세율 적용</strong> 순서로 계산해요.
      ...
      <GreenBox title="IRP vs 일시금, 세금 차이">
        퇴직금 3,000만원·10년 근속 기준으로 일시금 수령 시 세금이 수십만원이라면,
        IRP 연금(10년 분할) 수령 시엔 30~40%만 내면 돼요.
        금액이 클수록 IRP 절세 효과가 훨씬 커지죠.
      </GreenBox>
