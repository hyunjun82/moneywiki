...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={body}>
        여러 직장의 피보험기간은 합산돼요. A편의점에서 108일, B카페에서 72일 — 합치면 180일이 되는 거예요. 단, 두 곳 모두 고용보험에 가입돼 있어야 해요. 한 곳이라도 미가입이면 그 기간은 합산에 포함되지 않으니까, 각 직장별로 가입 여부를 따로 확인하세요.
      </p>
      ...
      <p style={body}>
        재미있는 구조예요. 월급 80만원이던 사람이 실업급여로 월 198만원을 받는 셈이니까요. 하한액이 최저임금의 80% x 8시간 기준으로 정해지기 때문에 이런 역전이 생기는 거예요. 단시간 근로자 입장에서는 실업급여를 놓치면 오히려 더 큰 손해가 되는 구조죠.
      </p>
      ...
      <p style={body}>
        자발적으로 그만둔 경우라도 <strong>정당한 사유</strong>가 있으면 비자발적으로 인정받을 수 있어요. 임금 3개월 이상 미지급, 직장 내 괴롭힘, 출퇴근 왕복 3시간 초과가 대표적이죠. 이런 상황이라면 증빙자료(급여명세서, 녹음, 출퇴근 기록)를 미리 확보해두세요. 고용센터 심사에서 결정적인 역할을 하거든요.
      </p>
