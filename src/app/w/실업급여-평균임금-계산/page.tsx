...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={body}>
        이 계산법의 법적 근거는 <a href="https://www.law.go.kr/법령/근로기준법" style={{ color: "#1D9E75", textDecoration: "underline" }}>근로기준법 제2조</a>예요. 실업급여뿐 아니라 퇴직금 산정에도 동일한 공식을 쓰죠. 한 번 익혀두면 두 군데서 활용할 수 있고요.
      </p>
      ...
      <p style={body}>
        1일 평균임금은 1,030만원 / 92일 = <strong>약 111,957원</strong>이에요. 여기에 60%를 곱하면 약 67,174원이 1일 실업급여가 되죠. 2026년 상한액(68,100원)보다 낮으니까 67,174원이 그대로 적용돼요. 반대로 월급이 더 높아서 60%가 상한액을 넘겼다면 68,100원에서 잘리고요.
      </p>
      ...
      <p style={body}>
        하한액은 1일 <strong>66,048원</strong>이에요. 최저임금 수준으로 일했더라도 이 아래로는 내려가지 않아요. 상한과 하한 사이 차이가 약 2,000원밖에 안 되니까, 결국 대부분의 수급자가 비슷한 범위에서 받게 되는 구조예요. 차이를 만드는 건 수급일수죠.
      </p>
      <p style={body}>
