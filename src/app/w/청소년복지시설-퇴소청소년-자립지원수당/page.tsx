...
// Q1. 청소년복지시설을 퇴소 후 자립을 준비 중인 청소년이 지원금을 알고 싶은 상황
// Q2. 퇴소청소년 자립지원수당 자격을 파악하고 신청한다
  ...
  return (
    <div style={{ maxWidth: "720px", margin: "0 auto", padding: "0 16px 40px" }}>
      <h1 style={{ fontSize: "clamp(20px,4vw,26px)", fontWeight: 800, lineHeight: 1.35, marginBottom: "16px" }}>
        <span style={{ color: "#1D9E75" }}>퇴소청소년 자립지원수당 신청 자격</span>
      </h1>

      <p style={{ fontSize: "15px", lineHeight: 1.8, color: "#374151", marginBottom: "12px" }}>
        청소년복지시설을 나온 후 홀로 자립을 준비하는 건 정말 쉽지 않아요. 주거, 생활비, 취업 준비까지 동시에 해야 하는데 도움받을 곳이 마땅치 않죠. 정부에서는 시설을 나온 청소년이 자립 기반을 다질 수 있도록 매달 30만원씩 최대 5년간 자립지원수당을 지원해요. 작은 금액처럼 보일 수 있지만 5년 동안 꾸준히 받으면 총 1,800만원이 쌓여 실질적인 자립 재원이 돼요.
      </p>
      <p style={{ fontSize: "15px", lineHeight: 1.8, color: "#374151", marginBottom: "12px" }}>
      ...
      <H2>신청 자격과 대상 시설</H2>
      <p style={{ fontSize: "15px", lineHeight: 1.8, color: "#374151", marginBottom: "12px" }}>
        퇴소청소년 자립지원수당은 여성가족부가 지정한 청소년복지시설에서 퇴소한 청소년이 대상이에요. 대상 시설은 청소년쉼터(단기·중기·장기), 청소년자립생활관, 청소년회복지원시설 등이에요. 국공립 또는 민간 운영 여부와 관계없이 여성가족부 지정 시설이면 해당돼요.
      </p>
      <p style={{ fontSize: "15px", lineHeight: 1.8, color: "#374151", marginBottom: "12px" }}>
      ...
      <p style={{ fontSize: "15px", lineHeight: 1.8, color: "#374151", marginBottom: "12px" }}>
        지원 기간은 퇴소 시점부터 최대 5년이에요. 중간에 취업을 하거나 결혼을 해도 자격 요건을 유지하면 계속 받을 수 있죠. 다만 매년 자격 유지 여부를 확인하는 갱신 절차가 있어서 이를 놓치지 않는 게 중요해요. 갱신 안내를 받으면 기한 내에 서류를 제출해야 중단 없이 이어갈 수 있죠.
      </p>
      <p style={{ fontSize: "15px", lineHeight: 1.8, color: "#374151", marginBottom: "12px" }}>
