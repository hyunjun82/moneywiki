...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={body}>
        쉽게 말하면 실업급여의 &quot;병가 버전&quot;이에요. 아프다고 급여가 끊기는 게 아니라, 아픈 기간만큼 이름만 바뀌어서 계속 나오는 구조죠. 단, 아무 병이나 다 되는 건 아니에요 — 14일 이상 취업이 불가능해야 하고, 완치 후 14일 이내에 신청해야 해요.
      </p>
      <p style={body}>
      ...
      <p style={body}>
        상병급여 기간 동안에는 절대 일하면 안 돼요. &quot;일할 수 없는 상태&quot;라서 받는 건데, 소소한 알바라도 했다가 적발되면 <strong>부정수급</strong>으로 처리돼요. 받은 금액의 최대 5배를 반환해야 할 수 있으니까 치료에만 집중하세요.
      </p>
