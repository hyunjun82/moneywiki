  ...
  return (
    ...
    >
      ...
      <p style={body}>
        ...
        &quot;신고했느냐&quot;가 핵심이에요.
        조건에 맞는 알바를 해놓고 신고를 안 하면, 부정수급으로 전액 환수당하죠.
      ...
      <p style={body}>
        한 가지 주의할 점이 남았어요. 실업급여 수급 가능 기간(퇴직 후 12개월) 안에 소정급여일수를 소진해야 하거든요. 알바를 너무 많이 해서 수급이 계속 밀리면, 12개월이 지나 일부를 못 받는 상황이 생길 수 있죠. 적당한 선에서 관리하는 게 현명해요.
      </p>
      ...
      <p style={body}>
        알바하고 신고를 안 하면 <strong>부정수급</strong>이에요. <a href="https://www.law.go.kr/법령/고용보험법" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험법 제62조</a>가 명확하게 정해놓은 규정이죠. 이미 받은 실업급여 전액을 반환해야 하고, 거기에 <strong>최대 5배 추가 징수</strong>까지 붙어요. 30만 원 알바비를 숨기다가 수백만 원을 토해내는 거예요.
      </p>
      <p style={body}>
