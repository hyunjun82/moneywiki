// Q1. 퇴직금이 14일이 지나도 안 들어와서 어떻게 신고해야 하는지 막막한 상황이에요
// Q2. 고용24에 임금체불 진정을 접수하고, 진정서에 지연이자(연 20%)까지 명시해서 청구해요
// Q3. 지연이자 발생 시점·이율, 진정 절차 4단계, 소멸시효 3년, 진정서 문구, 필요 서류
// Q4. 계산기(지연이자 금액), Steps(절차), Checklist(놓치기 쉬운 포인트), GreenBox(핵심 문구)
...
const CHECK_ITEMS = [
  { id: "c1", label: "퇴직 후 14일이 지났는데 퇴직금이 입금되지 않았죠" },
  { id: "c2", label: "회사에 지급 요청했지만 거부하거나 계속 미루고 있죠" },
  { id: "c3", label: "퇴직일로부터 3년(소멸시효)이 아직 지나지 않았죠" },
  { id: "c4", label: "근로 기간이 1년 이상이고 주 15시간 이상 일했죠" },
];
...
const STEPS = [
  {
    ...
    desc: "고용24(ei.go.kr) → 민원신청 → 임금체불 진정으로 접수해요. 진정서에 '퇴직금 ○○만원 및 연 20% 지연이자 포함 청구'를 명시해야 나중에 지연이자도 함께 받을 수 있죠. 방문 진정은 관할 고용노동청 근로감독과에 가면 돼요.",
    tip: "온라인 접수가 가장 빠르고, 접수 즉시 소멸시효가 중단돼요",
    link: { label: "고용24 진정 접수하기", href: "https://www.ei.go.kr" },
  },
  {
    title: "근로감독관 조사 및 사실 확인",
    desc: "접수 후 담당 근로감독관이 배정돼요. 근로감독관은 사업주에게 출석 요구 및 자료 제출을 명령하고, 근로 사실과 미지급 금액을 확인하죠. 이 단계에서 사업주가 형사처벌(3년 이하 징역 또는 3,000만원 이하 벌금) 위험을 인식하고 대부분 지급해요.",
    tip: "보통 접수 후 1~3개월 내 처리되고, 단순 미지급은 더 빠른 경우도 있죠",
  },
  {
    title: "시정 명령 — 지급 이행 요구",
    desc: "근로감독관이 조사 결과를 바탕으로 사업주에게 시정 명령을 내려요. 시정 기간 내에 퇴직금과 지연이자를 지급하면 사건이 종결되고, 시정 명령을 무시하면 검찰에 송치돼요.",
    tip: "이 단계에서도 미지급이면 검찰 송치로 형사 처벌이 진행돼요",
  },
  {
    title: "검찰 송치 또는 소액심판 병행",
    desc: "시정 명령 후에도 지급하지 않으면 근로감독관이 사건을 검찰에 송치해요. 동시에 본인이 직접 법원에 소액심판(3,000만원 이하)을 신청하면 민사 강제집행도 가능하죠. 대한법률구조공단(132)에서 무료 법률 지원을 받을 수 있고요.",
    tip: "소액심판은 변호사 없이 직접 신청 가능하고, 인지대는 수만 원이에요",
  },
];

const CHECKLIST = [
  "지연이자 발생 시작일 체크: 퇴직 후 14일 초과 다음 날부터",
...
const FAQS = [
  {
    ...
    a: "자동으로 받아지지 않아요. 고용노동부 진정서나 법원 청구서에 '연 20% 지연이자 포함'을 직접 명시해야 받을 수 있고요. 빠뜨리면 원금만 받게 될 수 있죠.",
  },
  {
    q: "소멸시효 3년이 지나면 정말 못 받나요?",
    a: "법적 청구권이 소멸해요. 다만 내용증명 발송(6개월 중단), 진정 접수, 소송 제기로 시효를 중단시킬 수 있죠. 3년이 임박했다면 빨리 진정부터 접수하는 게 중요해요.",
  },
  {
    q: "노동청 진정 결과까지 얼마나 걸리나요?",
    a: "보통 1~3개월이에요. 사업주가 출석을 거부하거나 사건이 복잡하면 더 걸릴 수 있고요. 민사소송(6개월~1년)보다 훨씬 빠르고 무료예요.",
  },
  {
    q: "회사가 폐업했어도 지연이자 청구가 되나요?",
    a: "체당금 제도로 정부에서 퇴직금 일부를 받을 수 있죠. 지연이자는 대표이사 개인에 대한 민사 청구로 별도 진행해야 할 수 있고, 폐업 후 2년 내 신청해야 하죠.",
  },
  {
    q: "진정 접수 후 회사가 불이익을 주면 어떻게 하나요?",
    a: "근로기준법 제104조가 신고를 이유로 한 불이익을 금지해요. 보복 행위가 있다면 별도로 진정을 넣을 수 있고, 처벌 대상이 돼요.",
  },
];
...
export default function Page() {
  return (
    <ArticleLayout
      sidebar={<Sidebar heading="퇴직금 가이드" items={퇴직금_SIDEBAR} highlightSlugs={퇴직금_HIGHLIGHT} currentSlug="퇴직금-미지급-신고-절차-지연이자-청구" />}
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        ...
        명시된 권리죠. 지연이자는 자동으로 받아지지 않고, 진정서에 직접 명시해야만 받을 수 있죠.
      ...
      <p style={body}>
        퇴직 후 14일이 지났는데 퇴직금이 안 들어왔다면 이미 지연이자가 쌓이고 있죠.
        소멸시효 3년이 지나기 전이라면 언제든 진정을 접수할 수 있죠.
        아직 시효가 남아 있다면 지금 바로 행동하는 게 중요하고요.
      </p>
      <p style={body}>
        진정 접수 자체는 무료고, 서류가 부족해도 통장 내역이나 카카오톡 대화만으로 시작할 수 있죠.
        접수하는 순간 소멸시효도 멈춰요.
      </p>
      ...
      <EligibilityChecker
        items={CHECK_ITEMS}
        allMatchText="지연이자 포함 진정이 가능한 상황이에요. 아래 절차를 따라 진행해봐요."
        partialMatchText="상황에 따라 다를 수 있죠. 고용노동부(1350)에 먼저 상담해봐요."
      />
      ...
      <p style={body}>
        ...
        미지급 기간이 길어질수록 이자도 쌓이기 때문에 지연 일수를 정확히 기록해둬야 하죠.
      </p>
      <p style={body}>
      ...
      <p style={body}>
        ...
        없는 서류가 있어도 온라인으로 대체 서류를 구할 수 있고요.
      </p>
      ...
      <BorderBox>
        ...
        무료로 출력할 수 있죠. 근로 사실은 동료 진술이나 카카오톡 대화로도 인정돼요.
      </BorderBox>
      ...
      <p style={body}>
        ...
        대부분의 사건은 2~3단계(근로감독관 조사·시정 명령)에서 해결되고, 4단계까지 가는 경우는 드물죠.
      </p>
      ...
      <p style={body}>
        ...
        소멸시효는 진정 접수하면 그 시점부터 완전히 중단되고요.
      </p>
      ...
      <GreenBox>
        ...
        진정서에 "퇴직금 ○○만원 및 14일 초과분 연 20% 지연이자를 함께 청구해요"라고 써야 하죠.<br />
      ...
      <Disclaimer text="이 글은 2026년 3월 기준 근로기준법을 바탕으로 작성됐어요. 제도 변경이 있을 수 있으니 최신 기준은 고용노동부(1350)에서 살펴봐요." />
    </ArticleLayout>
  );
}
