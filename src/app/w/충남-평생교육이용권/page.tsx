...
const SIDEBAR_LINKS = ["충남 평생교육이용권 신청방법", "충청남도 평생교육이용권 자격", "평생교육이용권 AI디지털 이용권", "평생교육이용권 사용처 조회", "서울 평생교육이용권 신청", "인천 평생교육이용권 신청", "충북 평생교육이용권 신청", "강원 평생교육이용권 신청", "NH농협카드 채움카드 발급", "차상위계층 확인 방법", "기초생활수급자 신청", "충남 복지 교육 지원", "평생교육이용권 추첨 기준", "평생교육이용권 우수이용자 70만원", "충남 평생학습 포털"];
const HUB_LINKS = [{"title": "서울 평생교육이용권 | 4월 9일까지", "desc": "서울 4개 유형 자격·절차 정리", "href": "/w/서울-평생교육이용권"}, {"title": "인천 평생교육이용권 | 4월 8일까지", "desc": "인천형 소득 무관 유형 안내", "href": "/w/인천-평생교육이용권"}, {"title": "충북 평생교육이용권 | 4월 10일까지", "desc": "충북 신청 조건·기간 정리", "href": "/w/충북-평생교육이용권"}, {"title": "경남 평생교육이용권 | 4월 17일까지", "desc": "경남 시군별 접수처 안내", "href": "/w/경남-평생교육이용권"}];
const STEPS = [{"title": "내 유형 먼저 고르세요", "desc": "일반·AI디지털·노인 중 1개만 신청. 중복 신청 자동 무효예요."}, {"title": "lllcard.kr/chungnam 접속", "desc": "카카오·PASS 간편인증 후 신청서를 작성해요.", "link": {"label": "lllcard.kr/chungnam", "url": "https://www.lllcard.kr/chungnam"}}, {"title": "신청서 작성 + 제출", "desc": "유형 선택 → 자격 정보 입력 → 제출.", "tip": "4월 17일 마감, 미리 신청하세요"}, {"title": "선정 결과 통보", "desc": "문자·카카오톡으로 개별 통보. 선정 시 NH농협 채움카드에 35만원 포인트 자동 충전이에요."}, {"title": "강좌 수강 + 사용", "desc": "등록된 기관에서 수강료·교재비로 결제해요. 12월 31일까지 사용해야 해요.", "tip": "미사용 잔액 연말 자동 소멸"}];
const FAQS = [{"urgent": true, "q": "충남 거주자인데 세종시 공고로 신청해도 되나요?", "a": "안 돼요. 주민등록등본 상 주소지 기준이에요. 충남에 주민등록이 있으면 충남 공고(lllcard.kr/chungnam)로만 신청해야 해요. 세종시 거주자는 세종 공고를 따로 확인하세요."}, {"urgent": true, "q": "30세 이상이면 소득 상관없이 신청 가능한가요?", "a": "AI·디지털 이용권은 만 30세 이상이면 소득 무관하게 신청할 수 있어요. 단, AI·디지털 관련 강좌(코딩, 영상편집, ChatGPT 활용 등)만 사용 가능한 전용 이용권이에요."}, {"urgent": false, "q": "사용 기한이 12월 31일인데 늦게 선정되면 시간이 부족하지 않나요?", "a": "1차 모집 선정 후 충분한 사용 기간이 있어요. 단, 미사용 잔액은 12월 31일 이후 자동 소멸되니 선정 직후부터 계획적으로 활용하세요."}, {"urgent": false, "q": "NH농협카드가 없어요.", "a": "선정 후 card.nonghyup.com 또는 NH농협은행 영업점에서 채움카드를 발급하세요. 기존 채움카드 소지자는 자동 충전이에요."}, {"urgent": false, "q": "추첨 탈락하면 기회가 없나요?", "a": "2차 모집이 진행될 수 있어요. lllcard.kr/chungnam에서 다음 공고를 확인하세요."}];
...
const REFERENCES = [{"category": "공식 공고", "items": [{"label": "충남 평생교육이용권 누리집 (lllcard.kr/chungnam)", "url": "https://www.lllcard.kr/chungnam"}]}, {"category": "법령·카드", "items": [{"label": "평생교육법 제16조의2 — 평생교육이용권의 발급 등", "url": "https://www.law.go.kr/"}, {"label": "NH농협카드 채움카드 신규 발급", "url": "https://card.nonghyup.com"}]}];
const APPLY_URL = "https://www.lllcard.kr/chungnam";
const APPLY_LABEL = "충남 평생교육이용권 신청하기";
const DEADLINE_ISO = "2026-04-17T23:59:00+09:00";
const DEADLINE_LABEL = "2026년 4월 17일(금) 마감";
const DEADLINE_SHORT = "4월 17일";
const NOTE_SPECIFIC = "충남 1차: 일반·AI디지털·노인 3개 유형";
  ...
  return (
    <div style={{ maxWidth: 1060, margin: "0 auto", padding: "2rem 1.5rem", fontFamily: "'Pretendard', 'Apple SD Gothic Neo', sans-serif", color: "#111", display: "flex", gap: 28, alignItems: "flex-start" }}>
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <p style={{ fontSize: 13, color: "#1D9E75", fontWeight: 600, marginBottom: 10 }}>복지 · 교육 지원 · 충청남도</p>
        <h1 style={{ fontSize: 26, fontWeight: 700, lineHeight: 1.45, marginBottom: 14 }}>
          2026 충남 평생교육이용권 35만원 |<br />
          신청자격·기간·사용처 정리
        </h1>
        <p style={{ fontSize: 15, color: "#374151", lineHeight: 2.1, marginBottom: "1rem" }}>
          충남에서 연 35만원 교육비를 지원받을 수 있어요.\n4월 17일까지 여유가 있지만 마감 직전 접속자가 몰려요.\n미리 유형 확인하고 신청해두세요.
        </p>
        ...
        <H2>충청남도 평생교육이용권, 신청 전에 이것부터 확인하세요</H2>
        <p style={body}>
          충청남도에 주민등록이 있어야 충청남도 공고로 신청할 수 있어요.<br />
          2026년부터 국가 단일 모집이 아닌 광역 지자체별 개별 모집으로 바뀌었어요.<br />
          타 지역 공고로 신청하면 자동 탈락이에요.
        </p>
        <GreenBox title="2026 충청남도 1차 핵심 정보">
          신청 기간: 2026년 3월 30일(월) ~ 4월 17일(금)<br />
          지원 금액: 1인당 연 35만원 · 우수이용자 최대 70만원<br />
          신청 방법: www.lllcard.kr/chungnam (PC·모바일 가능)<br />
        ...
        <p style={body}>
          온라인 사용기관은 전국 공통이에요. 충청남도 어디서나 수강할 수 있어요.<br />
          실제 강좌 목록은 www.lllcard.kr/chungnam에서 검색하세요.
        </p>
        ...
        <div style={{ marginTop: "1.2rem", padding: "14px 18px", background: "#f9fafb", borderRadius: 10, fontSize: 12, color: "#9ca3af", lineHeight: 1.9 }}>
          이 글은 법률·정책 정보 제공을 목적으로 작성됐어요. 개별 선정 결과는 충청남도 공고 기준에 따르며, 중요한 결정 전에 반드시 공식 출처를 직접 확인하세요.
          <br />※ 충남 1차: 일반·AI디지털·노인 3개 유형
        </div>
      </div>
    </div>
  );
