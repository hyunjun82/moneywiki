...
const CHECK_ITEMS = [
  ...
  { id: "c2", label: "회사가 서면 동의서를 제시하며 서명을 요구하고 있어요" },
  { id: "c3", label: "동의서에 구체적인 지급 예정일이 적혀 있어요" },
...
const STEPS = [
  {
    title: "동의서 내용 꼼꼼히 검토",
    desc: "서명 전에 세 가지를 반드시 확인해야 해요. 첫째, 구체적인 지급 예정일이 적혀 있는지. 둘째, 지연이자 포기 조항이 없는지. 셋째, 연장 사유가 명시됐는지예요. 이 중 하나라도 빠지면 수정을 요구하거나 서명하지 않는 게 유리해요.",
    tip: "지연이자 포기 조항이 있으면 삭제 요청 또는 서명 거부하세요",
  },
  {
    title: "동의 여부 결정",
    desc: "동의는 강요가 아닌 자발적 합의여야 유효해요. 퇴직 전 사전 합의가 원칙이고, 퇴직 후에 강요로 받은 동의서는 무효를 주장할 수 있어요. 합리적인 연장 기간(14~30일)이고 이자 포기 조항이 없다면 서명할 수 있어요.",
    tip: "거부해도 불이익 없어요 — 지연이자 청구권은 그대로 유지돼요",
  },
  {
    title: "동의서 교부 및 보관",
    desc: "서명 후 동의서 사본을 반드시 받아두세요. 이후 분쟁 시 합의 내용을 증명하는 핵심 증거가 돼요. 이메일이나 문자로 내용을 재확인해두면 더 안전해요.",
    tip: "동의서 원본 또는 사진 캡처를 반드시 보관하세요",
  },
  {
    title: "연장 기간 내 지급 모니터링",
    desc: "합의한 기한 안에 퇴직금이 실제로 입금됐는지 확인해요. 연장 기한도 초과하면 그 시점부터 다시 지연이자(연 20%)가 발생하고, 고용노동부에 진정을 낼 수 있어요. 지급 약속이 반복해서 미뤄지면 즉시 신고하세요.",
...
const FAQS = [
  {
    ...
    a: "아니에요. 동의는 자발적 합의예요. 서명을 거부해도 불이익이 없어요. 거부하면 14일 초과분부터 지연이자(연 20%)를 청구할 수 있어요.",
  },
  {
    q: "동의서에 지연이자 포기 조항이 있는데 서명해야 하나요?",
    a: "서명하면 이자를 받기 어려워져요. 포기 조항 삭제를 요청하거나, 삭제가 안 되면 서명하지 않고 고용노동부에 진정을 내는 게 유리해요.",
  },
  {
    q: "동의서를 썼는데 연장 기한도 지났어요",
    a: "연장 기한 초과분부터 다시 지연이자(연 20%)가 발생해요. 추가로 고용노동부에 진정을 낼 수 있어요.",
  },
  {
    q: "구두로 합의했는데 유효한가요?",
    a: "구두 합의는 입증이 어렵고 유효성 논란이 생겨요. 근로기준법 제36조는 서면 합의를 요구해요. 구두만 있다면 사실상 미지급 상태로 봐도 무방해요.",
  },
  {
    q: "퇴직 후 강요로 서명한 동의서도 유효한가요?",
    a: "강요·사기·착오로 서명한 경우는 무효를 주장할 수 있어요. 근로기준법 제36조는 사전 합의가 원칙이에요. 노무사나 법률구조공단(132)에 상담하세요.",
  },
  {
    q: "동의서 없이 기한이 지났으면 어떻게 되나요?",
    a: "14일 초과 시점부터 자동으로 지연이자(연 20%)가 발생해요. 동의서 없이 기한이 지나면 바로 고용노동부 진정을 낼 수 있어요.",
  },
];
  ...
  return (
    ...
    >
      ...
      <h1 style={{ fontSize: 26, fontWeight: 700, lineHeight: 1.45, marginBottom: 14 }}>
        ...
        유효 조건·작성 방법·거부 시 대응까지
      </h1>

      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        회사가 퇴직금을 바로 못 주겠다며 기한 연장 동의서를 내밀 때가 있어요.
        서명 전에 지연이자 포기 조항이 있는지 반드시 확인해야 해요.
        이 조항이 들어 있으면 서명 순간 <a href="/w/퇴직금-지연이자" style={{ color: "#1D9E75", textDecoration: "underline" }}>지연이자(연 20%)</a> 청구권을 잃을 수 있어요.
      ...
      <H2>연장 동의서가 유효하려면 조건이 있어요</H2>
      <p style={body}>
        <a href="/w/퇴직금-지급-기한" style={{ color: "#1D9E75", textDecoration: "underline" }}>퇴직금 지급 기한</a>은 근로자퇴직급여보장법 제9조에 따라 퇴직 후 14일이에요.
        단, 근로기준법 제36조는 당사자가 합의하면 기한을 연장할 수 있다고 정해요.
        여기서 합의는 반드시 서면이어야 하고, 퇴직 전 사전 합의가 원칙이에요.
        구두로만 합의했다면 유효성 논란이 생겨요.
      </p>
      <p style={body}>
        동의서에 꼭 들어가야 할 세 가지가 있어요. 연장 사유, 구체적인 지급 예정일, 그리고 지연이자 적용 여부예요.
        이 중 하나라도 빠지면 분쟁이 생겼을 때 근로자에게 불리하게 작용할 수 있어요.
      ...
      <H2>합의 기한 초과 시 지연이자 계산</H2>
      <p style={body}>
        동의서를 써줬더라도 합의한 기한을 또 넘기면 그 시점부터 다시 지연이자가 발생해요.
        동의서에 지연이자 포기 조항이 없었다면 청구할 수 있어요.
        미지급 퇴직금과 초과 일수를 입력해서 예상 이자를 미리 파악하세요.
      </p>
      ...
      <H2>동의서 필수 항목과 첨부 서류</H2>
      <p style={body}>
        동의서 본문에 빠지면 안 되는 항목과, 퇴직금 기준 입증에 필요한 첨부 서류를 정리했어요.
        첨부 서류는 분쟁이 생겼을 때 퇴직금 원금을 입증하는 데 써요.
      </p>
      ...
      <H2>작성부터 지급까지 절차 4단계</H2>
      <p style={body}>
        동의서 내용 검토 → 동의 여부 결정 → 교부 및 보관 → 기한 내 지급 확인 순서예요.
        처음 단계에서 이자 포기 조항을 걸러내는 게 핵심이에요.
      </p>
      ...
      <H2>서명 전 반드시 확인할 체크리스트</H2>
      <p style={body}>
        이자 포기 조항이 가장 위험해요. 서명 전 아무 생각 없이 넘기면 수십만 원 이자를 잃을 수 있어요.
        아래 항목을 하나씩 체크하고 서명 여부를 결정하세요.
      </p>
