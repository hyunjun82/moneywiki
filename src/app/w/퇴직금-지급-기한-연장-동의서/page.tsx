...
const CHECK_ITEMS = [
  { id: "c1", label: "회사가 퇴직금 지급 기한 연장 동의서를 써달라고 해요" },
  { id: "c2", label: "동의서에 서명해야 하는지 모르겠어요" },
  { id: "c3", label: "동의서 서명 후 지연이자를 받을 수 있는지 궁금해요" },
  { id: "c4", label: "동의 없이 거부했을 때 어떻게 되는지 알고 싶어요" },
];
...
const STEPS = [
  {
    title: "동의서 내용 꼼꼼히 확인",
    desc: "지급기한 연장 동의서에 서명 전 ①연장 기간이 명시됐는지 ②지연이자 포기 조항이 없는지 ③지급 보장 방법이 적혀 있는지를 확인하세요. 지연이자 포기 문구가 있으면 서명하는 순간 이자를 받을 수 없어요.",
    tip: "동의서는 수정 요청이 가능해요 — 불리한 조항은 삭제 요청하세요",
  },
  {
    title: "동의 여부 결정",
    desc: "동의는 강요가 아닌 자발적 합의여야 해요. 합리적인 연장 기간(14~30일)이고 지연이자 포기 조항이 없다면 동의할 수 있어요. 반대로 기간이 너무 길거나 이자 포기 조항이 있으면 거부하세요.",
    tip: "거부하더라도 회사는 나쁘게 대우할 수 없어요 — 근로기준법으로 보호받아요",
  },
  {
    title: "동의 없이 거부 시 대응",
    desc: "거부하면 14일 초과분부터 자동으로 지연이자(연 20%)가 발생해요. 회사에 퇴직금과 지연이자를 포함한 청구서를 발송하고, 응하지 않으면 노동청 진정을 내세요.",
  ...
  },
  {
    ...
    tip: "동의서에 서명했어도 지급이 안 되면 즉시 신고할 수 있어요",
  },
];
...
const FAQS = [
  ...
  },
  {
    ...
    a: "서명하면 이자를 받기 어려워져요. 포기 조항 삭제를 요청하거나, 삭제 안 되면 서명하지 않고 노동청에 진정을 내는 게 유리해요.",
  },
  {
    q: "동의서를 썼는데 연장 기한도 지났어요",
    a: "다시 지연이자가 발생해요. 연장된 기한 초과분에 대해 연 20% 이자를 청구할 수 있고, 노동청에 다시 신고할 수 있어요.",
  },
  {
    q: "동의서에 서명한 뒤 마음이 바뀌었어요",
    a: "사후에 취소하기는 어려워요. 단, 강요·사기·착오로 서명한 경우엔 무효를 주장할 수 있어요. 세부 사항은 노무사나 법률구조공단(132)에 상담하세요.",
  },
  {
  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        지급기한 연장 동의서에 서명하기 전에 <strong>지연이자 포기 조항</strong>이 없는지 반드시 확인해야 해요.
      ...
      <p style={body}>
        ...
        이것들이 없거나 이자 포기 조항이 있다면 서명하지 말고 노동청에 신고하는 게 유리해요.
      </p>
      ...
      <EligibilityChecker
        items={CHECK_ITEMS}
        allMatchText="동의서 검토가 필요해요. 아래 계산기로 연장 기간 지연이자를 먼저 확인하세요."
      ...
      <GreenBox title="서명 전에 이자 포기 조항을 꼭 확인하세요">
        아무 생각 없이 서명하면 수십만 원 이자를 포기할 수 있어요.<br />
        포기 조항이 있으면 삭제를 요청하거나 서명하지 마세요.
      </GreenBox>
