...
const CHECK_ITEMS = [
  ...
  { id: "c3", label: "IRP 계좌를 퇴직 전에 개설했어요" },
  { id: "c4", label: "IRP 계좌번호를 회사 인사팀에 전달했어요" },
];
...
const DOCS = [
  ...
  { name: "퇴직소득원천징수영수증", required: false, where: "회사 발급 — 세금 내역 확인용" },
];

const STEPS = [
  {
    title: "사직서 제출 — 퇴직일 확정",
    desc: "퇴직일을 명확히 적은 사직서를 인사팀 또는 직속 상관에게 제출해요. 이 날짜가 14일 지급 기한의 기산점이 돼요. 구두 통보만 하면 나중에 퇴직일 자체가 분쟁 대상이 될 수 있어요.",
    tip: "서면·이메일로 전달해서 기록을 남겨두세요. 퇴직일 다음날부터 14일 카운트가 시작돼요",
  },
  {
    title: "IRP 계좌 개설",
    desc: "퇴직금이 300만원을 초과하면 IRP(개인형 퇴직연금) 계좌로만 받을 수 있어요. 2022년부터 의무화된 규정이에요. 은행·증권사·보험사 어디서든 모바일 앱으로 10분이면 개설돼요. 계좌 개설은 무료예요.",
    tip: "55세 이상이거나 퇴직금 300만원 이하면 일반 계좌 수령 가능해요",
    link: { label: "IRP 계좌 개설 방법 보기", href: "/w/퇴직금-통장" },
  },
  {
    title: "IRP 계좌번호 인사팀에 통보",
    desc: "개설한 IRP 계좌번호를 회사 인사팀에 전달해요. 이 정보가 없으면 회사가 퇴직금을 송금하지 못해요. 퇴직일 전에 미리 전달하면 처리가 빨라지고, 14일 기한을 여유 있게 맞출 수 있어요.",
    tip: "문자·이메일로 전달해서 전달 시각 기록을 남겨두세요. 분쟁 시 증거가 돼요",
  },
  {
    title: "퇴직일로부터 14일 이내 IRP 입금 확인",
    desc: "퇴직일 다음 날부터 14일 이내에 IRP 계좌에 입금됐는지 확인해요. 14일이 지나도 입금이 없으면 먼저 인사팀에 서면으로 지급을 요청하세요. 그래도 미지급이면 고용노동부 고객상담센터(☎1350)나 민원마당에 임금체불 진정을 넣으면 돼요.",
    tip: "14일 초과 시 연 20% 지연이자가 자동 발생해요. 지급 기한을 넘기면 회사에 이자까지 청구할 수 있어요",
    link: { label: "퇴직금 지급 기한 14일 원칙 보기", href: "/w/퇴직금-지급-기한" },
  },
  {
    title: "퇴직소득원천징수영수증 수령 및 세금 확인",
    desc: "회사는 퇴직금 지급 시 퇴직소득세를 원천징수하고 영수증을 발급해요. 영수증으로 세금 계산이 맞는지 확인하세요. 오류가 있으면 회사에 정정 요청, 그래도 안 되면 세무서에 경정청구를 낼 수 있어요.",
...
const CHECKLIST = [
  ...
  "14일 이내 IRP 입금 확인: 미입금 시 서면 지급 요청",
  "퇴직소득원천징수영수증 수령: 세금 내역 직접 확인",
...
const FAQS = [
  {
    ...
    a: "법적으로 퇴직일 다음 날부터 14일 이내에 지급해야 해요. 회사가 급여일에 맞춰 처리하기도 하지만, 14일이 법정 상한선이에요. 14일이 지나면 연 20% 지연이자가 자동으로 발생해요.",
  },
  {
    q: "IRP 계좌가 없으면 퇴직금을 못 받나요?",
    a: "55세 이상이거나 퇴직금이 300만원 이하라면 일반 계좌로 받을 수 있어요. 그 외에는 IRP가 반드시 필요해요. 퇴직 전에 개설해두지 않으면 지급이 늦어질 수 있으니, 퇴직일 결정 후 바로 개설하세요.",
  },
  {
    q: "회사가 IRP 계좌를 안 받겠다고 하면 어떻게 하나요?",
    a: "근로자퇴직급여보장법상 퇴직금 300만원 초과 시 IRP 입금이 의무예요. 회사가 거부하면 고용노동부 고객상담센터(☎1350)에 신고할 수 있어요. 회사 입장에서도 의무 위반이에요.",
  },
  {
    q: "퇴직금 계산이 잘못된 것 같아요. 어떻게 이의신청하나요?",
    a: "퇴직소득원천징수영수증을 받아서 직접 계산해보세요. 퇴직 전 3개월 평균임금 × 근속연수가 기준이에요. 계산이 틀렸다면 인사팀에 정정 요청을 서면으로 하고, 해결이 안 되면 고용노동부에 진정을 낼 수 있어요.",
  },
  {
    q: "회사가 폐업해서 퇴직금을 못 받을 것 같아요.",
    a: "체당금 제도를 활용하세요. 고용노동부에서 사업주 도산 인정을 받으면 정부가 퇴직금을 대신 지급해줘요. 근로복지공단에 신청하면 되고, 최고 3년치 퇴직금까지 보장받을 수 있어요.",
  },
  {
...
const RELATED = [
  { slug: "퇴직금-지급-기한", title: "퇴직금 지급 기한 14일 원칙", description: "14일 안에 안 들어오면 지연이자까지 청구할 수 있어요." },
  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        퇴직금이 자동으로 들어오는 게 아니에요. 퇴직 전에 준비해야 할 것, 회사가 해야 할 것, 입금 확인까지 순서가 있어요.
      ...
      <p style={body}>
        ...
        IRP 계좌 개설과 계좌번호 전달이 늦으면 14일 기한 내 입금이 밀릴 수 있어요.
      ...
      <EligibilityChecker
        items={CHECK_ITEMS}
        allMatchText="퇴직금 수령 준비가 다 됐어요. 14일 이내 IRP 입금 여부만 확인하면 돼요."
        partialMatchText="아직 준비가 덜 된 부분이 있어요. 위 항목 중 빠진 것부터 처리하세요."
      />
      ...
      <p style={body}>
        ...
        월급이 큰 변화 없이 유지됐다면 아래 계산기로 대략적인 금액을 바로 확인할 수 있어요.
      </p>
      <p style={body}>
        300만원을 초과하는지 미리 파악해야 IRP 계좌 개설 여부를 결정할 수 있어요.
        1년 미만 근속이면 퇴직금 자체가 발생하지 않아요.
      </p>
      ...
      <p style={body}>
        ...
        IRP 계좌번호와 사직서가 핵심이고, 나머지는 이의신청이나 세금 확인 시 필요한 보조 서류예요.
      </p>
      <p style={body}>
      ...
      <p style={body}>
        사직서 제출부터 세금 확인까지, 단계별로 따라가면 빠짐없이 처리할 수 있어요.
        각 단계에서 기록(서면·문자·이메일)을 남겨두면 나중에 분쟁이 생겼을 때 증거가 돼요.
      </p>
