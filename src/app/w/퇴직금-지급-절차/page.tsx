...
const CHECK_ITEMS = [
  ...
  { id: "c4", label: "인사팀에 IRP 계좌번호를 전달했어요" },
];
...
const STEPS = [
  {
    title: "퇴직 의사 전달",
    desc: "사직서를 작성해 인사팀 또는 직속 상관에게 전달해요. 퇴직일을 명확히 기재해두는 게 중요해요. 이 날짜부터 14일 기한이 시작돼요.",
    tip: "구두 통보보다 서면(사직서)으로 남기는 게 분쟁 예방에 유리해요",
  },
  {
    title: "IRP 계좌 개설",
    desc: "퇴직금이 300만원을 초과하면 IRP(개인형 퇴직연금) 계좌로만 받을 수 있어요. 2022년부터 의무화됐어요. 은행·증권사·보험사 어디서든 모바일 앱으로 10분이면 개설이 끝나요.",
    tip: "55세 이상이거나 퇴직금이 300만원 이하면 일반 계좌로 받을 수 있어요",
  },
  {
    title: "회사에 계좌번호 통보",
    desc: "IRP 계좌번호를 회사 인사팀에 전달해요. 이 정보가 있어야 회사가 퇴직금을 IRP로 송금할 수 있어요. 퇴직 전에 미리 전달해두면 처리가 빨라져요.",
    tip: "계좌번호는 문자나 메일로 전달해서 기록을 남겨두세요",
  },
  {
    title: "14일 이내 IRP 입금 확인",
    desc: "퇴직일로부터 14일 이내에 IRP 계좌에 입금이 됐는지 확인하세요. 14일이 지나도 입금이 없으면 회사에 서면으로 지급을 요청하고, 그래도 안 되면 고용노동부에 임금체불 진정을 넣으면 돼요.",
    tip: "14일이 지나면 연 20% 지연이자가 발생해요",
  },
];
...
const FAQS = [
  {
    ...
    a: "법적으로 퇴사일로부터 14일 이내에 지급해야 해요. 대부분의 회사는 급여일에 맞춰 처리하기도 하지만, 14일이 법정 기한이에요.",
  },
  {
  ...
  },
  {
    ...
    a: "퇴직소득원천징수영수증을 받아서 직접 확인해보세요. 계산이 틀렸다면 회사에 정정을 요청하고, 안 되면 고용노동부에 진정을 낼 수 있어요.",
  },
  {
    q: "회사가 폐업해서 퇴직금 절차가 막혔을 때는?",
    a: "체당금 제도를 활용하세요. 고용노동부에 도산 인정을 받으면 정부가 퇴직금을 대신 지급해줘요. 근로복지공단에 신청하면 돼요.",
  },
];
...
const REFERENCES = [
  {
    category: "법령",
    items: [
      { label: "근로자퇴직급여보장법: 퇴직금 지급 절차 및 기한", url: "https://www.law.go.kr/법령/근로자퇴직급여보장법" },
...
const RELATED = [
  { slug: "퇴직금-지급-기한", title: "퇴직금 지급 기한 14일 원칙", description: "14일 안에 안 들어오면 지연이자까지 청구 가능해요." },
  { slug: "퇴직금-통장", title: "퇴직금 IRP 계좌 활용", description: "IRP 계좌가 왜 필요한지, 어디서 만드는지 정리했어요." },
  { slug: "퇴직금-지급-청구-방법", title: "퇴직금 지급 청구 방법", description: "퇴직금을 직접 청구하는 방법을 안내해요." },
];
  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        ...
        퇴직자 본인이 준비해야 할 것도 있어요. 2022년부터 퇴직금 300만원 초과 시
        <a href="/w/퇴직금-통장" style={{ color: "#1D9E75", textDecoration: "underline" }}>IRP 계좌</a>로만
        수령이 의무화됐어요.
        <a href="https://www.law.go.kr/법령/근로자퇴직급여보장법" style={{ color: "#1D9E75", textDecoration: "underline" }}>근로자퇴직급여보장법</a>에
      ...
      <p style={body}>
        ...
        퇴직 전에 미리 준비해두면 불필요한 분쟁을 막을 수 있어요.
      </p>

      <GreenBox title="퇴직금 지급 절차 핵심">
        ① 사직서 제출 → ② IRP 계좌 개설 → ③ 계좌번호 인사팀 전달<br />
        → ④ 퇴직일로부터 14일 이내 IRP 입금 확인<br />
        ※ 300만원 초과 시 IRP 계좌 필수 (2022년부터 의무화)
      </GreenBox>
      ...
      <Calculator
        ...
        note="※ 근로자퇴직급여보장법 기준. 정확한 금액은 퇴직 전 3개월 평균임금 기준으로 계산해요."
      />
      ...
      <GreenBox title="300만원 초과 퇴직금은 IRP로만 수령 가능해요">
        2022년부터 퇴직금 300만원 초과 시 IRP 계좌로만 받을 수 있어요.<br />
        IRP로 받으면 퇴직소득세가 유예되고, 퇴직금 전액이 그대로 입금돼요.<br />
