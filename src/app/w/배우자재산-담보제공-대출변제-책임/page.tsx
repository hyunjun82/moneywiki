...
// Q1. 배우자재산 담보제공 대출변제 책임 관련 정보가 필요한 상황
...
const FAQS = [
  { q: "남편 빚인데 왜 제 집을 팔려고 하나요?", a: "부인이 본인 명의 부동산을 담보로 제공했다면 남편이 빚을 갚지 못할 때 담보권이 실행되어 매각될 수 있어요." },
  { q: "담보 제공을 동의 없이 했다면요?", a: "배우자가 동의 없이 부동산에 근저당권을 설정했다면 무효를 주장할 수 있어요. 등기부등본과 근저당권설정계약서를 확인하세요." },
  { q: "물적 담보 제공자는 얼마까지 책임지나요?", a: "담보로 제공한 재산의 가액 범위 내에서만 책임져요. 담보 가치가 3억원이면 3억원까지만 책임지고 나머지는 책임 없어요." }
];
  ...
  return (
    <ArticleLayout>
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        남편 빚인데 왜 제 부동산을 매각하려고 하나요? 배우자 재산을 담보로 제공한 경우 대출 변제 책임과 권리를 알아봐요.
      </p>
      <Divider />
