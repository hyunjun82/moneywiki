...
// Q1. 계약서에 '프리랜서'나 '위탁계약'이라고 쓰여 있는데 회사 지시를 받으며 고정급을 받았고, 퇴직 후 퇴직금을 받지 못한 상황이다.
// Q2. 근로자성을 입증해서 고용노동청에 진정을 넣거나 소액심판을 제기해 퇴직금을 받는다.
// Q3. 근로자성 4가지 판단 기준(지시·감독, 고정급, 시간·장소 통제, 전속성), 증거 수집 방법, 고용노동청 진정 절차, 소멸시효 3년.
// Q4. EligibilityChecker(근로자성 자가 체크) + Calculator(퇴직금 추정) + Steps(청구 절차) + DocTable(서류) + Checklist(행동)
//
// MAP:
// - Q1 → 서론 톤: 계약서 명칭이 아닌 실제 형태 강조
// - Q2 → H2 순서: 근로자성 판단 → 퇴직금 계산 → 서류 → 청구 절차 → 체크리스트
// - Q3 → H2 개수/깊이: 5개 섹션, 각 판단 기준 구체적으로 서술
// - Q4 → 컴포넌트 배치: EligibilityChecker, Calculator, DocTable, Steps, Checklist
...
const STEPS = [
  {
    title: "근로자성 자가 판단",
    desc: "근로자 여부는 4가지로 판단해요. ① 업무 지시·감독, ② 고정급 지급, ③ 시간·장소 통제, ④ 전속성(다른 곳 일 못 함). 이 중 3가지 이상 해당되면 근로자로 인정받을 가능성이 높죠. 계약서 명칭은 관계없어요.",
    tip: "대법원도 계약서 이름보다 실제 업무 형태를 우선시해요",
  },
  {
    title: "증거 수집",
    desc: "업무 지시 메시지·이메일 캡처, 교육·회의 참석 내역, 고정급 통장 입금 내역을 모아요. 출근·퇴근 시간이 정해진 사실을 보여주는 메시지가 특히 유리해요. 증거가 많을수록 인정 가능성이 올라가요.",
    tip: "통장 거래내역에서 매달 고정금액 입금 패턴이 핵심 증거가 돼요",
  },
  {
    title: "고용노동청 진정 제기",
    desc: "관할 고용노동청에 임금 체불 진정을 내요. 고용24(work.go.kr) 온라인 신청 또는 방문 신청 모두 가능해요. 진정 비용은 무료고, 근로감독관이 조사 후 퇴직금 지급 명령을 내릴 수 있죠.",
    tip: "고용노동부 1350에 전화 상담 먼저 하면 신청 방법을 안내받을 수 있죠",
    link: { label: "고용24 진정 신청", href: "https://www.work.go.kr" },
  },
  {
    title: "소액심판 또는 민사소송",
    desc: "회사가 근로자성을 인정하지 않거나 지급을 거부하면 법원에 소액심판(청구액 3,000만원 이하)을 제기해요. 법원은 계약서가 아닌 실제 업무 형태를 보고 판단해요. 근로자성이 인정되면 퇴직금에 연 20% 지연이자까지 받을 수 있죠.",
    tip: "대한법률구조공단(132)에서 무료 법률 지원을 받을 수 있죠",
  },
];
...
const FAQS = [
  {
    ...
    a: "계약서 명칭이 아니라 실제 근무 형태가 기준이에요. 회사의 지시·감독을 받고 고정급을 받았다면 근로자로 인정될 수 있죠. 대법원도 계약 형식보다 실질적인 종속 관계를 우선시해요.",
  },
  {
    q: "방문판매원은 근로자로 인정받기 어렵나요?",
    a: "업무 형태에 따라 달라요. 지역별 담당 구역이 정해지거나, 출근 시간이 고정되거나, 매달 고정급을 받았다면 근로자성을 주장할 수 있죠. 성과와 무관한 고정 수입이 있다면 특히 유리해요.",
  },
  {
    q: "근로자성 판단에서 가장 중요한 기준은 뭔가요?",
    a: "사용자의 지시·감독 여부가 핵심이에요. 회사가 업무 내용을 정해주고 방식을 통제했다면 이게 가장 강력한 근거가 돼요. 고정급·시간 통제·전속성도 함께 살펴봐요.",
  },
  {
    q: "고용노동청 진정과 소액심판 중 뭐가 더 빠른가요?",
    a: "고용노동청 진정이 더 빠르고 비용이 없어요. 다만 회사가 근로자성을 인정하지 않으면 강제 이행이 어려울 수 있죠. 그때는 법원 소액심판이 실질적인 해결 방법이에요.",
  },
  {
    q: "퇴직한 지 2년이 지났는데 청구할 수 있나요?",
    a: "퇴직금 청구권의 소멸시효는 퇴직일로부터 3년이에요. 2년이 지났다면 아직 청구 가능해요. 단 소멸시효가 임박했다면 빠르게 고용노동청 진정이나 법원 소송을 진행하세요.",
  },
  {
    q: "회사가 세금신고를 사업소득으로 했는데도 퇴직금을 받을 수 있나요?",
    a: "받을 수 있죠. 세금 처리 방식은 근로자성 판단의 절대 기준이 아니에요. 실제 업무 형태가 근로자에 해당하면 사업소득 처리를 해도 퇴직금 청구가 가능해요.",
  },
];
  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        계약서에 '프리랜서' 또는 '위탁계약'이라고 쓰여 있어도, 실제로 회사의 지시를 받고 고정급을 받았다면 <a href="/w/퇴직금-수령방법" style={{ color: "#1D9E75", textDecoration: "underline" }}>퇴직금</a>을 청구할 수 있죠.
      ...
      <p style={body}>
        ...
        이런 형태라면 <a href="/w/퇴직금-조건" style={{ color: "#1D9E75", textDecoration: "underline" }}>퇴직금 조건</a>을 충족한 근로자로 주장할 수 있죠.
      ...
      <EligibilityChecker
        items={CHECK_ITEMS}
        allMatchText="근로자성 인정 가능성이 높아요. 아래 계산기로 예상 퇴직금을 살펴보고 청구를 진행해보세요."
        partialMatchText="일부 조건이 해당될 수 있죠. 고용노동부(1350) 상담을 먼저 받아보세요."
      />
      ...
      <p style={body}>
        ...
        1년 근속당 1개월치 평균 임금이 퇴직금으로 나오고, 회사가 14일 이상 지급을 미루면 연 20% 지연이자도 청구할 수 있죠.
        슬라이더로 월 수입과 근무 기간을 입력하면 예상 금액을 바로 볼 수 있죠.
      </p>
      ...
      <p style={body}>
        ...
        계약서가 위탁계약이어도 실제 업무 형태를 드러내는 증거가 충분하면 돼요.
      ...
      <p style={body}>
        ...
        회사가 버티더라도 법원 소액심판으로 강제 집행까지 이어갈 수 있죠.
      </p>
      ...
      <GreenBox>
        ...
        업무 지시를 받고 고정급을 받았다면 근로자로 인정받을 수 있죠.
      </GreenBox>
