...
const FAQS = [
  { q: "연말정산 대학생에 대해 자세히 알 수 있나요?", a: "이 글에서 핵심 내용을 정리했어요. 아래 내용을 참고하세요." },
...
const RELATED = [
  { slug: "연말정산-인적공제", title: "- title: 연말정산 인적공제", description: "" },
  { slug: "연말정산-gyoyugbi-seaekgongje", title: "연말정산 교육비 세액공제", description: "" },
  { slug: "연말정산-janyeo-seaekgongje", title: "연말정산 자녀 세액공제", description: "" }
];
...
export default function Page() {
  return (
    <ArticleLayout>
      ...
      <h1 style={{ fontSize: 26, fontWeight: 700, lineHeight: 1.45, marginBottom: 14 }}>연말정산 대학생</h1>
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>""대학생 자녀가 있으면 연말정산에서 어떤 공제를 받을 수 있어요?""</p>
      <p style={body}>대학생 자녀는 만 20세 이하면 인적공제받고, 등록금은 교육비 세액공제 대상이에요. 아르바이트 소득이 100만원 넘으면 공제 못 받아요.</p>
      <Divider /><ArticleAd position="intro" />
      <H2>핵심 정리</H2>
      <GreenBox title="요약">"· 만 20세 이하 대학생은 인적공제 대상이에요.\\n· 등록금은 연간 900만원까지 15% 세액공제받아요.\\n· 아르바이트 소득 100만원 넘으면 인적공제 못 받아요."</GreenBox>
