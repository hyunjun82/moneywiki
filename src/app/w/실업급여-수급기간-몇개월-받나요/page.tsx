...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={body}>
        수급기간이 30일 차이 나면 돈으로 약 204만원이에요. 2026년 1일 상한액 68,100원을 기준으로 계산한 금액이죠.
      ...
      <p style={body}>
        ...
        이직확인서가 나왔으면 워크넷에 구직등록을 하고, 수급자격 교육(온라인으로 가능)을 이수한 뒤 관할 고용센터에 실업급여를 신청하면 돼요.
      </p>
      <p style={body}>
