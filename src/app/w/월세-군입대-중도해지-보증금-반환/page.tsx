...
// Q1. 월세 군입대 중도해지 보증금 반환 관련 정보가 필요한 상황
...
const FAQS = [
  { q: "군입대 때문에 월세 중도해지할 수 있나요?", a: "법적으로는 집주인 동의가 필요해요. 군입대는 법정 해지 사유가 아니라서 일방적으로 해지할 수 없어요." },
  { q: "중도해지하면 보증금 언제 받나요?", a: "집주인과 합의하면 바로 받을 수 있어요. 합의 없이 나가면 원래 계약기간 만료 전까지 못 받을 수도 있어요." },
  { q: "대체 임차인을 구하면 보증금 받을 수 있나요?", a: "네, 가능해요. 다음 세입자를 구해서 집주인이 동의하면 보증금을 바로 받을 수 있어요." }
];
  ...
  return (
    <ArticleLayout>
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        월세 계약기간 중에 군대 가게 됐어요. 중도해지하고 보증금 돌려받을 수 있는지 알려드려요
      </p>
      <Divider />
