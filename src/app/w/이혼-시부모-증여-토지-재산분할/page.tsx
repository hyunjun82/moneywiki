...
const FAQS = [
  { urgent: true, q: "시부모가 증여해준 부동산은 재산분할 대상인가요?", a: "원칙적으로 혼인 중 일방이 상속·증여로 받은 재산은 특유재산으로 재산분할 대상이 아니에요. 하지만 혼인 기간이 길고, 배우자가 그 재산의 유지·증식에 기여했다면 재산분할 대상이 될 수 있어요. 실무상 혼인 10년 이상이면 특유재산도 분할 대상에 포함되는 경향이 있어요." },
  { urgent: true, q: "내가 부모님께 받은 토지도 상대방이 분할해달라고 할 수 있나요?", a: "같은 원리예요. 내가 혼인 중 부모님께 증여받은 토지도 원칙적으로 특유재산이에요. 상대방이 그 토지 관리·개발에 기여했다는 것을 입증하지 못하면 재산분할 대상에서 제외돼요. 증여 사실을 입증하는 서류(증여계약서, 등기부등본 취득원인)를 보관해두세요." },
  { urgent: false, q: "혼인 전에 가져온 재산도 재산분할 대상인가요?", a: "혼인 전 개인 재산은 특유재산으로 원칙적으로 분할 대상이 아니에요. 단, 혼인 기간 중 가치가 증가했고 배우자의 기여가 있었다면 그 증가분만 대상이 될 수 있어요. 혼인 전 취득을 입증하는 등기부등본 취득 날짜를 확인해두세요." },
  { urgent: false, q: "부모 돈으로 산 집인데 내 명의예요. 재산분할 대상인가요?", a: "내 명의로 된 집이라도 부모가 자금을 댔다면 '명의신탁' 또는 '특유재산'이라고 주장할 수 있어요. 하지만 입증하지 못하면 공동재산으로 분할 대상이 될 수 있어요. 부모님 자금 출처를 입증하는 계좌 이체 내역이나 차용증을 보관해두는 게 중요해요." },
];
  ...
  return (
    <div style={{ maxWidth: 1060, margin: "0 auto", padding: "2rem 1.5rem", fontFamily: "'Pretendard', 'Apple SD Gothic Neo', sans-serif", color: "#111", display: "flex", gap: 28, alignItems: "flex-start" }}>
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <p style={{ fontSize: 13, color: G, fontWeight: 600, marginBottom: 10 }}>이혼 · 재산분할 · 특유재산</p>
        <h1 style={{ fontSize: 26, fontWeight: 700, lineHeight: 1.45, marginBottom: 14 }}>
          이혼할 때 시부모 증여 토지도 |<br />
          재산분할이 되나요
        </h1>
        <p style={{ ...body, fontSize: 15 }}>이혼 재산분할에서 가장 많이 다투는 부분 중 하나예요. 부모님이 혼인 중에 증여해준 토지나 아파트가 재산분할 대상인지 아닌지 법원이 어떻게 판단하는지 정리했어요. 원칙은 '특유재산은 분할 대상 아님'이지만 예외가 많아요.</p>
        <HubLinks />
        <H2>특유재산이란 뭘까</H2>
        <p style={body}>특유재산은 혼인 중에 취득했지만 특정 사람의 개인 재산으로 인정되는 거예요. 가장 흔한 특유재산은 상속이나 증여로 받은 거죠. 예를 들어 배우자 부모가 혼인 중에 아들·딸에게 준 토지나 집은 원칙적으로 특유재산이에요.</p>
        <p style={body}>특유재산의 핵심은 '혼인 기간 중에 누가 그 재산을 취득했는가'가 아니라 '혼인 기간 중에 그 재산의 관리나 증식에 배우자가 기여했는가'예요. 만약 시부모가 아들에게 증여한 토지를 딸이 전혀 손도 안 대고 있었다면 재산분할 대상이 될 수 없어요. 하지만 그 토지에 함께 집을 지었거나, 그 토지에서 나는 소득을 함께 생활비로 썼다면 얘기가 달라져요.</p>
        <H2>특유재산도 재산분할 대상이 될 수 있는 경우</H2>
        <p style={body}>법원은 특유재산이라도 '혼인 기간이 길고 배우자의 기여가 크다'면 재산분할 대상에 포함시켜요. 실무상 기준은 혼인 기간인데, 보통 혼인 10년 이상이면 특유재산도 분할 대상으로 다루는 경향이 있어요. 당신이 시부모 증여 토지를 받았지만 그동안 배우자가 아이 양육, 집안일, 그 토지 관리에 힘써왔다면 재산분할 대상이 될 수 있다는 거죠.</p>
        <p style={body}>법원이 특유재산의 가치 증가에 기여도를 판단하는 기준도 중요해요. 토지를 받았을 당시의 가격과 이혼할 때의 가격이 얼마나 달랐는지, 그 기간 동안 배우자가 어떻게 참여했는지를 봐요. 단순히 '함께 살면서 가치가 올랐다'는 것만으로는 부족하고, 구체적인 기여(투자, 관리, 개발)를 입증해야 해요.</p>
        <H2>특유재산 입증 자료 준비하는 방법</H2>
        <p style={body}>특유재산임을 입증하려면 서류가 중요해요. 가장 핵심 자료는 증여계약서예요. 부모가 자식에게 준 것이 분명하다면 증여계약서, 아니면 통장 기록이라도 있어야 해요. 등기부등본도 확인해서 '취득 원인'을 봐야 해요. 등기부등본의 '취득 원인'에 '증여'라고 명시되면 그것이 가장 강력한 증거가 돼요.</p>
        <p style={body}>토지나 부동산의 경우 부모님이 자금을 댔다는 것을 입증하는 계좌 이체 내역도 보관해두세요. 예를 들어 집을 지으면서 부모님이 공사비를 직접 이체했다면 그 기록이 남아있어야 해요. 차용증(돈을 빌린 게 아니라 받은 거라는 증거)도 도움이 돼요. 혼인 전에 받은 자산의 경우 혼인 전 취득을 증명하는 등기부등본 날짜 확인이 필수예요.</p>
        <H2>이혼할 때 시부모 증여 토지도 — 자주 묻는 것들</H2>
        <FAQ />
