...
const CHECK_ITEMS = [
  ...
  { id: "c2", label: "재직 중이거나 퇴직할 때 서명했어요" },
  { id: "c3", label: "퇴직금을 한 푼도 받지 못했어요" },
...
const STEPS = [
  {
    title: "포기각서 무효 확인",
    desc: "근로자퇴직급여보장법 제9조는 강행법규라 포기 약정 자체가 무효예요. 서명한 날짜와 실제 퇴직금 수령 여부를 정리해두세요. 각서 사본이 있다면 오히려 유리한 증거가 돼요.",
    tip: "받지도 않고 쓴 포기각서 = 무효. 받은 뒤 쓴 영수확인서 = 유효. 이 차이가 핵심이에요",
  },
  {
    title: "증빙 서류 수집",
    desc: "근로계약서, 급여명세서, 4대보험 가입이력을 준비해요. 입사일과 퇴직일이 명확히 보여야 해요. 4대보험 가입이력은 국민건강보험공단 홈페이지에서 무료로 출력할 수 있어요.",
    tip: "회사 퇴직 전에 미리 챙겨두는 게 훨씬 편해요",
    link: { label: "4대보험 가입이력 조회", href: "https://www.nhis.or.kr" },
  },
  {
    title: "내용증명 발송",
    desc: "'포기각서는 강행법규 위반으로 무효이며, 퇴직금 ○○만원을 청구합니다'라는 내용으로 내용증명을 보내요. 소멸시효를 6개월 중단하는 효과가 생겨서 청구 기한을 늦출 수 있어요. 우체국 내용증명 서비스를 이용하면 돼요.",
    tip: "발송일 기준 소멸시효 중단 — 시효 만료 직전이어도 내용증명 먼저 보내세요",
    link: { label: "우체국 내용증명 안내", href: "https://www.epost.go.kr" },
  },
  {
    title: "고용노동부 진정 접수",
    desc: "회사가 거부하면 고용노동부 임금체불 진정을 접수해요. 민원마당(minwon.moel.go.kr)에서 온라인으로 신청할 수 있어요. 근로감독관이 직접 사업주를 조사해요. 소멸시효 3년 이내면 이미 퇴직한 뒤에도 청구 가능해요.",
...
const FAQS = [
  {
    ...
    a: "못 받는 게 아니에요. 근로자퇴직급여보장법은 강행법규라 근로자가 서명한 포기 약정 자체가 무효예요. 서명 여부와 상관없이 퇴직금 청구권은 그대로 살아있어요.",
  },
  {
    q: "포기각서와 퇴직금 영수증은 어떻게 다른가요?",
    a: "결정적 차이는 돈이 먼저냐, 각서가 먼저냐예요. 퇴직금을 실제로 받은 뒤 서명한 영수확인서는 유효해요. 반면 한 푼도 받지 않은 상태에서 '받지 않겠다'고 쓴 각서는 무효예요.",
  },
  {
    q: "회사가 포기각서 서명을 강요하면 어떻게 하나요?",
    a: "서명을 거부할 수 있어요. 강요 자체가 위법이라 고용노동부에 신고할 수 있어요. 이미 서명했더라도 나중에 청구 가능하니 서명했다고 포기하지 않아도 돼요.",
  },
  {
    q: "퇴직 후 3년이 지났는데 청구할 수 있나요?",
    a: "소멸시효 3년이 지나면 청구권이 소멸돼요. 퇴직일 기준 3년 이내라면 가능해요. 시효 만료가 얼마 남지 않았다면 내용증명을 먼저 보내 소멸시효를 중단시켜야 해요.",
  },
  {
    q: "퇴직 후에 쓴 합의서도 무효인가요?",
    a: "퇴직 전 합의서는 무조건 무효예요. 퇴직 후에 작성한 합의서는 상황에 따라 달라요. 퇴직 후 자유로운 상태에서 적법하게 합의한 경우라면 효력이 인정될 수 있어요.",
  },
  {
  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        ...
        회사가 각서를 내밀어도 서명할 의무가 없고, 이미 서명했어도 청구권은 그대로 살아있어요.
        소멸시효 3년 안에 청구하면 퇴직금 전액과 지연이자까지 받을 수 있어요.
      </p>
      ...
      <p style={body}>
        ...
        이 법은 강행법규로, 근로자와 사용자가 서로 합의해도 법이 정한 기준을 낮출 수 없어요.
        포기각서는 "나는 퇴직금을 받지 않겠다"는 약속이지만, 강행법규 아래에서는 이런 약속 자체가 효력이 없어요.
      </p>
      <p style={body}>
        근로기준법 제15조도 같은 원칙이에요. 법이 정한 기준에 미치지 못하는 근로조건은 그 부분이 무효라고 명시하고 있어요.
      ...
      <EligibilityChecker
        items={CHECK_ITEMS}
        allMatchText="퇴직금 청구가 가능한 상황이에요. 포기각서는 법적으로 무효라 아래 계산기로 예상 금액을 확인해보세요."
      ...
      <p style={body}>
        포기각서가 무효라면 퇴직금 전액을 청구할 수 있어요.
        퇴직금은 평균임금 × 30일 × 근속연수로 계산해요.
        지급기한인 14일을 넘기면 연 20% <a href="/w/퇴직금-지연이자" style={{ color: "#1D9E75", textDecoration: "underline" }}>지연이자</a>도 자동으로 붙어요.
      </p>
      <p style={body}>
        지연이자는 회사가 퇴직금을 주지 않는 기간만큼 쌓여요.
        미지급 기간이 길수록 청구 금액이 커지기 때문에, 소멸시효 만료 전에 빠르게 움직이는 게 유리해요.
      </p>
      ...
      <p style={body}>
        4대보험 가입이력은 국민건강보험공단 홈페이지에서 무료로 출력할 수 있어요.
        회사를 떠나기 전에 미리 챙겨두면 나중에 훨씬 편해요.
        회사가 자료 제공을 거부하면 근로감독관이 직접 확보해줄 수 있어요.
      </p>
      ...
      <p style={body}>
        ...
        <a href="/w/퇴직금-소멸시효" style={{ color: "#1D9E75", textDecoration: "underline" }}>소멸시효</a>는 퇴직일 기준 3년이에요.
        내용증명 발송부터 시작하면 소멸시효가 6개월 중단되는 효과도 생겨요.
      </p>
