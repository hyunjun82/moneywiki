...
const STEPS = [
  ...
  },
  {
    ...
    tip: "DC형은 금융기관 처리 기간이 별도로 필요해요. 미리 확인해봐요",
  },
  {
  ...
  return (
    ...
    >
      ...
      <p style={body}>
        ...
        DB형 퇴직연금은 원칙적으로 중간정산이 안 되니, 내 회사 제도 유형을 먼저 확인해봐요.
      ...
      <BorderBox title="DC형 퇴직연금이라면">
        ...
        회사 인사팀과 함께 금융기관 담당자에게 처리 절차를 먼저 확인해봐요.
      ...
      <Disclaimer text="이 글은 2026년 3월 기준 근로자퇴직급여 보장법 및 동법 시행령을 바탕으로 작성됐어요. 법정 사유나 절차는 변경될 수 있으니 최신 기준은 고용노동부(1350)에 직접 문의하세요." />
    </ArticleLayout>
  );
}
