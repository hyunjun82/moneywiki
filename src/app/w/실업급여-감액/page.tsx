...
const FAQS = [
  { q: "실업급여 받으면서 일하면 얼마나 깎여요?", a: "취업 기간에 대한 급여가 감액 또는 지급 안 돼요. 소득이 있었으면 반드시 신고해야 해요." },
  { q: "같은 회사에 또 들어가도 실업급여가 깎여요?", a: "네, 반복 수급할 때마다 최대 50%까지 급여를 줄일 수 있어요. 특히 2회 이상 수급하는 분들이 대상이에요." },
  { q: "거짓으로 취업활동 했다고 신고하면?", a: "부정수급으로 적발되면 받은 급여를 모두 돌려줘야 해요. 연 20% 지연이자도 붙어요." }
];
  ...
  return (
    <ArticleLayout>
      ...
      <h1 style={{ fontSize: 26, fontWeight: 700, lineHeight: 1.45, marginBottom: 14 }}>
        실업급여 감액 사유: 부정수급과 취업<br />
        거부 시 급여 삭감 기준
      </h1>
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        실업급여가 줄어들 수 있다는데 불안하시죠? 감액되는 경우와 삭감 비율을 정리해드려요.
      </p>
      <Divider />
