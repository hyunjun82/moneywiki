...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={body}>
        문제는 회사가 &lsquo;자발적 퇴사&rsquo;나 &lsquo;개인 사유&rsquo;로 기재하는 경우예요. 이렇게 되면 고용센터에서 비자발적 퇴사로 인정해주지 않을 수 있죠. 퇴사 전에 이직확인서에 뭐라고 적히는지 반드시 회사와 확인해두세요. 이 한 줄이 수백만 원의 차이를 만들어요.
      </p>
      ...
      <p style={body}>
        이럴 땐 <strong>고용센터에 이의신청</strong>을 하면 돼요. 담당자가 회사에 확인 전화를 하고 사실관계를 조사하죠. 이때 <strong>증빙자료</strong>가 승패를 갈라요. 회사가 퇴직을 권유한 문자, 이메일, 면담 녹음이 있으면 유리한데, 본인이 직접 녹음한 건 합법이에요.
      </p>
      <p style={body}>
      ...
      <p style={body}>
        둘의 차이를 명확히 알아야 서류를 제대로 챙길 수 있어요. 권고사직은 회사가 퇴직을 <strong>권유</strong>하고 근로자가 <strong>동의</strong>해서 나가는 거예요. 해고는 회사가 <strong>일방적으로</strong> 근로관계를 끊는 거죠. 실업급여 관점에서 보면 둘 다 비자발적 퇴사이기 때문에 수급 대상이에요. 단, 횡령이나 무단결근 같은 중대 귀책사유로 해고된 경우는 제한될 수 있고요.
      </p>
      <p style={body}>
        실전에서 가장 조심해야 할 건 <strong>사직서</strong>예요. 권고사직에 동의하면서 사직서를 쓸 때 &lsquo;일신상의 사유&rsquo;라고 적으면 자발적 퇴사로 보일 수 있죠. &lsquo;회사 권고에 의한 퇴직&rsquo;이라고 명시하거나, 아예 사직서 대신 <strong>권고사직 동의서</strong>를 받으세요. 이 한 줄이 실업급여 수급 여부를 갈라요.
      </p>
      <p style={body}>
