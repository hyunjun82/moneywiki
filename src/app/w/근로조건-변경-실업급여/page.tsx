...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={body}>
        임금 삭감이 가장 흔한 사유예요. <strong>월급이 20% 이상 줄어들면</strong> 정당한 퇴사 사유로 인정되죠. 300만 원 받던 사람이 240만 원으로 깎이면 정확히 20% 삭감이에요. 이 경우 본인이 먼저 퇴사하더라도 실업급여 신청이 가능하죠.
      </p>
      <p style={body}>
      ...
      <p style={body}>
        근무지 변경은 <strong>통근이 불가능한 수준</strong>이어야 인정돼요. 서울에서 일하던 사람이 부산 지사로 발령받으면 당연히 해당되죠. 왕복 출퇴근 3시간 이상이 기준이에요. 회사가 이사비용이나 주거 지원을 제공하면 판단이 달라질 수 있지만, 아무 지원 없이 강행했다면 정당한 사유가 돼요.
      </p>
      ...
      <p style={body}>
        고용센터에 신청하면 담당자가 이직확인서와 증빙자료를 보고 수급자격을 심사해요. 만약 불인정 결정이 나오더라도 <strong>60일 이내에 이의신청</strong>이 가능하죠. 추가 증거를 첨부해서 재심사를 받으면 되고요. 퇴직 전에 <a href="https://www.ei.go.kr" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용24</a>나 고용센터(1350)에 사전 상담을 받아두면 심사 과정이 훨씬 수월해져요.
      </p>
