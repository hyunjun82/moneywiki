...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={body}>
        <a href="https://www.law.go.kr/법령/고용보험법시행규칙" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험법 시행규칙</a>이 정한 사유는 크게 7가지예요. 가장 흔한 건 <strong>임금 관련 문제</strong>죠. 월급의 30% 이상을 안 줬거나 2개월 넘게 밀렸다면 정당한 사유에 해당돼요. 최저임금에 못 미치는 급여를 받은 경우도 마찬가지고요.
      </p>
      <p style={body}>
        두 번째는 <strong>직장 내 괴롭힘과 성희롱</strong>이에요. 상사나 동료한테 지속적으로 괴롭힘을 당하거나 성희롱 피해를 입고 퇴사한 경우죠. 세 번째는 <strong>통근 곤란</strong> — 사업장 이전이나 본인 이사 때문에 출퇴근 왕복이 3시간을 넘겨버린 경우예요.
      </p>
      <p style={body}>
        네 번째는 <strong>본인 건강 문제</strong>예요. 의사 진단서로 &quot;계속 근로가 어렵다&quot;는 판단이 나와야 하죠. 다섯 번째 <strong>가족 간병</strong>은 30일 이상 직접 간병이 필요한 경우에 해당돼요. 여섯 번째 <strong>근로계약 위반</strong>은 채용 때 약속한 것과 실제 업무가 크게 다른 경우이고, 일곱 번째 <strong>사업장 법 위반</strong>은 산업안전보건법을 심각하게 어긴 사업장이 대상이에요.
      </p>
      ...
      <p style={body}>
        심사에서 불인정 결정이 나와도 길이 끝난 건 아니죠. <strong>60일 이내에 이의신청</strong>을 할 수 있죠. 추가 증거를 첨부해서 이의신청서를 제출하면 재심사를 받게 돼요. 그래도 안 되면 심사청구, 재심사청구까지 3단계의 불복 절차가 남아 있으니까요.
      </p>
