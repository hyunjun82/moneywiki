  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        대학원에 다닌다고 실업급여를 못 받는 건 아니에요.{" "}
        <a href="https://www.law.go.kr/법령/고용보험법" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험법</a>에서
        실업급여 수급 조건은 <strong>재취업 의사와 능력</strong>이죠.
        야간·주말 대학원이면 거의 문제없고, 전일제도 구직활동을 입증하면 받을 수 있어요.
        다만 대학원 수업 자체는 구직활동으로 인정되지 않아서 별도로 입사지원이나 면접이 필요해요.
      </p>
      ...
      <p style={body}>
        ...
        학교나 연구소에서 근로계약을 체결하고 급여를 받았다면, 고용보험 가입 대상이에요.
      ...
      <p style={body}>
        ...
        둘째, <strong>비자발적으로 퇴직</strong>해야 하죠. RA 계약만료, 연구과제 종료 등은 비자발적 퇴사로 인정돼요.
        셋째, <strong>재취업 의사와 능력</strong>이 있어야 해요. 이 세 번째 조건이 대학원생에게 가장 중요한 부분이에요.
      </p>
      <p style={body}>
      ...
      <GreenBox title="대학원생 실업급여 자격 요건">
        고용보험 가입 이력 (RA·TA·계약직 등) 필수<br />
        비자발적 퇴직 (계약만료, 연구과제 종료 등)<br />
      ...
      <p style={body}>
        ...
        고용센터에서도 이 점을 인정해요. 낮에 일할 수 있는 상태이니 재취업 의사와 능력이 있다고 보는 거예요.
        별도로 구직 의사를 입증할 필요가 없어요. 일반 수급자와 동일하게 처리되죠.
      </p>
      <p style={body}>
        <strong>전일제 대학원</strong>은 상황이 달라요. 평일 낮에 수업이 있으니까 고용센터에서 "낮에 일할 수 있는 건지" 확인하죠.
        입증 방법은 간단해요. 워크넷이나 채용사이트에서 <strong>실제로 입사지원한 기록</strong>을 남기면 돼요.
        면접에 참여한 기록도 강력한 증빙이에요.
        "오전 수업이 없는 날에 근무 가능하다"거나 "재택근무 가능한 일자리를 찾고 있다"고 설명하는 것도 방법이죠.
      </p>
      <p style={body}>
        대학원 시간표를 고용센터에 가져가서 취업 가능한 시간대를 보여주면 더 좋아요.
      ...
      <BorderBox title="야간 vs 전일제 대학원 비교">
        야간·주말 대학원 → 별도 입증 불필요, 일반 수급자와 동일<br />
        전일제 대학원 → 입사지원·면접 기록으로 구직 의사 입증 필요<br />
        휴학 상태 → 전일제든 야간이든 구직 의사 인정 용이
      </BorderBox>
      ...
      <p style={body}>
        ...
        학업이지 취업 준비가 아니니까요. 실업인정을 받으려면 별도로 구직활동을 해야 하죠.
      </p>
      <p style={body}>
      ...
      <p style={body}>
        실업인정 때 필요한 구직활동 횟수도 챙겨야 해요.
        1~2차 실업인정은 <strong>1회</strong>, 3차부터는 <strong>2회 이상</strong>이에요.
        대학원 수업이 아무리 바빠도 이 횟수는 반드시 채워야 실업급여가 지급되죠.
        입사지원은 온라인으로도 가능하니까 시간이 크게 들지 않아요.
      </p>
      ...
      <p style={body}>
        수급기간은 나이와 피보험기간에 따라 120일에서 270일까지 달라지죠.
        30세 미만이고 피보험기간이 1년 이상 3년 미만이면 120일이에요.
        50세 이상이고 10년 이상 가입했으면 최대 270일까지 받을 수 있고요.
        대학원생은 비교적 젊은 층이 많으니 120~150일이 일반적이에요.
      </p>
      <p style={body}>
        RA나 계약직으로 일했을 때 급여가 낮았더라도 걱정 안 해도 돼요.
        하한액(66,048원/일)이 보장되니까요.
        정확한 예상 금액은{" "}
        <a href="https://www.ei.go.kr" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용24</a>에서 모의계산을 해볼 수 있어요.
      </p>

      <GreenBox title="대학원생 실업급여 핵심 요약">
        1일 상한액 68,100원 / 하한액 66,048원 (2026년 기준)<br />
        퇴직 전 평균임금의 60%로 계산<br />
        수급기간: 나이·피보험기간에 따라 120~270일
      </GreenBox>
      ...
      <p style={body}>
        <strong>취업하면 실업급여는 바로 끝나요.</strong>
        대학원 다니면서 취업하면 그때부터 실업급여가 중단되죠.
        다만 수급일수의 절반 이상을 남기고 취업하면 <strong>조기재취업수당</strong>을 받을 수 있어요.
        남은 수급일수의 절반을 일시금으로 주는 제도이니까 꼭 챙기세요.
      </p>
      <p style={body}>
        <strong>휴학 상태면 오히려 수월해요.</strong>
        대학원을 휴학했다면 전일제든 야간이든 상관없이 구직 의사를 인정받기 쉽죠.
        학업에 시간을 쓰고 있지 않다는 게 명확하니까요.
        실업급여 수급 기간에만 휴학하는 것도 전략이에요.
      </p>
      <p style={body}>
        <strong>고용센터마다 판단이 조금씩 다를 수 있어요.</strong>
        ...
        사전 상담은 무료이고, 내 상황에서 어떤 서류를 준비해야 하는지 안내받을 수 있죠.
      </p>
