  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        실업급여를 받으려면 구직활동 횟수를 채워야 하는데, 생각보다 단순해요.{" "}
        ...
        온라인 입사지원 한 건도 구직활동으로 인정되고,{" "}
        <a href="https://www.work.go.kr" style={{ color: "#1D9E75", textDecoration: "underline" }}>워크넷</a>에서 지원하면 10분이면 끝나죠.
        직업훈련을 받고 있다면 별도 구직활동 없이 자동 인정돼요.
      </p>
      ...
      <p style={body}>
        ...
        실업인정을 받을 때 "나는 이 기간 동안 구직활동을 했다"는 걸 증명해야 해요.
        그런데 1차부터 쭉 같은 횟수가 아니에요.{" "}
      ...
      <p style={body}>
        ...
        초반에는 구직 준비 기간이 필요하니까 기준을 낮춰둔 거죠.
        이력서를 정비하고, 어떤 분야로 갈지 방향을 잡는 시간이 필요한 시기예요.
        1회면 되니까 워크넷에서 입사지원 한 건만 해도 넘어가요.
      </p>
      <p style={body}>
        그런데 <strong>4차부터는 2회 이상</strong>으로 기준이 올라가요.
        충분히 준비 기간을 가졌으니 본격적으로 구직에 나서라는 의미예요.
        4주마다 2회니까 2주에 1번꼴로 입사지원을 하면 되는 셈이죠.
        부담스러운 횟수는 아니에요.
      </p>
      ...
      <p style={body}>
        ...
        <a href="https://www.work.go.kr" style={{ color: "#1D9E75", textDecoration: "underline" }}>워크넷</a>에서
        채용공고를 찾아 지원 버튼만 누르면 되죠.
        워크넷 입사지원 기록은{" "}
        <a href="https://www.ei.go.kr" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용24</a>에 자동 연동되니까 별도로 증빙을 올릴 필요도 없어요.
        집에서 10분이면 끝나는 가장 간편한 방법이에요.
      </p>
      <p style={body}>
        사람인, 잡코리아, 인크루트 같은 <strong>민간 채용사이트</strong>에서 지원해도 인정돼요.
        다만 이 경우에는 입사지원 완료 화면을 캡처해서 고용24에 직접 올려야 하죠.
        워크넷보다 한 단계 번거롭지만, 본인이 원하는 분야의 공고가 더 많다면 충분히 활용할 만해요.
        캡처할 때 지원 일자와 회사명이 보이도록 찍는 게 포인트예요.
      </p>
      <p style={body}>
        입사지원 외에도 인정되는 활동이 꽤 있어요.
        <strong>면접</strong>을 봤다면 당연히 인정되고, <strong>채용박람회</strong> 참가도 해당되죠.
        고용센터에서 <strong>직업상담</strong>을 받거나, 고용24에서 온라인 취업특강을 수강한 것도 구직활동이에요.
        핵심은 "취업을 위한 적극적인 노력"이라는 걸 보여주면 된다는 거예요.
      </p>

      <BorderBox title="구직활동으로 인정되는 것들">
        온라인 입사지원 (워크넷 자동 연동, 사람인/잡코리아 캡처 필요)<br />
        면접 참석 (면접 확인서 또는 이메일 증빙)<br />
      ...
      <p style={body}>
        ...
        훈련에 참여하는 것 자체가 구직활동으로 인정되니까요.
        훈련 출석 기록이 고용센터 시스템에 자동으로 잡히기 때문에 따로 증빙할 것도 없죠.
        구직활동 횟수를 신경 쓸 필요가 아예 없어지는 거예요.
      </p>
      <p style={body}>
        그래서 많은 수급자가 직업훈련을 선택해요.
        새로운 기술을 배울 수 있으니 재취업에도 유리하고, 구직활동 부담도 줄어드니 일석이조인 셈이죠.
        훈련 기간 동안에도 실업급여는 정상 지급돼요.
        훈련수당이 별도로 나오는 과정도 있으니까 고용센터에서 안내받아보세요.
      </p>
      <p style={body}>
        직업훈련을 받지 않는 경우라면 <strong>워크넷 입사지원</strong>이 가장 편한 방법이에요.
        자동 연동이라 증빙 걱정도 없고, 집에서 10분이면 되죠.
        4차 이후에는 2회가 필요하니까 2주에 한 번씩 워크넷에서 지원하면 무리 없이 채울 수 있어요.
        본인 경력에 맞는 공고에 지원해야 인정되니까 무작위 지원은 피하세요.
      </p>
      ...
      <p style={body}>
        구직활동에서 가장 많이 실수하는 부분이 <strong>기간</strong>이에요.
        구직활동은 반드시 해당 실업인정 기간 안에 해야 하죠.
        예를 들어 1월 1일~28일이 실업인정 기간인데, 12월에 한 활동은 인정이 안 돼요.
        반대로 1월 29일 이후에 한 것도 이번 차수에는 해당이 안 되죠.
      </p>
      <p style={body}>
        <strong>질 낮은 지원</strong>도 문제가 돼요.
        본인 경력이나 자격과 전혀 관계없는 곳에 무작위로 지원하면 구직활동으로 인정이 안 될 수 있죠.
        같은 회사에 반복 지원하는 것도 마찬가지예요.
        고용센터에서 "성실한 구직 노력"인지 판단하기 때문에, 본인 분야에 맞는 곳에 지원하는 게 안전해요.
      </p>
      <p style={body}>
        횟수를 채우지 못하면 그 차수의 <strong>실업급여가 지급되지 않아요</strong>.
        영구적으로 끊기는 건 아니고, 다음 실업인정 때 횟수를 채우면 이후분부터 다시 받을 수 있죠.
        하지만 못 받은 기간의 급여는 소급되지 않아요.
        실업인정 기간이 시작되면 초반에 구직활동을 해두는 게 안전하죠.
      </p>

      <GreenBox title="구직활동 3대 주의사항">
        기간 내 활동만 인정 &mdash; 해당 실업인정 기간 안에서 해야 해요<br />
        성실한 지원만 인정 &mdash; 무작위/반복 지원은 불인정될 수 있어요<br />
        횟수 미달 시 해당 차수 미지급 &mdash; 소급 지급 안 되니 빠뜨리지 마세요
      </GreenBox>
      ...
      <p style={body}>
        ...
        온라인으로 실업인정을 신청하면 "구직활동 내역" 항목이 나오는데, 여기에 활동 종류와 날짜를 적고 증빙자료를 올리면 되죠.
        워크넷으로 입사지원한 경우에는 자동으로 목록에 뜨니까 선택만 하면 돼요.
      </p>
      <p style={body}>
        다른 사이트에서 지원했다면 캡처 화면을 첨부하세요.
        면접을 본 경우에는 면접 확인서나 면접 일시가 적힌 이메일을 올리면 돼요.
        증빙자료가 부족하면 인정이 안 될 수 있으니까 지원할 때마다 캡처하는 습관을 들이세요.
        고용24 앱에서도 증빙 파일을 첨부할 수 있어서 스마트폰으로도 처리가 가능하죠.
      </p>
      <p style={body}>
        활동한 내역은 미리미리 <strong>기록으로 남겨두세요</strong>.
        입사지원 완료 화면 캡처, 면접 일시 메모, 훈련 수료증 등을 폴더에 모아두면 실업인정 때 한꺼번에 올리기 편하죠.
        실업인정일에 허둥대지 않으려면 평소에 정리해두는 습관이 필요해요.
        고용24에서 실업인정 알림을 설정해두면 일정을 놓칠 일도 없고요.
      </p>
