...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={body}>
        퇴직을 앞두고 있다면 내 피보험기간이 다음 구간까지 얼마나 남았는지 꼭 따져보세요. 가입기간이 2년 11개월이라면 한 달만 더 버티면 3년 구간(180일)으로 올라가요. 150일에서 180일로 바뀌면 <strong>약 198만원</strong>을 더 받는 셈이니까요.
      </p>
      ...
      <p style={body}>
        <strong>단시간 근로자</strong>(주 15~40시간)에게 특히 유리한 구조예요. 주 20시간 파트타임으로 월 100만원을 받던 분이 실업급여를 신청하면 월 198만원이 나와요. 일할 때보다 실업급여가 2배 가까운 거죠. 고용보험 가입기간 180일만 충족하면 되니까 파트타임이라도 절대 포기하지 마세요.
      </p>
      <p style={body}>
