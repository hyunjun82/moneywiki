...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={body}>
        수급자격이 인정되면 <strong>1차 실업인정일</strong>이 잡혀요. 이후 1~4주 간격으로 실업인정을 받으면서 구직급여가 입금되는 구조이죠. 실업인정일에 구직활동 내역을 제출해야 하고, 2회차부터는 온라인으로도 처리 가능해요.
      </p>
      <p style={body}>
        핵심은 <strong>퇴직일 다음 날부터 12개월 이내</strong>에 신청을 마쳐야 한다는 거예요. 12개월이 지나면 수급일수가 남아 있어도 받을 수 없죠. 교육을 미루면 그만큼 돈을 못 받는 기간이 길어지는 거니까, 퇴직 직후에 바로 시작하는 게 가장 유리해요.
      </p>

      <GreenBox title="교육 후 실업급여까지 흐름">
      ...
      <p style={body}>
        들으면서 <strong>메모해두면 나중에 도움이 돼요</strong>. 실업인정 방법, 구직활동 인정 횟수, 부정수급 기준 같은 내용은 수급 기간 내내 필요한 정보이죠. 영상에서 한 번 듣고 흘려보내면 나중에 헷갈리는 경우가 많아요.
      </p>
      <p style={body}>
