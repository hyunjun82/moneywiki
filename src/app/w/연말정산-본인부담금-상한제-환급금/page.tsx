...
const FAQS = [
  { q: "연말정산 본인부담금 상한제 환급금에 대해 자세히 알 수 있나요?", a: "이 글에서 핵심 내용을 정리했어요. 아래 내용을 참고하세요." },
...
const SOURCES = [
  { name: "- name: 국세청 의료비 세액공제", href: "https://www.nts.go.kr" },
  { name: "국민건강보험법 제44조", href: "https://www.law.go.kr/법령/국민건강보험법" }
];

const RELATED = [
  { slug: "연말정산-실손보험금", title: "- title: 연말정산 실손보험금", description: "" },
...
export default function Page() {
  return (
    <ArticleLayout>
      ...
      <h1 style={{ fontSize: 26, fontWeight: 700, lineHeight: 1.45, marginBottom: 14 }}>연말정산 본인부담금 상한제 환급금</h1>
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>"건강보험에서 의료비 돌려받았는데, 연말정산에 영향 있나요? 네. 환급받은 금액은 의료비 공제에서 빼야 해요. 실손보험금과 같은 원리예요."</p>
      <p style={body}>건강보험 본인부담금 상한제로 환급받은 금액은 의료비 공제에서 빼야 해요. 실손보험금과 같은 원리예요.</p>
      <Divider /><ArticleAd position="intro" />
      <H2>핵심 정리</H2>
      <GreenBox title="요약">"· 본인부담금 상한제 환급금은 의료비 공제에서 차감해요.\\n· 건강보험공단에서 통지해요.\\n· 연도별로 정산 시점이 달라요."</GreenBox>
