...
const SIDEBAR_LINKS = ["인천 평생교육이용권 신청방법", "인천형 평생교육이용권 자격", "평생교육이용권 AI디지털 이용권", "평생교육이용권 사용처 조회", "서울 평생교육이용권 신청", "강원 평생교육이용권 신청", "충북 평생교육이용권 신청", "충남 평생교육이용권 신청", "NH농협카드 채움카드 발급", "차상위계층 확인 방법", "기초생활수급자 신청", "인천시 복지 교육 지원", "평생교육이용권 추첨 기준", "평생교육이용권 우수이용자 70만원", "인천 평생학습 포털"];
const HUB_LINKS = [{"title": "서울 평생교육이용권 | 4월 9일까지", "desc": "서울 4개 유형 자격·절차 정리", "href": "/w/서울-평생교육이용권"}, {"title": "강원 평생교육이용권 | 4월 7일까지", "desc": "강원 AI디지털·노인 조건 정리", "href": "/w/강원-평생교육이용권"}, {"title": "충남 평생교육이용권 | 4월 17일까지", "desc": "충남 신청 조건·사용처 안내", "href": "/w/충남-평생교육이용권"}, {"title": "경남 평생교육이용권 | 4월 17일까지", "desc": "경남 시군별 접수처 안내", "href": "/w/경남-평생교육이용권"}];
const STEPS = [{"title": "내 유형 먼저 고르세요", "desc": "일반·AI디지털·노인 중 1개만 신청. 중복 신청 자동 무효예요.", "tip": "소득 무관 유형이 유리할 수 있어요"}, {"title": "lllcard.kr/incheon 접속", "desc": "카카오·PASS 간편인증 후 신청서를 작성해요. PC·스마트폰 모두 가능해요.", "link": {"label": "lllcard.kr/incheon", "url": "https://www.lllcard.kr/incheon"}}, {"title": "신청서 작성 + 제출", "desc": "유형 선택 → 자격 정보 입력 → 제출.", "tip": "마감 전날까지 여유 있게 신청하세요"}, {"title": "선정 결과 통보", "desc": "문자·카카오톡으로 개별 통보. 선정 시 NH농협 채움카드에 35만원 포인트 자동 충전이에요."}, {"title": "강좌 수강 + 사용", "desc": "등록된 온·오프라인 기관에서 수강료·교재비로 결제해요. 12월 31일까지 사용해야 해요.", "tip": "미사용 잔액 연말 자동 소멸"}];
const FAQS = [{"urgent": true, "q": "인천 거주자인데 서울 공고로 신청해도 되나요?", "a": "안 돼요. 주민등록등본 상 주소지 기준이에요. 인천에 주민등록이 있으면 반드시 인천 공고(lllcard.kr/incheon)로 신청해야 해요. 타 지역 공고로 신청하면 자동 탈락이에요."}, {"urgent": true, "q": "소득이 높은데 일반 이용권 신청할 수 있나요?", "a": "네, 신청할 수 있어요. 기초생활수급자·차상위계층을 먼저 선발하고 남은 자리는 무작위 추첨이에요. 소득이 높아도 추첨에는 참여 가능해요. 단, 30세 이상이면 소득 무관한 AI디지털 이용권을 선택하는 게 유리할 수 있어요."}, {"urgent": true, "q": "인천 장애인 이용권은 어디서 신청해요?", "a": "2026년 인천 1차 모집에는 장애인 이용권 별도 공고가 없었어요. 정부24(보조금24)를 통해 신청하거나 인천시 상담센터(032-722-7220)에 문의하세요."}, {"urgent": false, "q": "AI디지털 이용권으로 어떤 강좌를 들을 수 있어요?", "a": "ChatGPT 활용, 영상편집, 코딩, 정보처리기사, 컴퓨터활용능력 등 디지털 강좌예요. 디지털 전용 사용기관에서만 사용할 수 있어요. 일반 이용권 사용처보다 범위가 좁으니 미리 기관을 확인하세요."}, {"urgent": false, "q": "NH농협카드가 없어요.", "a": "선정 후 card.nonghyup.com 또는 NH농협은행·농축협 영업점에서 채움카드를 발급하면 돼요. 기존 채움카드 소지자는 자동 충전이에요."}, {"urgent": false, "q": "추첨 탈락하면 기회가 없나요?", "a": "2차 모집이 진행될 수 있어요. 인천시 상담센터(032-722-7220)에 문의하거나 lllcard.kr/incheon에서 다음 공고를 확인하세요."}];
const COURSES = [{"cat": "자격증", "col": "#1D9E75", "items": ["컴퓨터활용능력", "정보처리기사", "공인중개사", "사회복지사"]}, {"cat": "어학", "col": "#2563EB", "items": ["영어 회화", "일본어", "중국어", "HSK 준비"]}, {"cat": "AI·디지털", "col": "#7C3AED", "items": ["ChatGPT 활용", "영상편집", "코딩 입문", "유튜브 제작"]}, {"cat": "취미·생활", "col": "#D97706", "items": ["바리스타", "제과제빵", "캘리그라피", "인문학"]}];
const REFERENCES = [{"category": "공식 공고", "items": [{"label": "인천 평생교육이용권 누리집 (lllcard.kr/incheon)", "url": "https://www.lllcard.kr/incheon"}, {"label": "인천시 상담센터 ☎032-722-7220", "url": "tel:0327227220"}]}, {"category": "법령·카드", "items": [{"label": "평생교육법 제16조의2 — 평생교육이용권의 발급 등", "url": "https://www.law.go.kr/"}, {"label": "NH농협카드 채움카드 신규 발급", "url": "https://card.nonghyup.com"}]}];
const APPLY_URL = "https://www.lllcard.kr/incheon";
const APPLY_LABEL = "인천 평생교육이용권 신청하기";
const DEADLINE_ISO = "2026-04-08T23:59:00+09:00";
const DEADLINE_LABEL = "2026년 4월 8일(수) 마감";
const DEADLINE_SHORT = "4월 8일";
const NOTE_SPECIFIC = "인천 1차: 일반·AI디지털·노인 3개 유형";
  ...
  return (
    <div style={{ maxWidth: 1060, margin: "0 auto", padding: "2rem 1.5rem", fontFamily: "'Pretendard', 'Apple SD Gothic Neo', sans-serif", color: "#111", display: "flex", gap: 28, alignItems: "flex-start" }}>
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <p style={{ fontSize: 13, color: "#1D9E75", fontWeight: 600, marginBottom: 10 }}>복지 · 교육 지원 · 인천광역시</p>
        <h1 style={{ fontSize: 26, fontWeight: 700, lineHeight: 1.45, marginBottom: 14 }}>
          2026 인천 평생교육이용권 신청기간 |<br />
          소득 무관 신청 가능한 유형은 따로 있어요
        </h1>
        <p style={{ fontSize: 15, color: "#374151", lineHeight: 2.1, marginBottom: "1rem" }}>
          소득이 높아서 못 받겠다고 포기하셨다면 다시 확인하세요.\n30세 이상이면 소득과 무관하게 신청할 수 있는 유형이 있어요.\n4월 8일 마감 전에 내 유형부터 먼저 확인하세요.
        </p>
        ...
        <H2>인천광역시 평생교육이용권, 신청 전에 이것부터 확인하세요</H2>
        <p style={body}>
          인천광역시에 주민등록이 있어야 인천광역시 공고로 신청할 수 있어요.<br />
          2026년부터 국가 단일 모집이 아닌 광역 지자체별 개별 모집으로 바뀌었어요.<br />
          타 지역 공고로 신청하면 자동 탈락이에요.
        </p>
        <GreenBox title="2026 인천광역시 1차 핵심 정보">
          신청 기간: 2026년 3월 20일(목) ~ 4월 8일(수)<br />
          지원 금액: 1인당 연 35만원 · 우수이용자 최대 70만원<br />
          신청 방법: www.lllcard.kr/incheon (PC·모바일 가능)<br />
        ...
        <p style={body}>
          온라인 사용기관은 전국 공통이에요. 인천광역시 어디서나 수강할 수 있어요.<br />
          실제 강좌 목록은 www.lllcard.kr/incheon에서 검색하세요.
        </p>
        ...
        <CTA url={APPLY_URL} deadline={DEADLINE_SHORT} ctaTitle={"지금 바로 신청하세요.\\n소득 무관 유형도 있어요."} ctaDesc={"AI·디지털(30세↑)·노인(65세↑) 이용권은 소득 조건 없어요.\\n연 35만원 교육비 지원이에요."} />

        <Divider />
        <References refs={REFERENCES} />

        <div style={{ marginTop: "1.2rem", padding: "14px 18px", background: "#f9fafb", borderRadius: 10, fontSize: 12, color: "#9ca3af", lineHeight: 1.9 }}>
          이 글은 법률·정책 정보 제공을 목적으로 작성됐어요. 개별 선정 결과는 인천광역시 공고 기준에 따르며, 중요한 결정 전에 반드시 공식 출처를 직접 확인하세요.
          <br />※ 인천 1차: 일반·AI디지털·노인 3개 유형
        </div>
      </div>
    </div>
  );
