...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={body}>
        제일 많이 하는 실수가 뭔지 아세요? 온라인 교육을 안 듣고 가는 거예요. <strong>수급자격 신청자 온라인 교육</strong>을 이수하지 않으면 고용센터에서 접수 자체를 안 받아줘요. &quot;집에서 교육부터 듣고 오세요&quot; 한 마디에 그대로 돌아와야 하죠.
      </p>
      <p style={body}>
      ...
      <p style={body}>
        온라인 교육 말고 <strong>구직등록</strong>도 미리 해두면 현장 대기 시간이 확 줄어들어요. 워크넷(work.go.kr)이나 고용24에서 5분이면 되는 일이죠. 신분증, 통장 사본까지 챙기면 준비 끝이에요.
      </p>
      ...
      <p style={body}>
        혹시 불인정 결정이 나오더라도 당황하지 마세요. <strong>60일 이내에 이의신청</strong>을 넣을 수 있으니까요. 추가 증빙 자료를 첨부해서 재심사를 요청하면 되죠. 현장에서 담당자에게 &quot;어떤 자료가 더 필요한지&quot; 바로 물어보는 게 가장 정확해요.
      </p>
