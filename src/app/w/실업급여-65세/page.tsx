  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        ...
        <a href="https://www.law.go.kr/법령/고용보험법" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험법 제10조</a>에서 65세 이후 신규 취업자는
        고용보험 적용 대상에서 제외하고 있지만, 65세 이전에 취업해서 계속 일한 사람은
        나이에 상관없이 실업급여를 받을 수 있어요.
        50세 이상 기준이 적용돼서 가입기간 10년 이상이면 최대 270일까지 받을 수 있죠.
      </p>
      ...
      <p style={body}>
        <a href="https://www.law.go.kr/법령/고용보험법" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험법 제10조</a>에서 <strong>65세 이후에 새로 취업한 사람</strong>은 고용보험 적용 대상에서 빼요. 65세가 넘어서 새로 취업하면 고용보험에 가입이 안 되죠. 고용보험료도 안 내고, 퇴직해도 실업급여를 못 받아요.
      </p>
      <p style={body}>
        그렇다면 왜 65세가 기준일까요? <strong>국민연금 수령 시작 나이</strong>와 맞물려 있죠. 65세부터 국민연금을 받을 수 있으니, 연금과 실업급여를 동시에 받으면 중복 지원이 돼요. 그래서 65세 이후 신규 취업자는 고용보험에서 제외한 거예요.
      </p>
      <p style={body}>
        다만 65세 이전부터 일하던 사람은 <strong>기득권을 인정</strong>해서 계속 고용보험을 유지하죠. 이미 보험료를 내고 있던 사람의 권리를 갑자기 빼앗으면 안 되니까요. 핵심은 딱 하나, <strong>&ldquo;언제 취업했느냐&rdquo;</strong>예요.
      </p>
      ...
      <p style={body}>
        64세에 취업해서 68세에 퇴직했다면? 받을 수 있죠. 취업 시점이 65세 이전이니까요. 60세에 취업해서 70세에 퇴직해도 마찬가지예요. 중간에 65세를 넘겼어도 계속 같은 직장에서 일했으면 고용보험이 유지되죠.
      </p>
      <p style={body}>
        반대로, 66세에 처음 취업한 사람은 고용보험 가입 대상 자체가 아니에요. 고용보험료를 낸 적이 없으니 실업급여를 받을 수 없죠. 67세에 취업해서 69세에 퇴직해도 결과는 같아요.
      </p>
      <p style={body}>
        주의할 건 <strong>65세 이후 이직</strong>이에요. 65세 이전에 A회사에서 일하다가, 65세 이후에 B회사로 옮기면 B회사에서는 <strong>신규 취업</strong>으로 봐요. B회사에서 고용보험에 가입이 안 되니 실업급여도 못 받죠. 65세 이후에 이직을 고려하고 있다면 이 부분을 반드시 따져봐야 해요.
      </p>
      ...
      <p style={body}>
        여기서 중요한 예외가 하나 있죠. <strong>일용직 근로자</strong>는 나이에 관계없이 고용보험이 적용돼요. 건설 현장 일용직, 단기 알바처럼 하루 단위로 고용되는 형태가 해당되죠.
      </p>
      <p style={body}>
        왜 일용직은 예외일까요? 일용직은 고용이 불안정하고, 국민연금 수급과 직접적인 관련이 적어요. 그래서 고용보험법에서 나이와 무관하게 보호하고 있죠. 70세 일용직 근로자도 고용보험에 가입이 되고, 피보험기간이 쌓여요.
      </p>
      <p style={body}>
      ...
      <p style={body}>
        아니에요. 65세 이상이라고 수급기간이 짧아지거나 금액이 깎이지 않아요. <strong>50세 이상</strong>과 동일한 기준을 적용받죠. 오히려 50세 미만보다 유리한 편이에요.
      </p>
      <p style={body}>
        피보험기간에 따라 수급일수가 달라지는데, 50세 이상이면 같은 피보험기간에서도 수급일수가 더 많아요. 피보험기간 10년 이상이면 <strong>최대 270일</strong>까지 실업급여를 받을 수 있죠. 1년 미만이어도 120일이에요.
      </p>
      <p style={body}>
        금액도 마찬가지예요. 퇴직 전 3개월 평균임금의 60%를 기준으로 계산하고, 상한액과 하한액이 정해져 있죠. 2026년 기준 1일 상한액 68,100원, 하한액 66,048원이에요. 고령이라는 이유로 감액되는 건 없어요.
      </p>
      ...
      {/* 섹션 5 — 실전 확인 방법 */}
      <H2>가입 시점과 수급 조건을 지금 바로 확인하세요</H2>
      <p style={body}>
        가장 먼저 할 일은 <strong>본인의 고용보험 가입 여부</strong>를 확인하는 거예요. <a href="https://www.ei.go.kr" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용24</a>에 접속해서 피보험자격 이력을 조회하면, 현재 고용보험에 가입돼 있는지, 언제부터 가입됐는지 알 수 있죠.
      </p>
      <p style={body}>
        급여명세서에서 고용보험료가 공제되고 있는지도 같이 살펴보세요. 고용보험료가 빠지고 있다면 가입 상태인 거예요. 만약 65세 이전에 입사했는데 고용보험료가 안 빠지고 있다면, 회사에 확인을 요청해야 하죠.
      </p>
      <p style={body}>
        퇴직을 앞두고 있다면 <strong>이직확인서</strong>에 퇴직 사유가 정확히 기재되는지도 챙겨야 해요. 정년퇴직, 계약만료 같은 비자발적 사유가 맞게 적혀 있어야 실업급여 심사가 수월하죠. 준비가 됐다면 퇴직 후 가능한 빨리 고용센터에 방문하거나 온라인으로 신청하세요.
      </p>
      ...
      <p style={{ ...body, marginBottom: 14 }}>
        65세 이상 실업급여에 대해 실제로 궁금해하시는 내용을 모았어요.
      </p>
      <FAQ items={FAQS} />
