...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={body}>
        주의할 건 <strong>65세 이후 이직</strong>이에요. 65세 이전에 A회사에서 일하다가 65세 이후에 B회사로 옮기면, B회사 입장에서는 <strong>신규 취업</strong>으로 봐요. B회사에서는 고용보험 가입이 안 되니 실업급여도 못 받죠. 65세 이후에 이직을 고려하고 있다면 이 부분을 반드시 따져봐야 해요.
      </p>
      ...
      <p style={body}>
        금액도 마찬가지예요. 퇴직 전 3개월 평균임금의 60%를 기준으로 계산하고, 상한액·하한액이 정해져 있죠. 2026년 기준 1일 상한액 68,100원, 하한액 66,048원이에요. 나이가 많다고 깎이는 건 없어요.
      </p>
