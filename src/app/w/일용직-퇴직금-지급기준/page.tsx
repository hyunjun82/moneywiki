...
//     일용직으로 1년 넘게 일했는데 퇴직금을 받을 수 있는지 모르는 상황
// Q2. 이 사람이 이 글을 읽고 나서 할 수 있어야 하는 행동은?
//     계속 근로 여부를 스스로 판단하고, 사업주에게 퇴직금을 청구하거나 노동청에 진정을 넣는 행동
// Q3. 이 행동을 하려면 반드시 알아야 하는 정보는?
//     계속 근로 인정 기준(반복·정기 출근), 주 15시간 기준, 증거 서류, 청구 절차 4단계, 소멸시효 3년
// Q4. 이 정보를 가장 잘 전달하는 형태는?
//     EligibilityChecker(내 상황 체크) + Calculator(금액) + DocTable(서류) + Steps(절차) + Checklist(요약)
...
const CHECK_ITEMS = [
  { id: "c1", label: "같은 사업장에서 반복·정기적으로 출근했죠" },
  { id: "c2", label: "4주 평균 주 15시간 이상 일한 기간이 있고요" },
...
const STEPS = [
  {
    title: "계속 근로 여부 판단",
    desc: "일용직이라도 같은 사업장에서 반복·정기 출근했다면 계속 근로로 인정돼요. 매일 계약을 새로 맺는 형식이어도 실질적으로 고정된 날마다 출근했다면 법원과 노동부가 계속 근로로 보는 경우가 많죠.",
    tip: "통장 이체 패턴이 일정하면 계속 근로 입증에 가장 효과적이에요",
  },
  {
    title: "주 15시간 이상 체크",
    desc: "4주 평균 주 15시간 이상이면 퇴직금 지급 요건을 충족해요. 하루 8시간씩 주 3일만 일해도 주 24시간으로 조건을 넘죠. 15시간 미만이면 퇴직금 대상이 아니에요.",
    tip: "어떤 주는 적게 일해도 4주 평균이 15시간 이상이면 요건 충족이에요",
  },
  {
    title: "사업주에게 퇴직금 청구",
    desc: "계속 근로 + 주 15시간 이상 조건을 갖췄다면 사업주에게 퇴직금 지급을 요청해요. 퇴직일로부터 14일 이내가 지급 기한이에요. 서면이나 문자로 청구 기록을 반드시 남겨두는 게 중요해요.",
    tip: "건설 일용직은 건설근로자공제회 퇴직공제금 제도도 함께 활용할 수 있죠",
  },
  {
    title: "미지급 시 노동청 진정",
    desc: "사업주가 거부하면 고용노동부(1350) 또는 관할 지방노동청에 진정을 내세요. 일용직 계약 형태와 무관하게 계속 근로가 인정되면 퇴직금을 받을 수 있죠. 소멸시효는 퇴직일로부터 3년이에요.",
    tip: "노동청 진정 전에 법률구조공단(132) 무료 상담을 활용하면 좋죠",
    link: { label: "고용노동부 민원 신청", href: "https://minwon.moel.go.kr" },
  },
];

const CHECKLIST = [
  "계속 근로 여부: 반복·정기 출근 사실 체크 (통장 내역이 핵심 증거)",
...
const FAQS = [
  {
    ...
    a: "아니에요. 계약 형태가 일용직이어도 실질적으로 계속 근무했고 주 15시간 이상이라면 퇴직금 청구 대상이죠. 법원과 노동부 모두 실질 관계를 기준으로 판단해요.",
  },
  {
    q: "매일 계약을 새로 맺는데 계속 근로가 인정되나요?",
    a: "계약 형식보다 실질을 봐요. 같은 사업장에서 정해진 날마다 반복 출근했고, 사실상 고용 관계가 지속됐다면 계속 근로로 인정될 수 있죠. 통장 이체 기록이 가장 중요한 증거예요.",
  },
  {
    q: "건설 일용직도 퇴직금을 받을 수 있나요?",
    a: "건설근로자는 일반 퇴직금 외에 건설근로자공제회의 퇴직공제금 제도도 있죠. 퇴직공제금은 건설현장 근무일수 252일 이상이면 별도로 청구할 수 있죠.",
  },
  {
    q: "일용직 퇴직금 소멸시효는 얼마인가요?",
    a: "3년이에요. 마지막 근무일로부터 3년 내에 청구해야 하죠. 내용증명이나 노동청 진정으로 소멸시효를 중단할 수 있죠.",
  },
  {
    q: "근로계약서가 없는 일용직도 퇴직금 신고가 가능한가요?",
    a: "가능해요. 통장 이체 내역, 문자 메시지, 출퇴근 기록 등 근무 사실을 입증할 수 있다면 노동청에 진정을 낼 수 있죠. 계약서가 없어도 실질 근무 사실로 청구해요.",
  },
  {
    q: "주 15시간을 못 채운 주가 있으면 퇴직금을 못 받나요?",
    a: "4주 평균 기준이에요. 어떤 주에 적게 일하더라도 4주 평균이 15시간 이상이면 요건을 충족해요. 일부 주의 근무시간이 짧아도 전체 평균으로 판단하죠.",
  },
];
...
export default function Page() {
  return (
    <ArticleLayout
      sidebar={<Sidebar heading="퇴직금 가이드" items={퇴직금_SIDEBAR} highlightSlugs={퇴직금_HIGHLIGHT} currentSlug="일용직-퇴직금-지급기준" />}
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        ...
        계약서에 '일용직'이라고 적혀 있어도 실질 관계를 기준으로 판단하죠.
        건설 일용직은 <a href="/w/건설근로자공제회-퇴직금-수령방법" style={{ color: "#1D9E75", textDecoration: "underline" }}>건설근로자공제회 퇴직공제금</a> 제도도 별도로 활용할 수 있죠.
      </p>
      ...
      <p style={body}>
        핵심은 '실질적 계속 근로'예요. 매일 계약을 새로 맺는 형식이어도, 같은 사업장에서 정해진 날마다 반복 출근했다면 법원이 계속 근로로 보는 경우가 많죠.
        여기에 주 15시간 이상 조건까지 충족하면 퇴직금 청구가 가능해요.
      </p>
      <p style={body}>
        건설 현장 일용직은 일반 퇴직금 외에 건설근로자공제회 퇴직공제금 제도를 이용할 수 있죠.
      ...
      <EligibilityChecker
        items={CHECK_ITEMS}
        allMatchText="일용직이어도 퇴직금 청구가 가능한 상황이에요. 아래 계산기로 예상 금액을 살펴봐요."
        partialMatchText="계속 근로 인정 여부에 따라 다를 수 있죠. 고용노동부(1350) 상담을 권해요."
      />
      ...
      <p style={body}>
        일당과 계속 근로 개월 수를 입력하면 월 임금과 퇴직금 예상액을 바로 볼 수 있죠.
        실제 퇴직금은 퇴직 전 3개월 평균임금으로 계산하니, 급여명세서나 통장 이체 기준이 가장 정확하죠.
      </p>
      ...
      <p style={body}>
        ...
        근로계약서가 없어도 청구할 수 있으니, 지금 당장 통장 내역과 업무 지시 기록을 챙겨두는 게 좋죠.
      </p>
      <p style={body}>
      ...
      <p style={body}>
        계속 근로 여부 판단 → 주 15시간 체크 → 사업주 청구 → 미지급 시 노동청 진정 순서예요.
        소멸시효가 3년이니 퇴직 후 너무 늦지 않게 진행하는 게 중요하죠.
      </p>
      ...
      <p style={body}>
        ...
        사업주가 거부하더라도 노동청 진정으로 충분히 받아낼 수 있죠.
      </p>
      ...
      <GreenBox>
        ...
        반복·정기 출근 사실만 입증되면 노동청과 법원에서 인정받을 수 있죠.
      </GreenBox>
