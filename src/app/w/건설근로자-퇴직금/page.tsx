...
const STEPS = [
  {
    title: "공제부금 적립 내역 확인",
    desc: "건설근로자공제회 홈페이지(cretirement.or.kr) 또는 앱에서 내 공제부금 적립 내역을 조회해요. 원청 또는 하청 사업주가 근무일당 9,600원씩 적립해줘요. 미적립 기간이 있으면 사업주에게 소급 적립 요청을 해야 해요.",
  ...
  {
    title: "온라인 또는 방문 신청",
    desc: "건설근로자공제회 홈페이지나 앱에서 온라인 신청이 가능해요. 방문 신청은 전국 지부에서 할 수 있어요. 신분증과 통장 사본만 있으면 되고, 공인인증서로 본인 확인이 돼요.",
