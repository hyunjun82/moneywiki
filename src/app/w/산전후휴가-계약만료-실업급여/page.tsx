...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={body}>
        이직확인서에 퇴직 사유가 <strong>&ldquo;계약기간 만료&rdquo;</strong>로 적혀 있는지 꼭 확인하세요. 회사가 &ldquo;자발적 퇴사&rdquo;로 기재하면 실업급여 심사에서 문제가 생기죠. 기재가 잘못됐다면 고용센터(1350)에 정정을 요청할 수 있어요.
      </p>
      ...
      <p style={body}>
        실업급여 수급기간은 <strong>퇴직일(계약만료일)로부터 1년</strong>이에요. 산전후휴가 90일은 약 3개월이니까, 남은 9개월 동안 실업급여를 받을 수 있어요. 시간은 넉넉한 편이라 조급해할 필요 없죠.
      </p>
      ...
      <p style={body}>
        놓치기 쉬운 게 <strong>재취업 의사</strong>예요. 실업급여를 받으려면 &ldquo;일할 의사와 능력&rdquo;이 있어야 하죠.
      ...
      <p style={body}>
        수급 기간은 나이와 고용보험 가입기간에 따라 120일에서 270일까지 달라져요. 30세 미만에 가입기간 1~3년이면 150일, 50세 이상에 10년 넘게 가입했으면 270일이죠. 본인 조건에 맞는 수급일수는 <a href="https://www.ei.go.kr" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용24</a>에서 바로 조회할 수 있어요.
      </p>
      <p style={body}>
