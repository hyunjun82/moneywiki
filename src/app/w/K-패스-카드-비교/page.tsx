...
const RELATED = [
  { slug: "연말정산-대중교통-신용카드", title: "대중교통 신용카드 공제 40%", description: "K-패스 환급 외에 연말정산에서 40% 추가 공제 받는 방법이에요." },
  { slug: "실업급여-계산기", title: "실업급여 계산기", description: "고용보험 가입 기간·임금으로 실업급여 예상액 계산해요." },
  { slug: "청년도약계좌", title: "청년도약계좌 가입 조건·혜택", description: "월 최대 70만원 납입으로 정부 기여금 받는 청년 적금이에요." },
];
