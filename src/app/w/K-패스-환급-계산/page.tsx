  ...
  return (
    <ArticleLayout sidebar={<Sidebar heading="K-패스 가이드" items={K패스_SIDEBAR} currentSlug="K-패스-환급-계산" />}>
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        K-패스 신청할지 말지 고민되죠? 내 교통비로 실제 얼마가 돌아오는지 먼저 계산해봐야 해요.
        아래에서 일반·청년·저소득 버튼 누르면 월 교통비별 환급액이 바로 나와요.
        이거 보면 카드 만들지 말지 5초 만에 결정할 수 있어요.
      </p>
      ...
      <H2>내 환급액 바로 확인</H2>
      <p style={body}>
        내 유형 눌러보면 아래 표가 바로 바뀌어요. 월 교통비 구간에서 내 환급액을 찾아봐요.
      </p>
