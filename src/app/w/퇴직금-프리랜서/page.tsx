...
// Q1. 프리랜서 계약으로 1년 이상 일했는데 퇴직금을 못 받고 나왔거나, 곧 그만두려는데 퇴직금을 받을 수 있는지 몰라서 검색하는 상황이에요.
// Q2. 자신이 근로자성 인정 대상인지 판단하고, 증거를 챙겨서 고용노동부에 진정을 접수할 수 있어야 해요.
// Q3. 근로자성 판단 4가지 기준(출퇴근 강제·업무지시·전속성·도구 제공), 3.3% 세금과 무관함, 퇴직 전 증거 수집이 핵심, 고용노동부 진정 절차, 소멸시효 3년.
// Q4. EligibilityChecker(자가진단) + Calculator(예상액) + Steps(절차) + FAQ(실전 의문 해소)
// MAP: Q1→서론(상황 공감), Q2→H2 순서(판단→증거→절차→청구), Q3→각 섹션 깊이, Q4→컴포넌트 선택
...
const STEPS = [
  {
    title: "근로자성 판단 기준 파악",
    desc: "계약 명칭이 '프리랜서'라도 실질적으로 지휘·감독 아래 근무했다면 근로기준법상 근로자예요. 출퇴근 강제 여부, 업무 방식 지시 여부, 전속성(한 업체에서만 일함), 작업 도구 제공 여부 4가지가 핵심이에요. 여러 항목이 해당될수록 근로자로 인정될 가능성이 커지죠.",
    tip: "대법원은 계약 형식보다 실질적 근로관계를 우선 판단해요 (대법원 2006다49318)",
  },
  {
    title: "증거 수집 (퇴직 전 반드시)",
    desc: "업무 지시 내용이 담긴 카카오톡·이메일·슬랙 메시지를 캡처해서 저장해요. 출퇴근 기록, 업무 보고 내역, 회사 시스템 접근 기록도 강력한 증거예요. 급여가 정기적으로 입금된 통장 거래내역은 근무 기간과 수입 금액을 동시에 입증해주죠.",
    tip: "퇴직 후에는 회사 시스템 접근이 막히니 재직 중에 미리 저장해두세요",
  },
  {
    title: "고용노동부 진정 접수",
    desc: "고용노동부 민원마당(minwon.moel.go.kr)에서 온라인으로 진정을 낼 수 있죠. 근로감독관이 사실 조사를 진행하고, 근로자성이 인정되면 사업주에게 퇴직금 지급 명령이 내려지고요. 진정 접수는 무료예요.",
    tip: "1350(고용노동부 고객상담센터)에 먼저 전화 상담을 받으면 진정 방향을 잡기 쉬워요",
    link: { label: "고용노동부 민원마당 바로가기", href: "https://minwon.moel.go.kr" },
  },
  {
    title: "퇴직금 수령",
    desc: "근로자성이 인정되면 프리랜서 계약 기간 전체에 대한 퇴직금을 받을 수 있죠. 퇴직금이 300만원을 초과하면 IRP 계좌로 수령해야 하고, 퇴직소득세가 원천징수된 뒤 지급돼요. 소멸시효 3년 이내에 청구해야 해요.",
    tip: "IRP로 수령하면 과세 이연 효과로 퇴직소득세를 나중에 낼 수 있죠",
  },
];

const CHECKLIST = [
  "근로자성 판단: 출퇴근 강제·업무 지시·전속성·도구 제공 여부 살피기",
...
const FAQS = [
  {
    ...
    a: "계약 명칭보다 실제 근무 형태가 기준이에요. 회사 지시를 받고, 출퇴근이 강제됐고, 1년 이상 전속으로 일했다면 근로자로 인정될 수 있죠. 대법원도 계약 형식보다 실질적 관계를 우선해요.",
  },
  {
    q: "3.3% 원천징수를 했으면 근로자가 아닌가요?",
    a: "그렇지 않아요. 세금 처리 방식은 근로자성 판단과 별개예요. 사업소득세 3.3%를 냈더라도 실질적으로 근로자였다면 퇴직금 청구가 가능하죠. 세무서에 납부한 세금도 환급받을 수 있는 경우가 많아요.",
  },
  {
    q: "근로자성 판단 기준이 뭔가요?",
  ...
  },
  {
    ...
    a: "업종과 근무 형태에 따라 달라요. 보험설계사, 골프장 경기보조원 등은 근로자성이 인정된 대법원 판례가 있죠. 개별 사안마다 판단이 달라지니 고용노동부(1350)에 상담받는 게 빨라요.",
  },
  {
    q: "퇴직금 청구를 회사가 거부하면 어떻게 하나요?",
    a: "고용노동부에 진정을 내면 근로감독관이 직접 조사해요. 근로자성이 인정되면 지급 명령이 내려지고, 회사가 불이행하면 형사 처벌 대상이에요. 진정은 무료로 접수할 수 있죠.",
  },
  {
    q: "이미 퇴직한 뒤에도 청구할 수 있나요?",
    a: "퇴직일로부터 3년 이내라면 청구 가능해요. 소멸시효가 지나기 전에 빠르게 움직이는 게 중요해요. 증거가 남아 있다면 퇴직 후에도 충분히 인정받을 수 있죠.",
  },
];
  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        계약서에 '프리랜서'라고 적혀 있어도 퇴직금을 받을 수 있는 경우가 많아요.
        출퇴근이 정해져 있고, 회사 지시를 받고 일했고, 1년 이상 그 업체에서만 일했다면
        <a href="https://www.law.go.kr/법령/근로기준법" style={{ color: "#1D9E75", textDecoration: "underline" }}>근로기준법</a>상 근로자로 볼 수 있죠.
        계약 형식이 아니라 실질적인 근무 형태가 기준이에요.
        3.3% 세금을 냈다고 해도 마찬가지고요.
      </p>
      ...
      <p style={body}>
        ...
        대법원도 이 기준으로 여러 차례 프리랜서의 근로자성을 인정한 판례가 있죠.
      </p>
      <p style={body}>
        반대로 여러 업체와 동시에 계약하고, 작업 방식을 스스로 결정하고, 본인 장비로 일했다면 근로자성이 부정될 수 있죠.
      ...
      <EligibilityChecker
        items={CHECK_ITEMS}
        allMatchText="근로자성이 인정될 가능성이 높아요. 아래 계산기로 예상 퇴직금을 먼저 살펴보세요."
      ...
      <p style={body}>
        ...
        프리랜서 계약 기간 전체가 근속기간으로 인정되기 때문에, 오래 일했을수록 금액이 커지죠.
        슬라이더로 월 수입과 계약 기간을 조정해서 예상액을 살펴보세요.
      </p>
      ...
      <p style={body}>
        ...
        계약서가 '위탁' 또는 '용역' 형태여도 진정 접수에는 문제없고요.
      </p>
      ...
      <p style={body}>
        ...
        근로감독관이 직접 사실 조사를 하고, 근로자성이 인정되면 회사에 퇴직금 지급을 명령하죠.
      </p>
      ...
      <p style={body}>
        ...
        증거를 먼저 챙기고, 근로자성 판단 기준에 해당하는 항목을 하나씩 살피면 돼요.
      </p>
      ...
      <GreenBox>
        ...
        사업소득세 3.3%를 납부했더라도 실질적으로 근로자였다면 퇴직금을 청구할 수 있죠.
      </GreenBox>
