...
// ─── 데이터
const TYPES = [{"minAge": 19, "name": "장애인 이용권", "age": "만 19세 이상 등록장애인", "income": "소득 무관 · 정부24(보조금24) 신청", "color": "#7C3AED", "bg": "#F5F3FF", "quota": "-"}];
const SIDEBAR_LINKS = ["대전 장애인 평생교육이용권", "대전 평생교육이용권 신청방법", "장애인 평생교육이용권 자격", "평생교육이용권 정부24 신청", "평생교육이용권 사용처 조회", "서울 평생교육이용권 신청", "인천 평생교육이용권 신청", "충남 평생교육이용권 신청", "경남 평생교육이용권 신청", "NH농협카드 채움카드 발급", "등록장애인 복지 지원", "장애인 교육 지원 제도", "평생교육이용권 우수이용자 70만원", "보조금24 신청 방법", "대전시 복지 지원"];
const HUB_LINKS = [{"title": "서울 평생교육이용권 | 4월 9일까지", "desc": "서울 4개 유형 자격·절차 정리", "href": "/w/서울-평생교육이용권"}, {"title": "인천 평생교육이용권 | 4월 8일까지", "desc": "인천형 소득 무관 유형 안내", "href": "/w/인천-평생교육이용권"}, {"title": "충남 평생교육이용권 | 4월 17일까지", "desc": "충남 신청 조건·사용처 안내", "href": "/w/충남-평생교육이용권"}, {"title": "경남 평생교육이용권 | 4월 17일까지", "desc": "경남 시군별 접수처 안내", "href": "/w/경남-평생교육이용권"}];
const STEPS = [{"title": "등록장애인 여부 확인", "desc": "장애인복지법에 따른 등록장애인이면 소득과 관계없이 신청 가능해요.", "tip": "장애등급 무관, 등록만 되어 있으면 돼요"}, {"title": "정부24(www.gov.kr) 접속", "desc": "정부24 → 보조금24 → '평생교육이용권' 검색 → 장애인 유형 선택해요.", "link": {"label": "www.gov.kr (정부24)", "url": "https://www.gov.kr"}}, {"title": "신청서 작성 + 제출", "desc": "자격 정보 입력 후 제출해요. 대리 신청 시 위임장·가족관계증명서가 필요해요.", "tip": "4월 3일 마감, 여유 있게 신청하세요"}, {"title": "선정 결과 통보", "desc": "문자·카카오톡으로 개별 통보. 선정 시 NH농협 채움카드에 35만원 포인트 자동 충전이에요."}, {"title": "강좌 수강 + 사용", "desc": "등록된 기관에서 수강료·교재비로 결제해요. 12월 31일까지 사용해야 해요.", "tip": "미사용 잔액 연말 자동 소멸"}];
const FAQS = [{"urgent": true, "q": "장애인 이용권은 반드시 정부24에서 신청해야 하나요?", "a": "네. 대전 장애인 평생교육이용권은 정부24(www.gov.kr) 보조금24에서 신청해요. lllcard.kr이 아니에요. 정부24 접속 후 '평생교육이용권' 검색 → 장애인 유형을 선택하면 돼요."}, {"urgent": true, "q": "대전 일반 이용권은 지금 신청 가능한가요?", "a": "아니에요. 대전 일반 이용권 1차(3.9~3.27)는 이미 마감됐어요. 현재(3월 기준) 대전에서 신청 가능한 건 장애인 이용권(4월 3일 마감)이에요. 2차 모집 공고를 기다리거나 대전시에 문의하세요."}, {"urgent": true, "q": "등록장애인이면 소득과 무관하게 신청할 수 있나요?", "a": "네. 장애인복지법에 따른 등록장애인이면 소득 조건 없이 신청할 수 있어요. 장애등급에 관계없이 등록장애인이면 해당돼요."}, {"urgent": false, "q": "가족이 대신 신청해줄 수 있나요?", "a": "정부24에서 법정대리인 또는 위임장을 통한 대리 신청이 가능해요. 위임장과 가족관계증명서 등 추가 서류가 필요해요."}, {"urgent": false, "q": "NH농협카드가 없어요.", "a": "선정 후 card.nonghyup.com 또는 NH농협은행·농축협 영업점에서 채움카드를 발급하면 돼요."}];
const COURSES = [{"cat": "자격증", "col": "#1D9E75", "items": ["컴퓨터활용능력", "정보처리기사", "사회복지사", "요양보호사"]}, {"cat": "어학", "col": "#2563EB", "items": ["영어 회화", "일본어", "중국어", "한국어 강좌"]}, {"cat": "AI·디지털", "col": "#7C3AED", "items": ["ChatGPT 활용", "영상편집", "스마트폰 활용", "정보기기 사용"]}, {"cat": "취미·생활", "col": "#D97706", "items": ["바리스타", "제과제빵", "공예", "인문학"]}];
const REFERENCES = [{"category": "공식 신청", "items": [{"label": "정부24(보조금24) 장애인 평생교육이용권 신청", "url": "https://www.gov.kr"}, {"label": "대전시 상담센터 ☎042-530-8200", "url": "tel:0425308200"}]}, {"category": "법령·카드", "items": [{"label": "평생교육법 제16조의2 — 평생교육이용권의 발급 등", "url": "https://www.law.go.kr/"}, {"label": "NH농협카드 채움카드 신규 발급", "url": "https://card.nonghyup.com"}]}];
const APPLY_URL = "https://www.gov.kr";
const APPLY_LABEL = "정부24(보조금24) 신청하기";
const DEADLINE_ISO = "2026-04-03T23:59:00+09:00";
const DEADLINE_LABEL = "2026년 4월 3일(금) 마감 (장애인 유형)";
const DEADLINE_SHORT = "4월 3일";
const NOTE_SPECIFIC = "대전 장애인 이용권: 정부24(보조금24) 전용 신청";
...
export default function DaejeonDisabledPage() {
  return (
    <div style={{ maxWidth: 1060, margin: "0 auto", padding: "2rem 1.5rem", fontFamily: "'Pretendard', 'Apple SD Gothic Neo', sans-serif", color: "#111", display: "flex", gap: 28, alignItems: "flex-start" }}>
      <Sidebar links={SIDEBAR_LINKS} />
      <div style={{ flex: 1, minWidth: 0 }}>
        <p style={{ fontSize: 13, color: "#1D9E75", fontWeight: 600, marginBottom: 10 }}>복지 · 교육 지원 · 대전광역시</p>
        <h1 style={{ fontSize: 26, fontWeight: 700, lineHeight: 1.45, marginBottom: 14 }}>
          2026 대전 장애인 평생교육이용권 |<br />
          정부24 신청방법·자격 정리
        </h1>
        <p style={{ fontSize: 15, color: "#374151", lineHeight: 2.1, marginBottom: "1rem" }}>
          대전 장애인 평생교육이용권은 신청 경로가 달라요.\nlllcard.kr이 아니라 정부24(보조금24)에서 신청해야 해요.\n4월 3일 마감 전에 경로와 자격을 먼저 확인하세요.
        </p>
        ...
        <H2>대전광역시 평생교육이용권, 신청 전에 이것부터 확인하세요</H2>
        <p style={body}>
          대전광역시에 주민등록이 있어야 대전광역시 공고로 신청할 수 있어요.<br />
          2026년부터 국가 단일 모집이 아닌 광역 지자체별 개별 모집으로 바뀌었어요.<br />
          타 지역 공고로 신청하면 자동 탈락이에요.
        </p>
        <GreenBox title="2026 대전광역시 1차 핵심 정보">
          신청 기간: 2026년 3월 16일(월) ~ 4월 3일(금) [장애인 유형]<br />
          지원 금액: 1인당 연 35만원 · 우수이용자 최대 70만원<br />
          신청 방법: www.gov.kr (PC·모바일 가능)<br />
          결제 수단: NH농협 채움카드 포인트 자동 충전<br />
          사용 기한: 2026년 12월 31일까지<br />
          ※ 일반 이용권 1차(3.9~3.27)는 이미 마감됐어요\n장애인 이용권은 정부24에서만 신청 가능해요
        </GreenBox>
        ...
        <p style={body}>
          온라인 사용기관은 전국 공통이에요. 대전광역시 어디서나 수강할 수 있어요.<br />
        ...
        <CTA url={APPLY_URL} deadline={DEADLINE_SHORT} ctaTitle={"4월 3일 마감이에요.\\n정부24에서 지금 신청하세요."} ctaDesc={"등록장애인이면 소득 조건 없이 신청할 수 있어요.\\n연 35만원 교육비 지원이에요."} />

        <Divider />
        <References refs={REFERENCES} />

        <div style={{ marginTop: "1.2rem", padding: "14px 18px", background: "#f9fafb", borderRadius: 10, fontSize: 12, color: "#9ca3af", lineHeight: 1.9 }}>
          이 글은 법률·정책 정보 제공을 목적으로 작성됐어요. 개별 선정 결과는 대전광역시 공고 기준에 따르며, 중요한 결정 전에 반드시 공식 출처를 직접 확인하세요.
          <br />※ 대전 장애인 이용권: 정부24(보조금24) 전용 신청
        </div>
      </div>
    </div>
  );
