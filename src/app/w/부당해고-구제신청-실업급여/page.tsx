...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={body}>
        네, 동시에 진행하면 돼요. 두 절차는 <strong>완전히 별개</strong>니까요.{" "}
      ...
      <p style={body}>
        복직되면 밀린 임금을 받고 실업급여를 반환하면 되죠.
        금전보상이면 보상금에 실업급여까지 다 챙길 수 있고요.
        결과별 처리 방식을 아래에서 정리했어요.
      </p>
      ...
      <p style={body}>
        부당하게 해고됐다고 판단되면{" "}
        <a href="https://www.nlrc.go.kr" style={{ color: "#1D9E75", textDecoration: "underline" }}>노동위원회</a>에 구제신청을 할 수 있어요.{" "}
        <a href="https://www.law.go.kr/법령/근로기준법" style={{ color: "#1D9E75", textDecoration: "underline" }}>근로기준법 제28조</a>에서 보장하는 권리죠.
        부당해고로 인정되면 <strong>복직</strong> 또는 <strong>금전보상</strong>을 받게 돼요.
      </p>
      <p style={body}>
        기한이 중요해요. 해고일로부터 <strong>3개월 이내</strong>에 지방노동위원회에 신청해야 하죠.
        하루라도 넘기면 신청 자체가 불가능해요.
        지방노동위원회 결과에 불복하면 중앙노동위원회에 재심을 청구할 수도 있고요.
      </p>
      <p style={body}>
        여기서 핵심을 짚어야 해요.
        구제신청을 넣었다고 해고가 바로 취소되는 게 아니에요.
      ...
      <p style={body}>
        ...
        워크넷 구직등록 → 수급자격 신청 → 실업인정 → 수령, 이 순서대로 진행하면 되죠.
        고용센터에 &quot;구제신청 진행 중&quot;이라는 사실만 알려주면 돼요.
      </p>
      <p style={body}>
        한 가지 주의할 점이 있어요.
      ...
      <p style={body}>
        금액은 퇴직 전 평균임금의 <strong>60%</strong>예요.
        2026년 기준 1일 상한액이 <strong>68,100원</strong>, 하한액이 <strong>66,048원</strong>이죠.
        월로 환산하면 최대 약 204만 원 정도가 돼요.
        아래 계산기에서 본인 예상 금액을 바로 확인해 보세요.
      </p>
      ...
      <p style={body}>
        ...
        각각 실업급여 처리 방식이 완전히 다르니까 미리 파악해두는 게 중요해요.
      </p>
      <p style={body}>
        <strong>복직 판정</strong>이 나오면 해고가 처음부터 무효가 돼요.
        법적으로 계속 재직 중이었던 셈이라, 받았던 실업급여를 <strong>반환</strong>해야 하죠.
        대신 해고 기간 동안의 <strong>밀린 임금</strong>을 회사에서 받게 돼요.
        밀린 임금에서 실업급여 반환금을 차감하는 식으로 정산하면 되고요.
      </p>
      <p style={body}>
        <strong>금전보상</strong>을 선택하면 이야기가 달라져요.
        복직 대신 보상금을 받는 거라 해고 자체는 유지되죠.
        실업 상태가 맞으니까 받은 실업급여를 돌려줄 필요가 없어요.
        회사와 관계가 틀어져서 복직이 현실적으로 어려운 분이 이 방법을 많이 택하죠.
      </p>
      <p style={body}>
      ...
      <p style={body}>
        ...
        &quot;복직될 것 같으니까 구직활동은 안 해도 되겠지?&quot; 이렇게 생각하는 분이 많죠.
        실업급여는 구직활동을 해야 나오는 제도라, 구제신청 여부와 무관하게 실업인정을 반드시 받아야 해요.
      </p>
      <p style={body}>
      ...
      <p style={body}>
        ...
        구제신청은 해고 직후 바로 넣는 게 좋고, 실업급여도 미루지 말아야 수급일수를 최대한 확보할 수 있죠.
        두 절차 모두 해고 직후에 동시 시작하는 게 가장 유리해요.
      </p>
      ...
      <p style={body}>
        ...
        노동위원회에는 부당해고 구제신청,{" "}
        <a href="https://www.ei.go.kr" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용24</a>에서는 실업급여 신청이에요.
        노동위원회 상담전화는 <strong>02-6906-5500</strong>, 고용센터는 <strong>1350</strong>이죠.
        어디부터 해야 할지 모르겠으면 전화 상담부터 받아보세요.
      </p>
      <p style={body}>
        어떤 결과가 나오든 손해 보는 구조가 아니에요.
        복직되면 밀린 임금을 받죠.
        금전보상이면 보상금에 실업급여까지 챙기게 돼요.
        기각되더라도 중대한 귀책사유가 아닌 이상 실업급여는 유지되고요.
