...
const CHECK_ITEMS = [
  { id: "c1", label: "퇴직일로부터 14일이 지났어요" },
  { id: "c2", label: "퇴직금 지급 기한 연장에 서면 합의하지 않았어요" },
  { id: "c3", label: "퇴직금이 아직 입금되지 않았어요" },
...
const STEPS = [
  {
    title: "14일 경과 여부 확인",
    desc: "퇴직금은 퇴직일 다음 날부터 14일 이내(달력일 기준)에 지급해야 해요. 합의 없이 이 기한을 넘기면 체불에 해당해요. 지연이자(연 20%)는 14일이 지난 다음 날부터 실제 지급일까지 자동 발생해요.",
  ...
  {
    title: "고용노동청 진정",
    desc: "내용증명 후에도 지급하지 않으면 관할 고용노동청에 체불 진정을 내요. 고용24 온라인 또는 방문으로 접수할 수 있어요. 근로감독관이 조사 후 지급 명령을 내려요.",
...
const CHECKLIST = [
  ...
  "서면 합의 여부: 연장 합의서에 이자 포기 조항 없는지 확인",
...
const FAQS = [
  {
    ...
    a: "근로자와 사업주가 서면으로 지급 기한 연장에 합의하면 합법이에요. 다만 합의 없이 14일을 넘기면 위법이고, 형사 고발도 가능해요. 회사가 일방적으로 늦추는 건 체불에 해당해요.",
  },
  {
    q: "지연이자 연 20%는 언제부터 계산하나요?",
    a: "퇴직일로부터 14일이 지난 다음 날부터 실제 지급일까지 연 20%를 계산해요. 예를 들어 1,000만원이 30일 지연됐다면 약 16만원의 지연이자가 발생해요.",
  },
  {
    q: "회사가 지급 기한 연장 동의서에 서명하라고 하면 어떻게 해야 하나요?",
    a: "서명 전에 내용을 꼼꼼히 읽어보세요. 이자 포기 조항이 들어 있으면 지연이자 청구권을 잃어요. 구체적인 지급일과 이자 조항이 빠져 있다면 서명하지 않는 게 유리해요.",
  },
  {
    q: "퇴사한 지 1년이 됐는데 아직도 청구할 수 있나요?",
    a: "청구할 수 있어요. 퇴직금 청구권 소멸시효는 3년이에요. 퇴직 후 3년이 지나지 않았다면 고용노동청 진정이나 소액심판으로 지금도 청구 가능해요.",
  },
  {
    q: "퇴직금을 IRP가 아닌 일반 계좌로 받았는데 문제가 있나요?",
    a: "300만원 초과 퇴직금을 IRP 아닌 계좌로 받은 건 회사 측 위반이에요. 퇴직금을 받은 근로자에게는 불이익이 없어요. 회사가 위법 처리될 수 있어요.",
  },
];
  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        퇴직금은 퇴직일 다음 날부터 14일 이내에 지급해야 해요.
        <a href="https://www.law.go.kr/법령/근로기준법" style={{ color: "#1D9E75", textDecoration: "underline" }}>근로기준법 제36조</a>에 명시된 규정이에요.
        달력일 기준이라 공휴일이 껴있어도 관계없어요.
        14일을 넘기면 연 20%의 <a href="/w/퇴직금-지연이자" style={{ color: "#1D9E75", textDecoration: "underline" }}>지연이자</a>가 자동으로 발생하고, <a href="/w/퇴직금-미지급-신고" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용노동청 신고</a>나 소액심판으로 청구할 수 있어요.
      </p>
      ...
      <p style={body}>
        퇴직금 지급 기한은 퇴직일 다음 날부터 14일이에요. 근무일이 아닌 달력일 기준이에요.
        공휴일이나 주말이 포함돼도 기한이 늘어나지 않아요.
      ...
      <EligibilityChecker
        items={CHECK_ITEMS}
        allMatchText="지연이자 청구 조건에 해당해요. 아래 계산기로 금액을 확인하고 바로 대응하세요."
      ...
      <p style={body}>
        ...
        미지급 퇴직금과 14일 초과 지연 일수를 입력하면 지연이자를 바로 확인할 수 있어요.
        지연이자도 퇴직금과 함께 청구할 수 있어요.
      </p>
      ...
      <p style={body}>
        ...
        연장 합의서의 이자 포기 조항을 놓치면 지연이자를 잃을 수 있어요.
      </p>
