  ...
  return (
    ...
    >
      ...
      <p style={body}>
        ...
        다만 아무 유족이나 받을 수 있는 건 아니에요. 법이 정한 수급 순위가 있고, 소멸시효도 3년이에요.
      </p>
      <p style={body}>
      ...
      <p style={body}>
        지급 금액은 사망자가 생전에 받던 구직급여와 동일해요. 2026년 기준으로 1일 상한액 <strong>68,100원</strong>, 하한액 <strong>66,048원</strong>이죠. 미지급분이 50일이라면 상한액 기준으로 약 340만원 정도 돼요.
      </p>
      <p style={body}>
