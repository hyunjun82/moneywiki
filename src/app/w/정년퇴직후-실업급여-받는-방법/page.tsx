...
export default function Page() {
  return (
    ...
    >
      ...
      <p style={body}>
        많이 헷갈리는 부분인데, 핵심은 <strong>&ldquo;퇴직 시 나이&rdquo;가 아니라 &ldquo;입사 시 나이&rdquo;</strong>예요. 퇴직할 때 70세라도 입사할 때 65세 미만이었으면 문제없죠. 수급기간도 이 기준으로 결정되니까, 입사 시점을 먼저 확인하세요.
      </p>
      ...
      <p style={body}>
        수급기간은 <strong>나이</strong>와 <strong>피보험기간</strong>(고용보험 가입 기간) 두 가지로 정해져요. 50세 이상이면 같은 피보험기간이라도 수급일수가 더 길어지죠. 정년퇴직자는 대부분 50세 이상이라 유리한 기준이 적용돼요.
      </p>
      <p style={body}>
      ...
      <p style={body}>
        새 직장에 정식 취업한 경우에는 <strong>실업급여가 중단</strong>돼요. 다만 수급기간의 절반 이상 남기고 재취업했다면 <strong>조기재취업수당</strong>을 받을 수 있죠. 남은 수급일수의 절반을 일시금으로 주는 제도예요. 빨리 재취업할수록 유리한 구조이기도 하고요.
      </p>
      <p style={body}>
      ...
      <p style={body}>
        수급기간 동안 <strong>구직활동도 필수</strong>예요. 1~4주 간격으로 실업인정일에 고용센터에 출석하거나 온라인으로 보고해야 하죠. &ldquo;이제 은퇴할 거라 일할 생각이 없다&rdquo;고 하면 수급자격이 유지되지 않아요. 재취업 의사와 능력이 있어야 한다는 게 법이 정한 조건이에요.
      </p>
      <p style={body}>
