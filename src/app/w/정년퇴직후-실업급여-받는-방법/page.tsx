  ...
  return (
    ...
    >
      ...
      <p style={{ ...body, fontSize: 15, lineHeight: 2.1 }}>
        "정년퇴직했는데 실업급여를 받을 수 있을까?"<br />
        받을 수 있어요. 정년퇴직은 본인 의지가 아니라 회사 규정에 따른 퇴직이니까요.<br /><br />
        <a href="https://www.law.go.kr/법령/고용보험법" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험법</a>에서
        정년퇴직을 <strong>비자발적 퇴사</strong>로 분류해요. <strong>65세 이전에 입사</strong>해서 고용보험에 가입한 상태라면
        실업급여 수급 자격이 있죠. 50세 이상은 수급기간도 길어서, 10년 이상 근무했다면 최대 <strong>270일(약 9개월)</strong>,
        월 최대 약 <strong>204만원</strong>까지 받을 수 있어요.
      </p>
      ...
      <p style={body}>
        실업급여를 받으려면 고용보험에 가입돼 있어야 해요. 그런데 <a href="https://www.law.go.kr/법령/고용보험법" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용보험법 제10조</a>에서 <strong>65세 이후에 새로 취업한 사람</strong>은 고용보험 가입 대상에서 제외하고 있죠. 고용보험에 가입이 안 되니 실업급여도 나올 수 없는 구조예요.
      </p>
      <p style={body}>
        반대로, <strong>65세 이전에 입사해서 계속 근무</strong>한 분은 정년이 65세를 넘더라도 고용보험이 유지돼요. 60세에 입사해서 68세까지 다녔다면 고용보험 피보험자 자격이 그대로 살아 있는 거죠. 이 경우 정년퇴직하면 실업급여를 받을 수 있어요.
      </p>
      <p style={body}>
        헷갈리는 분이 많은데, 핵심은 <strong>"퇴직 시 나이"가 아니라 "입사 시 나이"</strong>예요. 퇴직할 때 70세여도 입사할 때 65세 미만이었으면 문제없죠. 퇴직 나이가 아니라 입사 나이로 판단한다는 점을 꼭 기억하세요.
      </p>
      ...
      <p style={body}>
        실업급여 수급기간은 <strong>나이</strong>와 <strong>피보험기간</strong>(고용보험 가입 기간) 두 가지로 결정돼요. 50세 이상이면 같은 피보험기간이라도 수급일수가 더 길어지죠. 정년퇴직자는 대부분 50세 이상이라 유리한 기준이 적용돼요.
      </p>
      <p style={body}>
        피보험기간 1년 미만이면 나이와 관계없이 120일로 동일해요. 1년~3년이면 50세 이상은 <strong>180일</strong>, 3년~5년이면 <strong>210일</strong>, 5년~10년이면 <strong>240일</strong>, 10년 이상이면 최대 <strong>270일</strong>을 받을 수 있죠.
      </p>
      ...
      <p style={body}>
        정년퇴직자는 근속기간이 긴 경우가 대부분이에요. 같은 회사에서 20년, 30년 일한 분이라면 피보험기간 10년을 가뿐히 넘기니까 <strong>270일(약 9개월)</strong> 동안 받게 되죠. 금액은 퇴직 전 평균임금의 <strong>60%</strong>이고, 2026년 기준 1일 상한액 68,100원, 하한액 66,048원이에요.
      </p>
      ...
      <p style={body}>
        첫 번째 단계는 <strong>이직확인서 확인</strong>이에요. 회사가 퇴직 후 10일 이내에 고용센터에 이직확인서를 제출해야 하죠. <a href="https://www.ei.go.kr" style={{ color: "#1D9E75", textDecoration: "underline" }}>고용24</a>에 접속하면 처리 여부를 확인할 수 있어요. 이직 사유가 "정년퇴직" 또는 "정년"으로 기재돼 있는지 꼭 살펴보세요.
      </p>
      <p style={body}>
        두 번째는 <strong>워크넷 구직등록</strong>이에요. 워크넷(work.go.kr)에서 구직등록을 완료해야 해요. 실업급여는 재취업 의사가 있는 사람에게 주는 급여라서, 구직활동 의지를 보여줘야 하죠. 온라인으로 5분이면 끝나요.
      </p>
      <p style={body}>
        세 번째로 관할 <strong>고용센터에 직접 방문</strong>해서 수급자격을 신청해요. 신분증, 통장 사본, 증명사진 1장이 필요하죠. 수급자격이 인정되면 7일의 대기기간을 거친 뒤 실업인정을 받을 때마다 실업급여가 입금돼요. 실업인정은 1~4주 간격으로 온라인 또는 방문으로 진행해요.
      </p>
      ...
      <p style={body}>
        정년퇴직 후 새 직장에 취업하면 실업 상태가 아니기 때문에 <strong>실업급여가 중단</strong>돼요. 수급기간의 절반 이상 남기고 재취업했다면 <strong>조기재취업수당</strong>을 신청할 수 있죠. 남은 수급일수의 절반을 일시금으로 받는 제도예요.
      </p>
      <p style={body}>
        정년퇴직 후 <strong>촉탁직으로 재계약</strong>하는 경우도 많아요. 촉탁직으로 일하는 동안은 실업 상태가 아니라 실업급여를 신청할 수 없어요. 촉탁 계약이 종료된 뒤에 신청하면 되죠. 촉탁 기간도 피보험기간에 포함되니까 수급일수가 늘어나는 효과가 있어요.
      </p>
      <p style={body}>
        <strong>비상근 고문</strong>으로 재계약한 경우는 달라요. 고문은 근로자가 아니라 고용보험 가입 대상이 아니에요. 이 경우에는 정년퇴직 시점에 실업급여를 바로 신청할 수 있고, 정년퇴직까지의 피보험기간을 기준으로 수급일수가 산정돼요.
      </p>
      ...
      <p style={body}>
        가장 중요한 건 <strong>신청 기한 12개월</strong>이에요. 퇴직일로부터 12개월 안에 실업급여를 받아야 하죠. 늦게 신청할수록 실제로 받을 수 있는 기간이 줄어들어요. 수급일수가 270일이더라도 퇴직 후 6개월 뒤에 신청하면 남은 6개월 안에 소화해야 하니까요.
      </p>
      <p style={body}>
        수급 기간 동안 <strong>구직활동도 필수</strong>예요. 1~4주 간격으로 실업인정일에 고용센터에 출석하거나 온라인으로 보고해야 하죠. "이제 은퇴할 거라 일할 생각이 없다"고 하면 수급자격이 유지되지 않아요. 재취업 의사와 능력이 있어야 한다는 게 법이 정한 조건이에요.
      </p>
      <p style={body}>
        한 가지 더 알아두세요. <strong>국민연금, 퇴직금, 실업급여는 모두 동시에 받을 수 있어요.</strong> 서로 다른 제도이기 때문에 중복 수령에 아무런 제한이 없죠. 정년퇴직하면 퇴직금 + 국민연금 + 실업급여, 세 가지를 함께 챙기는 게 맞아요.
      </p>
