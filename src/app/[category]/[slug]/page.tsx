...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      title: article.title,
      description: article.metaDescription,
      url: `https://www.jjyu.co.kr/${catSlug}/${spokeSlug}`,
      type: "article",
      publishedTime: article.datePublished,
      modifiedTime: article.dateModified,
      authors: ["https://www.jjyu.co.kr/about"],
      siteName: "머니위키",
      locale: "ko_KR",
    },
    twitter: {
    ...
    alternates: {
      canonical: `https://www.jjyu.co.kr/${catSlug}/${spokeSlug}`,
    },
  };
}
...
export default async function SpokePage({ params }: PageProps) {
  ...
  const url = `https://www.jjyu.co.kr/${catSlug}/${spokeSlug}`;
      ...
      <div className="border-b bg-white">
        <div className="mx-auto max-w-3xl px-4 py-3">
          <nav className="flex items-center gap-1 text-sm text-gray-500">
            ...
            <Link href={`/${catSlug}`} className="hover:text-[#1B3A5C]">
              {catInfo.name}
            </Link>
            <svg
              className="h-3.5 w-3.5"
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                position: 2,
                name: catInfo.name,
                item: `https://www.jjyu.co.kr/${catSlug}`,
              },
              {
                "@type": "ListItem",
                position: 3,
