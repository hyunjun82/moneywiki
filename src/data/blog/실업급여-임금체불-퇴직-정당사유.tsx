    ...
    >
      ...
      <RelatedArticles
        items={[
          ...
          { num: "03", title: "임금삭감 퇴직 정당사유", desc: "실업급여·퇴직사유", href: "/w/실업급여-임금삭감-퇴직-정당사유" },
          { num: "04", title: "직장내 괴롭힘 퇴직 정당사유", desc: "실업급여·퇴직사유", href: "/w/실업급여-직장내-괴롭힘-퇴직-정당사유" },
