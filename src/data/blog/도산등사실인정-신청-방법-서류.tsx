...
export default function Page() {
  ...
  const toc = [
    ...
    { t: "필요 서류 뭐가 있나요?", sub: "폐업 증빙 · 임금체불 증빙 서류 목록" },
    { t: "심사 기간은 얼마나 걸리나요?", sub: "처리 기간 2~6주 · 빠른 처리 방법" },
    { t: "자주 묻는 질문" },
  ];
  ...
  return (
    ...
    >
      ...
      <CheckerShell title="도산등사실인정 신청 준비가 됐나요?" sub="30초 확인">
        ...
        {result === "official_yes" && (
          <ResultPass title="서류가 갖춰졌어요. 바로 신청하세요">
            ...
            <ResultCTA icon="📋" title="고용노동부 관할 지청 신청" desc="지청 방문 접수" href="https://www.moel.go.kr" />
          </ResultPass>
        )}
        {result === "official_no" && (
      ...
      {/* SECTION 04 */}
      <Sec n="SECTION 04" id="s4" title="필요 서류는 뭐가 있나요?" sub="폐업 증빙 · 임금체불 증빙 서류 목록" />
      ...
      {/* SECTION 05 */}
      <Sec n="SECTION 05" id="s5" title="심사 기간은 얼마나 걸리나요?" sub="처리 기간 2~6주 · 빠른 처리 방법" />
