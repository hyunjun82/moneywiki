...
export default function Page() {
  ...
  const links: ResLink[] = [
    { icon: "📋", title: "고용노동부 도산등사실인정 신청", desc: "관할 지청 방문 접수", href: "https://www.moel.go.kr" },
    { icon: "💰", title: "도산대지급금 신청 방법", desc: "인정서 발급 후 2년 기한 절차", href: "/w/도산대지급금-신청-방법-절차" },
  ];

  const toc = [
    { t: "STEP 01 신청 가능 여부 확인" },
    { t: "도산등사실인정 사업 폐지란 뭐예요?", sub: "법원 파산 없이 인정 받는 방법" },
    { t: "사업 폐지 vs 영업양도 차이가 뭐예요?", sub: "임금채권 처리 방식 · 연대책임 여부" },
    { t: "사업 폐지 사실상 도산 기준은 어떻게 되나요?", sub: "지급 불능 증거 · 폐지 증거 기준" },
    { t: "사업 영업양도 임금채권 어떻게 청구하나요?", sub: "양수인 연대책임 · 동시 청구 방법" },
    { t: "자주 묻는 질문" },
  ];
  ...
  return (
    ...
    >
      ...
      {/* SECTION 02 */}
      <Sec n="SECTION 02" id="s2" title="도산등사실인정 사업 폐지란 뭐예요?" sub="법원 파산 없이 인정 받는 방법" />
      ...
      <InlineLink
        icon="📋"
        title="도산등사실인정 신청 방법 — 고용노동부 지청 4단계"
        desc="신청서 제출부터 인정서 발급까지 절차 정리"
        href="/w/도산등사실인정-신청-방법-서류"
      />
      ...
      {/* SECTION 04 */}
      <Sec n="SECTION 04" id="s4" title="사업 폐지 사실상 도산 기준은 어떻게 되나요?" sub="지급 불능 증거 · 폐지 증거 기준" />
      ...
      <InlineLink
        icon="🏢"
        title="도산등사실인정 사업주 요건 — 6개월 이상 산재보험"
        desc="사업주 규모·기간 조건이 충족되어야 신청 가능해요"
      ...
      {/* SECTION 05 */}
      <Sec n="SECTION 05" id="s5" title="사업 영업양도 임금채권 어떻게 청구하나요?" sub="양수인 연대책임 · 동시 청구 방법" />
      ...
      <SpokeLink num={1} title="도산등사실인정 신청 방법 서류" desc="고용노동부 지청 신청 4단계 절차" href="/w/도산등사실인정-신청-방법-서류" />
      <SpokeLink num={2} title="도산대지급금 신청 방법 절차" desc="2년 기한과 필요 서류 목록" href="/w/도산대지급금-신청-방법-절차" />
