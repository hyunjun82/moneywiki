      ...
      <div className="checker-wrap">
        <div className="checker-card">
          <div className="ck-header">
            <strong className="ck-title">취업신고, 나는 해야 하나요?</strong>
            <span className="ck-sub">30초 확인</span>
          </div>
          <p className="ck-intro">취업 여부와 신고 상태만 알면 바로 판정돼요.</p>

          <div className="ck-group">
            <p className="ck-q">현재 취업 상태가 어떻게 되나요?</p>
            <div className="ck-opts">
              {[
                ...
                <button
                  key={o.v}
                  className={`ck-opt${sel.employed === o.v ? " on" : ""}`}
                  onClick={() => setSel((p) => ({ ...p, employed: o.v }))}
                >
                  {o.t}
                </button>
              ))}
          ...
          <div className="ck-group">
            ...
            <div className="ck-opts">
              {[
                ...
                <button
                  key={o.v}
                  className={`ck-opt${sel.reported === o.v ? " on" : ""}`}
                  onClick={() => setSel((p) => ({ ...p, reported: o.v }))}
                >
                  {o.t}
                </button>
              ))}
