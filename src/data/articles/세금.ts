      ...
      mainSections: [
        ...
        },
        {
          ...
          link: {
            slug: "상속세-계산-세율-공제",
            label: "상속세 계산 방법 보기",
            bridge: "두 방식의 차이를 잡으셨나요? 그렇다면 현행 기준으로 실제 얼마가 나오는지부터 맞춰 보시는 게 좋겠죠.",
          },
          sourceQuote: {
            excerpt:
