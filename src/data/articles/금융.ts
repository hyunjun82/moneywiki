...
export const 금융: ArticleCategory = {
  ...
  articles: [
    ...
    },
    {
      ...
      heroHook:
        "가입 자격은 넓지만 **혜택 조건은 따로 붙습니다.** 열아홉이면 소득과 무관하게 계좌를 열 수 있는데, 감면받은 세금은 **3년을 채워야** 내 것으로 남습니다.\n\n놓치기 쉬운 대목은 두 가지입니다. 직전 3개년 금융소득종합과세 대상자는 **입구에서 걸리고**, 비과세 한도를 400만원으로 올리려면 소득 증빙을 따로 내야 합니다. 가입자격부터 한 줄씩 맞춰 보시죠.",
    ...
    },
    {
      ...
      heroHook:
        "IRP의 혜택은 **세 겹입니다.** 넣을 때 세액공제를 받고, 굴리는 동안 과세를 미루고, 받을 때 낮은 세율로 냅니다.\n\n가장 크게 갈리는 지점은 마지막입니다. 같은 돈을 **연금으로 받느냐 한 번에 찾느냐**에 따라 세율이 몇 배 차이 납니다. 받는 방법을 정하는 순간 세금이 정해지니, 연금수령 요건부터 맞춰 보시죠.",
