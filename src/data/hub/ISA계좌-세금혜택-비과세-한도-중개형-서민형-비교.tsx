/**
 * ISA계좌 세금혜택 비과세 한도 | 중개형 서민형 유형 비교 2026 — 허브
 *
 * 팩트체크 완료 (2026-02-13):
 * - 비과세: 서민형 400만원, 일반형 200만원 (개정안 미통과, 현행 유지)
 * - 납입: 연 2,000만원, 누적 1억원 (현행 유지)
 * - 이월: 가능 (2021년 개정)
...
const data: HubData = {
  ...
  meta: {
    title: 'ISA계좌 세금혜택 비과세 한도 | 중개형 서민형 유형 비교 2026',
    description: 'ISA계좌 비과세 한도가 서민형은 400만원까지라는 거 아시나요? 중개형 서민형 차이부터 납입한도 이월, 연금전환 세액공제까지 한 글에 정리해드려요.',
    keywords: [
      'ISA계좌 비과세 한도',
      'ISA계좌 중개형 서민형',
      'ISA 세금혜택 절세',
    ...
    ogTitle: 'ISA계좌 세금혜택 비과세 한도 | 중개형 서민형 유형 비교 2026 | 머니위키',
  ...
  toc: [
    ...
    { id: 'sec-manage', text: 'ISA계좌 납입한도와 만기는 어떻게 되나요?' },
    { id: 'sec-invest', text: 'ISA계좌에서 뭘 사야 절세되나요?' },
  ...
  sections: [
...

    {
      ...
      content: (
        <>
          ...
          <p>
            서민형이면 일반 계좌보다 <strong>67만원 절세</strong>돼요. 일반형도 47만원을 아껴요. ISA는 <strong>손익통산</strong>도 적용되는데, A주식에서 100만원 손해보고 B주식에서 200만원 벌었으면 순이익 100만원에만 세금을 매겨요. 일반 계좌에서는 손해 본 건 반영 안 되고 벌어들인 200만원 전체에 세금을 내야 해요.
          </p>
      ...
      sectionSpoke: [
        { icon: '💰', title: 'ISA계좌 비과세 한도와 손익통산 절세 계산', desc: '수익 구간별 정확한 절세액 + ISA 절세 계산기', href: '/w/ISA계좌-비과세-한도-손익통산-절세-계산' },
      ],
      bridgeCTA: {
        href: '#checker',
        badge: '계산기',
        ...
        <>
          ...
          <HubTable
            ...
            rows={[
              ...
              ['연 수수료', { text: '0.003~0.01%', highlight: true }, '0.3~0.5%', '0.5~1.0%'],
              ['수익률 잠재력', '높음', '중간', '중간'],
              ['난이도', '직접 판단', '낮음', '낮음'],
            ]}
          />
          ...
          <HubTable
            ...
            rows={[
              ['소득 조건', '제한 없음', { text: '총급여 5,000만원 이하', highlight: true }, '종합소득 3,800만원 이하'],
...

    {
      ...
      content: (
        <>
          ...
          <div className="my-4 space-y-0">
            <div className="flex gap-3 pb-3 border-b border-neutral-100">
              ...
              <div>
                ...
                <p className="text-xs text-neutral-500 leading-relaxed m-0">중개형은 토스증권·미래에셋증권, 신탁형은 KB국민은행이 인기 많아요.</p>
              </div>
            </div>
          ...
          <HubTipBox title="증권사별 수수료 차이">
            <p className="mb-0 leading-relaxed">
              미래에셋·삼성증권이 평생 우대 수수료(0.003~0.004%)를 제공해요. 토스증권·카카오페이증권도 저렴한 편이에요. 3,000만원 투자 시 3년이면 수수료 차이가 수만 원 나요.
            </p>
          </HubTipBox>
        </>
      ),
      ...
      bridgeCTA: {
        ...
        desc: '연간 2,000만원까지 납입할 수 있고, 못 채운 한도는 다음 해로 이월돼요.',
      },
    },

    {
      id: 'sec-manage',
      tag: '05 운용',
      heading: 'ISA계좌 납입한도와 만기는 어떻게 되나요?',
      subtitle: '연 2,000만원 한도, 이월 가능, 3년 만기, 원금 자유 인출',
      content: (
        <>
          <p>
            ISA에 넣을 수 있는 돈은 <strong>연간 2,000만원, 누적 1억원</strong>이에요. 2021년 개정으로 미사용 한도의 <strong>이월이 가능</strong>해졌어요. 올해 1,000만원만 넣었다면 남은 1,000만원은 다음 해로 이월돼서, 내년에는 최대 3,000만원까지 넣을 수 있어요. 월별 한도는 없어서 한 번에 2,000만원을 넣어도 돼요.
          </p>
          <p>
...

    {
      ...
      content: (
        <>
          ...
          <HubTable
            id="tbl-etf"
            title="ISA에 적합한 ETF 유형"
            subtitle="배당·이자 수익이 높을수록 ISA 효과 큼"
            headers={['ETF 유형', '특징', '배당률 범위', '보수']}
            rows={[
              [{ text: '국내 고배당', highlight: true }, 'KODEX 고배당 등', '3~5%', '0.2~0.3%'],
              ['미국 배당 추종', 'TIGER 미국배당다우존스 등', '2~4%', '0.07~0.15%'],
              ['국내 대형주', 'KODEX 200 등', '1.5~2.5%', '0.05~0.15%'],
              ['채권형', 'KODEX 단기채권 등', '3~4%', '0.05~0.1%'],
            ]}
          />

          <p>
            고배당 ETF를 50% 이상 넣고, 안정 ETF와 채권 ETF를 섞으면 연 3~4% 배당을 받으면서 비과세 혜택을 최대로 누릴 수 있어요. 1,000만원 투자 시 연 배당 40만원 기준으로 3년이면 120만원인데, 서민형이면 전액 비과세예요.
          </p>
  ...
  faq: [
    ...
    { question: '미사용 납입한도가 다음 해로 이월되나요?', answer: '<strong>네, 2021년 개정 이후 이월이 가능해요.</strong> 올해 1,000만원만 넣었으면 남은 1,000만원이 내년으로 이월돼서 최대 3,000만원까지 넣을 수 있어요. 누적 한도 1억원 안에서 가능해요.' },
  ],
  ...
  summary: [
    ...
    <>3년 의무 유지해야 비과세 받고, 연간 <strong>2,000만원</strong>까지 납입 가능하며 미사용분은 <strong>이월</strong>돼요.</>,
  ],

  source: { name: '금융위원회', date: '2026.02 기준' },
