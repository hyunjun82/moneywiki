  ...
  spokeGroups: [
    {
      title: '급여별 상세',
      spokes: [
        { slug: '1인가구-생계급여-조건', title: '1인가구 생계급여 조건과 소득인정액 계산', desc: '선정기준 820,556원 · 실수령액 계산 예시', badge: '급여' },
        { slug: '의료급여-1종-2종-차이', title: '의료급여 1종 2종 차이 — 본인부담금 비교', desc: '1종 본인부담 0원 · 건강보험료 면제', badge: '급여' },
        { slug: '주거급여-임차료-지원금', title: '주거급여 임차료 지원금 — 서울 1인 최대 35만원', desc: '기준임대료 · 자가 수선유지급여', badge: '급여' },
        { slug: '교육급여-지원-항목', title: '교육급여 지원 항목과 금액', desc: '교육활동지원비 연 최대 65만원', badge: '급여' },
      ],
    },
    {
      title: '소득인정액 계산',
      spokes: [
        { slug: '소득인정액-계산-사례', title: '소득인정액 계산 사례 — 가구유형별 예시', desc: '근로소득공제 30% · 복지로 모의계산', badge: '계산' },
        { slug: '재산-소득환산율', title: '재산의 소득환산율 — 자동차, 전세금 기준', desc: '기본재산액 서울 9,900만원 공제', badge: '계산' },
      ],
    },
    {
      title: '부양의무자·대안 제도',
      spokes: [
        { slug: '부양의무자-기준-면제', title: '부양의무자 기준 면제 조건 — 의료급여 유지', desc: '연소득 1.3억 · 재산 12억 기준', badge: '제도' },
        { slug: '차상위계층-조건', title: '차상위계층 조건과 혜택', desc: '중위소득 50% 이하 · 의료비 감면', badge: '제도' },
        { slug: '긴급복지지원-신청', title: '긴급복지지원 신청 방법 — 선지급 후 조사', desc: '최대 71만원 · 즉시 지원', badge: '제도' },
      ],
    },
  ],
