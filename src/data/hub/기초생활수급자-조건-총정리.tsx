    ...
    // ===== 06 신청 =====
    {
      ...
      content: (
        <>
          ...
          <div className="bg-[#FFF8E1] border border-[#FFE082] rounded-xl py-5 px-6 my-5">
            ...
            <a href="/w/차상위계층-조건-혜택" className="inline-flex items-center gap-1 bg-[#1E3A5F] !text-white text-[13px] font-bold py-[10px] px-5 rounded-lg no-underline hover:bg-[#2B5280] transition-colors">
              차상위계층 조건 확인 →
            </a>
          </div>
        </>
