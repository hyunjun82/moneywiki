...
export const CATEGORY_MIGRATION_MAP: Record<string, string> = {
  ...
  // 아래는 글의 category 값이 아니라, 본문·페이지에 하드코딩된 /category/ 주소다.
  // 그 이름의 카테고리가 없어 전부 404 였다(예: /category/고용 235곳, /category/근로-노동 25곳).
  // 어디로 보낼지는 그 주제를 다루는 기존 글들의 실제 category 값을 세어 정했다.
  "근로-노동": "근로",   // "근로/노동" 의 하이픈 표기
  "임금": "근로",        // 임금 관련 48편 중 36편이 근로/노동
  "산재": "근로",        // 산재 22편 중 17편이 근로/노동
  "육아": "근로",        // 육아 26편 중 16편이 근로/노동 (육아휴직)
  "기업": "근로",        // 장애인고용부담금 등 사업주 의무
  "국민연금": "퇴직",     // 맵의 "연금": "퇴직" 과 같은 갈래
  "기초연금": "복지",
  "복지-연금": "복지",   // "복지/연금" 의 하이픈 표기
  "소상공인지원": "복지",
  "주거": "부동산",
  "이혼": "법률",        // 맵의 "가정법률": "법률" 과 같은 갈래
  "경제·금융": "금융",
  "자동차": "세금",      // 유류세 환급 등 세금 문서에서 부른다
  "교육-장학금": "교육",  // "교육/장학금" 의 하이픈 표기
};
