...
import ISA가입Checker from '@/components/checkers/ISA가입Checker'
...
const data: SpokeData = {
  ...
  prevNext: {
    prev: { title: 'ISA계좌 중개형 서민형 일반형 | 유형별 장단점 선택 기준', href: '/w/ISA계좌-중개형-서민형-일반형-유형-선택-기준' },
    next: { title: 'ISA계좌 납입한도 이월 규정 | 연간 한도 누적 한도 관리법', href: '/w/ISA계좌-납입한도-연간-2000만원-이월-규정' },
  },
  ...
  sections: [
    {
      ...
      content: (
        <>
          ...
          <p className="text-neutral-600 mb-4 leading-relaxed">
            서민형은 소득 조건이 있지만 일반형은 제한이 없어요. <a href="/w/ISA계좌-중개형-서민형-일반형-유형-선택-기준">서민형</a> 조건이 안 되면 일반형으로 가입하면 돼요. 이미 ISA 계좌가 있는데 다른 증권사로 옮기고 싶으면, 기존 계좌를 해지하고 새로 개설해야 해요. 3년 의무기간이 리셋되니까 신중하게 결정하세요.
          </p>
    ...
    },
    {
      id: 'checker',
      number: 'CHECK',
      heading: 'ISA 가입 가능한지 확인해 볼까요?',
      subtitle: '3가지만 선택하면 바로 알 수 있어요',
      content: <ISA가입Checker />,
    },
...

    {
      ...
      content: (
        <>
          ...
          <p className="text-neutral-600 mb-4 leading-relaxed">
            개설 후에는 <strong>자동이체를 바로 설정</strong>하세요. 매달 정해진 금액을 자동으로 넣으면 잊지 않고 꾸준히 투자할 수 있어요. <a href="/w/ISA계좌-납입한도-연간-2000만원-이월-규정">연간 한도 2,000만원</a>을 꽉 채우려면 월 166만원이 필요하고, 여유가 없으면 50만원부터 시작해도 돼요.
          </p>
