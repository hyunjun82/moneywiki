...
const data: SpokeData = {
  ...
  prevNext: {
    ...
    next: { title: '기초생활수급자 조건 총정리', href: '/w/기초생활수급자-조건-총정리' },
  },
  ...
  sections: [
      ...
      content: (
        <>
          ...
          <SpokeLinks
            title="소득인정액 더 알아보기"
            items={[
              { num: '01', heading: '기초생활수급자 조건과 급여 총정리', desc: '4가지 급여별 선정기준과 신청 방법 한 번에 확인', href: '/w/기초생활수급자-조건-총정리' },
            ]}
          />
        </>
      ),
...

    {
      ...
      content: (
        <>
          <p className="text-neutral-600 mb-4 leading-relaxed">
             2026년 기준으로 <strong>생계급여, <a href="/w/주거급여-신청" className="text-[#4A7AB5] underline">주거급여</a>, 교육급여</strong>의 부양의무자 기준은 <strong>완전 폐지</strong>됐어요. 부모님이나 자녀가 돈을 많이 벌어도 내 소득인정액만 기준 이하면 받을 수 있어요.
          </p>

          <Chips
            items={[
              { icon: '✅', label: '생계급여', value: '폐지', href: '#checker' },
              { icon: '⚠️', label: '의료급여', value: '유지', href: '#checker' },
              { icon: '✅', label: '주거급여', value: '폐지', href: '/w/주거급여-신청' },
              { icon: '✅', label: '교육급여', value: '폐지', href: '/w/교육급여-바우처-사용처-잔액-조회-방법' },
            ]}
          />
          ...
          <SpokeLinks
            title="부양의무자 더 알아보기"
            items={[
              { num: '01', heading: '기초생활수급자 조건과 급여 총정리', desc: '부양의무자 폐지 현황과 의료급여 예외 기준까지', href: '/w/기초생활수급자-조건-총정리' },
            ]}
          />
        </>
      ),
      pasBridge: {
        href: '/w/긴급복지-생계지원-신청-조건-금액',
...

    {
      ...
      pasBridge: {
        ...
        answer: <>위의 간편 체크에서 예상 수급 여부를 바로 확인해볼 수 있어요.</>,
        buttonText: '내 수급자격 체크하기 →',
      },
    },
  ...
  relatedSpokes: [
    { badge: '전체 조건', title: '기초생활수급자 조건과 급여 총정리', desc: '4가지 급여별 선정기준과 신청 방법', href: '/w/기초생활수급자-조건-총정리' },
    { badge: '긴급복지', title: '긴급복지 생계지원 신청 조건과 금액', desc: '선지급 후 조사, 최대 월 71만원', href: '/w/긴급복지-생계지원-신청-조건-금액' },
    { badge: '차상위', title: '차상위계층 혜택 리스트 및 증명서 발급', desc: '의료비 감면, 통신비 할인 등 혜택 확인', href: '/w/차상위계층-혜택-리스트-및-증명서-발급-방법' },
    { badge: '동시수급', title: '기초수급자 실업급여 동시수급 소득 영향', desc: '실업급여 받으면 수급자격 유지되는지 확인', href: '/w/기초수급자-실업급여-동시수급-소득-영향' },
    { badge: '압류방지', title: '생계비계좌 압류방지통장 행복지킴이 차이', desc: '수급비를 안전하게 보호하는 방법', href: '/w/생계비계좌-압류방지통장-행복지킴이-차이' },
  ],
