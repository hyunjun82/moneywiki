    ...
    /* ── S1: 수급 조건 ── */
    {
      ...
      content: (
        <>
          ...
          <SpokeRateBars
            bars={[
              { label: '퇴직 전 평균임금의 60%', rate: '60%', width: '60%' },
              { label: '1일 상한액 68,100원', rate: '68,100원', width: '85%' },
              { label: '1일 하한액 66,048원', rate: '66,048원', width: '83%' },
            ]}
          />
    ...
    /* ── S3: 상호주의 ── */
    {
      ...
      content: (
        <>
          ...
          <SpokeFlow
            steps={[
              { icon: '🌍', label: '본국법 확인', sub: '한국인에게 고용보험 상응 급여 지급 여부' },
              { icon: '🤝', label: '상호주의 충족', sub: '본국이 한국인 보호 시 → 한국도 적용' },
              { icon: '📋', label: '고용보험 가입', sub: '근로복지공단에 피보험자격 취득 신고' },
              { icon: '✅', label: '실업급여 수급', sub: '내국인과 동일한 4대 요건 충족 시' },
            ]}
          />
