    ...
    // ═══ SECTION 05: 가입 절차 — bridgeCTA 사용 (마지막 본문) ═══
    {
      ...
      content: (
        <>
          ...
          <SpokeStepCards
            items={[
              { step: '01', title: '계좌 확인', desc: '참여 금융기관 9곳 중 DC형 또는 IRP 계좌 보유 여부 확인' },
              { step: '02', title: '청약 기간 확인', desc: '기획재정부 국채 발행계획에서 매월 청약일 확인' },
              { step: '03', title: '만기 선택', desc: '10년물 또는 20년물 중 투자 목표에 맞게 선택' },
              { step: '04', title: '청약 금액 입력', desc: '모바일 앱이나 웹에서 금액 입력 후 청약 신청' },
              { step: '05', title: '배정 결과 확인', desc: '청약일 다음 날 배정 결과 확인 (300만원 우선 배정)' },
              { step: '06', title: '만기 보유', desc: '만기까지 보유 시 원금 + 가산금리(복리) 수령' },
            ]}
          />
