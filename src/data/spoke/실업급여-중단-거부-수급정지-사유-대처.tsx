...

    {
      ...
      content: (
        <>
          ...
          <DetailBox
            title="수급정지가 면제되는 정당한 사유 3가지"
            items={[
              { num: '01', heading: '직종이 능력에 안 맞는 경우', desc: '소개받은 직업이 본인의 경력·기술·자격과 맞지 않으면 거부할 수 있어요' },
              { num: '02', heading: '주거 이전이 곤란한 경우', desc: '취직을 위해 이사해야 하지만 가족 사정 등으로 이전이 어려운 경우예요' },
              { num: '03', heading: '임금이 20% 이상 낮은 경우', desc: '같은 지역·같은 직종의 통상 임금보다 20% 넘게 낮으면 정당한 거부로 인정돼요' },
            ]}
          />
