...

    {
      ...
      content: (
        <>
          ...
          <p className="text-neutral-600 mb-4 leading-relaxed">
            누적 한도에 도달하면 <a href="/w/ISA계좌-만기-해지-중도인출-연금전환-방법">만기</a>까지 기다렸다가 해지하고 바로 재가입하는 게 유리해요. 재가입하면 연간 2,000만원, 누적 1억원 한도가 처음부터 다시 시작돼요. <a href="/w/ISA계좌-비과세-한도-손익통산-절세-계산">비과세 한도</a>도 새로 받아요.
          </p>
