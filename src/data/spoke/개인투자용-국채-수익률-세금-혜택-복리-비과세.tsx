...
const data: SpokeData = {
  ...
  meta: {
    ...
    ogDescription: '복리 가산금리 + 분리과세 15.4% 절세 효과를 정리했어요.',
  },
  ...
  hero: {
    ...
    intro: (
      <p className="text-base text-neutral-500 leading-relaxed">
        "국채는 수익률이 낮다"고 생각하는 분 많죠? 은행 예금처럼 단리라면 그렇겠지만,
        개인투자용 국채는 가산금리가 연복리로 쌓여서 20년물은 만기 수익 147%까지 올라가요.
        거기에 분리과세 15.4%까지 적용되니 실수령 이자가 은행과 비교가 안 돼요.
        수익률 계산부터 절세 효과까지 차례대로 볼게요.
      </p>
    ),
    hubCTA: {
      badge: 'DC형 IRP 투자 조건 보기',
      desc: '투자 조건, 참여 금융기관 9곳, 신청 절차까지 정리돼 있어요',
    },
  },
  ...
  sections: [
    ...
    // SECTION 01: 수익률
    {
      ...
      pasBridge: {
        href: '/w/연금형-개인투자용-국채-신청-방법-10년물-20년물',
        question: '이 수익률로 국채를 사려면 전용계좌가 필요한 거 아셨나요?',
        answer: (
          <>
            참여 금융기관 <strong>9곳</strong> 중 1곳에서 전용계좌를 개설하면 돼요. 모바일 비대면으로 가능하고, DC형·IRP로도 바로 청약할 수 있어요.
          </>
        ),
        buttonText: '국채 청약 신청 절차 →',
      },
    ...
    // SECTION 02: 세금 혜택
    {
      ...
      pasBridge: {
        ...
        question: 'DC형이나 IRP로 투자하면 세액공제까지 받을 수 있을까요?',
        answer: (
          <>
            연금저축 합산 <strong>연 900만원 한도</strong>로 13.2~16.5% 세액공제를 받을 수 있어요. 분리과세 15.4%와 별개 혜택이에요.
          </>
        ),
    ...
    // SECTION 03: 복리 가산금리
    {
      ...
      pasBridge: {
        href: '/w/퇴직연금-국채-vs-ETF-비교-안정성-수익률',
        question: '복리 수익이 좋은 건 알겠는데, 20년 동안 자금이 묶이는 게 부담되시나요?',
        answer: (
          <>
            ETF는 언제든 매도할 수 있지만 원금 보장이 안 돼요. 국채는 묶이지만 <strong>원금 + 확정 수익</strong>이 보장돼요. 투자 성향에 따라 답이 달라요.
          </>
        ),
    ...
    // SECTION 04: 비과세 혜택 조건
    {
      ...
      bridgeCTA: {
        ...
        badge: '전체',
        title: '퇴직연금 국채 투자 전체를 한눈에 비교',
        desc: '투자 조건, 신청 절차, 금융기관까지 정리',
        icon: 'grid',
      },
    },
