...
const data: SpokeData = {
  ...
  hero: {
    badge: '2026년 기준',
    h1: <><span className="text-emerald-600">3주택자 양도세</span> 중과세율 계산과 비과세 조건</>,
    intro: (
      <>
  ...
  sections: [
    {
      ...
      content: (
        <>
          ...
          <RateCards cards={[
            { value: '기본세율', label: '유예 기간 중', lines: ['~2026.5.9', '6~45% + 장기공제 가능'], highlight: '지금', highlightColor: 'emerald' as const },
