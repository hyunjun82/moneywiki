...
// �Ӵ������û����
export const �Ӵ������û����_DATA: FormRow[] = [
  {
    fields: [
      { label: "���� ����", isHeader: true },
      { placeholder: "�Ӵ�� ���� û����", exampleValue: "�Ӵ�� ���� û����", colspan: 3 },
    ],
  },
  {
    fields: [
  ...
  {
    fields: [
      { label: "�Ӵ� ����", isHeader: true },
      { placeholder: "�ּ�", exampleValue: "����� ������ ������� 123, 101�� 202ȣ", colspan: 3 },
    ],
  },
  {
    fields: [
      { label: "���� �Ӵ��", isHeader: true },
      { placeholder: "�� �ݾ�", exampleValue: "�� 1,000,000��", colspan: 3 },
    ],
  },
  {
    fields: [
      { label: "���� ��û��", isHeader: true },
      { placeholder: "���� �� �ݾ�", exampleValue: "�� 1,050,000�� (5% ����)", colspan: 3 },
    ],
  },
  {
    fields: [
      { label: "���� ����", isHeader: true },
      { placeholder: "����", exampleValue: "������·� �ݿ� �� �α� �ü� ����", colspan: 3 },
    ],
  },
  {
    fields: [
      { label: "���� �ñ�", isHeader: true },
      { placeholder: "������", exampleValue: "2026�� 3�� 1�Ϻ���", colspan: 3 },
    ],
  },
  {
    fields: [
      { label: "û����", isHeader: true },
      { placeholder: "���� �� ����ó", exampleValue: "�Ӵ��� �̹δ�, ����ó: 010-1234-5678", colspan: 3 },
    ],
  },
];
// 청구서 양식 미리보기 데이터 (49개)
