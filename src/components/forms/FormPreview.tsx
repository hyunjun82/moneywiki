...
export const 기안서_DATA = [
  ...
  { fields: [{ placeholder: "기안 내용을 상세히 기재합니다.", exampleValue: "1. 사업명: 신규 ERP 도입 / 2. 예산: 50,000,000원 / 3. 목적: 업무 효율화", colspan: 4 }] },
...
export const 통지서_DATA = [
  ...
  { fields: [{ label: "통지 내용", isHeader: true, colspan: 4 }] },
  { fields: [{ placeholder: "통지 내용을 기재합니다.", exampleValue: "귀하의 근무지를 변경합니다. 변경일: 2026년 4월 1일 / 변경 전: 서울 본사 → 변경 후: 부산 지사", colspan: 4 }] },
