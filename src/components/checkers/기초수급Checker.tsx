...
const BENEFIT_LINKS = {
  ...
  m: { icon: '🏥', title: '의료급여 1종 2종 차이 — 병원비 0원 조건', desc: '본인부담금·건강보험료 면제 기준', href: '/w/의료급여-1종-2종-차이' },
  h: { icon: '🏠', title: '주거급여 임차료 지원금 — 최대 35만원', desc: '서울·경기·지방 기준임대료', href: '/w/주거급여-신청조건' },
  e: { icon: '📚', title: '교육급여 지원 항목 — 교육활동지원비', desc: '교과서 지원 · 교육활동지원비', href: '/w/교육급여-지원항목' },
}

const FAIL_LINKS = [
  { icon: '🛡️', title: '차상위계층 조건 — 소득 조금 넘어도 혜택받는 법', desc: '중위소득 50% 이하', href: '/w/차상위계층-조건-혜택' },
  { icon: '🆘', title: '긴급복지지원 신청 — 선지급 후 조사, 최대 71만원', desc: '즉시 지원', href: '/w/긴급복지지원-신청방법' },
]
