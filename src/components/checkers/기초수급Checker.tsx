...
const BENEFIT_LINKS = {
  s: { icon: '💰', title: '생계급여 실수령액 — 내가 받을 금액은?', desc: '소득인정액별 실수령액 예시', href: '/w/기초생활수급자-1인가구-생계급여-조건-소득인정액' },
  m: { icon: '🏥', title: '의료급여 조건 — 병원비 0원 조건', desc: '기초수급자 조건 전체 확인', href: '/w/기초생활수급자-조건-총정리' },
  h: { icon: '🏠', title: '주거급여 임차료 지원금 — 최대 35만원', desc: '서울·경기·지방 기준임대료', href: '/w/주거급여-신청' },
  e: { icon: '📚', title: '교육급여 바우처 사용처와 잔액 조회', desc: '교육활동지원비 사용 방법', href: '/w/교육급여-바우처-사용처-잔액-조회-방법' },
}

const FAIL_LINKS = [
  { icon: '🛡️', title: '차상위계층 혜택 — 소득 조금 넘어도 혜택받는 법', desc: '중위소득 50% 이하', href: '/w/차상위계층-혜택-리스트-및-증명서-발급-방법' },
  { icon: '🆘', title: '긴급복지 생계지원 — 선지급 후 조사, 최대 71만원', desc: '즉시 지원', href: '/w/긴급복지-생계지원-신청-조건-금액' },
]
