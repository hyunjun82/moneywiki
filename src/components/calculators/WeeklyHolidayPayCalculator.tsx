...
export default function WeeklyHolidayPayCalculator() {
  ...
  const MIN_WAGE_2026 = 10030; // 2026년 최저임금
      ...
      <div className="bg-gradient-to-r from-purple-600 to-violet-600 px-6 py-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-purple-100 text-sm">주 15시간 이상 근무 시 발생</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-6">
        <div className="mb-6">
          ...
          <div className="flex gap-2 mt-3">
            <button onClick={() => setHourlyWage(MIN_WAGE_2026)} className="flex-1 py-2 bg-purple-100 hover:bg-purple-200 text-purple-600 rounded-lg text-sm font-medium">최저시급</button>
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 border-2 border-neutral-200 rounded-xl focus:border-purple-500"
            >
        ...
        {hourlyWage > 0 && (
          <div className="bg-gradient-to-r from-purple-50 to-violet-50 rounded-2xl p-6 border border-purple-100">
            <h3 className="text-lg font-bold text-purple-800 mb-4">계산 결과</h3>
        ...
        <div className="mt-6 p-4 bg-amber-50 rounded-xl border border-amber-100">
          <h4 className="font-medium text-amber-800 mb-2">주휴수당이란?</h4>
