      ...
      <div className="bg-gradient-to-r from-[#1E3A5F] to-teal-600 px-6 py-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[#EDF2F8] text-sm">연봉 기준 소득세 계산</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-6">
        ...
        {result && (
          <div className="bg-gradient-to-r from-[#F5F8FB] to-teal-50 rounded-2xl p-6 border border-[#EDF2F8]">
            <h3 className="text-lg font-bold text-[#132A42] mb-4">소득세 계산 결과</h3>

            <div className="bg-white rounded-xl p-4 mb-4">
              <div className="text-sm text-neutral-500 mb-1">연간 소득세 + 지방소득세</div>
              <div className="text-3xl font-bold text-[#1E3A5F]">{formatNumber(result.totalTax)}원</div>
            ...
            <div className="bg-white rounded-xl p-4 space-y-2 text-sm">
              ...
              <div className="flex justify-between font-bold border-t pt-2 text-[#1E3A5F]">
                <span>총 납부세액</span>
          ...
          <div className="grid grid-cols-2 gap-2 text-sm">
            {taxBrackets.map((bracket, i) => (
              <div key={i} className="flex justify-between p-2 bg-white rounded">
                ...
                <span className="font-medium text-[#1E3A5F]">{bracket.rate}</span>
              </div>
            ))}
          </div>
        </div>
