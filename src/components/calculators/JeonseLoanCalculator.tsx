      ...
      <div className="bg-gradient-to-r from-violet-600 to-purple-600 px-6 py-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-violet-100 text-sm">월 이자와 총 비용 계산</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-6">
          ...
          <div className="grid grid-cols-3 gap-2">
            {[
              ...
              >
                ...
                <div className="text-xs text-violet-600">{type.rate}</div>
        ...
        <div className="mb-6">
          ...
          <div className="relative">
            <input
              ...
              placeholder="대출받을 금액"
              className="w-full px-4 py-4 text-xl font-bold border-2 border-neutral-200 rounded-xl focus:border-violet-500 focus:ring-0 transition-colors text-right pr-12"
            />
            <span className="absolute right-4 top-1/2 -translate-y-1/2 text-neutral-500">원</span>
          </div>
          {loanAmount > 0 && (
            <p className="mt-1 text-sm text-violet-600">{formatWon(loanAmount)}</p>
          )}
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          ...
          <div>
            ...
            <input
              ...
              min="0"
              max="20"
              className="w-full px-4 py-3 border-2 border-neutral-200 rounded-xl focus:border-violet-500 focus:ring-0 transition-colors text-right"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-3 border-2 border-neutral-200 rounded-xl focus:border-violet-500 focus:ring-0 transition-colors"
            >
        ...
        {loanAmount > 0 && (
          <div className="bg-gradient-to-r from-violet-50 to-purple-50 rounded-2xl p-6 border border-violet-100">
            <h3 className="text-lg font-bold text-violet-800 mb-4">계산 결과</h3>
            ...
            <button
              ...
              className="w-full mt-4 py-3 text-sm text-violet-600 hover:text-violet-700 font-medium flex items-center justify-center gap-2"
            >
            ...
            {showSchedule && schedule.length > 0 && (
              <div className="mt-4 bg-white rounded-xl overflow-hidden border border-violet-100">
        ...
        <div className="mt-6 p-4 bg-violet-50 rounded-xl border border-violet-100">
          <h4 className="font-medium text-violet-800 mb-3">전세대출 상품 비교</h4>
