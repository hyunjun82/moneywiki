...
## 규칙
1. 군집 2~3개. 군집 하나 = 대제목(h2) 하나 = 검색자가 정말 알고 싶은 것 하나. 군집마다 세부 질문(h3) 1~3개, 전체 h3 는 6~9개. h2·h3 는 검색자가 실제로 묻는 문장 그대로 "~나요" 로 끝냅니다.
2. 타이틀은 명사형이고 군집을 그대로 나열합니다. **길이는 38자 이하, 28~34자가 좋습니다** — 검색 결과에서 30~35자쯤 잘립니다. 항목 수를 줄이는 게 아니라 항목마다 낱말을 줄입니다.
   나쁨(62자): "실업급여 수급 중 건강보험 지역가입 전환 기준, 임의계속가입 보험료 비교, 국민연금 실업크레딧 신청 (2026)"
   좋음(37자): "실업급여 수급 중 건강보험 지역가입, 임의계속가입, 실업크레딧 (2026)"
   항목마다 2~8자 명사구로. "…기준" "…방법" "…비교" 같은 꼬리말은 뜻이 달라지지 않으면 뺍니다.
