---
title: 퇴직금 IRP 수령·절차·방법 안내
description: 퇴직금 IRP 수령 절차와 방법, 연금 vs 일시금 선택, 세금 차이를 알려드려요
category: 퇴직금
keywords:
  - 퇴직금
  - IRP 수령
...
author: 머니위키 에디터
summary:
  - IRP 퇴직금은 55세 이후 연금으로 또는 퇴직 시 일시금으로 수령 가능해요
  - 연금 수령 시 퇴직소득세가 30~40% 감면되어 더 유리해요
  - 중도해지 시 기타소득세 16.5% 부과로 손실이 발생하니 가능하면 유지하세요
sources:
  ...
  - name: 금융감독원 통합연금포털
    ...
    date: 2026-01
faq:
  - question: IRP 퇴직금은 언제부터 받을 수 있나요?
    answer: 55세 이후 연금으로, 또는 퇴직 시 일시금으로 받을 수 있어요.
  - question: 연금으로 받으면 세금이 줄어드나요?
    answer: 네. 퇴직소득세의 30~40%를 깎아줘요. 세금 측면에서 매우 유리해요.
  - question: IRP 중도해지하면 세금을 얼마나 내나요?
    answer: 기타소득세 16.5%를 내야 해요. 손실이 크므로 가능하면 55세까지 유지하세요.
