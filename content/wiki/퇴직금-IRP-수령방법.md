---
title: IRP 퇴직금·수령·연금 전환
description: IRP 퇴직금을 연금으로 받는 방법과 일시금, 중도해지 세금 차이를 알려드려요
category: 근로/노동
keywords:
  - IRP 퇴직금
  - 퇴직금 수령
...
author: 머니위키 에디터
summary:
  - IRP 퇴직금은 55세부터 연금으로, 언제든지 일시금으로 수령할 수 있어요
  - 연금으로 받으면 퇴직소득세가 30~40% 감면돼 가장 유리한 방법이에요
  - 중도해지 시 기타소득세 16.5%가 부과되니 특별한 사유 없으면 피하세요
sources:
